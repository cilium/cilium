...
var pollerCmd = &cobra.Command{
	Use:   "fqdn-poller",
	Short: "Prepare for fqdn-poller upgrades to cilium 1.4",
	Long: `Prepare for fqdn-poller upgrades to cilium 1.4 by creating a
...
fqdn-poller policies where an interruption in allowed IPs is undesirable. It
may also be used when switching from fqdn-poller based DNS discovery to DNS
Proxy based discovery where an endpoint may not make an interceptable DNS
request soon enough to be used by toFQDNs policy rules`,
