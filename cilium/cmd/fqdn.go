...
func init() {
	...
	fqdnCleanCacheCmd.Flags().StringVarP(&fqdnCacheClearCIDR, "cidr", "c", "", "Cache entries from given CIDR range will be deleted")
...
func cleanFQDNCache() {
	...
	if fqdnCacheClearCIDR != "" {
		params.SetCidr(&fqdnCacheClearCIDR)
	}
