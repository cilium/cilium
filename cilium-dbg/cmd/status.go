...
func init() {
	...
	statusCmd.Flags().BoolVar(&withoutK8sConnectivity, "without-k8s-connectivity", false, "whether the result of connectivity check to kube-apiserver should affect the result of health status of daemon")
...
func statusDaemon() {
	...
	params.SetWithoutK8sConnectivity(&withoutK8sConnectivity)
