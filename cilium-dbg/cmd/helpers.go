...
func parseL4PortsSlice(slice []string) ([]*models.Port, error) {
	...
	for _, v := range slice {
		...
		case 2:
			...
			switch protoStr {
			case models.PortProtocolTCP, models.PortProtocolUDP, models.PortProtocolSCTP, models.PortProtocolICMP, models.PortProtocolICMPV6, models.PortProtocolVRRP, models.PortProtocolANY:
			default:
