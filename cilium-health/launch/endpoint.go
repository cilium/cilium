...
func LaunchAsEndpoint(owner endpoint.Owner, node *node.Node, mtuConfig mtu.Configuration) (*Client, error) {
	var (
	...
	hostAddressing := node.GetModel().PrimaryAddress
