...
func (x *AttachmentContext) GetNetwork() *AttachmentContext_Network {
	if x != nil {
		if x, ok := x.Context.(*AttachmentContext_Network_); ok {
			return x.Network
		}
	}
	return nil
...
type AttachmentContext_Network_ struct {
	Network *AttachmentContext_Network `protobuf:"bytes,3,opt,name=network,proto3,oneof"`
}

type AttachmentContext_Overlay_ struct {
	Overlay *AttachmentContext_Overlay `protobuf:"bytes,4,opt,name=overlay,proto3,oneof"`
}

type AttachmentContext_Socket_ struct {
	Socket *AttachmentContext_Socket `protobuf:"bytes,5,opt,name=socket,proto3,oneof"`
}

type AttachmentContext_Wireguard_ struct {
	Wireguard *AttachmentContext_Wireguard `protobuf:"bytes,6,opt,name=wireguard,proto3,oneof"`
}

type AttachmentContext_Xdp struct {
	Xdp *AttachmentContext_XDP `protobuf:"bytes,7,opt,name=xdp,proto3,oneof"`
}
...
func (*AttachmentContext_Network_) isAttachmentContext_Context() {}
...
func (*AttachmentContext_PodInfo) Descriptor() ([]byte, []int) {
	return file_datapathplugins_datapathplugins_proto_rawDescGZIP(), []int{1, 1}
}
...
func (*AttachmentContext_Host) Descriptor() ([]byte, []int) {
	return file_datapathplugins_datapathplugins_proto_rawDescGZIP(), []int{1, 2}
}
...
func (*AttachmentContext_LXC) Descriptor() ([]byte, []int) {
	return file_datapathplugins_datapathplugins_proto_rawDescGZIP(), []int{1, 3}
}
...
func (*AttachmentContext_Network) Descriptor() ([]byte, []int) {
	return file_datapathplugins_datapathplugins_proto_rawDescGZIP(), []int{1, 4}
}
...
func (*AttachmentContext_Overlay) Descriptor() ([]byte, []int) {
	return file_datapathplugins_datapathplugins_proto_rawDescGZIP(), []int{1, 5}
}
...
func (*AttachmentContext_Socket) Descriptor() ([]byte, []int) {
	return file_datapathplugins_datapathplugins_proto_rawDescGZIP(), []int{1, 6}
}
...
func (*AttachmentContext_Wireguard) Descriptor() ([]byte, []int) {
	return file_datapathplugins_datapathplugins_proto_rawDescGZIP(), []int{1, 7}
}
...
func (*AttachmentContext_XDP) Descriptor() ([]byte, []int) {
	return file_datapathplugins_datapathplugins_proto_rawDescGZIP(), []int{1, 8}
}
...
func (x *InstrumentCollectionRequest_Collection_Program) Reset() {
	*x = InstrumentCollectionRequest_Collection_Program{}
	mi := &file_datapathplugins_datapathplugins_proto_msgTypes[24]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *InstrumentCollectionRequest_Collection_Map) Reset() {
	*x = InstrumentCollectionRequest_Collection_Map{}
	mi := &file_datapathplugins_datapathplugins_proto_msgTypes[25]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *InstrumentCollectionRequest_Hook_AttachTarget) Reset() {
	*x = InstrumentCollectionRequest_Hook_AttachTarget{}
	mi := &file_datapathplugins_datapathplugins_proto_msgTypes[28]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
const file_datapathplugins_datapathplugins_proto_rawDesc = "" +
	...
	"\anetwork\x18\x03 \x01(\v2*.datapathplugins.AttachmentContext.NetworkH\x00R\anetwork\x12F\n" +
	"\aoverlay\x18\x04 \x01(\v2*.datapathplugins.AttachmentContext.OverlayH\x00R\aoverlay\x12C\n" +
	"\x06socket\x18\x05 \x01(\v2).datapathplugins.AttachmentContext.SocketH\x00R\x06socket\x12L\n" +
	"\twireguard\x18\x06 \x01(\v2,.datapathplugins.AttachmentContext.WireguardH\x00R\twireguard\x12:\n" +
	"\x03xdp\x18\a \x01(\v2&.datapathplugins.AttachmentContext.XDPH\x00R\x03xdp\x1a#\n" +
...
var file_datapathplugins_datapathplugins_proto_msgTypes = make([]protoimpl.MessageInfo, 29)
var file_datapathplugins_datapathplugins_proto_goTypes = []any{
	...
	(*AttachmentContext_InterfaceInfo)(nil),                     // 8: datapathplugins.AttachmentContext.InterfaceInfo
	(*AttachmentContext_PodInfo)(nil),                           // 9: datapathplugins.AttachmentContext.PodInfo
	(*AttachmentContext_Host)(nil),                              // 10: datapathplugins.AttachmentContext.Host
	(*AttachmentContext_LXC)(nil),                               // 11: datapathplugins.AttachmentContext.LXC
	(*AttachmentContext_Network)(nil),                           // 12: datapathplugins.AttachmentContext.Network
	(*AttachmentContext_Overlay)(nil),                           // 13: datapathplugins.AttachmentContext.Overlay
	(*AttachmentContext_Socket)(nil),                            // 14: datapathplugins.AttachmentContext.Socket
	(*AttachmentContext_Wireguard)(nil),                         // 15: datapathplugins.AttachmentContext.Wireguard
	(*AttachmentContext_XDP)(nil),                               // 16: datapathplugins.AttachmentContext.XDP
	(*PrepareCollectionRequest_CollectionSpec)(nil),             // 17: datapathplugins.PrepareCollectionRequest.CollectionSpec
	(*PrepareCollectionRequest_CollectionSpec_ProgramSpec)(nil), // 18: datapathplugins.PrepareCollectionRequest.CollectionSpec.ProgramSpec
	(*PrepareCollectionRequest_CollectionSpec_MapSpec)(nil),     // 19: datapathplugins.PrepareCollectionRequest.CollectionSpec.MapSpec
	nil, // 20: datapathplugins.PrepareCollectionRequest.CollectionSpec.ProgramsEntry
	nil, // 21: datapathplugins.PrepareCollectionRequest.CollectionSpec.MapsEntry
	(*PrepareCollectionResponse_HookSpec)(nil),                    // 22: datapathplugins.PrepareCollectionResponse.HookSpec
	(*PrepareCollectionResponse_HookSpec_OrderingConstraint)(nil), // 23: datapathplugins.PrepareCollectionResponse.HookSpec.OrderingConstraint
	(*InstrumentCollectionRequest_Collection)(nil),                // 24: datapathplugins.InstrumentCollectionRequest.Collection
	(*InstrumentCollectionRequest_Hook)(nil),                      // 25: datapathplugins.InstrumentCollectionRequest.Hook
	(*InstrumentCollectionRequest_Collection_Program)(nil),        // 26: datapathplugins.InstrumentCollectionRequest.Collection.Program
	(*InstrumentCollectionRequest_Collection_Map)(nil),            // 27: datapathplugins.InstrumentCollectionRequest.Collection.Map
	nil, // 28: datapathplugins.InstrumentCollectionRequest.Collection.ProgramsEntry
	nil, // 29: datapathplugins.InstrumentCollectionRequest.Collection.MapsEntry
	(*InstrumentCollectionRequest_Hook_AttachTarget)(nil), // 30: datapathplugins.InstrumentCollectionRequest.Hook.AttachTarget
}
var file_datapathplugins_datapathplugins_proto_depIdxs = []int32{
	10, // 0: datapathplugins.AttachmentContext.host:type_name -> datapathplugins.AttachmentContext.Host
	11, // 1: datapathplugins.AttachmentContext.lxc:type_name -> datapathplugins.AttachmentContext.LXC
	12, // 2: datapathplugins.AttachmentContext.network:type_name -> datapathplugins.AttachmentContext.Network
	13, // 3: datapathplugins.AttachmentContext.overlay:type_name -> datapathplugins.AttachmentContext.Overlay
	14, // 4: datapathplugins.AttachmentContext.socket:type_name -> datapathplugins.AttachmentContext.Socket
	15, // 5: datapathplugins.AttachmentContext.wireguard:type_name -> datapathplugins.AttachmentContext.Wireguard
	16, // 6: datapathplugins.AttachmentContext.xdp:type_name -> datapathplugins.AttachmentContext.XDP
	17, // 7: datapathplugins.PrepareCollectionRequest.collection:type_name -> datapathplugins.PrepareCollectionRequest.CollectionSpec
	2,  // 8: datapathplugins.PrepareCollectionRequest.local_node_config:type_name -> datapathplugins.LocalNodeConfig
	3,  // 9: datapathplugins.PrepareCollectionRequest.attachment_context:type_name -> datapathplugins.AttachmentContext
	22, // 10: datapathplugins.PrepareCollectionResponse.hooks:type_name -> datapathplugins.PrepareCollectionResponse.HookSpec
	24, // 11: datapathplugins.InstrumentCollectionRequest.collection:type_name -> datapathplugins.InstrumentCollectionRequest.Collection
	2,  // 12: datapathplugins.InstrumentCollectionRequest.local_node_config:type_name -> datapathplugins.LocalNodeConfig
	3,  // 13: datapathplugins.InstrumentCollectionRequest.attachment_context:type_name -> datapathplugins.AttachmentContext
	25, // 14: datapathplugins.InstrumentCollectionRequest.hooks:type_name -> datapathplugins.InstrumentCollectionRequest.Hook
	8,  // 15: datapathplugins.AttachmentContext.Host.iface:type_name -> datapathplugins.AttachmentContext.InterfaceInfo
	8,  // 16: datapathplugins.AttachmentContext.LXC.iface:type_name -> datapathplugins.AttachmentContext.InterfaceInfo
	9,  // 17: datapathplugins.AttachmentContext.LXC.pod_info:type_name -> datapathplugins.AttachmentContext.PodInfo
	8,  // 18: datapathplugins.AttachmentContext.Overlay.iface:type_name -> datapathplugins.AttachmentContext.InterfaceInfo
	8,  // 19: datapathplugins.AttachmentContext.Wireguard.iface:type_name -> datapathplugins.AttachmentContext.InterfaceInfo
	8,  // 20: datapathplugins.AttachmentContext.XDP.iface:type_name -> datapathplugins.AttachmentContext.InterfaceInfo
	20, // 21: datapathplugins.PrepareCollectionRequest.CollectionSpec.programs:type_name -> datapathplugins.PrepareCollectionRequest.CollectionSpec.ProgramsEntry
	21, // 22: datapathplugins.PrepareCollectionRequest.CollectionSpec.maps:type_name -> datapathplugins.PrepareCollectionRequest.CollectionSpec.MapsEntry
	18, // 23: datapathplugins.PrepareCollectionRequest.CollectionSpec.ProgramsEntry.value:type_name -> datapathplugins.PrepareCollectionRequest.CollectionSpec.ProgramSpec
	19, // 24: datapathplugins.PrepareCollectionRequest.CollectionSpec.MapsEntry.value:type_name -> datapathplugins.PrepareCollectionRequest.CollectionSpec.MapSpec
	0,  // 25: datapathplugins.PrepareCollectionResponse.HookSpec.type:type_name -> datapathplugins.HookType
	23, // 26: datapathplugins.PrepareCollectionResponse.HookSpec.constraints:type_name -> datapathplugins.PrepareCollectionResponse.HookSpec.OrderingConstraint
	1,  // 27: datapathplugins.PrepareCollectionResponse.HookSpec.OrderingConstraint.order:type_name -> datapathplugins.PrepareCollectionResponse.HookSpec.OrderingConstraint.Order
	28, // 28: datapathplugins.InstrumentCollectionRequest.Collection.programs:type_name -> datapathplugins.InstrumentCollectionRequest.Collection.ProgramsEntry
	29, // 29: datapathplugins.InstrumentCollectionRequest.Collection.maps:type_name -> datapathplugins.InstrumentCollectionRequest.Collection.MapsEntry
	0,  // 30: datapathplugins.InstrumentCollectionRequest.Hook.type:type_name -> datapathplugins.HookType
	30, // 31: datapathplugins.InstrumentCollectionRequest.Hook.attach_target:type_name -> datapathplugins.InstrumentCollectionRequest.Hook.AttachTarget
	26, // 32: datapathplugins.InstrumentCollectionRequest.Collection.ProgramsEntry.value:type_name -> datapathplugins.InstrumentCollectionRequest.Collection.Program
	27, // 33: datapathplugins.InstrumentCollectionRequest.Collection.MapsEntry.value:type_name -> datapathplugins.InstrumentCollectionRequest.Collection.Map
	4,  // 34: datapathplugins.DatapathPlugin.PrepareCollection:input_type -> datapathplugins.PrepareCollectionRequest
	6,  // 35: datapathplugins.DatapathPlugin.InstrumentCollection:input_type -> datapathplugins.InstrumentCollectionRequest
	5,  // 36: datapathplugins.DatapathPlugin.PrepareCollection:output_type -> datapathplugins.PrepareCollectionResponse
	7,  // 37: datapathplugins.DatapathPlugin.InstrumentCollection:output_type -> datapathplugins.InstrumentCollectionResponse
...
func file_datapathplugins_datapathplugins_proto_init() {
	...
	file_datapathplugins_datapathplugins_proto_msgTypes[1].OneofWrappers = []any{
		...
		(*AttachmentContext_Network_)(nil),
