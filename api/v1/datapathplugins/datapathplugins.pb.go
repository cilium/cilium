...
func (HookType) Descriptor() protoreflect.EnumDescriptor {
	return file_datapathplugins_proto_enumTypes[0].Descriptor()
}

func (HookType) Type() protoreflect.EnumType {
	return &file_datapathplugins_proto_enumTypes[0]
}
...
func (HookType) EnumDescriptor() ([]byte, []int) {
	return file_datapathplugins_proto_rawDescGZIP(), []int{0}
}
...
func (PrepareCollectionResponse_HookSpec_OrderingConstraint_Order) Descriptor() protoreflect.EnumDescriptor {
	return file_datapathplugins_proto_enumTypes[1].Descriptor()
}

func (PrepareCollectionResponse_HookSpec_OrderingConstraint_Order) Type() protoreflect.EnumType {
	return &file_datapathplugins_proto_enumTypes[1]
}
...
func (PrepareCollectionResponse_HookSpec_OrderingConstraint_Order) EnumDescriptor() ([]byte, []int) {
	return file_datapathplugins_proto_rawDescGZIP(), []int{4, 0, 0, 0}
}
...
func (x *LocalNodeConfig) Reset() {
	*x = LocalNodeConfig{}
	mi := &file_datapathplugins_proto_msgTypes[0]
...
func (x *AttachmentContext) Reset() {
	*x = AttachmentContext{}
	mi := &file_datapathplugins_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AttachmentContext) Descriptor() ([]byte, []int) {
	return file_datapathplugins_proto_rawDescGZIP(), []int{1}
}
...
func (x *Config) Reset() {
	*x = Config{}
	mi := &file_datapathplugins_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Config) Descriptor() ([]byte, []int) {
	return file_datapathplugins_proto_rawDescGZIP(), []int{2}
}
...
func (x *Config) GetHost() *BPFHost {
	if x != nil {
		if x, ok := x.Config.(*Config_Host); ok {
			return x.Host
		}
	}
	return nil
...
func (x *Config) GetLxc() *BPFLXC {
	if x != nil {
		if x, ok := x.Config.(*Config_Lxc); ok {
			return x.Lxc
		}
	}
	return nil
...
func (x *Config) GetOverlay() *BPFOverlay {
	if x != nil {
		if x, ok := x.Config.(*Config_Overlay); ok {
			return x.Overlay
		}
	}
	return nil
...
func (x *Config) GetSocket() *BPFSock {
	if x != nil {
		if x, ok := x.Config.(*Config_Socket); ok {
			return x.Socket
		}
	}
	return nil
...
func (x *Config) GetWireguard() *BPFWireguard {
	if x != nil {
		if x, ok := x.Config.(*Config_Wireguard); ok {
			return x.Wireguard
		}
	}
	return nil
...
func (x *Config) GetXdp() *BPFXDP {
	if x != nil {
		if x, ok := x.Config.(*Config_Xdp); ok {
			return x.Xdp
		}
	}
	return nil
...
type Config_Host struct {
	Host *BPFHost `protobuf:"bytes,1,opt,name=host,proto3,oneof"`
}

type Config_Lxc struct {
	Lxc *BPFLXC `protobuf:"bytes,2,opt,name=lxc,proto3,oneof"`
}

type Config_Overlay struct {
	Overlay *BPFOverlay `protobuf:"bytes,3,opt,name=overlay,proto3,oneof"`
}

type Config_Socket struct {
	Socket *BPFSock `protobuf:"bytes,4,opt,name=socket,proto3,oneof"`
}

type Config_Wireguard struct {
	Wireguard *BPFWireguard `protobuf:"bytes,5,opt,name=wireguard,proto3,oneof"`
}

type Config_Xdp struct {
	Xdp *BPFXDP `protobuf:"bytes,6,opt,name=xdp,proto3,oneof"`
}

func (*Config_Host) isConfig_Config() {}

func (*Config_Lxc) isConfig_Config() {}

func (*Config_Overlay) isConfig_Config() {}

func (*Config_Socket) isConfig_Config() {}

func (*Config_Wireguard) isConfig_Config() {}

func (*Config_Xdp) isConfig_Config() {}
...
func (x *PrepareCollectionRequest) Reset() {
	*x = PrepareCollectionRequest{}
	mi := &file_datapathplugins_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*PrepareCollectionRequest) Descriptor() ([]byte, []int) {
	return file_datapathplugins_proto_rawDescGZIP(), []int{3}
}
...
func (x *PrepareCollectionRequest) GetConfig() *Config {
	if x != nil {
		return x.Config
	}
	return nil
...
func (x *PrepareCollectionResponse) Reset() {
	*x = PrepareCollectionResponse{}
	mi := &file_datapathplugins_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*PrepareCollectionResponse) Descriptor() ([]byte, []int) {
	return file_datapathplugins_proto_rawDescGZIP(), []int{4}
}
...
type InstrumentCollectionRequest struct {
	...
	AttachmentContext *AttachmentContext                      `protobuf:"bytes,3,opt,name=attachment_context,json=attachmentContext,proto3" json:"attachment_context,omitempty"`
	Config            *Config                                 `protobuf:"bytes,4,opt,name=config,proto3" json:"config,omitempty"`
	Hooks             []*InstrumentCollectionRequest_Hook     `protobuf:"bytes,5,rep,name=hooks,proto3" json:"hooks,omitempty"`
	Pins              string                                  `protobuf:"bytes,6,opt,name=pins,proto3" json:"pins,omitempty"`
...
func (x *InstrumentCollectionRequest) Reset() {
	*x = InstrumentCollectionRequest{}
	mi := &file_datapathplugins_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*InstrumentCollectionRequest) Descriptor() ([]byte, []int) {
	return file_datapathplugins_proto_rawDescGZIP(), []int{5}
}
...
func (x *InstrumentCollectionRequest) GetConfig() *Config {
	if x != nil {
		return x.Config
	}
	return nil
...
func (x *InstrumentCollectionResponse) Reset() {
	*x = InstrumentCollectionResponse{}
	mi := &file_datapathplugins_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*InstrumentCollectionResponse) Descriptor() ([]byte, []int) {
	return file_datapathplugins_proto_rawDescGZIP(), []int{6}
}
...
func (x *AttachmentContext_InterfaceInfo) Reset() {
	*x = AttachmentContext_InterfaceInfo{}
	mi := &file_datapathplugins_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AttachmentContext_InterfaceInfo) Descriptor() ([]byte, []int) {
	return file_datapathplugins_proto_rawDescGZIP(), []int{1, 0}
}
...
func (x *AttachmentContext_PodInfo) Reset() {
	*x = AttachmentContext_PodInfo{}
	mi := &file_datapathplugins_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AttachmentContext_PodInfo) Descriptor() ([]byte, []int) {
	return file_datapathplugins_proto_rawDescGZIP(), []int{1, 1}
}
...
func (x *AttachmentContext_Host) Reset() {
	*x = AttachmentContext_Host{}
	mi := &file_datapathplugins_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AttachmentContext_Host) Descriptor() ([]byte, []int) {
	return file_datapathplugins_proto_rawDescGZIP(), []int{1, 2}
}
...
func (x *AttachmentContext_LXC) Reset() {
	*x = AttachmentContext_LXC{}
	mi := &file_datapathplugins_proto_msgTypes[10]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AttachmentContext_LXC) Descriptor() ([]byte, []int) {
	return file_datapathplugins_proto_rawDescGZIP(), []int{1, 3}
}
...
type AttachmentContext_Network struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *AttachmentContext_Network) Reset() {
	*x = AttachmentContext_Network{}
	mi := &file_datapathplugins_proto_msgTypes[11]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *AttachmentContext_Network) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AttachmentContext_Network) ProtoMessage() {}

func (x *AttachmentContext_Network) ProtoReflect() protoreflect.Message {
	mi := &file_datapathplugins_proto_msgTypes[11]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AttachmentContext_Network.ProtoReflect.Descriptor instead.
func (*AttachmentContext_Network) Descriptor() ([]byte, []int) {
	return file_datapathplugins_proto_rawDescGZIP(), []int{1, 4}
}
...
func (x *AttachmentContext_Overlay) Reset() {
	*x = AttachmentContext_Overlay{}
	mi := &file_datapathplugins_proto_msgTypes[12]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AttachmentContext_Overlay) Descriptor() ([]byte, []int) {
	return file_datapathplugins_proto_rawDescGZIP(), []int{1, 5}
}
...
func (x *AttachmentContext_Socket) Reset() {
	*x = AttachmentContext_Socket{}
	mi := &file_datapathplugins_proto_msgTypes[13]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AttachmentContext_Socket) Descriptor() ([]byte, []int) {
	return file_datapathplugins_proto_rawDescGZIP(), []int{1, 6}
}
...
func (x *AttachmentContext_Wireguard) Reset() {
	*x = AttachmentContext_Wireguard{}
	mi := &file_datapathplugins_proto_msgTypes[14]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AttachmentContext_Wireguard) Descriptor() ([]byte, []int) {
	return file_datapathplugins_proto_rawDescGZIP(), []int{1, 7}
}
...
func (x *AttachmentContext_XDP) Reset() {
	*x = AttachmentContext_XDP{}
	mi := &file_datapathplugins_proto_msgTypes[15]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AttachmentContext_XDP) Descriptor() ([]byte, []int) {
	return file_datapathplugins_proto_rawDescGZIP(), []int{1, 8}
}
...
func (x *PrepareCollectionRequest_CollectionSpec) Reset() {
	*x = PrepareCollectionRequest_CollectionSpec{}
	mi := &file_datapathplugins_proto_msgTypes[16]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*PrepareCollectionRequest_CollectionSpec) Descriptor() ([]byte, []int) {
	return file_datapathplugins_proto_rawDescGZIP(), []int{3, 0}
}
...
func (x *PrepareCollectionRequest_CollectionSpec_ProgramSpec) Reset() {
	*x = PrepareCollectionRequest_CollectionSpec_ProgramSpec{}
	mi := &file_datapathplugins_proto_msgTypes[17]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*PrepareCollectionRequest_CollectionSpec_ProgramSpec) Descriptor() ([]byte, []int) {
	return file_datapathplugins_proto_rawDescGZIP(), []int{3, 0, 0}
}
...
func (x *PrepareCollectionRequest_CollectionSpec_MapSpec) Reset() {
	*x = PrepareCollectionRequest_CollectionSpec_MapSpec{}
	mi := &file_datapathplugins_proto_msgTypes[18]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*PrepareCollectionRequest_CollectionSpec_MapSpec) Descriptor() ([]byte, []int) {
	return file_datapathplugins_proto_rawDescGZIP(), []int{3, 0, 1}
}
...
func (x *PrepareCollectionResponse_HookSpec) Reset() {
	*x = PrepareCollectionResponse_HookSpec{}
	mi := &file_datapathplugins_proto_msgTypes[21]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*PrepareCollectionResponse_HookSpec) Descriptor() ([]byte, []int) {
	return file_datapathplugins_proto_rawDescGZIP(), []int{4, 0}
}
...
func (x *PrepareCollectionResponse_HookSpec_OrderingConstraint) Reset() {
	*x = PrepareCollectionResponse_HookSpec_OrderingConstraint{}
	mi := &file_datapathplugins_proto_msgTypes[22]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*PrepareCollectionResponse_HookSpec_OrderingConstraint) Descriptor() ([]byte, []int) {
	return file_datapathplugins_proto_rawDescGZIP(), []int{4, 0, 0}
}
...
func (x *InstrumentCollectionRequest_Collection) Reset() {
	*x = InstrumentCollectionRequest_Collection{}
	mi := &file_datapathplugins_proto_msgTypes[23]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*InstrumentCollectionRequest_Collection) Descriptor() ([]byte, []int) {
	return file_datapathplugins_proto_rawDescGZIP(), []int{5, 0}
}
...
func (x *InstrumentCollectionRequest_Hook) Reset() {
	*x = InstrumentCollectionRequest_Hook{}
	mi := &file_datapathplugins_proto_msgTypes[24]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*InstrumentCollectionRequest_Hook) Descriptor() ([]byte, []int) {
	return file_datapathplugins_proto_rawDescGZIP(), []int{5, 1}
}
...
func (x *InstrumentCollectionRequest_Collection_Program) Reset() {
	*x = InstrumentCollectionRequest_Collection_Program{}
	mi := &file_datapathplugins_proto_msgTypes[25]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*InstrumentCollectionRequest_Collection_Program) Descriptor() ([]byte, []int) {
	return file_datapathplugins_proto_rawDescGZIP(), []int{5, 0, 0}
}
...
func (x *InstrumentCollectionRequest_Collection_Map) Reset() {
	*x = InstrumentCollectionRequest_Collection_Map{}
	mi := &file_datapathplugins_proto_msgTypes[26]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*InstrumentCollectionRequest_Collection_Map) Descriptor() ([]byte, []int) {
	return file_datapathplugins_proto_rawDescGZIP(), []int{5, 0, 1}
}
...
func (x *InstrumentCollectionRequest_Hook_AttachTarget) Reset() {
	*x = InstrumentCollectionRequest_Hook_AttachTarget{}
	mi := &file_datapathplugins_proto_msgTypes[29]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*InstrumentCollectionRequest_Hook_AttachTarget) Descriptor() ([]byte, []int) {
	return file_datapathplugins_proto_rawDescGZIP(), []int{5, 1, 0}
}
...
var File_datapathplugins_proto protoreflect.FileDescriptor

const file_datapathplugins_proto_rawDesc = "" +
	"\n" +
	"\x15datapathplugins.proto\x12\x0fdatapathplugins\x1a\x11host_config.proto\x1a\x10lxc_config.proto\x1a\x14overlay_config.proto\x1a\x11sock_config.proto\x1a\x16wireguard_config.proto\x1a\x10xdp_config.proto\"\x11\n" +
	"\x0fLocalNodeConfig\"\xb3\b\n" +
	...
	"\bpod_info\x18\x02 \x01(\v2*.datapathplugins.AttachmentContext.PodInfoR\apodInfo\x1a\t\n" +
	"\aNetwork\x1aQ\n" +
	"\aOverlay\x12F\n" +
	...
	"\acontext\"\xc8\x02\n" +
	"\x06Config\x12.\n" +
	"\x04host\x18\x01 \x01(\v2\x18.datapathplugins.BPFHostH\x00R\x04host\x12+\n" +
	"\x03lxc\x18\x02 \x01(\v2\x17.datapathplugins.BPFLXCH\x00R\x03lxc\x127\n" +
	"\aoverlay\x18\x03 \x01(\v2\x1b.datapathplugins.BPFOverlayH\x00R\aoverlay\x122\n" +
	"\x06socket\x18\x04 \x01(\v2\x18.datapathplugins.BPFSockH\x00R\x06socket\x12=\n" +
	"\twireguard\x18\x05 \x01(\v2\x1d.datapathplugins.BPFWireguardH\x00R\twireguard\x12+\n" +
	"\x03xdp\x18\x06 \x01(\v2\x17.datapathplugins.BPFXDPH\x00R\x03xdpB\b\n" +
	"\x06config\"\xae\x06\n" +
	...
	"\x06config\x18\x04 \x01(\v2\x17.datapathplugins.ConfigR\x06config\x1a\xe5\x03\n" +
	...
	"\x11local_node_config\x18\x02 \x01(\v2 .datapathplugins.LocalNodeConfigR\x0flocalNodeConfig\x12Q\n" +
	"\x12attachment_context\x18\x03 \x01(\v2\".datapathplugins.AttachmentContextR\x11attachmentContext\x12/\n" +
	"\x06config\x18\x04 \x01(\v2\x17.datapathplugins.ConfigR\x06config\x12G\n" +
	"\x05hooks\x18\x05 \x03(\v21.datapathplugins.InstrumentCollectionRequest.HookR\x05hooks\x12\x12\n" +
	"\x04pins\x18\x06 \x01(\tR\x04pins\x12\x16\n" +
	"\x06cookie\x18\a \x01(\tR\x06cookie\x1a\xec\x03\n" +
	"\n" +
	"Collection\x12a\n" +
...
var (
	file_datapathplugins_proto_rawDescOnce sync.Once
	file_datapathplugins_proto_rawDescData []byte
)

func file_datapathplugins_proto_rawDescGZIP() []byte {
	file_datapathplugins_proto_rawDescOnce.Do(func() {
		file_datapathplugins_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_datapathplugins_proto_rawDesc), len(file_datapathplugins_proto_rawDesc)))
	})
	return file_datapathplugins_proto_rawDescData
}

var file_datapathplugins_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_datapathplugins_proto_msgTypes = make([]protoimpl.MessageInfo, 30)
var file_datapathplugins_proto_goTypes = []any{
	...
	(*Config)(nil),                                              // 4: datapathplugins.Config
	(*PrepareCollectionRequest)(nil),                            // 5: datapathplugins.PrepareCollectionRequest
	(*PrepareCollectionResponse)(nil),                           // 6: datapathplugins.PrepareCollectionResponse
	(*InstrumentCollectionRequest)(nil),                         // 7: datapathplugins.InstrumentCollectionRequest
	(*InstrumentCollectionResponse)(nil),                        // 8: datapathplugins.InstrumentCollectionResponse
	(*AttachmentContext_InterfaceInfo)(nil),                     // 9: datapathplugins.AttachmentContext.InterfaceInfo
	(*AttachmentContext_PodInfo)(nil),                           // 10: datapathplugins.AttachmentContext.PodInfo
	(*AttachmentContext_Host)(nil),                              // 11: datapathplugins.AttachmentContext.Host
	(*AttachmentContext_LXC)(nil),                               // 12: datapathplugins.AttachmentContext.LXC
	(*AttachmentContext_Network)(nil),                           // 13: datapathplugins.AttachmentContext.Network
	(*AttachmentContext_Overlay)(nil),                           // 14: datapathplugins.AttachmentContext.Overlay
	(*AttachmentContext_Socket)(nil),                            // 15: datapathplugins.AttachmentContext.Socket
	(*AttachmentContext_Wireguard)(nil),                         // 16: datapathplugins.AttachmentContext.Wireguard
	(*AttachmentContext_XDP)(nil),                               // 17: datapathplugins.AttachmentContext.XDP
	(*PrepareCollectionRequest_CollectionSpec)(nil),             // 18: datapathplugins.PrepareCollectionRequest.CollectionSpec
	(*PrepareCollectionRequest_CollectionSpec_ProgramSpec)(nil), // 19: datapathplugins.PrepareCollectionRequest.CollectionSpec.ProgramSpec
	(*PrepareCollectionRequest_CollectionSpec_MapSpec)(nil),     // 20: datapathplugins.PrepareCollectionRequest.CollectionSpec.MapSpec
	nil, // 21: datapathplugins.PrepareCollectionRequest.CollectionSpec.ProgramsEntry
	nil, // 22: datapathplugins.PrepareCollectionRequest.CollectionSpec.MapsEntry
	(*PrepareCollectionResponse_HookSpec)(nil),                    // 23: datapathplugins.PrepareCollectionResponse.HookSpec
	(*PrepareCollectionResponse_HookSpec_OrderingConstraint)(nil), // 24: datapathplugins.PrepareCollectionResponse.HookSpec.OrderingConstraint
	(*InstrumentCollectionRequest_Collection)(nil),                // 25: datapathplugins.InstrumentCollectionRequest.Collection
	(*InstrumentCollectionRequest_Hook)(nil),                      // 26: datapathplugins.InstrumentCollectionRequest.Hook
	(*InstrumentCollectionRequest_Collection_Program)(nil),        // 27: datapathplugins.InstrumentCollectionRequest.Collection.Program
	(*InstrumentCollectionRequest_Collection_Map)(nil),            // 28: datapathplugins.InstrumentCollectionRequest.Collection.Map
	nil, // 29: datapathplugins.InstrumentCollectionRequest.Collection.ProgramsEntry
	nil, // 30: datapathplugins.InstrumentCollectionRequest.Collection.MapsEntry
	(*InstrumentCollectionRequest_Hook_AttachTarget)(nil), // 31: datapathplugins.InstrumentCollectionRequest.Hook.AttachTarget
	(*BPFHost)(nil),      // 32: datapathplugins.BPFHost
	(*BPFLXC)(nil),       // 33: datapathplugins.BPFLXC
	(*BPFOverlay)(nil),   // 34: datapathplugins.BPFOverlay
	(*BPFSock)(nil),      // 35: datapathplugins.BPFSock
	(*BPFWireguard)(nil), // 36: datapathplugins.BPFWireguard
	(*BPFXDP)(nil),       // 37: datapathplugins.BPFXDP
}
var file_datapathplugins_proto_depIdxs = []int32{
	11, // 0: datapathplugins.AttachmentContext.host:type_name -> datapathplugins.AttachmentContext.Host
	12, // 1: datapathplugins.AttachmentContext.lxc:type_name -> datapathplugins.AttachmentContext.LXC
	14, // 2: datapathplugins.AttachmentContext.overlay:type_name -> datapathplugins.AttachmentContext.Overlay
	15, // 3: datapathplugins.AttachmentContext.socket:type_name -> datapathplugins.AttachmentContext.Socket
	16, // 4: datapathplugins.AttachmentContext.wireguard:type_name -> datapathplugins.AttachmentContext.Wireguard
	17, // 5: datapathplugins.AttachmentContext.xdp:type_name -> datapathplugins.AttachmentContext.XDP
	32, // 6: datapathplugins.Config.host:type_name -> datapathplugins.BPFHost
	33, // 7: datapathplugins.Config.lxc:type_name -> datapathplugins.BPFLXC
	34, // 8: datapathplugins.Config.overlay:type_name -> datapathplugins.BPFOverlay
	35, // 9: datapathplugins.Config.socket:type_name -> datapathplugins.BPFSock
	36, // 10: datapathplugins.Config.wireguard:type_name -> datapathplugins.BPFWireguard
	37, // 11: datapathplugins.Config.xdp:type_name -> datapathplugins.BPFXDP
	18, // 12: datapathplugins.PrepareCollectionRequest.collection:type_name -> datapathplugins.PrepareCollectionRequest.CollectionSpec
	2,  // 13: datapathplugins.PrepareCollectionRequest.local_node_config:type_name -> datapathplugins.LocalNodeConfig
	3,  // 14: datapathplugins.PrepareCollectionRequest.attachment_context:type_name -> datapathplugins.AttachmentContext
	4,  // 15: datapathplugins.PrepareCollectionRequest.config:type_name -> datapathplugins.Config
	23, // 16: datapathplugins.PrepareCollectionResponse.hooks:type_name -> datapathplugins.PrepareCollectionResponse.HookSpec
	25, // 17: datapathplugins.InstrumentCollectionRequest.collection:type_name -> datapathplugins.InstrumentCollectionRequest.Collection
	2,  // 18: datapathplugins.InstrumentCollectionRequest.local_node_config:type_name -> datapathplugins.LocalNodeConfig
	3,  // 19: datapathplugins.InstrumentCollectionRequest.attachment_context:type_name -> datapathplugins.AttachmentContext
	4,  // 20: datapathplugins.InstrumentCollectionRequest.config:type_name -> datapathplugins.Config
	26, // 21: datapathplugins.InstrumentCollectionRequest.hooks:type_name -> datapathplugins.InstrumentCollectionRequest.Hook
	9,  // 22: datapathplugins.AttachmentContext.Host.iface:type_name -> datapathplugins.AttachmentContext.InterfaceInfo
	9,  // 23: datapathplugins.AttachmentContext.LXC.iface:type_name -> datapathplugins.AttachmentContext.InterfaceInfo
	10, // 24: datapathplugins.AttachmentContext.LXC.pod_info:type_name -> datapathplugins.AttachmentContext.PodInfo
	9,  // 25: datapathplugins.AttachmentContext.Overlay.iface:type_name -> datapathplugins.AttachmentContext.InterfaceInfo
	9,  // 26: datapathplugins.AttachmentContext.Wireguard.iface:type_name -> datapathplugins.AttachmentContext.InterfaceInfo
	9,  // 27: datapathplugins.AttachmentContext.XDP.iface:type_name -> datapathplugins.AttachmentContext.InterfaceInfo
	21, // 28: datapathplugins.PrepareCollectionRequest.CollectionSpec.programs:type_name -> datapathplugins.PrepareCollectionRequest.CollectionSpec.ProgramsEntry
	22, // 29: datapathplugins.PrepareCollectionRequest.CollectionSpec.maps:type_name -> datapathplugins.PrepareCollectionRequest.CollectionSpec.MapsEntry
	19, // 30: datapathplugins.PrepareCollectionRequest.CollectionSpec.ProgramsEntry.value:type_name -> datapathplugins.PrepareCollectionRequest.CollectionSpec.ProgramSpec
	20, // 31: datapathplugins.PrepareCollectionRequest.CollectionSpec.MapsEntry.value:type_name -> datapathplugins.PrepareCollectionRequest.CollectionSpec.MapSpec
	0,  // 32: datapathplugins.PrepareCollectionResponse.HookSpec.type:type_name -> datapathplugins.HookType
	24, // 33: datapathplugins.PrepareCollectionResponse.HookSpec.constraints:type_name -> datapathplugins.PrepareCollectionResponse.HookSpec.OrderingConstraint
	1,  // 34: datapathplugins.PrepareCollectionResponse.HookSpec.OrderingConstraint.order:type_name -> datapathplugins.PrepareCollectionResponse.HookSpec.OrderingConstraint.Order
	29, // 35: datapathplugins.InstrumentCollectionRequest.Collection.programs:type_name -> datapathplugins.InstrumentCollectionRequest.Collection.ProgramsEntry
	30, // 36: datapathplugins.InstrumentCollectionRequest.Collection.maps:type_name -> datapathplugins.InstrumentCollectionRequest.Collection.MapsEntry
	0,  // 37: datapathplugins.InstrumentCollectionRequest.Hook.type:type_name -> datapathplugins.HookType
	31, // 38: datapathplugins.InstrumentCollectionRequest.Hook.attach_target:type_name -> datapathplugins.InstrumentCollectionRequest.Hook.AttachTarget
	27, // 39: datapathplugins.InstrumentCollectionRequest.Collection.ProgramsEntry.value:type_name -> datapathplugins.InstrumentCollectionRequest.Collection.Program
	28, // 40: datapathplugins.InstrumentCollectionRequest.Collection.MapsEntry.value:type_name -> datapathplugins.InstrumentCollectionRequest.Collection.Map
	5,  // 41: datapathplugins.DatapathPlugin.PrepareCollection:input_type -> datapathplugins.PrepareCollectionRequest
	7,  // 42: datapathplugins.DatapathPlugin.InstrumentCollection:input_type -> datapathplugins.InstrumentCollectionRequest
	6,  // 43: datapathplugins.DatapathPlugin.PrepareCollection:output_type -> datapathplugins.PrepareCollectionResponse
	8,  // 44: datapathplugins.DatapathPlugin.InstrumentCollection:output_type -> datapathplugins.InstrumentCollectionResponse
...
func init() { file_datapathplugins_proto_init() }
func file_datapathplugins_proto_init() {
	if File_datapathplugins_proto != nil {
		return
	}
	file_host_config_proto_init()
	file_lxc_config_proto_init()
	file_overlay_config_proto_init()
	file_sock_config_proto_init()
	file_wireguard_config_proto_init()
	file_xdp_config_proto_init()
	file_datapathplugins_proto_msgTypes[1].OneofWrappers = []any{
	...
	file_datapathplugins_proto_msgTypes[2].OneofWrappers = []any{
		(*Config_Host)(nil),
		(*Config_Lxc)(nil),
		(*Config_Overlay)(nil),
		(*Config_Socket)(nil),
		(*Config_Wireguard)(nil),
		(*Config_Xdp)(nil),
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_datapathplugins_proto_rawDesc), len(file_datapathplugins_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   30,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_datapathplugins_proto_goTypes,
		DependencyIndexes: file_datapathplugins_proto_depIdxs,
		EnumInfos:         file_datapathplugins_proto_enumTypes,
		MessageInfos:      file_datapathplugins_proto_msgTypes,
	}.Build()
	File_datapathplugins_proto = out.File
	file_datapathplugins_proto_goTypes = nil
	file_datapathplugins_proto_depIdxs = nil
}
