...
// GetPolicyPathParams contains all the bound params for the get policy path operation
...
func (o *GetPolicyPathParams) bindPath(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
