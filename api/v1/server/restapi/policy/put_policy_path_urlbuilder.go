...
func (o *PutPolicyPathURL) Build() (*url.URL, error) {
	...
	if path != "" {
		...
		return nil, errors.New("Path is required on PutPolicyPathURL")
	}
...
func (o *PutPolicyPathURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on PutPolicyPathURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on PutPolicyPathURL")
	}
