...
// GetFqdnGccacheNotFoundCode is the HTTP code returned for type GetFqdnGccacheNotFound
const GetFqdnGccacheNotFoundCode int = 404

/*
GetFqdnGccacheNotFound No GC cache entries found

swagger:response getFqdnGccacheNotFound
*/
type GetFqdnGccacheNotFound struct {
}

// NewGetFqdnGccacheNotFound creates GetFqdnGccacheNotFound with default headers values
...
// WriteResponse to the client
func (o *GetFqdnGccacheNotFound) WriteResponse(rw http.ResponseWriter, producer runtime.Producer) {
