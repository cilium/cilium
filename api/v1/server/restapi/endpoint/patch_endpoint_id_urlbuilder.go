...
func (o *PatchEndpointIDURL) Build() (*url.URL, error) {
	...
	if id != "" {
		...
		return nil, errors.New("ID is required on PatchEndpointIDURL")
	}
...
func (o *PatchEndpointIDURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on PatchEndpointIDURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on PatchEndpointIDURL")
	}
