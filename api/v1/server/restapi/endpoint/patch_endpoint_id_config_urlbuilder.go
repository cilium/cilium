...
func (o *PatchEndpointIDConfigURL) Build() (*url.URL, error) {
	...
	if id != "" {
		...
		return nil, errors.New("ID is required on PatchEndpointIDConfigURL")
	}
...
func (o *PatchEndpointIDConfigURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on PatchEndpointIDConfigURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on PatchEndpointIDConfigURL")
	}
