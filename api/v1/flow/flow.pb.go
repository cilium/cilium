...
const file_flow_flow_proto_rawDesc = "" +
	"\n" +
	"\x0fflow/flow.proto\x12\x04flow\x1a\x19google/protobuf/any.proto\x1a\x1egoogle/protobuf/wrappers.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xfc\f\n" +
	"\x04Flow\x12.\n" +
	...
	"\x17trace_observation_point\x18\x18 \x01(\x0e2\x1b.flow.TraceObservationPointR\x15traceObservationPoint\x12:\n" +
	...
	"\x12ingress_allowed_by\x18\x8a\xa4\x01 \x03(\v2\f.flow.PolicyR\x10ingressAllowedByJ\x04\b\a\x10\bJ\x04\b\f\x10\rJ\x04\b\x11\x10\x12J\x04\b\x12\x10\x13\"\xc4\x01\n" +
	"\x06Layer4\x12\x1d\n" +
	...
	"\btrace_id\x18\x01 \x01(\tR\atraceId\"\xb5\x01\n" +
	"\bEndpoint\x12\x0e\n" +
	...
	"\x05flags\x18\x03 \x01(\v2\x0e.flow.TCPFlagsR\x05flags\"\x8b\x01\n" +
	"\x02IP\x12\x16\n" +
	...
	"\bsub_type\x18\x02 \x01(\x05R\asubType\"\x82\n" +
	"\n" +
	"\n" +
	"FlowFilter\x12\x12\n" +
	"\x04uuid\x18\x1d \x03(\tR\x04uuid\x12\x1b\n" +
	"\tsource_ip\x18\x01 \x03(\tR\bsourceIp\x12\x1d\n" +
	"\n" +
	...
	"\x14destination_workload\x18\x1b \x03(\v2\x0e.flow.WorkloadR\x13destinationWorkload\x12C\n" +
	"\x11traffic_direction\x18\x1e \x03(\x0e2\x16.flow.TrafficDirectionR\x10trafficDirection\x12'\n" +
	"\averdict\x18\x05 \x03(\x0e2\r.flow.VerdictR\averdict\x124\n" +
	"\n" +
	...
	"\tnode_name\x18\x18 \x03(\tR\bnodeName\x12.\n" +
	"\n" +
	"ip_version\x18\x19 \x03(\x0e2\x0f.flow.IPVersionR\tipVersion\x12\x19\n" +
	"\btrace_id\x18\x1c \x03(\tR\atraceId\"\xce\x01\n" +
	"\x03DNS\x12\x14\n" +
	...
	"\n" +
	"TRANSLATED\x10\a*\xfb\x10\n" +
	"\n" +
	"DropReason\x12\x17\n" +
	"\x13DROP_REASON_UNKNOWN\x10\x00\x12\x17\n" +
	"\x12INVALID_SOURCE_MAC\x10\x82\x01\x12\x1c\n" +
	"\x17INVALID_DESTINATION_MAC\x10\x83\x01\x12\x16\n" +
	...
	"\"CT_CANNOT_CREATE_ENTRY_FROM_PACKET\x10\x8a\x01\x12\x1c\n" +
	...
	"\x1fERROR_RETRIEVING_TUNNEL_OPTIONS\x10\x94\x01\x12\x1a\n" +
	"\x15INVALID_GENEVE_OPTION\x10\x95\x01\x12\x1e\n" +
	"\x19UNKNOWN_L3_TARGET_ADDRESS\x10\x96\x01\x12\x1b\n" +
	"\x16STALE_OR_UNROUTABLE_IP\x10\x97\x01\x12&\n" +
	"!NO_MATCHING_LOCAL_CONTAINER_FOUND\x10\x98\x01\x12'\n" +
	...
	"\x06NO_SID\x10\xb9\x01\x12\x17\n" +
	"\x12MISSING_SRV6_STATE\x10\xba\x01\x12\n" +
	"\n" +
	...
	"\x11DROP_EP_NOT_READY\x10\xcb\x01*J\n" +
