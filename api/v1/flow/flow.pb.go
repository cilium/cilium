...
type CiliumEventType struct {
	...
	//
	// Some type in Cilium/data path use `iota` as a legitimate value, which (in
	// json export, at least) strip out the "empty value" of zero. Using
	// `sub_type_name` may not only be more reliable but also more clear.
	SubType int32 `protobuf:"varint,2,opt,name=sub_type,json=subType,proto3" json:"sub_type,omitempty"`
	// human-readable string representation of `int32 type = 1`, e.g. `trace`
	TypeName string `protobuf:"bytes,3,opt,name=type_name,json=typeName,proto3" json:"type_name,omitempty"`
	// human-readable string representation of `int32 sub_type = 2`, e.g.
	// `to-endpoint`
...
func (m *CiliumEventType) GetTypeName() string {
	if m != nil {
		return m.TypeName
	}
	return ""
...
func (m *CiliumEventType) GetSubTypeName() string {
	if m != nil {
...
var fileDescriptor_3c1fa740027c1208 = []byte{
	...
	,
}
