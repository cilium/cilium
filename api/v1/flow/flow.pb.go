...
const file_flow_flow_proto_rawDesc = "" +
	"\n" +
	"\x0fflow/flow.proto\x12\x04flow\x1a\x19google/protobuf/any.proto\x1a\x1egoogle/protobuf/wrappers.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\x9c\x0f\n" +
	"\x04Flow\x12.\n" +
	...
	"\acapsule\x18' \x01(\v2\x13.flow.EncapsulationR\acapsule\x12&\n" +
	...
	"\x06ICMPv6\x12\x12\n" +
	"\x04type\x18\x01 \x01(\rR\x04type\x12\x12\n" +
	"\x04code\x18\x02 \x01(\rR\x04code\"\xae\x01\n" +
	"\rEncapsulation\x128\n" +
	"\bprotocol\x18\x01 \x01(\x0e2\x1c.flow.Encapsulation.ProtocolR\bprotocol\x12\x18\n" +
