...
type FlowFilter struct {
	...
	// TCP flags filters flows based on TCP packet flags (e.g. SYN, ACK, PSH, FIN,
	// RST, CWR, NS, ECE, URG)
	TcpFlags []*TCPFlags `protobuf:"bytes,21,rep,name=tcp_flags,json=tcpFlags,proto3" json:"tcp_flags,omitempty"`
}
...
var file_flow_flow_proto_rawDesc = []byte{
	...
	0x6d, 0x70, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x95, 0x07, 0x0a, 0x04, 0x46, 0x6c, 0x6f,
	...
	0x05, 0x52, 0x07, 0x73, 0x75, 0x62, 0x54, 0x79, 0x70, 0x65, 0x22, 0xb9, 0x06, 0x0a, 0x0a, 0x46,
	...
	0x6e, 0x49, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x12, 0x2b, 0x0a, 0x09, 0x74, 0x63, 0x70,
	0x5f, 0x66, 0x6c, 0x61, 0x67, 0x73, 0x18, 0x15, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x0e, 0x2e, 0x66,
	0x6c, 0x6f, 0x77, 0x2e, 0x54, 0x43, 0x50, 0x46, 0x6c, 0x61, 0x67, 0x73, 0x52, 0x08, 0x74, 0x63,
	0x70, 0x46, 0x6c, 0x61, 0x67, 0x73, 0x22, 0xb5, 0x01, 0x0a, 0x07, 0x50, 0x61, 0x79, 0x6c, 0x6f,
...
var file_flow_flow_proto_depIdxs = []int32{
	...
	15, // 26: flow.FlowFilter.tcp_flags:type_name -> flow.TCPFlags
	6,  // 27: flow.Payload.type:type_name -> flow.EventType
	29, // 28: flow.Payload.time:type_name -> google.protobuf.Timestamp
	24, // 29: flow.HTTP.headers:type_name -> flow.HTTPHeader
	7,  // 30: flow.LostEvent.source:type_name -> flow.LostEventSource
	30, // 31: flow.LostEvent.cpu:type_name -> google.protobuf.Int32Value
