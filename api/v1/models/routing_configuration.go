...
// RoutingConfiguration Routing configuration of a cluster node. It defines how to other cluster
...
type RoutingConfiguration struct {
	...
	// Direct routing configuration of the node
	DirectRouting *DirectRoutingConfiguration `json:"directRouting,omitempty"`

	// Encapsulation defines whether and how networking encapsulation can be
