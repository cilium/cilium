...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ConfigSettings) DeepCopyInto(out *ConfigSettings) {
	*out = *in
	if in.Deltas != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ConfigSettings.
func (in *ConfigSettings) DeepCopy() *ConfigSettings {
	if in == nil {
		return nil
	}
	out := new(ConfigSettings)
	in.DeepCopyInto(out)
	return out
}
...
func (in *StatusResponse) DeepCopyInto(out *StatusResponse) {
	*out = *in
	...
	if in.ConfigSettings != nil {
		in, out := &in.ConfigSettings, &out.ConfigSettings
		*out = new(ConfigSettings)
		(*in).DeepCopyInto(*out)
	}
