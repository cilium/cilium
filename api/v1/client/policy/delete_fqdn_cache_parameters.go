...
// WithCidr adds the cidr to the delete fqdn cache params
func (o *DeleteFqdnCacheParams) WithCidr(cidr *string) *DeleteFqdnCacheParams {
	o.SetCidr(cidr)
	return o
}

// SetCidr adds the cidr to the delete fqdn cache params
func (o *DeleteFqdnCacheParams) SetCidr(cidr *string) {
	o.Cidr = cidr
}
