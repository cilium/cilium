...
const TraceObservationPoint_FROM_CRYPTO_DEV = flow.TraceObservationPoint_FROM_CRYPTO_DEV
const TraceObservationPoint_TO_CRYPTO_DEV = flow.TraceObservationPoint_TO_CRYPTO_DEV
