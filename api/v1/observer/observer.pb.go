...
var file_observer_observer_proto_rawDesc = []byte{
	...
	0x61, 0x6d, 0x65, 0x22, 0xe9, 0x02, 0x0a, 0x0b, 0x45, 0x78, 0x70, 0x6f, 0x72, 0x74, 0x45, 0x76,
	...
	0x0e, 0x72, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x73, 0x32,
	0xe7, 0x01, 0x0a, 0x08, 0x4f, 0x62, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x12, 0x45, 0x0a, 0x08,
	0x47, 0x65, 0x74, 0x46, 0x6c, 0x6f, 0x77, 0x73, 0x12, 0x19, 0x2e, 0x6f, 0x62, 0x73, 0x65, 0x72,
	0x76, 0x65, 0x72, 0x2e, 0x47, 0x65, 0x74, 0x46, 0x6c, 0x6f, 0x77, 0x73, 0x52, 0x65, 0x71, 0x75,
	0x65, 0x73, 0x74, 0x1a, 0x1a, 0x2e, 0x6f, 0x62, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x2e, 0x47,
	0x65, 0x74, 0x46, 0x6c, 0x6f, 0x77, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22,
...
var file_observer_observer_proto_msgTypes = make([]protoimpl.MessageInfo, 9)
var file_observer_observer_proto_goTypes = []interface{}{
	...
	(*ExportEvent)(nil),           // 8: observer.ExportEvent
	(*wrappers.UInt32Value)(nil),  // 9: google.protobuf.UInt32Value
	(*flow.FlowFilter)(nil),       // 10: flow.FlowFilter
	(*timestamp.Timestamp)(nil),   // 11: google.protobuf.Timestamp
	(*flow.Flow)(nil),             // 12: flow.Flow
	(*relay.NodeStatusEvent)(nil), // 13: relay.NodeStatusEvent
	(*flow.LostEvent)(nil),        // 14: flow.LostEvent
	(*flow.AgentEvent)(nil),       // 15: flow.AgentEvent
	(*flow.DebugEvent)(nil),       // 16: flow.DebugEvent
	(relay.NodeState)(0),          // 17: relay.NodeState
}
var file_observer_observer_proto_depIdxs = []int32{
	9,  // 0: observer.ServerStatusResponse.num_connected_nodes:type_name -> google.protobuf.UInt32Value
	9,  // 1: observer.ServerStatusResponse.num_unavailable_nodes:type_name -> google.protobuf.UInt32Value
	10, // 2: observer.GetFlowsRequest.blacklist:type_name -> flow.FlowFilter
	10, // 3: observer.GetFlowsRequest.whitelist:type_name -> flow.FlowFilter
	11, // 4: observer.GetFlowsRequest.since:type_name -> google.protobuf.Timestamp
	11, // 5: observer.GetFlowsRequest.until:type_name -> google.protobuf.Timestamp
	12, // 6: observer.GetFlowsResponse.flow:type_name -> flow.Flow
	13, // 7: observer.GetFlowsResponse.node_status:type_name -> relay.NodeStatusEvent
	14, // 8: observer.GetFlowsResponse.lost_events:type_name -> flow.LostEvent
	15, // 9: observer.GetFlowsResponse.agent_event:type_name -> flow.AgentEvent
	16, // 10: observer.GetFlowsResponse.debug_event:type_name -> flow.DebugEvent
	11, // 11: observer.GetFlowsResponse.time:type_name -> google.protobuf.Timestamp
	6,  // 12: observer.GetNodesResponse.nodes:type_name -> observer.Node
	17, // 13: observer.Node.state:type_name -> relay.NodeState
	7,  // 14: observer.Node.tls:type_name -> observer.TLS
	12, // 15: observer.ExportEvent.flow:type_name -> flow.Flow
	13, // 16: observer.ExportEvent.node_status:type_name -> relay.NodeStatusEvent
	14, // 17: observer.ExportEvent.lost_events:type_name -> flow.LostEvent
	15, // 18: observer.ExportEvent.agent_event:type_name -> flow.AgentEvent
	16, // 19: observer.ExportEvent.debug_event:type_name -> flow.DebugEvent
	11, // 20: observer.ExportEvent.time:type_name -> google.protobuf.Timestamp
	2,  // 21: observer.Observer.GetFlows:input_type -> observer.GetFlowsRequest
	4,  // 22: observer.Observer.GetNodes:input_type -> observer.GetNodesRequest
	0,  // 23: observer.Observer.ServerStatus:input_type -> observer.ServerStatusRequest
	3,  // 24: observer.Observer.GetFlows:output_type -> observer.GetFlowsResponse
	5,  // 25: observer.Observer.GetNodes:output_type -> observer.GetNodesResponse
	1,  // 26: observer.Observer.ServerStatus:output_type -> observer.ServerStatusResponse
...
func file_observer_observer_proto_init() {
	...
	file_observer_observer_proto_msgTypes[8].OneofWrappers = []interface{}{
