 ...
 */
#define __swab64(x) \
	(__builtin_constant_p((__u64)(x)) ? ___constant_swab64(x) : __fswab64(x))
 ...
 */
#define __swahw32(x) \
	(__builtin_constant_p((__u32)(x)) ? ___constant_swahw32(x) : __fswahw32(x))
 ...
 */
#define __swahb32(x) \
	(__builtin_constant_p((__u32)(x)) ? ___constant_swahb32(x) : __fswahb32(x))
