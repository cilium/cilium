...
DECLARE_CONFIG(__u32, interface_mac_1, "First 32 bytes of the MAC address of the interface the bpf program is attached to")
DECLARE_CONFIG(__u16, interface_mac_2, "Second 16 bytes of the MAC address of the interface the bpf program is attached to")
