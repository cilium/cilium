...
#define bpf_core_read(dst, sz, src)					    \
	probe_read_kernel(dst, sz, (const void *)__builtin_preserve_access_index(src))

/* NOTE: see comments for BPF_CORE_READ_USER() about the proper types use. */
#define bpf_core_read_user(dst, sz, src)				    \
	probe_read_user(dst, sz, (const void *)__builtin_preserve_access_index(src))
/*
...
#define bpf_core_read_str(dst, sz, src)					    \
	probe_read_kernel_str(dst, sz, (const void *)__builtin_preserve_access_index(src))

/* NOTE: see comments for BPF_CORE_READ_USER() about the proper types use. */
#define bpf_core_read_user_str(dst, sz, src)				    \
	probe_read_user_str(dst, sz, (const void *)__builtin_preserve_access_index(src))
