...
int lxc_v4_remote_nodeport_local_backend_setup(struct __ctx_buff *ctx)
{
	...
	lb_v4_add_service_with_flags(0, NODEPORT_PORT, IPPROTO_TCP, 1, revnat_id,
...
int lxc_v4_remote_nodeport_hairpin_setup(struct __ctx_buff *ctx)
{
	...
	lb_v4_add_service_with_flags(0, NODEPORT_PORT_HAIRPIN, IPPROTO_TCP, 1, revnat_id,
				     SVC_FLAG_ROUTABLE | SVC_FLAG_NODEPORT, 0);
...
int lxc_v4_existing_conn_udp_second_setup(struct __ctx_buff *ctx)
{
	...
	lb_v4_add_service_with_flags(0, NODEPORT_PORT_UDP, IPPROTO_UDP, 1, revnat_id,
				     SVC_FLAG_ROUTABLE | SVC_FLAG_NODEPORT, 0);
