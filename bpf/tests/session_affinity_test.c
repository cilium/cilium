...
int test1_setup(struct __ctx_buff *ctx)
{
	struct {
		...
		SVC_KEY_VALUE(0, 100 /* affinity timeout */, LB_LOOKUP_SCOPE_FULL),
		SVC_KEY_VALUE(0, 100 /* affinity timeout */, LB_LOOKUP_SCOPE_LIMITED),

		SVC_KEY_VALUE(1, BACKEND_ID1, LB_LOOKUP_SCOPE_LIMITED),
		SVC_KEY_VALUE(2, BACKEND_ID2, LB_LOOKUP_SCOPE_LIMITED),
	};
	struct {
		__u32 key;
