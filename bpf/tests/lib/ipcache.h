		    ...
		    struct remote_ep_flags flags)
{
	...
	value.flag_unroutable = flags.flag_unroutable;
...
__ipcache_v4_add_entry(__be32 addr, __u8 cluster_id, __u32 sec_identity,
		       ...
		       bool ipv6_underlay, bool flag_unroutable, __u32 mask_size)
{
	...
	struct remote_ep_flags flags = {
		.flag_skip_tunnel = flag_skip_tunnel,
		.flag_ipv6_tunnel_ep = ipv6_underlay,
		.flag_unroutable = flag_unroutable,
	};
