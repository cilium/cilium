...
__lb_v4_add_service(__be32 addr, __be16 port, __u16 backend_count, __u16 rev_nat_index,
...
{
    __lb_v4_add_service(addr, port, backend_count, rev_nat_index, SVC_FLAG_ROUTABLE, 0);
}
...
lb_v4_add_service_with_flags(__be32 addr, __be16 port, __u16 backend_count, __u16 rev_nat_index,
                        __u8 flags, __u8 flags2)
{
    __lb_v4_add_service(addr, port, backend_count, rev_nat_index, flags, flags2);
}
...
static __always_inline void
lb_v6_add_service_with_flags(const union v6addr *addr, __be16 port, __u16 backend_count, __u16 rev_nat_index,
                        __u8 flags, __u8 flags2)
{
