...
static volatile const __u8 mac_zero[] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
static volatile const __u8 mac_v6mcast_base[] = {0x33, 0x33, 0x00, 0x00, 0x00, 0x00};
...
/* IPv6 mcast addresses (base address) */
