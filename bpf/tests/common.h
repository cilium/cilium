...
mock_bpf_sk_storage_get_common(void *map __maybe_unused, void *sk __maybe_unused, void *value __maybe_unused, __u64 flags __maybe_unused)
{
	return NULL;
}
