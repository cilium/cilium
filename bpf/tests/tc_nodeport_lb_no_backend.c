...
PKTGEN("tc", "tc_nodeport_no_backend_ipv4")
int nodeport_no_backend_ipv4_pktgen(struct __ctx_buff *ctx)
{
...
SETUP("tc", "tc_nodeport_no_backend_ipv4")
int nodeport_no_backend_ipv4_setup(struct __ctx_buff *ctx)
{
	__u16 revnat_id = 1;
...
CHECK("tc", "tc_nodeport_no_backend_ipv4")
int nodeport_no_backend_ipv4_check(__maybe_unused const struct __ctx_buff *ctx)
{
	void *data, *data_end;
	__u32 *status_code;
	struct ethhdr *l2;
...
SETUP("tc", "tc_nodeport_no_backend_ipv6")
int nodeport_no_backend_ipv6_setup(struct __ctx_buff *ctx)
{
	__u16 revnat_id = 1;
...
CHECK("tc", "tc_nodeport_no_backend_ipv6")
int nodeport_no_backend_ipv6_check(__maybe_unused const struct __ctx_buff *ctx)
{
	void *data, *data_end;
	__u32 *status_code;
	struct ethhdr *l2;
