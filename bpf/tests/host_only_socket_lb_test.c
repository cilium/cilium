...
int test1_check(__maybe_unused struct xdp_md *ctx)
{
	...
	struct { struct lb4_key key; struct lb4_service value; } services[] = {
		SVC_KEY_VALUE(DST_PORT, 0, 0, LB_LOOKUP_SCOPE_FULL),
		SVC_KEY_VALUE(DST_PORT, 0, 0, LB_LOOKUP_SCOPE_LIMITED),
		SVC_KEY_VALUE(DST_PORT, 1, 1, LB_LOOKUP_SCOPE_LIMITED),
		SVC_KEY_VALUE(DST_PORT_HOSTNS, 0, 0, LB_LOOKUP_SCOPE_FULL),
		SVC_KEY_VALUE(DST_PORT_HOSTNS, 0, 0, LB_LOOKUP_SCOPE_LIMITED),
		SVC_KEY_VALUE(DST_PORT_HOSTNS, 1, 1, LB_LOOKUP_SCOPE_LIMITED),
	};
