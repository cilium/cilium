...
#define REMOTE_NODE_IPV6	v6_node_two
#define HOST_NODE_IP		v4_node_three
#define HOST_NODE_IPV6		v6_node_three
#define LOCAL_NODE_IP		v4_node_one
#define LOCAL_NODE_IPV6		v6_node_one
...
#define BACKEND_IP_LOCALV6	v6_pod_two
...
int lxc_v6_remote_nodeport_local_backend_pktgen(struct __ctx_buff *ctx)
{
	...
	l4 = pktgen__push_ipv6_tcp_packet(&builder,
					  (__u8 *)client_mac, (__u8 *)node_mac,
					  (__u8 *)CLIENT_IPV6, (__u8 *)REMOTE_NODE_IPV6,
					  CLIENT_PORT, NODEPORT_PORT);
	if (!l4)
		return TEST_ERROR;
...
int lxc_v6_remote_nodeport_local_backend_setup(struct __ctx_buff *ctx)
{
	...
	ipv6_addr_copy(&remote_node_ip, (const union v6addr *)REMOTE_NODE_IPV6);
	ipv6_addr_copy(&backend_ip, (const union v6addr *)BACKEND_IP_LOCALV6);
...
int lxc_v6_remote_nodeport_local_backend_reply_pktgen(struct __ctx_buff *ctx)
{
	...
	l4 = pktgen__push_ipv6_tcp_packet(&builder,
					  (__u8 *)backend_mac, (__u8 *)client_mac,
					  (__u8 *)BACKEND_IP_LOCALV6, (__u8 *)CLIENT_IPV6,
					  BACKEND_PORT, CLIENT_PORT);
	if (!l4)
		return TEST_ERROR;
...
int lxc_v6_remote_nodeport_hairpin_reply_pktgen(struct __ctx_buff *ctx)
{
	...
	l4 = pktgen__push_ipv6_tcp_packet(&builder,
					  (__u8 *)client_mac, (__u8 *)node_mac,
					  (__u8 *)CLIENT_IPV6, (__u8 *)svc_loopback,
					  BACKEND_PORT, CLIENT_PORT);
	if (!l4)
		return TEST_ERROR;
...
int lxc_v6_existing_conn_udp_first_setup(struct __ctx_buff *ctx)
{
	...
	ipcache_v6_add_entry((union v6addr *)REMOTE_NODE_IPV6, 0, REMOTE_NODE_ID, 0, 0);
...
int lxc_v6_existing_conn_udp_second_setup(struct __ctx_buff *ctx)
{
	...
	lb_v6_add_backend(&zero_addr, NODEPORT_PORT_UDP, 1, 130,
			  (union v6addr *)BACKEND_IP_LOCALV6, BACKEND_PORT, IPPROTO_UDP, 0);

	endpoint_v6_add_entry((union v6addr *)BACKEND_IP_LOCALV6, BACKEND_IFACE, BACKEND_EP_ID,
...
int lxc_v6_host_nodeport_local_backend_pktgen(struct __ctx_buff *ctx)
{
	...
	l4 = pktgen__push_ipv6_tcp_packet(&builder,
					  (__u8 *)client_mac, (__u8 *)node_mac,
					  (__u8 *)CLIENT_IPV6, (__u8 *)HOST_NODE_IPV6,
					  CLIENT_PORT, NODEPORT_PORT);
	if (!l4)
		return TEST_ERROR;
...
int lxc_v6_host_nodeport_local_backend_setup(struct __ctx_buff *ctx)
{
	...
	ipv6_addr_copy(&host_node_ip, (const union v6addr *)HOST_NODE_IPV6);
	ipv6_addr_copy(&backend_ip, (const union v6addr *)BACKEND_IP_LOCALV6);
