 ...
 *
 * 1. will be traced with TRACE_FLAG_ENCRYPTED, because
 * do_decrypt marks them with MARK_MAGIC_DECRYPT.
 *
 * 2. will be traced without TRACE_FLAG_ENCRYPTED, because
 * do_decrypt does't touch to mark.
 *
 * 3. will be traced without TRACE_FLAG_ENCRYPTED, because
 ...
 * "encrypted by Cilium".
 *
 * We won't use TRACE_FLAG_ENCRYPTED even if the packets are ESP,
