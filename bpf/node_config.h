...
#define CILIUM_NET_MAC { .addr = { 0xce, 0x72, 0xa7, 0x03, 0x88, 0x56 } }
...
#define NAT_IN_MAC { .addr = { 0xde, 0xad, 0xbe, 0xef, 0xc0, 0xde } }
#define NAT_OUT_IFINDEX 1
#define NAT_OUT_MAC { .addr = { 0xde, 0xad, 0xbe, 0xef, 0xc0, 0xde } }
