...
#ifndef ROUTER_IP
DEFINE_IPV6(ROUTER_IP, 0xbe, 0xef, 0x0, 0x0, 0x0, 0x0, 0x0, 0x1, 0x0, 0x0, 0x0,
	    0x1, 0x0, 0x1, 0x0, 0x0);
#endif

#define HOST_IFINDEX   1
#define CILIUM_IFINDEX 1
#define NATIVE_DEV_MAC_BY_IFINDEX(_)                           \
	{                                                      \
		.addr = { 0xce, 0x72, 0xa7, 0x03, 0x88, 0x56 } \
	}

#ifndef HOST_IP
DEFINE_IPV6(HOST_IP, 0xbe, 0xef, 0x0, 0x0, 0x0, 0x0, 0x0, 0x1, 0x0, 0x0, 0xa,
	    0x0, 0x2, 0xf, 0xff, 0xff);
#endif
...
#  define IPV6_SNAT_EXCLUSION_DST_CIDR                          \
	  {                                                     \
		  .addr = { 0xfa, 0xce, 0xff, 0xff, 0xff, 0x0 } \
	  }
#  define IPV6_SNAT_EXCLUSION_DST_CIDR_MASK                     \
	  {                                                     \
		  .addr = { 0xff, 0xff, 0xff, 0xff, 0xff, 0x0 } \
	  }
...
#define VLAN_FILTER(ifindex, vlan_id) \
	switch (ifindex) {            \
	case 116:                     \
		switch (vlan_id) {    \
		case 4000:            \
