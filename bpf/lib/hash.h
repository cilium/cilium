 ...
 */
static __maybe_unused __u32 hash_from_tuple_v4(const struct ipv4_ct_tuple *tuple)
{
...
static __maybe_unused __u32 hash_from_tuple_v6(const struct ipv6_ct_tuple *tuple)
{
	__u32 a, b, c;
