...
static __maybe_unused void cilium_capture(struct __ctx_buff *ctx,
					   const __u8 subtype,
					   const __u16 rule_id,
					   const __u64 tstamp,
					   __u64 __cap_len)
...
static __maybe_unused void __cilium_capture_in(struct __ctx_buff *ctx,
...
static __maybe_unused void __cilium_capture_out(struct __ctx_buff *ctx,
						 __u16 rule_id, __u32 cap_len)
{
...
static __maybe_unused struct capture_rule *
