...
static __always_inline void send_policy_verdict_notify(
	struct __ctx_buff *ctx, __u32 remote_label, __u16 dst_port, __u8 proto,
	__u8 dir, __u8 is_ipv6, int verdict, __u16 proxy_port, __u8 match_type,
	__u8 is_audited, __u8 auth_type)
{
...
static __always_inline void send_policy_verdict_notify(
	...
	__u16 proxy_port __maybe_unused, __u8 match_type __maybe_unused,
	__u8 is_audited __maybe_unused, __u8 auth_type __maybe_unused)
{
}
