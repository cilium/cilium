...
static __always_inline int icmp4_to_icmp6(struct __sk_buff *skb, int nh_off)
{
...
static __always_inline int icmp6_to_icmp4(struct __sk_buff *skb, int nh_off)
{
	struct icmphdr icmp4 = {};
	struct icmp6hdr icmp6;
...
ipv6_prefix_match(struct in6_addr *addr, union v6addr *v6prefix)
{
 ...
 */
static __always_inline __maybe_unused int
ipv4_to_ipv6(struct __sk_buff *skb, struct iphdr *ip4, int nh_off, union v6addr *v6_dst)
{
	struct ipv6hdr v6 = {};
	struct iphdr v4;
	int csum_off;
 ...
 * d4 = d6[96 .. 127]
 */
static __always_inline __maybe_unused int ipv6_to_ipv4(struct __sk_buff *skb, int nh_off, __be32 saddr)
{
	struct ipv6hdr v6;
	struct iphdr v4 = {};
	int csum_off;
