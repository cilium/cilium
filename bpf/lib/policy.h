...
__policy_can_access(const void *map, struct __ctx_buff *ctx, __u32 local_id,
		    ...
		    __u8 proto, int dir,
		    __u8 icmp_type __maybe_unused, __u8 icmp_code __maybe_unused,
...
# endif
	...
	case ETH_P_IPV6:
# if defined(ENABLE_ICMP_RULE)
		/* Note that icmp_code is currently not populated. */
...
policy_can_access(struct __ctx_buff *ctx, __u32 local_id,
		  __u32 remote_id, __u16 ethertype __maybe_unused, __be16 dport,
		  __u8 proto, int dir, __u8 icmp_type, __u8 icmp_code,
		  bool is_untracked_fragment, __u8 *match_type, __s8 *ext_err,
		  __u16 *proxy_port, __u32 *cookie)
{
	return __policy_can_access(&cilium_policy_v2, ctx, local_id, remote_id,
				   ethertype, dport, proto, dir,
				   icmp_type, icmp_code,
 ...
 * @arg icmp_type	ICMP / ICMPv6 type
 * @arg icmp_code	ICMP / ICMPv6 code
...
policy_can_ingress(struct __ctx_buff *ctx, __u32 src_id, __u32 dst_id,
		   __u16 ethertype, __be16 dport, __u8 proto,
		   ...
		   __s8 *ext_err, __u16 *proxy_port, __u32 *cookie)
{
	...
	ret = policy_can_access(ctx, dst_id, src_id, ethertype, dport,
				proto, CT_INGRESS, icmp_type, icmp_code,
...
static __always_inline int policy_can_ingress6(struct __ctx_buff *ctx,
					       const struct ipv6_ct_tuple_ext *tuple_ext,
...
static __always_inline int policy_can_ingress4(struct __ctx_buff *ctx,
					       ...
					       __u32 *cookie)
{
	const struct ipv4_ct_tuple *tuple = &tuple_ext->tuple;
...
policy_can_egress(struct __ctx_buff *ctx, __u32 src_id, __u32 dst_id,
		  __u16 ethertype, __be16 dport, __u8 proto,
		  __u8 icmp_type, __u8 icmp_code, __u8 *match_type,
		  __u8 *audited, __s8 *ext_err, __u16 *proxy_port, __u32 *cookie)
{
	...
	ret = policy_can_access(ctx, src_id, dst_id, ethertype, dport,
				proto, CT_EGRESS, icmp_type, icmp_code,
				false, match_type,
