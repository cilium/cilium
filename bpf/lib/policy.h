...
static __always_inline int
__policy_can_access_shared(const struct __ctx_buff *ctx, __u32 local_id,
			   __u32 remote_id, __be16 dport, __u8 proto,
			   int dir, bool is_untracked_fragment,
		  ...
		  __u16 *proxy_port, __u32 *cookie)
{
	if (CONFIG(enable_shared_policy))
		return __policy_can_access_shared(ctx, local_id, remote_id,
						   dport, proto, dir,
