...
static __maybe_unused void edt_set_aggregate(struct __ctx_buff *ctx,
					      __u32 aggregate)
{
...
static __maybe_unused __u32 edt_get_aggregate(struct __ctx_buff *ctx)
{
...
static __maybe_unused int edt_sched_departure(struct __ctx_buff *ctx)
{
