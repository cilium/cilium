...
#define CILIUM_CALL_IPV4_NODEPORT_REVNAT_FWD	17
#define CILIUM_CALL_IPV6_NODEPORT_REVNAT_FWD	18
...
#define CILIUM_CALL_IPV4_NODEPORT_REVNAT_LOCAL	38
#define CILIUM_CALL_IPV6_NODEPORT_REVNAT_LOCAL	39
