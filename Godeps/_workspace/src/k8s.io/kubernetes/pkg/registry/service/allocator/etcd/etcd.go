...
import (
	...
	k8serr "github.com/noironetworks/cilium-net/Godeps/_workspace/src/k8s.io/kubernetes/pkg/api/errors"
	etcderr "github.com/noironetworks/cilium-net/Godeps/_workspace/src/k8s.io/kubernetes/pkg/api/errors/etcd"
	"github.com/noironetworks/cilium-net/Godeps/_workspace/src/k8s.io/kubernetes/pkg/api/unversioned"
	"github.com/noironetworks/cilium-net/Godeps/_workspace/src/k8s.io/kubernetes/pkg/registry/service/allocator"
	"github.com/noironetworks/cilium-net/Godeps/_workspace/src/k8s.io/kubernetes/pkg/runtime"
	"k8s.io/kubernetes/pkg/registry/service"
	"k8s.io/kubernetes/pkg/storage"

	"github.com/noironetworks/cilium-net/Godeps/_workspace/src/golang.org/x/net/context"
)
