...
import (
	...
	pkg2_api "github.com/noironetworks/cilium-net/Godeps/_workspace/src/k8s.io/kubernetes/pkg/api"
	pkg4_resource "github.com/noironetworks/cilium-net/Godeps/_workspace/src/k8s.io/kubernetes/pkg/api/resource"
	pkg1_unversioned "github.com/noironetworks/cilium-net/Godeps/_workspace/src/k8s.io/kubernetes/pkg/api/unversioned"
	pkg3_types "github.com/noironetworks/cilium-net/Godeps/_workspace/src/k8s.io/kubernetes/pkg/types"
	pkg6_intstr "github.com/noironetworks/cilium-net/Godeps/_workspace/src/k8s.io/kubernetes/pkg/util/intstr"
	pkg5_inf "github.com/noironetworks/cilium-net/Godeps/_workspace/src/speter.net/go/exp/math/dec/inf"
	"reflect"
	"runtime"
	time "time"
)
...
func (x *PodSecurityPolicySpec) codecDecodeSelfFromArray(l int, d *codec1978.Decoder) {
	...
	if r.TryDecodeAsNil() {
		...
		if false {
			...
			h.decSliceapi_Capability((*[]pkg2_api.Capability)(yyv18), d)
		}
	}
	yyj16++
	if yyhl16 {
