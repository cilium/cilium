...
import (
	...
	flag "github.com/noironetworks/cilium-net/docker-plugin/Godeps/_workspace/src/github.com/spf13/pflag"
	"github.com/noironetworks/cilium-net/docker-plugin/Godeps/_workspace/src/speter.net/go/exp/math/dec/inf"
)
