...
``clustermesh_remote_cluster_cache_revocations``  ``mode``, ``target_cluster`` Enabled    The total number of cache revocations related to the remote cluster
================================================= ============================ ========== =================================================================
...
``remote_cluster_cache_revocations``            ``mode``, ``target_cluster`` The total number of cache revocations related to the remote cluster
