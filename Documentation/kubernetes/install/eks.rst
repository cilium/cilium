...
#. Assign a fixed security identity to kube-dns
   ...
   This steps allows Cilium to bring up kube-dns networking and enforce
...
deployed in parallel. Cilium will automatically 
