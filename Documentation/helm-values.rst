...
.. list-table::
   ...
   * - :spelling:ignore:`encryption.strictMode.cidr`
     - CIDR for the WireGuard Pod2Pod strict mode. (deprecated: please use encryption.strictMode.egress.cidr)
     - string
     - ``""``
   ...
   * - :spelling:ignore:`encryption.strictMode.egress.cidr`
     - CIDR for the WireGuard Pod2Pod strict egress mode.
     - string
     - ``""``
   ...
   * - :spelling:ignore:`encryption.strictMode.enabled`
     - Enable WireGuard Pod2Pod strict mode. (deprecated: please use encryption.strictMode.egress.enabled)
     - bool
     - ``false``
   * - :spelling:ignore:`encryption.strictMode.ingress.enabled`
     - Enable strict ingress encryption. When enabled, all unencrypted Pod2Pod ingress traffic will be dropped. This option is only applicable when WireGuard and tunneling are enabled.
     - bool
     - ``false``
