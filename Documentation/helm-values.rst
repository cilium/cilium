...
.. list-table::
   ...
   * - :spelling:ignore:`authentication.mutual.spire.install.initImage`
     ...
     - object
     - ``{"digest":"sha256:2383baad1860bbe9d8a7a843775048fd07d8afe292b94bd876df64a69aae7cb1","override":null,"pullPolicy":"Always","repository":"docker.io/library/busybox","tag":"1.37.0","useDigest":true}``
   ...
   * - :spelling:ignore:`encryption.ztunnel`
     ...
     - object
     - ``{"affinity":{},"annotations":{},"caAddress":"https://localhost:15012","dnsCaptureEnabled":"false","enableHbone":"true","extraEnv":[],"extraVolumeMounts":[],"extraVolumes":[],"healthPort":15021,"image":{"digest":null,"override":null,"pullPolicy":"IfNotPresent","repository":"docker.io/istio/ztunnel","tag":"1.28.0-distroless","useDigest":false},"inpodUDS":"/var/run/cilium/ztunnel.sock","nodeSelector":{"kubernetes.io/os":"linux"},"podAnnotations":{},"podLabels":{},"priorityClassName":null,"readinessProbe":{"failureThreshold":3,"initialDelaySeconds":0,"periodSeconds":10},"resources":{"requests":{"cpu":"200m","memory":"512Mi"}},"secrets":{"bootstrapRootCert":null},"terminationGracePeriodSeconds":30,"tolerations":[{"effect":"NoSchedule","operator":"Exists"},{"key":"CriticalAddonsOnly","operator":"Exists"},{"effect":"NoExecute","operator":"Exists"}],"updateStrategy":{"rollingUpdate":{"maxSurge":1,"maxUnavailable":0},"type":"RollingUpdate"},"xdsAddress":"https://localhost:15012"}``
   ...
   * - :spelling:ignore:`encryption.ztunnel.dnsCaptureEnabled`
     - Enable DNS capture in ztunnel.
     - string
     - ``"false"``
   * - :spelling:ignore:`encryption.ztunnel.enableHbone`
     - Enable HBONE (HTTP-Based Overlay Network Environment) protocol.
     - string
     - ``"true"``
   ...
   * - :spelling:ignore:`encryption.ztunnel.inpodUDS`
     - Unix domain socket path for in-pod communication.
     - string
     - ``"/var/run/cilium/ztunnel.sock"``
   ...
   * - :spelling:ignore:`encryption.ztunnel.updateStrategy`
     ...
     - object
     - ``{"rollingUpdate":{"maxSurge":1,"maxUnavailable":0},"type":"RollingUpdate"}``
   * - :spelling:ignore:`encryption.ztunnel.xdsAddress`
     - XDS server address for ztunnel to connect to.
     - string
     - ``"https://localhost:15012"``
   ...
   * - :spelling:ignore:`envoy.image`
     ...
     - object
     - ``{"digest":"sha256:fa2e805e501fd7f179705d0835158b5af92d3fdded7c7ee5b3c9170d18dae87e","override":null,"pullPolicy":"Always","repository":"quay.io/cilium/cilium-envoy","tag":"v1.35.9-1768610924-2528359430c6adba1ab20fc8396b4effe491ed96","useDigest":true}``
   ...
   * - :spelling:ignore:`serviceAccounts.ztunnel`
     ...
     - object
     - ``{"annotations":{},"automount":false,"create":true,"name":"cilium-ztunnel"}``
