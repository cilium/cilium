...
.. list-table::
   ...
   * - :spelling:ignore:`envoy.log.accessLogBufferSize`
     ...
     - int
     - ``4096``
   * - :spelling:ignore:`envoy.log.accessLogWorkers`
     - Number of worker goroutines processing Envoy access log messages per connection. Increase this value on nodes with high L7 traffic to reduce per-connection processing latency.
     - int
     - ``4``
