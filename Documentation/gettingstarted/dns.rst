...
.. code-block:: shell-session
   ...
   $ kubectl exec mediabot -- curl -I https://api.github.com | head -1
   HTTP/2 200

   $ kubectl exec mediabot -- curl -I --max-time 5 https://support.github.com | head -1
...
.. code-block:: shell-session
   ...
   $ kubectl exec mediabot -- curl -I https://support.github.com | head -1
   HTTP/1.1 200 OK
...
.. code-block:: shell-session
   ...
   $ kubectl exec mediabot -- curl -I --max-time 5 http://support.github.com | head -1
