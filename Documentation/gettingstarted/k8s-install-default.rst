...
.. tabs::
    ...
    .. group-tab:: Azure/AKS
       ...
       **Install Cilium:**
       ...
       Now that Cilium is installed we can remove the taint on the new node pool and then delete the 
       original node pool. This will allow for the Pods on the original system node pool to be rescheduled on
