    ...
    .. group-tab:: Kubespray
       ...
       **Configure cluster:**
       ...
       .. code-block:: bash
           ...
           # Set kube_owner to root to ensure proper permissions for CNI components
           sed -i 's/^kube_owner:.*$/kube_owner: root/' inventory/mycluster/group_vars/k8s_cluster.yml
