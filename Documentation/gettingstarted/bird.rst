...
If you are not familiar with it, better to have a glance at the `User's Guide
...
collaborating with Cilium. Installation and configurations on other platforms
should be much similar.
...
schemes. However, BGP scheme design is beyond of the scope of this guide.
...
.. raw:: html
    ...
    <p align="center"><img src="images/bird_sample_topo.png" width="35%" height="35%"></p>
...
.. raw:: html
    ...
    <p align="center"><img src="images/bird_sample_bgp.png" width="35%" height="35%"></p>
...
.. code:: bash
    ...
    # Forbide synchronizing BIRD routing tables with the OS kernel.
    protocol kernel {
...
Replace the placeholders with your own ones:

- ``NODE_IP``: IP address of this node
- ``NODE_ASN``: autonomous system number (ASN) of this node
- ``NEIGHBOR_*_IP``: IP address of the BGP peer
- ``NEIGHBOR_*_ASN``: ASN of the BGP peer
- ``NEIGHBOR_PWD``: password of the BGP peer
...
.. raw:: html
    ...
    <p align="center"><img src="images/bird_dashboard.png" width="95%" height="95%"></p>
...
nodes. In this case, you need configure `Equal-Cost Multi-Path (ECMP) routing
