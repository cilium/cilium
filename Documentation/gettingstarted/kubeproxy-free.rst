...
- ``global.kubeProxyReplacement=probe``: This option is only intended for a hybrid setup,
  ...
  the Cilium agent will set ``global.nodePort.bindProtection`` to ``false`` in this mode in
