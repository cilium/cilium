...
.. parsed-literal::
    ...
    KubeProxyReplacement:   Strict   [NodePort (SNAT, 30000-32767), HostPort, ExternalIPs, HostReachableServices (TCP, UDP)]
...
``hostPort: 8080`` parameter can be used to check the mapping:
