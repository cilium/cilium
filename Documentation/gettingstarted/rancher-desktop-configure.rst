...
Next you need to start Rancher Desktop with ``containerd`` and create a :download:`override.yaml <rancher-desktop-override.yaml>`:

.. literalinclude:: rancher-desktop-override.yaml
   :language: yaml
