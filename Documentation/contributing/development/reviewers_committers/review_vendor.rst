...
Each time a non-draft PR modifying files owned by the team opens, GitHub
...
of replace directives where possible, due to the extra maintenance budren that
they incur.
...
involves creating a fork of the upstream library and modifying import statements y
of the libray to point to the fork.
