...
```
  ...
  -h, --help                                                      help for cilium-agent
      ...
      --max-delay-namespace-label-change duration                 Randomly delay CiliumIdentity updates for Endpoints by up to this time after Namespace labels change (default 30s)
