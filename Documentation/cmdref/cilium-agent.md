...
```
  ...
  -D, --debug                                                     Enable debugging mode
      ...
      --enable-ip-option-tracing uint8                            Enable packet IP tracing. Set this option to specify the IP options field of IPv4 packet from which to read tracing information; a value of 0 disables IP tracing.
