...
```
      ...
      --bpf-ct-timeout-regular-any string                     Timeout for entries in non-TCP CT table (default "1m")
      --bpf-ct-timeout-regular-tcp string                     Timeout for established entries in TCP CT table (default "6h")
      --bpf-ct-timeout-regular-tcp-fin string                 Teardown timeout for entries in TCP CT table (default "10s")
      --bpf-ct-timeout-regular-tcp-syn string                 Establishment timeout for entries in TCP CT table (default "1m")
      --bpf-ct-timeout-service-any string                     Timeout for service entries in non-TCP CT table (default "1m")
      --bpf-ct-timeout-service-tcp string                     Timeout for established service entries in TCP CT table (default "6h")
