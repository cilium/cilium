...
```
  ...
  -D, --debug                                                     Enable debugging mode
      ...
      --enable-remote-node-masquerade                             Masquerade IPv4 packets from endpoints leaving the host destined to a remote node node in BPF routing mode. This option requires to set enable-bpf-masquerade to true.
