...
```
  ...
  -e, --docker string                               Path to docker runtime socket (DEPRECATED: use container-runtime-endpoint instead) (default "unix:///var/run/docker.sock")
      ...
      --policy-enforcement-clean-up                 When used along the policy-enforcement-interface flag, it cleans up all BPF programs installed when Cilium agent is terminated. (default: false)
