...
```
  ...
  -h, --help                                                 help for cilium-agent
      ...
      --install-no-conntrack-iptables-rules                  Install Iptables rules to skip netfilter connection tracking on all pod-to-pod traffic. This option is only effective when Cilium is running in direct routing and full KPR mode. (default true)
