...
```
  ...
  -h, --help                                         help for hive
      ...
      --pprof-block-profile-rate int                 Enable goroutine blocking profiling and set the rate of sampled events in nanoseconds (set to 1 to sample all event [warning: performance overhead])
