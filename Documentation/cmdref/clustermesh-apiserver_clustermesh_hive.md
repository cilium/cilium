...
## clustermesh-apiserver clustermesh hive

Inspect the hive

```
clustermesh-apiserver clustermesh hive [flags]
```
...
```
      ...
      --clustermesh-install-mcs-api-crds             Whether or not the MCS API CRDs should be automatically installed. clustermesh-enable-mcs-api must be true for this to take effect. (default true)
...
* [clustermesh-apiserver clustermesh hive dot-graph](clustermesh-apiserver_clustermesh_hive_dot-graph.md)	 - Output the dependencies graph in graphviz dot format
