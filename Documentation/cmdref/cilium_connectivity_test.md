...
```
  ...
  -p, --pause-on-fail                                         Pause execution on test failure
      ...
      --socat-image string                                    Image path to use for multicast tests (default "docker.io/alpine/socat:1.8.0.3@sha256:251414f1a5f80e169f79eba2c949a9e30e913d6312fec00b2cc240597a51db85")
      ...
      --test-conn-disrupt-image string                        Image path to use for connection disruption tests (default "docker.io/fristonio/test-connection-disruption:v0.0.17")
