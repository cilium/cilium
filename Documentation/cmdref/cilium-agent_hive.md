...
```
  ...
  -h, --help                                                      help for hive
      ...
      --hubble-export-aggregation-interval duration               Interval at which to aggregate before exporting Hubble flows. (default 30s)
      ...
      --hubble-export-fieldaggregate strings                      Specify list of fields to use for aggregation in Hubble exporter.
