...
```
  ...
  -h, --help                                                      help for hive
      ...
      --hubble-exclude-http-headers-allow strings                 HTTP headers to keep in flows; all others are excluded (dropped entirely)
      --hubble-exclude-http-headers-deny strings                  HTTP headers to exclude (drop entirely) from flows
