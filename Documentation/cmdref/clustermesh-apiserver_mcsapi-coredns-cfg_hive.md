...
## clustermesh-apiserver mcsapi-coredns-cfg hive

Inspect the hive

```
clustermesh-apiserver mcsapi-coredns-cfg hive [flags]
```
...
* [clustermesh-apiserver mcsapi-coredns-cfg hive dot-graph](clustermesh-apiserver_mcsapi-coredns-cfg_hive_dot-graph.md)	 - Output the dependencies graph in graphviz dot format
