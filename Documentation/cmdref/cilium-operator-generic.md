...
```
  ...
  -D, --debug                                                Enable debugging mode
      ...
      --gateway-api-use-remote-address                       Use the remote address as the client IP address when determining the origin client's IP address. (default true)
...
* [cilium-operator-generic shell](cilium-operator-generic_shell.md)	 - Connect to the shell
