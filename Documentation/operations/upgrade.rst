...
* ``update-ec2-adapter-limit-via-api`` CLI flag for the operator has been removed 
  since the operator will only and always use the EC2API to update the EC2 instance limit.
...
* ``eni.updateEC2AdapterLimitViaAPI`` is removed since the operator will 
  only and always use the EC2API to update the EC2 instance limit.
