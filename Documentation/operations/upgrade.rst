...
* Cilium will stop reporting its local cluster name and node name in metrics and logs. Users relying on those
  should configure their metrics/log collection system to add similar labels instead.
