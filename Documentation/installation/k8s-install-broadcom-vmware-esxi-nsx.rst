...
.. tabs::
    ...
    .. group-tab:: VXLAN
        ...
        .. note::
            ...
            With NSX(-T), you need to change tunnel port using ``--set tunnelPort=8223``
            There is some known issue about offload when use VXLAN UDP port standard (4789) or draft (8472) like cilium
    ...
    .. group-tab:: Geneve
        ...
        .. note::
            ...
            if you are using NSX(-T) and Network Virtualization (with Edge T0/T1), NSX also use Geneve Protocol between Transport (ESXi, Edge) Nodes.
            It can be more complicated for debugging and troubleshoot issue.
