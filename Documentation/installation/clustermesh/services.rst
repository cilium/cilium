...
the annotation ``io.cilium.service.global: "true"`` to declare it global.
...
This implicitly configures ``io.cilium.service.shared: "true"``. To prevent service
...
.. code-block:: yaml
   ...
   metadata:
     ...
     annotations:
       ...
       io.cilium.service.shared: "false"
   spec:
     type: ClusterIP
     ports:
     - port: 80
...
4. In cluster 1, add ``io.cilium.service.shared="false"`` to existing global service

   .. code-block:: shell-session

      kubectl annotate service rebel-base io.cilium.service.shared="false" --overwrite
...
7. In cluster 1, remove ``io.cilium.service.shared`` annotation of existing global service

   .. code-block:: shell-session

      kubectl annotate service rebel-base io.cilium.service.shared-
