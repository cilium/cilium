...
one interface.  If you would like to send on multiple interfaces, you should use the
``l2podAnnouncements.interfaces``/``l2-pod-announcements-interfaces`` option instead. 
...
.. tabs::
    .. group-tab:: Helm
        ...
        .. parsed-literal::
            ...
            $ helm upgrade cilium |CHART_RELEASE| \\
               ...
               --reuse-values \\
               --set l2podAnnouncements.enabled=true \\
               --set l2podAnnouncements.interfaces=^(eth0|ens1)$
    ...
    .. group-tab:: ConfigMap
        ...
        .. code-block:: yaml
            ...
            enable-l2-pod-announcements: true
            l2-pod-announcements-interface: "^(eth0|ens1)$"
