...
The previous example doesn't include any network policy, please refer to the below section for more details on how to
apply network policy for Ingress traffic.
