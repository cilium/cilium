...
========================== ==========================
`Longest Prefix Match`_    4.11+
`Host Reachable Services`_ 4.19.57+
`Kube-proxy Free`_         4.19.57+
========================== ==========================

.. _Longest Prefix Match: |SCM_WEB|\/install/upgrade/#restrictions-on-unique-prefix-lengths-for-cidr-policy-rules
.. _Host Reachable Services: |SCM_WEB|\/gettingstarted/host-services/
.. _Kube-proxy Free: |SCM_WEB|\/gettingstarted/kubeproxy-free
