...
.. note::
   ...
   The default firewall rules for the cluster's subnet do not allow ESP.

   An example of creating a firewall rule can be found in Cilium's GKE
   conformance tests: ".github/workflows/conformance-gke.yaml"
