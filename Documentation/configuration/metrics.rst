...
in :git-tree:`examples/kubernetes/addons/prometheus/04-prometheus.yaml`
...
Cilium Kubernetes DaemonSet spec in :git-tree:`examples/kubernetes/addons/prometheus/04-prometheus.yaml`
