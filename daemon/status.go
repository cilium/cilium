...
func (dss *daemonStatus) startStatusCollector(d *Daemon) {
	...
	dss.controllers.UpdateController("kvstore-status-collector",
	...
	dss.controllers.UpdateController("k8s-status-collector",
		controller.ControllerParams{
			RunInterval: collectStatusInterval,
			DoFunc: func() error {
	...
	dss.controllers.UpdateController("controller-status-collector",
		controller.ControllerParams{
			RunInterval: collectStatusInterval,
			DoFunc: func() error {
	...
	dss.controllers.UpdateController("container-runtime-status-collector",
		controller.ControllerParams{
			RunInterval: collectStatusInterval,
			DoFunc: func() error {
	...
	dss.controllers.UpdateController("global-locks-status-collector",
		controller.ControllerParams{
			RunInterval: collectStatusInterval,
			DoFunc: func() error {
				d.checkLocks()
	...
	dss.controllers.UpdateController("ipam-status-collector",
		controller.ControllerParams{
			RunInterval: collectStatusInterval,
			DoFunc: func() error {
	...
	dss.controllers.UpdateController("node-monitor-status-collector",
		controller.ControllerParams{
			RunInterval: collectStatusInterval,
			DoFunc: func() error {
	...
	dss.controllers.UpdateController("cluster-status-collector",
		controller.ControllerParams{
			RunInterval: collectStatusInterval,
			DoFunc: func() error {
	...
	dss.controllers.UpdateController("cilium-health-status-collector",
		controller.ControllerParams{
			RunInterval: collectStatusInterval,
			DoFunc: func() error {
	...
	dss.controllers.UpdateController("l7Proxy-status-collector",
		controller.ControllerParams{
			RunInterval: collectStatusInterval,
			DoFunc: func() error {
...
func (dss *daemonStatus) getStaleComponents() (stale []string, oldest time.Time) {
	var (
		now            = time.Now()
		staleThreshold = now.Add(-1 * staleTimeout) // timestamps older than this are stale
...
// checkLocks tries to acquire a couple of global locks to have the status API
// report an error in case of a deadlock on these locks
