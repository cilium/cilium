...
func (d *Daemon) PolicyAdd(rules policyAPI.Rules, opts *AddOptions) (uint64, error) {
	...
	// policySelectionWG is a waitgroup which is used to signal when the updating
	// of all of the caches of endpoints in the rules which were added / updated
	// have been updated.
...
func (d *Daemon) PolicyDelete(labels labels.LabelArray) (uint64, error) {
	...
	// policySelectionWG is a waitgroup which is used to signal when the updating
	// of all of the caches of allEndpoints in the rules which were added / updated
	// have been updated.
	var policySelectionWG sync.WaitGroup
