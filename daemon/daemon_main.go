...
func init() {
	...
	flags.String(option.CTMapEntriesTimeoutSrvTCPName, option.CTMapEntriesTimeoutSrvTCPDefault, "Timeout for established service entries in TCP CT table")
	option.BindEnv(option.CTMapEntriesTimeoutSrvTCPName)

	flags.String(option.CTMapEntriesTimeoutSrvAnyName, option.CTMapEntriesTimeoutSrvAnyDefault, "Timeout for service entries in non-TCP CT table")
	option.BindEnv(option.CTMapEntriesTimeoutSrvAnyName)
