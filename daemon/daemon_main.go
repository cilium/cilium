...
func initEnv(cmd *cobra.Command) {
	...
	if option.Config.EnableHostReachableServices {
		...
		if option.Config.EnableHostServicesTCP &&
			...
			log.Fatal("BPF host reachable services for TCP needs min kernel 4.18.0 or higher")
		}
		if option.Config.EnableHostServicesUDP &&
			...
			log.Fatal("BPF host reachable services for UDP needs kernel 4.19.57 or higher")
		}
	}
