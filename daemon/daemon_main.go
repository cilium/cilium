...
func init() {
	...
	flags.StringVar(&option.Config.ToFQDNsPreCache, option.ToFQDNsPreCache, defaults.ToFQDNsPreCache, "DNS cache data at this path is preloaded on agent startup")
