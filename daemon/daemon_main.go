...
func runDaemon() {
	...
	// Start the policy queue add worker to make sure that the restore of new
	// policies or CNP are updated correctly and we wait with the worker started.
	go d.PolicyQueueWorker(context.Background())
