...
func initEnv(cmd *cobra.Command) {
	...
	if option.Config.EnableHostReachableServices {
		...
		if option.Config.EnableHostServicesUDP &&
			...
			log.Fatal("BPF host reachable services for UDP needs kernel 4.19.57, v5.1.16, v5.2.0 or newer. If you run an older kernel and only need TCP, then specify: --host-reachable-services-protos=tcp")
		}
	}
