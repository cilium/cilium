...
func init() {
	...
	flags.Bool(option.EnableK8sEndpointSlice, defaults.EnableK8sEndpointSlice, fmt.Sprintf("Enable k8s EndpointSlice feature into Cilium"))
	option.BindEnv(option.EnableK8sEndpointSlice)
