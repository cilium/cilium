...
func getHealthzHandler(d *Daemon, params GetHealthzParams) middleware.Responder {
	...
	withoutK8sConnectivity := params.WithoutK8sConnectivity != nil && *params.WithoutK8sConnectivity
	sr := d.getStatus(brief, withoutK8sConnectivity)
...
func (d *Daemon) getStatus(brief bool, withoutK8sConnectivity bool) models.StatusResponse {
	...
	case d.clientset.IsEnabled() && d.statusResponse.Kubernetes != nil && d.statusResponse.Kubernetes.State != models.StatusStateOk && !withoutK8sConnectivity:
