...
func (ds *DaemonSuite) prepareEndpoint(t *testing.T, identity *identity.Identity, qa bool) *endpoint.Endpoint {
	...
	e := endpoint.NewTestEndpointWithState(ds.d, ds.d.epBuildQueue, ds.d.loader, ds.d.orchestrator, ds.d.compilationLock, ds.d.bwManager, ds.d.iptablesManager, ds.d.idmgr, ds.d.policyMapFactory, ds.d, testipcache.NewMockIPCache(), ds.d.l7Proxy, ds.d.identityAllocator, ds.d.ctMapGC, testEndpointID, endpoint.StateWaitingForIdentity)
