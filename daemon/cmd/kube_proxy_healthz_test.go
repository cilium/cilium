...
func (d *mockDaemon) getStatus(brief bool, requireK8sConnectivity bool) models.StatusResponse {
	return d.injectedStatusResponse
}

func (s *mockServiceInterface) GetLastUpdatedTs() time.Time {
	return s.lastUpdatedTs
}

func (s *mockServiceInterface) GetCurrentTs() time.Time {
	return s.currentTs
}
