...
func InitGlobalFlags(cmd *cobra.Command, vp *viper.Viper) {
	...
	flags.String(option.BGPRouterIDAllocationMode, option.BGPRouterIDAllocationModeNode, "BGP router-id allocation mode. Currently supported values: 'node' or 'ip-pool'")
