...
func InitGlobalFlags(logger *slog.Logger, cmd *cobra.Command, vp *viper.Viper) {
	...
	flags.Bool(option.EnableUnknownProtocols, defaults.EnableUnknownProtocols, "Enable traffic with unknown protocols in datapath")
	option.BindEnv(vp, option.EnableUnknownProtocols)
