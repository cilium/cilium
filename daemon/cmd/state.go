...
func (d *Daemon) fetchOldEndpoints(dir string) (*endpointRestoreState, error) {
	...
	state.possible = endpoint.ReadEPsFromDirNames(d.ctx, d, d.epBuildQueue, d.loader, d.orchestrator, d.compilationLock, d.bwManager, d.iptablesManager, d.idmgr, d.monitorAgent, d.policyMapFactory, d, d.ipcache, dir, eptsID)
