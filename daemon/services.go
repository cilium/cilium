...
func PutL3n4Addr(l3n4Addr types.L3n4Addr, baseID uint32) (*types.L3n4AddrID, error) {
	log.WithField(logfields.L4Addr, logfields.Repr(l3n4Addr)).Debug("Resolving service")
...
func GetL3n4AddrID(id uint32) (*types.L3n4AddrID, error) {
	...
	log.WithField(logfields.L4AddrID, strID).Debug("getting L3n4AddrID for ID")
...
func DeleteL3n4AddrIDByUUID(id uint32) error {
	log.WithField(logfields.L4AddrID, id).Debug("deleting L3n4Addr by ID")
