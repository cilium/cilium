...
var (
	...
	// local cache of Kubernetes Endpoints which relate to Headless Services.
...
func (d *Daemon) addK8sEndpointV1(ep *v1.Endpoints) {
	...
	if ok && svc.IsExternal() {
		...
		// corresponding headless service for any toServices rules which
		// select said service.
