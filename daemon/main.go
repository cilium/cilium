...
func init() {
	...
	flags.StringSliceVar(&option.Config.Workloads,
		"container-runtime", []string{"auto"}, `Sets the container runtime(s) used by Cilium { containerd | crio | docker | none | auto } ( "auto" the uses the container runtime found in the order: "docker", "containerd", "crio" )`)
