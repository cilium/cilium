...
// endpoint
func (d *Daemon) RemoveProxyRedirect(e regeneration.EndpointInfoSource, id string) (error, revert.FinalizeFunc, revert.RevertFunc) {
	if d.l7Proxy == nil {
		return nil, nil, nil
	}
...
func NewDaemon(dp datapath.Datapath, iptablesManager rulesManager) (*Daemon, *endpointRestoreState, error) {
	...
	if option.Config.InstallIptRules {
		d.l7Proxy = proxy.StartProxySupport(&d, d.datapath, d.endpointManager)
	} else {
