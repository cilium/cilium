...
func (d *Daemon) UpdateProxyRedirect(e *endpoint.Endpoint, l4 *policy.L4Filter, proxyWaitGroup *completion.WaitGroup, acked func(redirectPort uint16), nacked func(error)) error {
	if d.l7Proxy == nil {
		return fmt.Errorf("can't redirect, proxy disabled")
	}

	err := d.l7Proxy.CreateOrUpdateRedirect(l4, e.ProxyID(l4), e, proxyWaitGroup, acked, nacked)
	if err != nil {
		return err
	}
