...
func (in *IPAMStatus) DeepCopyInto(out *IPAMStatus) {
	*out = *in
	...
	if in.UsedPodCIDRs != nil {
		in, out := &in.UsedPodCIDRs, &out.UsedPodCIDRs
		*out = make(UsedPodCIDRMap, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *UsedPodCIDR) DeepCopyInto(out *UsedPodCIDR) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new UsedPodCIDR.
func (in *UsedPodCIDR) DeepCopy() *UsedPodCIDR {
	if in == nil {
		return nil
	}
	out := new(UsedPodCIDR)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in UsedPodCIDRMap) DeepCopyInto(out *UsedPodCIDRMap) {
	{
		in := &in
		*out = make(UsedPodCIDRMap, len(*in))
		for key, val := range *in {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new UsedPodCIDRMap.
func (in UsedPodCIDRMap) DeepCopy() UsedPodCIDRMap {
	if in == nil {
		return nil
	}
	out := new(UsedPodCIDRMap)
	in.DeepCopyInto(out)
	return *out
}
