...
import (
	...
	v33 "github.com/cilium/proxy/go/envoy/config/accesslog/v3"
...
var file_envoy_config_listener_v3_listener_proto_rawDesc = []byte{
	...
	0x08, 0x0e, 0x10, 0x0f, 0x4a, 0x04, 0x08, 0x17, 0x10, 0x18, 0x42, 0x8d, 0x01, 0x0a, 0x26, 0x69,
	0x6f, 0x2e, 0x65, 0x6e, 0x76, 0x6f, 0x79, 0x70, 0x72, 0x6f, 0x78, 0x79, 0x2e, 0x65, 0x6e, 0x76,
	0x6f, 0x79, 0x2e, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x2e, 0x6c, 0x69, 0x73, 0x74, 0x65, 0x6e,
	0x65, 0x72, 0x2e, 0x76, 0x33, 0x42, 0x0d, 0x4c, 0x69, 0x73, 0x74, 0x65, 0x6e, 0x65, 0x72, 0x50,
...
var file_envoy_config_listener_v3_listener_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_envoy_config_listener_v3_listener_proto_goTypes = []interface{}{
	...
	(*Listener_ConnectionBalanceConfig_ExactBalance)(nil), // 7: envoy.config.listener.v3.Listener.ConnectionBalanceConfig.ExactBalance
	(*v3.Address)(nil),                                    // 8: envoy.config.core.v3.Address
	(*v3.SocketOptionsOverride)(nil),                      // 9: envoy.config.core.v3.SocketOptionsOverride
	(*v31.CollectionEntry)(nil),                           // 10: xds.core.v3.CollectionEntry
	(*FilterChain)(nil),                                   // 11: envoy.config.listener.v3.FilterChain
	(*v32.Matcher)(nil),                                   // 12: xds.type.matcher.v3.Matcher
	(*wrapperspb.BoolValue)(nil),                          // 13: google.protobuf.BoolValue
	(*wrapperspb.UInt32Value)(nil),                        // 14: google.protobuf.UInt32Value
	(*v3.Metadata)(nil),                                   // 15: envoy.config.core.v3.Metadata
	(*ListenerFilter)(nil),                                // 16: envoy.config.listener.v3.ListenerFilter
	(*durationpb.Duration)(nil),                           // 17: google.protobuf.Duration
	(*v3.SocketOption)(nil),                               // 18: envoy.config.core.v3.SocketOption
	(v3.TrafficDirection)(0),                              // 19: envoy.config.core.v3.TrafficDirection
	(*UdpListenerConfig)(nil),                             // 20: envoy.config.listener.v3.UdpListenerConfig
	(*ApiListener)(nil),                                   // 21: envoy.config.listener.v3.ApiListener
	(*v33.AccessLog)(nil),                                 // 22: envoy.config.accesslog.v3.AccessLog
	(*v3.TypedExtensionConfig)(nil),                       // 23: envoy.config.core.v3.TypedExtensionConfig
}
var file_envoy_config_listener_v3_listener_proto_depIdxs = []int32{
	8,  // 0: envoy.config.listener.v3.AdditionalAddress.address:type_name -> envoy.config.core.v3.Address
	9,  // 1: envoy.config.listener.v3.AdditionalAddress.socket_options:type_name -> envoy.config.core.v3.SocketOptionsOverride
	10, // 2: envoy.config.listener.v3.ListenerCollection.entries:type_name -> xds.core.v3.CollectionEntry
	8,  // 3: envoy.config.listener.v3.Listener.address:type_name -> envoy.config.core.v3.Address
	1,  // 4: envoy.config.listener.v3.Listener.additional_addresses:type_name -> envoy.config.listener.v3.AdditionalAddress
	11, // 5: envoy.config.listener.v3.Listener.filter_chains:type_name -> envoy.config.listener.v3.FilterChain
	12, // 6: envoy.config.listener.v3.Listener.filter_chain_matcher:type_name -> xds.type.matcher.v3.Matcher
	13, // 7: envoy.config.listener.v3.Listener.use_original_dst:type_name -> google.protobuf.BoolValue
	11, // 8: envoy.config.listener.v3.Listener.default_filter_chain:type_name -> envoy.config.listener.v3.FilterChain
	14, // 9: envoy.config.listener.v3.Listener.per_connection_buffer_limit_bytes:type_name -> google.protobuf.UInt32Value
	15, // 10: envoy.config.listener.v3.Listener.metadata:type_name -> envoy.config.core.v3.Metadata
	4,  // 11: envoy.config.listener.v3.Listener.deprecated_v1:type_name -> envoy.config.listener.v3.Listener.DeprecatedV1
	0,  // 12: envoy.config.listener.v3.Listener.drain_type:type_name -> envoy.config.listener.v3.Listener.DrainType
	16, // 13: envoy.config.listener.v3.Listener.listener_filters:type_name -> envoy.config.listener.v3.ListenerFilter
	17, // 14: envoy.config.listener.v3.Listener.listener_filters_timeout:type_name -> google.protobuf.Duration
	13, // 15: envoy.config.listener.v3.Listener.transparent:type_name -> google.protobuf.BoolValue
	13, // 16: envoy.config.listener.v3.Listener.freebind:type_name -> google.protobuf.BoolValue
	18, // 17: envoy.config.listener.v3.Listener.socket_options:type_name -> envoy.config.core.v3.SocketOption
	14, // 18: envoy.config.listener.v3.Listener.tcp_fast_open_queue_length:type_name -> google.protobuf.UInt32Value
	19, // 19: envoy.config.listener.v3.Listener.traffic_direction:type_name -> envoy.config.core.v3.TrafficDirection
	20, // 20: envoy.config.listener.v3.Listener.udp_listener_config:type_name -> envoy.config.listener.v3.UdpListenerConfig
	21, // 21: envoy.config.listener.v3.Listener.api_listener:type_name -> envoy.config.listener.v3.ApiListener
	5,  // 22: envoy.config.listener.v3.Listener.connection_balance_config:type_name -> envoy.config.listener.v3.Listener.ConnectionBalanceConfig
	13, // 23: envoy.config.listener.v3.Listener.enable_reuse_port:type_name -> google.protobuf.BoolValue
	22, // 24: envoy.config.listener.v3.Listener.access_log:type_name -> envoy.config.accesslog.v3.AccessLog
	14, // 25: envoy.config.listener.v3.Listener.tcp_backlog_size:type_name -> google.protobuf.UInt32Value
	13, // 26: envoy.config.listener.v3.Listener.bind_to_port:type_name -> google.protobuf.BoolValue
	6,  // 27: envoy.config.listener.v3.Listener.internal_listener:type_name -> envoy.config.listener.v3.Listener.InternalListenerConfig
	13, // 28: envoy.config.listener.v3.Listener.DeprecatedV1.bind_to_port:type_name -> google.protobuf.BoolValue
	7,  // 29: envoy.config.listener.v3.Listener.ConnectionBalanceConfig.exact_balance:type_name -> envoy.config.listener.v3.Listener.ConnectionBalanceConfig.ExactBalance
	23, // 30: envoy.config.listener.v3.Listener.ConnectionBalanceConfig.extend_balance:type_name -> envoy.config.core.v3.TypedExtensionConfig
...
func file_envoy_config_listener_v3_listener_proto_init() {
	...
	file_envoy_config_listener_v3_listener_proto_msgTypes[4].OneofWrappers = []interface{}{
