...
const (
	...
	proxylibDeprecatedWarn    stringMatcher = "Support for proxylib has been deprecated due to lack of maintainers"         // cf. https://github.com/cilium/cilium/issues/38224       // cf.
