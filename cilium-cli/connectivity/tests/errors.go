...
const (
	...
	failedToRetrieveRemoteClusterCfg stringMatcher = "Unable to get remote cluster configuration.*failed to retrieve cluster configuration: not found" // Possible race condition in KVStoreMesh mode
