...
const (
	...
	certloaderInitialLoadWarn stringMatcher = "Initial TLS configuration load failed, certificate files might not yet be available, waiting on fswatcher update to become ready" // Expected when certificates are not yet mounted.
