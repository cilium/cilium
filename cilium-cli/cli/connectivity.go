...
func newCmdConnectivityTest(hooks api.Hooks) *cobra.Command {
	...
	cmd.Flags().StringVar(&params.LoadbalancerL7Image, "loadbalancer-l7-image", defaults.ConnectivityCheckOptionalImagesTest["ConnectivityTestLoadbabancerL7Image"], "Image path to use for L7 Loadbalancer tests")
