...
const (
	...
	// renovate: datasource=docker
	ConnectivityTestConnDisruptImage = "quay.io/cilium/test-connection-disruption:v0.0.15@sha256:c31ccc4d8c0258a71655c84977a96fa2710e7eb25c76a5403e29f0cc260c5ce2"
	// renovate: datasource=docker
