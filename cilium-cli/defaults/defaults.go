...
var (
	...
	ConnectivityCheckImagesTest = map[string]string{
		...
		// renovate: datasource=docker
		"ConnectivityTestConnDisruptImage": "docker.io/fristonio/test-connection-disruption:v0.0.17",
		...
		// renovate: datasource=docker
		"ConnectivityTestSocatImage": "docker.io/alpine/socat:1.8.0.3@sha256:251414f1a5f80e169f79eba2c949a9e30e913d6312fec00b2cc240597a51db85",
	}
