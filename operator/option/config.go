...
const (
	...
	// AWSEnableIPv6PrefixDelegation allows operator to allocate IPv6 prefixes to ENIs on nitro instances instead of individual
	// IP addresses. Allows for increased pod density on nodes.
...
type OperatorConfig struct {
	...
	// AWSEnablePrefixDelegation allows operator to allocate IPv6 prefixes to ENIs on nitro instances instead of individual
	// IP addresses. Allows for increased pod density on nodes.
