...
func init() {
	...
	flags.Float64(option.K8sClientQPSLimit, 0, "Queries per second limit for the K8s client")
	flags.Int(option.K8sClientBurst, 0, "Burst value allowed for the K8s client")
