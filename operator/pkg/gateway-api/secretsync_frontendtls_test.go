...
func TestEnqueueConfigMapsForFrontendTLSReferenceGrant(t *testing.T) {
	logger := hivetest.Logger(t)
	...
	handler.EnqueueConfigMapsForFrontendTLSReferenceGrant().Generic(
		t.Context(),
	...
	handler.EnqueueConfigMapsForFrontendTLSReferenceGrant().Delete(
		t.Context(),
