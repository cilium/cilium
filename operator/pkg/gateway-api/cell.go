...
func registerReconcilers(mgr ctrlRuntime.Manager, translator translation.Translator, logger *slog.Logger, controllerName string, installedOptionalCRDs []schema.GroupVersionKind, enableExtensionRefFilters bool) error {
	requiredReconcilers := []interface {
		...
		newGatewayReconciler(mgr, translator, logger, controllerName, enableExtensionRefFilters),
