...
// TODO: turn this into a generic checker that can be used for all route types
type backendValidatonFunc func(ctx context.Context, log *logrus.Entry, c client.Client, tr *gatewayv1alpha2.TLSRoute) (ctrl.Result, bool, error)
