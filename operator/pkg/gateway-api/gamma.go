...
func (r *gammaReconciler) enqueueRequestForOwningHTTPRoute(logger *slog.Logger) handler.EventHandler {
	return handler.EnqueueRequestsFromMapFunc(func(ctx context.Context, a client.Object) []reconcile.Request {
		...
		return getGammaReconcileRequestsForRoute(context.Background(), r.Client, a, hr.Spec.CommonRouteSpec, logger)
	})
}
...
// getGAMMAReconcileRequestsForRoute returns a list of GAMMA services to be reconciled bassd on the supplied HTTPRoute.
