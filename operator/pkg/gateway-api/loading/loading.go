...
func (l *TranslationInputLoader) Load(ctx context.Context, scopedLog *slog.Logger, gw *gatewayv1.Gateway, gatewayClass *gatewayv1.GatewayClass) (TranslationInputs, error) {
	...
	mergedListeners := l.resolveAllowedListenersFromGateway(gw)
...
func (l *TranslationInputLoader) resolveAllowedListenersFromGateway(gw *gatewayv1.Gateway) []ingestion.ListenerWithContext {
