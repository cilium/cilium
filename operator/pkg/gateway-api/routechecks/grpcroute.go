...
func (g *GRPCRouteRule) GetBackendRefs() []gatewayv1beta1.BackendRef {
...
func (g *GRPCRouteInput) GetGateway(parent gatewayv1beta1.ParentReference) (*gatewayv1beta1.Gateway, error) {
	if g.gateways == nil {
		g.gateways = make(map[gatewayv1beta1.ParentReference]*gatewayv1beta1.Gateway)
	}
