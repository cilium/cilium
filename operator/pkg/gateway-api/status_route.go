...
// RouteStatusResult is the computed route status view. It is returned rather
// than written so ext_proc rejection can be overlaid on it, and the whole view
// persisted once, instead of a Route briefly appearing accepted.
