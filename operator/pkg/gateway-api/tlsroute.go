...
type tlsRouteChecker func(ctx context.Context, client client.Client, hr *gatewayv1alpha2.TLSRoute) (ctrl.Result, error)
...
func (r *tlsRouteReconciler) enqueueFromIndex(index string) func(o client.Object) []reconcile.Request {
	return func(o client.Object) []reconcile.Request {
		...
		if err := r.Client.List(context.Background(), trList, &client.ListOptions{
