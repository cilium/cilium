...
type EndpointPicker struct {
	...
	// AppProtocol carries the InferencePool appProtocol. This applies to the connection
	// to the selected model-server endpoint.
	// "kubernetes/io/h2c" means the destination cluster must speak HTTP/2 cleartext
