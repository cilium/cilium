...
func TestSharedServicesUpdateSharingKeyAndRequestedIP(t *testing.T) {
	...
	svcA := &slim_core_v1.Service{
		ObjectMeta: slim_meta_v1.ObjectMeta{
			...
			UID:       serviceAUID,
			Annotations: map[string]string{
				ciliumSvcLBIPSAnnotation: "10.0.10.22",
				ciliumSvcLBISKAnnotation: "key-1",
			},
		},
		Spec: slim_core_v1.ServiceSpec{
	...
	svcB := &slim_core_v1.Service{
		ObjectMeta: slim_meta_v1.ObjectMeta{
			...
			UID:       serviceAUID,
			Annotations: map[string]string{
				ciliumSvcLBIPSAnnotation: "10.0.10.33",
				ciliumSvcLBISKAnnotation: "key-2",
			},
		},
		Spec: slim_core_v1.ServiceSpec{
			Type: slim_core_v1.ServiceTypeLoadBalancer,
	...
	svcC.Annotations[ciliumSvcLBIPSAnnotation] = "10.0.10.22"
	svcC.Annotations[ciliumSvcLBISKAnnotation] = "key-1"
