...
const (
	...
	// CESWithoutCEPs enables the CES controller to create CES directly from pods and removes its need for CiliumEndpoints.
	CESWithoutCEPs = "ces-without-ceps"
)
...
type SharedConfig struct {
	...
	// EnableIPSec enables IPsec encryption.
	EnableIPSec bool
}
