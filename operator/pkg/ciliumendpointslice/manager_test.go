...
func TestFCFSManager(t *testing.T) {
	...
	t.Run("Test adding new CEP to map", func(*testing.T) {
		...
		m.UpdatePodMapping(getPod("p1", "ns"), "node1", getCID("1"))
	...
	t.Run("Test creating enough CESs", func(*testing.T) {
		m := newCESManager(2, log)
		m.UpdatePodMapping(getPod("c1", "ns"), "node1", getCID("1"))
		m.UpdatePodMapping(getPod("c2", "ns"), "node1", getCID("1"))
		m.UpdatePodMapping(getPod("c3", "ns"), "node1", getCID("1"))
		m.UpdatePodMapping(getPod("c4", "ns"), "node1", getCID("1"))
		m.UpdatePodMapping(getPod("c5", "ns"), "node1", getCID("1"))
	...
	t.Run("Test keeping the CEPs from different namespaces in different CESs", func(*testing.T) {
		...
		m.UpdatePodMapping(getPod("c1", "ns1"), "node1", getCID("1"))
		m.UpdatePodMapping(getPod("c2", "ns2"), "node1", getCID("1"))
		m.UpdatePodMapping(getPod("c3", "ns3"), "node1", getCID("1"))
		m.UpdatePodMapping(getPod("c4", "ns4"), "node1", getCID("1"))
		m.UpdatePodMapping(getPod("c5", "ns5"), "node1", getCID("1"))
