...
func (c *SlimController) Start(ctx cell.HookContext) error {
	...
	c.reconciler = newSlimReconciler(c.context, c.clientset.CiliumV2alpha1(), c.manager, c.logger, c.ciliumEndpointSlice, c.pods, c.ciliumIdentity, c.ciliumNodes, c.namespace, c.ipsecEnabled, c.wgEnabled, c.metrics)
	c.doReconciler = c.reconciler
