...
func (c *Controller) onPodUpdate(pod *slim_corev1.Pod) {
	c.logger.Debug("c.onPodUpdate", logfields.K8sPodName, pod.GetName(), logfields.K8sNamespace, pod.Namespace)
	// TODO: Validate pod -> EndpointNetworking
	// TODO: Validate pod assigned Identity
...
func (c *Controller) onPodDelete(pod *slim_corev1.Pod) {
	c.logger.Debug("c.onPodDelete", logfields.K8sPodName, pod.GetName(), logfields.K8sNamespace, pod.Namespace)
