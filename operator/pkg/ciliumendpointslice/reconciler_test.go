...
func TestReconcileCreate(t *testing.T) {
	...
	r = newSlimReconciler(t.Context(), fakeClient.CiliumFakeClientset.CiliumV2alpha1(), m, hivetest.Logger(t), ciliumEndpointSlice, pods, ciliumIdentity, ciliumNode, namespace, false, false, cesMetrics)
	...
	m.mapping.upsertCEP(NewCEPName("pod1", "ns"), CESName("ces1"), "node1", gidA, "1")
	m.mapping.upsertCEP(NewCEPName("pod2", "ns"), CESName("ces1"), "node1", gidB, "2")
	m.mapping.upsertCEP(NewCEPName("pod3", "ns"), CESName("ces2"), "node1", gidC, "3")
...
func TestReconcileUpdate(t *testing.T) {
	...
	m.mapping.upsertCEP(NewCEPName("pod1", "ns"), CESName("ces1"), "node1", gidA, "1")
	m.mapping.upsertCEP(NewCEPName("pod2", "ns"), CESName("ces1"), "node1", gidB, "2")
	m.mapping.upsertCEP(NewCEPName("pod3", "ns"), CESName("ces2"), "node1", gidB, "2")
...
func TestReconcileDelete(t *testing.T) {
	...
	_, gidA := cidToGidLabels(cid1)
	_, gidB := cidToGidLabels(cid2)
	m.mapping.upsertCEP(NewCEPName("pod1", "ns"), CESName("ces2"), "node1", gidA, "1")
	m.mapping.upsertCEP(NewCEPName("pod2", "ns"), CESName("ces2"), "node1", gidB, "2")
	m.mapping.upsertCEP(NewCEPName("pod3", "ns"), CESName("ces2"), "node1", gidB, "2")
