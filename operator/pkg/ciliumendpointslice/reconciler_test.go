...
func TestReconcileCreate(t *testing.T) {
	...
	r = newReconciler(t.Context(), fakeClient.CiliumFakeClientset.CiliumV2alpha1(), m, hivetest.Logger(t), pods, ciliumEndpointSlice, ciliumNode, namespace, ciliumIdentity, cesMetrics, false, false)
