...
func TestReconcileCreateDefault(t *testing.T) {
	...
	m := newCESManager(2, false, hivetest.Logger(t))
	...
	r = newReconciler(t.Context(), fakeClient.CiliumFakeClientset.CiliumV2alpha1(), m, hivetest.Logger(t), ciliumEndpoint, pods, ciliumEndpointSlice, ciliumNode, namespace, ciliumIdentity, cesMetrics, false, false, false)
...
func TestReconcileCreate(t *testing.T) {
	var r *reconciler
	var fakeClient *k8sClient.FakeClientset
	m := newCESManager(2, true, hivetest.Logger(t))
	var pods resource.Resource[*slim_corev1.Pod]
	var ciliumEndpoint resource.Resource[*cilium_v2.CiliumEndpoint]
	var ciliumEndpointSlice resource.Resource[*cilium_v2a1.CiliumEndpointSlice]
	var ciliumNode resource.Resource[*cilium_v2.CiliumNode]
	...
	r = newReconciler(t.Context(), fakeClient.CiliumFakeClientset.CiliumV2alpha1(), m, hivetest.Logger(t), ciliumEndpoint, pods, ciliumEndpointSlice, ciliumNode, namespace, ciliumIdentity, cesMetrics, true, false, false)
	...
	m.cache.insertCES(CESName("ces1"), "ns")
	m.cache.insertCES(CESName("ces2"), "ns")

	_, gidA := cidToGidLabels(cid1)
	_, gidB := cidToGidLabels(cid2)
	_, gidC := cidToGidLabels(cid3)

	m.cache.upsertCEP(NewCEPName("pod1", "ns"), CESName("ces1"), "node1", gidA, "1")
	m.cache.upsertCEP(NewCEPName("pod2", "ns"), CESName("ces1"), "node1", gidB, "2")
	m.cache.upsertCEP(NewCEPName("pod3", "ns"), CESName("ces2"), "node1", gidC, "3")
...
func TestReconcileUpdate(t *testing.T) {
	...
	m.cache.upsertCEP(NewCEPName("pod1", "ns"), CESName("ces1"), "node1", gidA, "1")
	m.cache.upsertCEP(NewCEPName("pod2", "ns"), CESName("ces1"), "node1", gidB, "2")
	m.cache.upsertCEP(NewCEPName("pod3", "ns"), CESName("ces2"), "node1", gidB, "2")
...
func TestReconcileDelete(t *testing.T) {
	...
	_, gidA := cidToGidLabels(cid1)
	_, gidB := cidToGidLabels(cid2)
	m.cache.upsertCEP(NewCEPName("pod1", "ns"), CESName("ces2"), "node1", gidA, "1")
	m.cache.upsertCEP(NewCEPName("pod2", "ns"), CESName("ces2"), "node1", gidB, "2")
	m.cache.upsertCEP(NewCEPName("pod3", "ns"), CESName("ces2"), "node1", gidB, "2")
