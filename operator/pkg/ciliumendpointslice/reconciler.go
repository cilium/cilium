...
// TODO(jshr): This is called onCESCreate or onCESUpdate; which are called after
// the pod has been added to the cesCache.
// In what cases would we return nil here? Should we retry? Has the state changed,
// which will reconcile with the CES Cache eventually?
