...
func newDefaultReconciler(
	...
	dReconciler.reconciler.getEndpointer = &dReconciler
	return &dReconciler
}
...
func newSlimReconciler(
	...
	sReconciler.reconciler.getEndpointer = &sReconciler
	return &sReconciler
}
...
func (r *reconciler) reconcileCESCreate(cesName CESName) (err error) {
	...
	for _, cepName := range ceps {
		ccep := r.getEndpointer.getCoreEndpointFromStore(cepName)
