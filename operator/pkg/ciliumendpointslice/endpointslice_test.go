...
func TestFCFSModeSyncCESsInLocalCacheDefault(t *testing.T) {
	...
	r = newReconciler(t.Context(), fakeClient.CiliumFakeClientset.CiliumV2alpha1(), m, log, ciliumEndpoint, pods, ciliumEndpointSlice, ciliumNode, namespace, ciliumIdentity, cesMetrics, false, false, false)
...
func TestFCFSModeSyncCESsInLocalCache(t *testing.T) {
	...
	r = newReconciler(t.Context(), fakeClient.CiliumFakeClientset.CiliumV2alpha1(), m, log, ciliumEndpoint, pods, ciliumEndpointSlice, ciliumNode, namespace, ciliumIdentity, cesMetrics, true, false, false)
	cesStore, _ := ciliumEndpointSlice.Store(t.Context())
