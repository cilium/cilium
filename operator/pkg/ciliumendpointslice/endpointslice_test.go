...
func TestFCFSModeSyncCESsInLocalCache(t *testing.T) {
	...
	r = newSlimReconciler(t.Context(), fakeClient.CiliumFakeClientset.CiliumV2alpha1(), m, log, ciliumEndpointSlice, pods, ciliumIdentity, ciliumNode, namespace, false, false, cesMetrics)
	cesStore, _ := ciliumEndpointSlice.Store(t.Context())
