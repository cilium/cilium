...
func configTls(jobGroup job.Group, logger *slog.Logger, cfg certloaderConfig, prometheusTlsConfigPromise prometheusTLSConfigPromise) (metrics.TLSConfigPromise, error) {
	if !cfg.TLS {
