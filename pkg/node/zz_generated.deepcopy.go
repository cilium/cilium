...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TempLocalNode) DeepCopyInto(out *TempLocalNode) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TempLocalNode.
func (in *TempLocalNode) DeepCopy() *TempLocalNode {
	if in == nil {
		return nil
	}
	out := new(TempLocalNode)
	in.DeepCopyInto(out)
	return out
}
