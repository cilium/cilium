...
import (
	...
	mac "github.com/cilium/cilium/pkg/mac"
)
...
func (in *Interface) DeepCopyInto(out *Interface) {
	*out = *in
	...
	if in.MAC != nil {
		...
		*out = make(mac.MAC, len(*in))
		copy(*out, *in)
	}
	if in.EndpointAddresses != nil {
		in, out := &in.EndpointAddresses, &out.EndpointAddresses
		*out = make([]net.IP, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
...
func (in *Node) DeepCopyInto(out *Node) {
	*out = *in
	...
	if in.IPv4NativeRoutingCIDRs != nil {
		in, out := &in.IPv4NativeRoutingCIDRs, &out.IPv4NativeRoutingCIDRs
