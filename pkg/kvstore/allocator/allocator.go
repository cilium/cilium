...
//FIXME: Add kvstore.KVLocker parameter here. It is needed by pkg/allocator/Allocator.lockedAllocate (also to match AcquireReference)
...
//FIXME: I switched this back to using ListPrefix. Why was it changed?
