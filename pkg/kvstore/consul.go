...
func (c *consulClient) DeletePrefix(path string) (err error) {
...
func (c *consulClient) Set(key string, value []byte) (err error) {
...
func (c *consulClient) DeleteIfLocked(key string, lock KVLocker) (err error) {
...
func (c *consulClient) Delete(key string) (err error) {
...
func (c *consulClient) GetIfLocked(key string, lock KVLocker) (bv []byte, err error) {
...
func (c *consulClient) Get(key string) (bv []byte, err error) {
...
func (c *consulClient) GetPrefixIfLocked(ctx context.Context, prefix string, lock KVLocker) (k string, bv []byte, err error) {
	...
	k, bv, err = c.getPrefix(ctx, prefix)
	return k, bv, err
}
...
// CreateIfExists creates a key with the value only if key condKey exists
func (c *consulClient) CreateIfExists(condKey, key string, value []byte, lease bool) (err error) {
	defer func() {
...
func (c *consulClient) ListPrefixIfLocked(prefix string, lock KVLocker) (v KeyValuePairs, err error) {
	defer func() { Trace("ListPrefixIfLocked", err, logrus.Fields{fieldPrefix: prefix, fieldNumEntries: len(v)}) }()
	v, err = c.ListPrefix(prefix)
	return v, err
}

// ListPrefix returns a map of matching keys
func (c *consulClient) ListPrefix(prefix string) (v KeyValuePairs, err error) {
