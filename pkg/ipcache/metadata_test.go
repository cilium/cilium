...
var (
	worldPrefix        = cmtypes.NewPrefixCluster(netip.MustParsePrefix("1.1.1.1/32"), 0)
	inClusterPrefix    = cmtypes.NewPrefixCluster(netip.MustParsePrefix("10.0.0.4/32"), 0)
	inClusterPrefix2   = cmtypes.NewPrefixCluster(netip.MustParsePrefix("10.0.0.5/32"), 0)
	aPrefix            = cmtypes.NewPrefixCluster(netip.MustParsePrefix("100.4.16.32/32"), 0)
	allIPv4CIDRsPrefix = cmtypes.NewPrefixCluster(netip.MustParsePrefix(ipv4All), 0)
	allIPv6CIDRsPrefix = cmtypes.NewPrefixCluster(netip.MustParsePrefix(ipv6All), 0)
)
...
func TestInjectExisting(t *testing.T) {
	...
	prefix := cmtypes.NewPrefixCluster(netip.MustParsePrefix("172.19.0.5/32"), 0)
...
func TestFilterMetadataByLabels(t *testing.T) {
	...
	IPIdentityCache.metadata.upsertLocked(
		cmtypes.NewPrefixCluster(netip.MustParsePrefix("2.1.1.1/32"), 0),
		source.Generated, "gen-uid", labels.LabelWorld,
	)
	IPIdentityCache.metadata.upsertLocked(
		cmtypes.NewPrefixCluster(netip.MustParsePrefix("3.1.1.1/32"), 0),
...
func TestMetadataRevision(t *testing.T) {
	...
	p1 := cmtypes.NewPrefixCluster(netip.MustParsePrefix("1.1.1.1/32"), 0)
	p2 := cmtypes.NewPrefixCluster(netip.MustParsePrefix("1::1/128"), 0)
...
func TestUpsertMetadataInheritedCIDRPrefix(t *testing.T) {
	...
	parent := cmtypes.NewPrefixCluster(netip.MustParsePrefix("10.0.0.0/8"), 0)
	...
	child := cmtypes.NewPrefixCluster(netip.MustParsePrefix("10.10.0.1/32"), 0)
	...
	sibling := cmtypes.NewPrefixCluster(netip.MustParsePrefix("10.10.0.2/32"), 0)
	...
	parent = cmtypes.NewPrefixCluster(netip.MustParsePrefix("10.10.0.0/16"), 0)
	prefixes = IPIdentityCache.metadata.upsertLocked(parent, source.Kubernetes, "cidr-policy", labels.GetCIDRLabels(parent.AsPrefix()))
	remaining, _, err = IPIdentityCache.doInjectLabels(ctx, prefixes)
	require.NoError(t, err)
	require.Empty(t, remaining)
	...
	for i, tc := range []struct {
		...
		t.Run(strconv.Itoa(i), func(t *testing.T) {
			...
			for pfx, lstr := range tc.prefixes {
				...
				prefix := cmtypes.NewPrefixCluster(netip.MustParsePrefix(pfx), 0)
...
func TestUpsertMetadataCIDRGroup(t *testing.T) {
	p1 := cmtypes.NewPrefixCluster(netip.MustParsePrefix("10.0.0.0/8"), 0)
	p2 := cmtypes.NewPrefixCluster(netip.MustParsePrefix("10.0.0.0/16"), 0)
	p3 := cmtypes.NewPrefixCluster(netip.MustParsePrefix("10.0.0.0/24"), 0)
	p4 := cmtypes.NewPrefixCluster(netip.MustParsePrefix("10.0.0.0/25"), 0)
	p5 := cmtypes.NewPrefixCluster(netip.MustParsePrefix("10.0.0.0/26"), 0)
	p6 := cmtypes.NewPrefixCluster(netip.MustParsePrefix("10.0.0.0/27"), 0)
...
func Test_canonicalPrefix(t *testing.T) {
	tests := []struct {
		...
		{
			name:   "identity",
			prefix: cmtypes.NewPrefixCluster(netip.MustParsePrefix("10.10.10.10/32"), 0),
			want:   cmtypes.NewPrefixCluster(netip.MustParsePrefix("10.10.10.10/32"), 0),
		},
		{
			name:   "masked",
			prefix: cmtypes.NewPrefixCluster(netip.MustParsePrefix("10.10.10.10/16"), 0),
			want:   cmtypes.NewPrefixCluster(netip.MustParsePrefix("10.10.0.0/16"), 0),
		},
		{
			name:   "v4inv6",
			prefix: cmtypes.NewPrefixCluster(netip.MustParsePrefix("::ffff:10.10.10.10/24"), 0),
			want:   cmtypes.NewPrefixCluster(netip.MustParsePrefix("10.10.10.0/24"), 0),
		},
		{
			name:   "ipv6",
			prefix: cmtypes.NewPrefixCluster(netip.MustParsePrefix("2001:db8::dead/32"), 0),
			want:   cmtypes.NewPrefixCluster(netip.MustParsePrefix("2001:db8::/32"), 0),
		},
		{
			name:   "clusterID",
			prefix: cmtypes.NewPrefixCluster(netip.MustParsePrefix("10.10.10.10/32"), 5),
			want:   cmtypes.NewPrefixCluster(netip.MustParsePrefix("10.10.10.10/32"), 5),
		},
		{
			name:   "invalid",
			prefix: cmtypes.NewPrefixCluster(netip.PrefixFrom(netip.MustParseAddr("::ffff:10.10.10.10"), -1), 0),
			want:   cmtypes.NewPrefixCluster(netip.PrefixFrom(netip.MustParseAddr("::ffff:10.10.10.10"), -1), 0),
		},
	}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			for prefix, lbls := range tt.existing {
				pfx := cmtypes.NewPrefixCluster(netip.MustParsePrefix(prefix), 0)
				m.m[pfx] = prefixInfo{
					"resource": {
						labels: lbls,
					},
			...
			pfx := cmtypes.NewPrefixCluster(netip.MustParsePrefix(tt.prefix), 0)
...
func TestIPCachePodCIDREntries(t *testing.T) {
	...
	podCIDR1 := cmtypes.NewPrefixCluster(netip.MustParsePrefix("10.10.0.0/24"), 0)
	podCIDR2 := cmtypes.NewPrefixCluster(netip.MustParsePrefix("10.20.30.40/32"), 0)
...
func BenchmarkManyResources(b *testing.B) {
	...
	prefix := cmtypes.NewPrefixCluster(netip.MustParsePrefix("1.1.1.1/32"), 0)
