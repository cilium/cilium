...
// Run starts the watcher and blocks waiting for events. When events are
...
func (iw *IPIdentityWatcher) Run(listeners []IPIdentityMappingListener) {
restart:
...
// Close stops the IPIdentityWatcher and causes Run() to return
