...
const (
	...
	// DropNotifyFlagIsWireGuard is set in DropNotify.Flags when it refers to an WireGuard packet.
	DropNotifyFlagIsWireGuard
	// DropNotifyFlagIsIPSec is set in DropNotify.Flags when it refers to an IPSec packet.
