...
const (
	...
	// PolicyMatchL4 is the value of MatchType for traffic that matches a L4 rule with source identity any
	PolicyMatchL4All = 3
...
// DropNotify is the message format of a policy notification in the BPF ring buffer
