...
func (m *BGPRouterManager) GetRoutes(ctx context.Context, params restapi.GetBgpRoutesParams) ([]*models.BgpRoute, error) {
	...
	tt := api.ToAgentTableType(params.TableType)
...
func (m *BGPRouterManager) getRoutesFromServer(ctx context.Context, sc *ServerWithConfig, params restapi.GetBgpRoutesParams) ([]*models.BgpRoute, error) {
