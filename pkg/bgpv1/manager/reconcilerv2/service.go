...
func getPrefixes(family types.Family, svc *slim_corev1.Service, advert v2alpha1.BGPAdvertisement, addr netip.Addr, v4Prefixes, v6Prefixes types.PolicyPrefixMatchList) (types.PolicyPrefixMatchList, types.PolicyPrefixMatchList) {
	mask := addr.BitLen()
