...
func (in *ExtendedCommunity) DeepEqual(other *ExtendedCommunity) bool {
	if other == nil {
		return false
	}
...
func (in *RoutePolicyActions) DeepEqual(other *RoutePolicyActions) bool {
	...
	if ((in.AddExtendedCommunities != nil) && (other.AddExtendedCommunities != nil)) || ((in.AddExtendedCommunities == nil) != (other.AddExtendedCommunities == nil)) {
		in, other := &in.AddExtendedCommunities, &other.AddExtendedCommunities
		if other == nil {
			return false
		}
