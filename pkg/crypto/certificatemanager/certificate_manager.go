...
type managerConfig struct {
	...
	CertDirectory string `mapstructure:"certificates-directory"`
}

func (mc managerConfig) Flags(flags *pflag.FlagSet) {
	flags.String("certificates-directory", mc.CertDirectory, "Root directory to find certificates specified in L7 TLS policy enforcement")
}
