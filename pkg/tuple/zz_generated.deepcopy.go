...
func (in *TupleKey4) DeepCopyMapKey() types.MapKey {
...
// DeepCopyMapKey is an autogenerated deepcopy function, copying the receiver, creating a new types.MapKey.
func (in *TupleKey4Global) DeepCopyMapKey() types.MapKey {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyMapKey is an autogenerated deepcopy function, copying the receiver, creating a new types.MapKey.
func (in *TupleKey6) DeepCopyMapKey() types.MapKey {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyMapKey is an autogenerated deepcopy function, copying the receiver, creating a new types.MapKey.
func (in *TupleKey6Global) DeepCopyMapKey() types.MapKey {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
func (in *TupleValStub) DeepCopyMapValue() types.MapValue {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
