...
var Cell = cell.Module(
	...
	cell.ProvidePrivate(getNetworkDriverConfigResource),
...
func getNetworkDriverConfigResource(cs k8sClient.Clientset, lc cell.Lifecycle, mp workqueue.MetricsProvider) resource.Resource[*v2alpha1.CiliumNetworkDriverConfig] {
