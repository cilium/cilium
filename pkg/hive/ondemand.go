...
func NewOnDemand[Resource any](log *slog.Logger, resource Resource, lc cell.HookInterface) OnDemand[Resource] {
...
func (o *onDemand[Resource]) Release(r Resource) error {
	...
	o.refCount--
	if o.refCount == 0 {
		if err := o.lc.Stop(context.Background()); err != nil {
