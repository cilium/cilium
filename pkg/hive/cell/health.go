...
// Update represents a instantaneous health status update.
...
type Health interface {
	...
	// Subscribe to health status updates.:w
...
// UpdateTemp is an event that denotes the change of a modules health state.
...
type Status struct {
	// UpdateTemp is the last reported update for a module.
	Update
