...
// DeleteOldUpsertNew removes old from the identity manager and inserts new
// into the IdentityManager.
func (idm *IdentityManager) DeleteOldUpsertNew(old, new *identity.Identity) {
	idm.mutex.Lock()
	defer idm.mutex.Unlock()
...
// DeleteOldUpsertNew removes old from and inserts new
// into the GlobalIdentityManager.
func DeleteOldUpsertNew(old, new *identity.Identity) {
	GlobalIdentityManager.DeleteOldUpsertNew(old, new)
}
