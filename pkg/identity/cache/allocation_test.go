...
func TestAllocator(t *testing.T) {
	...
	testAllocator(t)
	testAllocatorOperatorIDManagement(t, client{cl})
}
...
func testAllocatorOperatorIDManagement(t *testing.T, cl client) {
...
type client struct{ kvstore.BackendOperations }

func (c *client) addIDKVStore(ctx context.Context, id string, lbls labels.Labels) error {
	key := &cacheKey.GlobalIdentity{LabelArray: lbls.LabelArray()}
...
func (c *client) removeIDKVStore(ctx context.Context, id string) error {
