...
// If the version is bigger than int64, it will return 9223372036854775807.
...
//  -1 if ver is older than the receiver's version.
//  0 if ver is the same as the receiver's version.
//  1 if ver is newer than the receiver's version.
