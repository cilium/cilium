...
func (Version) Descriptor() protoreflect.EnumDescriptor {
	return file_zds_ztunnel_proto_enumTypes[0].Descriptor()
}

func (Version) Type() protoreflect.EnumType {
	return &file_zds_ztunnel_proto_enumTypes[0]
}
...
func (Version) EnumDescriptor() ([]byte, []int) {
	return file_zds_ztunnel_proto_rawDescGZIP(), []int{0}
}
...
func (x *ZdsHello) Reset() {
	*x = ZdsHello{}
	mi := &file_zds_ztunnel_proto_msgTypes[0]
...
func (x *WorkloadInfo) Reset() {
	*x = WorkloadInfo{}
	mi := &file_zds_ztunnel_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*WorkloadInfo) Descriptor() ([]byte, []int) {
	return file_zds_ztunnel_proto_rawDescGZIP(), []int{1}
}
...
func (x *AddWorkload) Reset() {
	*x = AddWorkload{}
	mi := &file_zds_ztunnel_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AddWorkload) Descriptor() ([]byte, []int) {
	return file_zds_ztunnel_proto_rawDescGZIP(), []int{2}
}
...
func (x *KeepWorkload) Reset() {
	*x = KeepWorkload{}
	mi := &file_zds_ztunnel_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KeepWorkload) Descriptor() ([]byte, []int) {
	return file_zds_ztunnel_proto_rawDescGZIP(), []int{3}
}
...
func (x *DelWorkload) Reset() {
	*x = DelWorkload{}
	mi := &file_zds_ztunnel_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*DelWorkload) Descriptor() ([]byte, []int) {
	return file_zds_ztunnel_proto_rawDescGZIP(), []int{4}
}
...
func (x *SnapshotSent) Reset() {
	*x = SnapshotSent{}
	mi := &file_zds_ztunnel_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SnapshotSent) Descriptor() ([]byte, []int) {
	return file_zds_ztunnel_proto_rawDescGZIP(), []int{5}
}
...
func (x *Ack) Reset() {
	*x = Ack{}
	mi := &file_zds_ztunnel_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Ack) Descriptor() ([]byte, []int) {
	return file_zds_ztunnel_proto_rawDescGZIP(), []int{6}
}
...
func (x *WorkloadRequest) Reset() {
	*x = WorkloadRequest{}
	mi := &file_zds_ztunnel_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*WorkloadRequest) Descriptor() ([]byte, []int) {
	return file_zds_ztunnel_proto_rawDescGZIP(), []int{7}
}
...
func (x *WorkloadResponse) Reset() {
	*x = WorkloadResponse{}
	mi := &file_zds_ztunnel_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*WorkloadResponse) Descriptor() ([]byte, []int) {
	return file_zds_ztunnel_proto_rawDescGZIP(), []int{8}
}
...
var File_zds_ztunnel_proto protoreflect.FileDescriptor

const file_zds_ztunnel_proto_rawDesc = "" +
	"\n" +
	"\x11zds_ztunnel.proto\x12\x12istio.workload.zds\"A\n" +
	"\bZdsHello\x125\n" +
	...
	"\x02V1\x10\x01B)Z'github.com/cilium/cilium/pkg/ztunnel/pbb\x06proto3"

var (
	file_zds_ztunnel_proto_rawDescOnce sync.Once
	file_zds_ztunnel_proto_rawDescData []byte
)

func file_zds_ztunnel_proto_rawDescGZIP() []byte {
	file_zds_ztunnel_proto_rawDescOnce.Do(func() {
		file_zds_ztunnel_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_zds_ztunnel_proto_rawDesc), len(file_zds_ztunnel_proto_rawDesc)))
	})
	return file_zds_ztunnel_proto_rawDescData
}

var file_zds_ztunnel_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_zds_ztunnel_proto_msgTypes = make([]protoimpl.MessageInfo, 9)
var file_zds_ztunnel_proto_goTypes = []any{
...
var file_zds_ztunnel_proto_depIdxs = []int32{
...
func init() { file_zds_ztunnel_proto_init() }
func file_zds_ztunnel_proto_init() {
	if File_zds_ztunnel_proto != nil {
		return
	}
	file_zds_ztunnel_proto_msgTypes[7].OneofWrappers = []any{
		(*WorkloadRequest_Add)(nil),
		(*WorkloadRequest_Keep)(nil),
		(*WorkloadRequest_Del)(nil),
		(*WorkloadRequest_SnapshotSent)(nil),
	}
	file_zds_ztunnel_proto_msgTypes[8].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_zds_ztunnel_proto_rawDesc), len(file_zds_ztunnel_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   9,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_zds_ztunnel_proto_goTypes,
		DependencyIndexes: file_zds_ztunnel_proto_depIdxs,
		EnumInfos:         file_zds_ztunnel_proto_enumTypes,
		MessageInfos:      file_zds_ztunnel_proto_msgTypes,
	}.Build()
	File_zds_ztunnel_proto = out.File
	file_zds_ztunnel_proto_goTypes = nil
	file_zds_ztunnel_proto_depIdxs = nil
}
