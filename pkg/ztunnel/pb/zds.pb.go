...
const file_zds_proto_rawDesc = "" +
	"\n" +
	"\tzds.proto\x12\x12istio.workload.zds\"A\n" +
	"\bZdsHello\x125\n" +
...
var (
	...
	file_zds_proto_rawDescData []byte
)

func file_zds_proto_rawDescGZIP() []byte {
	file_zds_proto_rawDescOnce.Do(func() {
		file_zds_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_zds_proto_rawDesc), len(file_zds_proto_rawDesc)))
	})
...
func file_zds_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_zds_proto_rawDesc), len(file_zds_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   9,
			NumExtensions: 0,
			NumServices:   0,
