...
// BPFEnvironment returns a list of environment variables which are needed to
// make BPF programs and tc aware of the actual BPFFS mount path.
func BPFEnvironment() []string {
	return append(
		os.Environ(),
