...
var (
	...
	// supportedMapTypes stores the info about maps supported by currently
	// running kernel.
	supportedMapTypes *probes.SupportedMapTypes
)

// InitSupportedMapTypes initializes the global variable with information about
// supported BPF map types.
func InitSupportedMapTypes(mapTypes *probes.SupportedMapTypes) {
	supportedMapTypes = mapTypes
}
