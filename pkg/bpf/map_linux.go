...
//
// If the map type is MapTypeLRUHash and the kernel lacks support for this map
// type, then the map will be opened as MapTypeHash instead. Note that the BPF
// code that interacts with this map *MUST* be structured in such a way that the
// map is declared as the same type based on the same probe logic (e.g.
