...
func newSecretSyncer(logger *slog.Logger, envoyXdsServer xds.XDSServer) *secretSyncer {
	return &secretSyncer{
		logger:         logger,
...
func (r *secretSyncer) upsertK8sSecretV1(ctx context.Context, secret *slim_corev1.Secret) error {
	...
	resource.Secrets[envoySecret.Name] = envoySecret
...
func (r *secretSyncer) deleteK8sSecretV1(ctx context.Context, key resource.Key) error {
	...
	resource := xds.Resources{}
	resource.Secrets[secretName] = &envoy_extensions_tls_v3.Secret{
