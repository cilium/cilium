...
func Test_getWildcardNetworkPolicyRule(t *testing.T) {
	...
	obtained := getWildcardNetworkPolicyRule(handle, perSelectorPoliciesWithWildcard)
	...
	obtained = getWildcardNetworkPolicyRule(handle, perSelectorPolicies)
...
func TestGetPortNetworkPolicyRule(t *testing.T) {
	...
	obtained, canShortCircuit = getPortNetworkPolicyRule(handle, cachedSelector1, cachedSelector1.IsWildcard(), policy.ParserTypeHTTP, L7Rules12HeaderMatch, false)
	require.Equal(t, ExpectedPortNetworkPolicyRule122HeaderMatch, obtained)
	require.Equal(t, false, canShortCircuit)

	obtained, canShortCircuit = getPortNetworkPolicyRule(handle, cachedSelector2, cachedSelector2.IsWildcard(), policy.ParserTypeHTTP, L7Rules1, false)
