...
func (*Endpoint) Descriptor() ([]byte, []int) {
	return fileDescriptor_endpoint_56f54512d7b0ce73, []int{0}
}
...
func (*Endpoint_HealthCheckConfig) Descriptor() ([]byte, []int) {
	return fileDescriptor_endpoint_56f54512d7b0ce73, []int{0, 0}
}
...
func (*LbEndpoint) Descriptor() ([]byte, []int) {
	return fileDescriptor_endpoint_56f54512d7b0ce73, []int{1}
}
...
func (*LocalityLbEndpoints) Descriptor() ([]byte, []int) {
	return fileDescriptor_endpoint_56f54512d7b0ce73, []int{2}
}
...
func init() {
	proto.RegisterFile("envoy/api/v2/endpoint/endpoint.proto", fileDescriptor_endpoint_56f54512d7b0ce73)
}

var fileDescriptor_endpoint_56f54512d7b0ce73 = []byte{
