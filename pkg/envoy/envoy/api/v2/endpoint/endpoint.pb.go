...
func (*Endpoint) Descriptor() ([]byte, []int) {
	return fileDescriptor_endpoint_c0575e0c381169cc, []int{0}
}
...
func (*Endpoint_HealthCheckConfig) Descriptor() ([]byte, []int) {
	return fileDescriptor_endpoint_c0575e0c381169cc, []int{0, 0}
}
...
type LbEndpoint struct {
	...
	LoadBalancingWeight  *wrappers.UInt32Value `protobuf:"bytes,4,opt,name=load_balancing_weight,json=loadBalancingWeight" json:"load_balancing_weight,omitempty"`
	XXX_NoUnkeyedLiteral struct{}              `json:"-"`
	XXX_unrecognized     []byte                `json:"-"`
	XXX_sizecache        int32                 `json:"-"`
}
...
func (*LbEndpoint) Descriptor() ([]byte, []int) {
	return fileDescriptor_endpoint_c0575e0c381169cc, []int{1}
}
...
type LocalityLbEndpoints struct {
	...
	//   concerns with the current implementation and can be removed when
	//   `this issue <https://github.com/envoyproxy/envoy/issues/1285>`_ is fixed.
	LoadBalancingWeight *wrappers.UInt32Value `protobuf:"bytes,3,opt,name=load_balancing_weight,json=loadBalancingWeight" json:"load_balancing_weight,omitempty"`
...
func (*LocalityLbEndpoints) Descriptor() ([]byte, []int) {
	return fileDescriptor_endpoint_c0575e0c381169cc, []int{2}
}
...
func init() {
	proto.RegisterFile("envoy/api/v2/endpoint/endpoint.proto", fileDescriptor_endpoint_c0575e0c381169cc)
}

var fileDescriptor_endpoint_c0575e0c381169cc = []byte{
