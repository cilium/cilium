...
func (*UpstreamLocalityStats) Descriptor() ([]byte, []int) {
	return fileDescriptor_load_report_5fb4e07af11b6ec0, []int{0}
}
...
func (*UpstreamEndpointStats) Descriptor() ([]byte, []int) {
	return fileDescriptor_load_report_5fb4e07af11b6ec0, []int{1}
}
...
func (*EndpointLoadMetricStats) Descriptor() ([]byte, []int) {
	return fileDescriptor_load_report_5fb4e07af11b6ec0, []int{2}
}
...
func (*ClusterStats) Descriptor() ([]byte, []int) {
	return fileDescriptor_load_report_5fb4e07af11b6ec0, []int{3}
}
...
func (*ClusterStats_DroppedRequests) Descriptor() ([]byte, []int) {
	return fileDescriptor_load_report_5fb4e07af11b6ec0, []int{3, 0}
}
...
func init() {
	proto.RegisterFile("envoy/api/v2/endpoint/load_report.proto", fileDescriptor_load_report_5fb4e07af11b6ec0)
}

var fileDescriptor_load_report_5fb4e07af11b6ec0 = []byte{
