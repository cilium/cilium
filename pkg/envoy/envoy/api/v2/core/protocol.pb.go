...
type HttpProtocolOptions struct {
	...
	IdleTimeout *google_protobuf2.Duration `protobuf:"bytes,1,opt,name=idle_timeout,json=idleTimeout" json:"idle_timeout,omitempty"`
}
...
func (m *HttpProtocolOptions) GetIdleTimeout() *google_protobuf2.Duration {
	if m != nil {
