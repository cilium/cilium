...
func (*TcpKeepalive) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{2} }
...
func (*BindConfig) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{3} }
...
func (*CidrRange) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{5} }
