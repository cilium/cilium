...
func (TlsParameters_TlsProtocol) EnumDescriptor() ([]byte, []int) { return fileDescriptor0, []int{0, 0} }
...
func (*TlsParameters) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{0} }
...
func (*TlsSessionTicketKeys) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{2} }
...
type CertificateValidationContext struct {
	...
	AllowExpiredCertificate bool `protobuf:"varint,8,opt,name=allow_expired_certificate,json=allowExpiredCertificate" json:"allow_expired_certificate,omitempty"`
}
...
func (*CertificateValidationContext) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{3} }
...
func (*CommonTlsContext) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{4} }
...
type UpstreamTlsContext struct {
	...
	AllowRenegotiation bool `protobuf:"varint,3,opt,name=allow_renegotiation,json=allowRenegotiation" json:"allow_renegotiation,omitempty"`
}
...
func (*UpstreamTlsContext) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{5} }
...
func (*DownstreamTlsContext) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{6} }
...
func (*SdsSecretConfig) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{7} }
...
func init() { proto.RegisterFile("envoy/api/v2/auth/cert.proto", fileDescriptor0) }
