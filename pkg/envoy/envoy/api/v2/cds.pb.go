...
type Cluster struct {
	...
	// specific options.
	ExtensionProtocolOptions map[string]*google_protobuf.Struct `protobuf:"bytes,35,rep,name=extension_protocol_options,json=extensionProtocolOptions" json:"extension_protocol_options,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
...
func (*Cluster_LbSubsetConfig) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{0, 2} }
...
func (*Cluster_RingHashLbConfig) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{0, 3} }
...
type Cluster_OriginalDstLbConfig struct {
	...
	//   consequences.
	UseHttpHeader bool `protobuf:"varint,1,opt,name=use_http_header,json=useHttpHeader" json:"use_http_header,omitempty"`
}
...
func (*Cluster_OriginalDstLbConfig) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{0, 4} }
...
func (*Cluster_CommonLbConfig) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{0, 5} }
