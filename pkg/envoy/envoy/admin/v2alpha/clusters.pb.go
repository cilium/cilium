...
func (*Clusters) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{0} }
...
type ClusterStatus struct {
	...
	AddedViaApi bool `protobuf:"varint,2,opt,name=added_via_api,json=addedViaApi" json:"added_via_api,omitempty"`
...
func (*ClusterStatus) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{1} }
...
type HostStatus struct {
	...
	Stats map[string]*SimpleMetric `protobuf:"bytes,2,rep,name=stats" json:"stats,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
...
func (*HostStatus) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{2} }
...
type HostHealthStatus struct {
	...
	FailedActiveHealthCheck bool `protobuf:"varint,1,opt,name=failed_active_health_check,json=failedActiveHealthCheck" json:"failed_active_health_check,omitempty"`
	// The host is currently considered an outlier and has been ejected.
	FailedOutlierCheck bool `protobuf:"varint,2,opt,name=failed_outlier_check,json=failedOutlierCheck" json:"failed_outlier_check,omitempty"`
	// Health status as reported by EDS. Note: only HEALTHY and UNHEALTHY are currently supported
	// here.
	// TODO(mrice32): pipe through remaining EDS health status possibilities.
	EdsHealthStatus envoy_api_v2_core2.HealthStatus `protobuf:"varint,3,opt,name=eds_health_status,json=edsHealthStatus,enum=envoy.api.v2.core.HealthStatus" json:"eds_health_status,omitempty"`
}
...
func (*HostHealthStatus) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{3} }
...
func init() { proto.RegisterFile("envoy/admin/v2alpha/clusters.proto", fileDescriptor0) }
