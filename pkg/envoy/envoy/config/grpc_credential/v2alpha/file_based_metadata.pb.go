...
type FileBasedMetadataConfig struct {
	...
	HeaderKey string `protobuf:"bytes,2,opt,name=header_key,json=headerKey" json:"header_key,omitempty"`
	// Prefix to prepend to the secret in the metadata header
	// if no prefix is set, the default is to use no prefix
	HeaderPrefix string `protobuf:"bytes,3,opt,name=header_prefix,json=headerPrefix" json:"header_prefix,omitempty"`
}
...
func (*FileBasedMetadataConfig) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{0} }
...
func init() {
	proto.RegisterFile("envoy/config/grpc_credential/v2alpha/file_based_metadata.proto", fileDescriptor0)
}
