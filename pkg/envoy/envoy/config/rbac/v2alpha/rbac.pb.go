...
import envoy_type_matcher3 "github.com/cilium/cilium/pkg/envoy/envoy/type/matcher"
...
type Permission_Any struct {
	Any bool `protobuf:"varint,3,opt,name=any,oneof"`
}
...
type Permission_DestinationPort struct {
	DestinationPort uint32 `protobuf:"varint,6,opt,name=destination_port,json=destinationPort,oneof"`
}
...
func (*Permission_Set) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{2, 0} }
...
func (*Principal) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{3} }
...
func (*Principal_Set) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{3, 0} }
...
func (*Principal_Authenticated) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{3, 1} }
...
func init() { proto.RegisterFile("envoy/config/rbac/v2alpha/rbac.proto", fileDescriptor0) }
