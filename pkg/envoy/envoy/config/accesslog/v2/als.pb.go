...
func (*HttpGrpcAccessLogConfig) Descriptor() ([]byte, []int) {
	return fileDescriptor_als_96435975b4ad149b, []int{0}
}
...
func (*TcpGrpcAccessLogConfig) Descriptor() ([]byte, []int) {
	return fileDescriptor_als_96435975b4ad149b, []int{1}
}
...
func (*CommonGrpcAccessLogConfig) Descriptor() ([]byte, []int) {
	return fileDescriptor_als_96435975b4ad149b, []int{2}
}
...
func init() {
	proto.RegisterFile("envoy/config/accesslog/v2/als.proto", fileDescriptor_als_96435975b4ad149b)
}

var fileDescriptor_als_96435975b4ad149b = []byte{
