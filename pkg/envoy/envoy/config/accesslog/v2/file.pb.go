...
func (*FileAccessLog) Descriptor() ([]byte, []int) {
	return fileDescriptor_file_e4a3cb06094d3842, []int{0}
}
...
func init() {
	proto.RegisterFile("envoy/config/accesslog/v2/file.proto", fileDescriptor_file_e4a3cb06094d3842)
}

var fileDescriptor_file_e4a3cb06094d3842 = []byte{
