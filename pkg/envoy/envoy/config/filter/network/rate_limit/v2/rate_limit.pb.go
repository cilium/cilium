...
func (*RateLimit) Descriptor() ([]byte, []int) {
	return fileDescriptor_rate_limit_16db78d4c04b5ca0, []int{0}
}
...
func init() {
	proto.RegisterFile("envoy/config/filter/network/rate_limit/v2/rate_limit.proto", fileDescriptor_rate_limit_16db78d4c04b5ca0)
}

var fileDescriptor_rate_limit_16db78d4c04b5ca0 = []byte{
