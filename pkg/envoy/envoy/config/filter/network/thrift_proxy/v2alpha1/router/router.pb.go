...
func init() {
	proto.RegisterFile("envoy/config/filter/network/thrift_proxy/v2alpha1/router/router.proto", fileDescriptor_1ef1cd570bec7ee3)
}

var fileDescriptor_1ef1cd570bec7ee3 = []byte{
