...
func (*RBAC) Descriptor() ([]byte, []int) {
	return fileDescriptor_rbac_ba23fa2abe320bb5, []int{0}
}
...
func init() {
	proto.RegisterFile("envoy/config/filter/network/rbac/v2/rbac.proto", fileDescriptor_rbac_ba23fa2abe320bb5)
}

var fileDescriptor_rbac_ba23fa2abe320bb5 = []byte{
