...
type TcpProxy struct {
	...
	IdleTimeout *google_protobuf3.Duration `protobuf:"bytes,8,opt,name=idle_timeout,json=idleTimeout" json:"idle_timeout,omitempty"`
...
func (m *TcpProxy) GetIdleTimeout() *google_protobuf3.Duration {
	if m != nil {
