...
func (*TcpProxy) Descriptor() ([]byte, []int) {
	return fileDescriptor_tcp_proxy_8e44260d4a3e302b, []int{0}
}
...
func (*TcpProxy_DeprecatedV1) Descriptor() ([]byte, []int) {
	return fileDescriptor_tcp_proxy_8e44260d4a3e302b, []int{0, 0}
}
...
func (*TcpProxy_DeprecatedV1_TCPRoute) Descriptor() ([]byte, []int) {
	return fileDescriptor_tcp_proxy_8e44260d4a3e302b, []int{0, 0, 0}
}
...
func init() {
	proto.RegisterFile("envoy/config/filter/network/tcp_proxy/v2/tcp_proxy.proto", fileDescriptor_tcp_proxy_8e44260d4a3e302b)
}

var fileDescriptor_tcp_proxy_8e44260d4a3e302b = []byte{
