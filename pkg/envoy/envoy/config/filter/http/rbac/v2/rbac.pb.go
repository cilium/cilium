...
func (*RBAC) Descriptor() ([]byte, []int) {
	return fileDescriptor_rbac_8bf4dc2a34d36615, []int{0}
}
...
func (*RBACPerRoute) Descriptor() ([]byte, []int) {
	return fileDescriptor_rbac_8bf4dc2a34d36615, []int{1}
}
...
func init() {
	proto.RegisterFile("envoy/config/filter/http/rbac/v2/rbac.proto", fileDescriptor_rbac_8bf4dc2a34d36615)
}

var fileDescriptor_rbac_8bf4dc2a34d36615 = []byte{
