...
func (*Squash) Descriptor() ([]byte, []int) {
	return fileDescriptor_squash_6150df9cc4d01b71, []int{0}
}
...
func init() {
	proto.RegisterFile("envoy/config/filter/http/squash/v2/squash.proto", fileDescriptor_squash_6150df9cc4d01b71)
}

var fileDescriptor_squash_6150df9cc4d01b71 = []byte{
