...
type Router struct {
	...
	SuppressEnvoyHeaders bool     `protobuf:"varint,4,opt,name=suppress_envoy_headers,json=suppressEnvoyHeaders" json:"suppress_envoy_headers,omitempty"`
...
func (*Router) Descriptor() ([]byte, []int) {
	return fileDescriptor_router_38f89341e9e1638c, []int{0}
}
...
func init() {
	proto.RegisterFile("envoy/config/filter/http/router/v2/router.proto", fileDescriptor_router_38f89341e9e1638c)
}

var fileDescriptor_router_38f89341e9e1638c = []byte{
