...
func (Config_ValueType) EnumDescriptor() ([]byte, []int) { return fileDescriptor0, []int{0, 0} }
...
type Config_KeyValuePair struct {
	...
	MetadataNamespace string `protobuf:"bytes,1,opt,name=metadata_namespace,json=metadataNamespace" json:"metadata_namespace,omitempty"`
	...
	Type Config_ValueType `protobuf:"varint,4,opt,name=type,enum=envoy.config.filter.http.header_to_metadata.v2.Config_ValueType" json:"type,omitempty"`
}
...
func (*Config_KeyValuePair) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{0, 0} }
...
func (*Config_Rule) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{0, 1} }
...
func init() {
	proto.RegisterFile("envoy/config/filter/http/header_to_metadata/v2/header_to_metadata.proto", fileDescriptor0)
}
