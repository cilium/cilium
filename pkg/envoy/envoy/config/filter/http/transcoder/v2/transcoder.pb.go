...
func (*GrpcJsonTranscoder) Descriptor() ([]byte, []int) {
	return fileDescriptor_transcoder_844c16129acd224c, []int{0}
}
...
func (*GrpcJsonTranscoder_PrintOptions) Descriptor() ([]byte, []int) {
	return fileDescriptor_transcoder_844c16129acd224c, []int{0, 0}
}
...
func init() {
	proto.RegisterFile("envoy/config/filter/http/transcoder/v2/transcoder.proto", fileDescriptor_transcoder_844c16129acd224c)
}

var fileDescriptor_transcoder_844c16129acd224c = []byte{
