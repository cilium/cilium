...
func (FaultDelay_FaultDelayType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_fault_5b790614eca4dc90, []int{0, 0}
}
...
func (*FaultDelay) Descriptor() ([]byte, []int) {
	return fileDescriptor_fault_5b790614eca4dc90, []int{0}
}
...
func init() {
	proto.RegisterFile("envoy/config/filter/fault/v2/fault.proto", fileDescriptor_fault_5b790614eca4dc90)
}

var fileDescriptor_fault_5b790614eca4dc90 = []byte{
