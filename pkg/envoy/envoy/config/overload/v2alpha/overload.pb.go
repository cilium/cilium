...
func (*ResourceMonitor) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{0} }
...
func (*ThresholdTrigger) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{1} }
...
func (*Trigger) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{2} }
...
func (*OverloadAction) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{3} }
...
func (*OverloadManager) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{4} }
...
func init() { proto.RegisterFile("envoy/config/overload/v2alpha/overload.proto", fileDescriptor0) }
