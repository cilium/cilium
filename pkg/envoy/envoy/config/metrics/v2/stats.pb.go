...
type HystrixSink struct {
	...
	NumBuckets int64 `protobuf:"varint,1,opt,name=num_buckets,json=numBuckets" json:"num_buckets,omitempty"`
}
...
func (*HystrixSink) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{5} }
