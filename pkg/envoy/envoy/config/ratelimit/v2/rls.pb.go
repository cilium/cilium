...
func (*RateLimitServiceConfig) Descriptor() ([]byte, []int) {
	return fileDescriptor_rls_7a4c54b0d7a0c238, []int{0}
}
...
func init() {
	proto.RegisterFile("envoy/config/ratelimit/v2/rls.proto", fileDescriptor_rls_7a4c54b0d7a0c238)
}

var fileDescriptor_rls_7a4c54b0d7a0c238 = []byte{
