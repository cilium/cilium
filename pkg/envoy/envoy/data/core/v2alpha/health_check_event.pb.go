...
func (HealthCheckFailureType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_health_check_event_28b4b043ee5bc4ee, []int{0}
}
...
func (HealthCheckerType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_health_check_event_28b4b043ee5bc4ee, []int{1}
}
...
func (*HealthCheckAddHealthy) Descriptor() ([]byte, []int) {
	return fileDescriptor_health_check_event_28b4b043ee5bc4ee, []int{2}
}
...
func init() {
	proto.RegisterFile("envoy/data/core/v2alpha/health_check_event.proto", fileDescriptor_health_check_event_28b4b043ee5bc4ee)
}

var fileDescriptor_health_check_event_28b4b043ee5bc4ee = []byte{
