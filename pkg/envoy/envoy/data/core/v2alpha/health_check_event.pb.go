...
type HealthCheckEvent struct {
	...
	// Timestamp for event.
	Timestamp *google_protobuf4.Timestamp `protobuf:"bytes,6,opt,name=timestamp" json:"timestamp,omitempty"`
}
...
func (m *HealthCheckEvent) GetTimestamp() *google_protobuf4.Timestamp {
	if m != nil {
		return m.Timestamp
	}
	return nil
