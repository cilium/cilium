...
func (HealthCheckFailureType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_health_check_event_f09e3dfcb67cc0ce, []int{0}
}
...
func (HealthCheckerType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_health_check_event_f09e3dfcb67cc0ce, []int{1}
}
...
func (*HealthCheckAddHealthy) Descriptor() ([]byte, []int) {
	return fileDescriptor_health_check_event_f09e3dfcb67cc0ce, []int{2}
}
...
func init() {
	proto.RegisterFile("envoy/data/core/v2alpha/health_check_event.proto", fileDescriptor_health_check_event_f09e3dfcb67cc0ce)
}

var fileDescriptor_health_check_event_f09e3dfcb67cc0ce = []byte{
