...
func (*Event_Read) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{1, 0} }
...
func (*Event_Write) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{1, 1} }
...
func init() { proto.RegisterFile("envoy/data/tap/v2alpha/capture.proto", fileDescriptor0) }
