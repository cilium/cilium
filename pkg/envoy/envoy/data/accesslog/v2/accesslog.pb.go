...
func (TLSProperties_TLSVersion) EnumDescriptor() ([]byte, []int) { return fileDescriptor0, []int{4, 0} }
...
func (*TCPAccessLogEntry) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{0} }
...
type HTTPAccessLogEntry struct {
	// Common properties shared by all Envoy access logs.
	CommonProperties *AccessLogCommon               `protobuf:"bytes,1,opt,name=common_properties,json=commonProperties" json:"common_properties,omitempty"`
	ProtocolVersion  HTTPAccessLogEntry_HTTPVersion `protobuf:"varint,2,opt,name=protocol_version,json=protocolVersion,enum=envoy.data.accesslog.v2.HTTPAccessLogEntry_HTTPVersion" json:"protocol_version,omitempty"`
...
func (*HTTPAccessLogEntry) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{1} }
...
type AccessLogCommon struct {
	...
	StartTime *google_protobuf4.Timestamp `protobuf:"bytes,5,opt,name=start_time,json=startTime" json:"start_time,omitempty"`
	// Interval between the first downstream byte received and the last
	// downstream byte received (i.e. time it takes to receive a request).
	TimeToLastRxByte *google_protobuf3.Duration `protobuf:"bytes,6,opt,name=time_to_last_rx_byte,json=timeToLastRxByte" json:"time_to_last_rx_byte,omitempty"`
	// Interval between the first downstream byte received and the first upstream byte sent. There may
	// by considerable delta between *time_to_last_rx_byte* and this value due to filters.
	// Additionally, the same caveats apply as documented in *time_to_last_downstream_tx_byte* about
	// not accounting for kernel socket buffer time, etc.
	TimeToFirstUpstreamTxByte *google_protobuf3.Duration `protobuf:"bytes,7,opt,name=time_to_first_upstream_tx_byte,json=timeToFirstUpstreamTxByte" json:"time_to_first_upstream_tx_byte,omitempty"`
	// Interval between the first downstream byte received and the last upstream byte sent. There may
	// by considerable delta between *time_to_last_rx_byte* and this value due to filters.
	// Additionally, the same caveats apply as documented in *time_to_last_downstream_tx_byte* about
	// not accounting for kernel socket buffer time, etc.
	TimeToLastUpstreamTxByte *google_protobuf3.Duration `protobuf:"bytes,8,opt,name=time_to_last_upstream_tx_byte,json=timeToLastUpstreamTxByte" json:"time_to_last_upstream_tx_byte,omitempty"`
	// Interval between the first downstream byte received and the first upstream
	// byte received (i.e. time it takes to start receiving a response).
	TimeToFirstUpstreamRxByte *google_protobuf3.Duration `protobuf:"bytes,9,opt,name=time_to_first_upstream_rx_byte,json=timeToFirstUpstreamRxByte" json:"time_to_first_upstream_rx_byte,omitempty"`
	// Interval between the first downstream byte received and the last upstream
	// byte received (i.e. time it takes to receive a complete response).
	TimeToLastUpstreamRxByte *google_protobuf3.Duration `protobuf:"bytes,10,opt,name=time_to_last_upstream_rx_byte,json=timeToLastUpstreamRxByte" json:"time_to_last_upstream_rx_byte,omitempty"`
	// Interval between the first downstream byte received and the first downstream byte sent.
	// There may be a considerable delta between the *time_to_first_upstream_rx_byte* and this field
	// due to filters. Additionally, the same caveats apply as documented in
	// *time_to_last_downstream_tx_byte* about not accounting for kernel socket buffer time, etc.
	TimeToFirstDownstreamTxByte *google_protobuf3.Duration `protobuf:"bytes,11,opt,name=time_to_first_downstream_tx_byte,json=timeToFirstDownstreamTxByte" json:"time_to_first_downstream_tx_byte,omitempty"`
	...
	TimeToLastDownstreamTxByte *google_protobuf3.Duration `protobuf:"bytes,12,opt,name=time_to_last_downstream_tx_byte,json=timeToLastDownstreamTxByte" json:"time_to_last_downstream_tx_byte,omitempty"`
...
func (*AccessLogCommon) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{2} }
...
func (m *AccessLogCommon) GetStartTime() *google_protobuf4.Timestamp {
	if m != nil {
		return m.StartTime
	}
	return nil
...
func (m *AccessLogCommon) GetTimeToLastRxByte() *google_protobuf3.Duration {
	if m != nil {
...
func (m *AccessLogCommon) GetTimeToFirstUpstreamTxByte() *google_protobuf3.Duration {
	if m != nil {
...
func (m *AccessLogCommon) GetTimeToLastUpstreamTxByte() *google_protobuf3.Duration {
	if m != nil {
...
func (m *AccessLogCommon) GetTimeToFirstUpstreamRxByte() *google_protobuf3.Duration {
	if m != nil {
...
func (m *AccessLogCommon) GetTimeToLastUpstreamRxByte() *google_protobuf3.Duration {
	if m != nil {
...
func (m *AccessLogCommon) GetTimeToFirstDownstreamTxByte() *google_protobuf3.Duration {
	if m != nil {
...
func (m *AccessLogCommon) GetTimeToLastDownstreamTxByte() *google_protobuf3.Duration {
	if m != nil {
...
func (*ResponseFlags) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{3} }
...
type ResponseFlags_Unauthorized struct {
	Reason ResponseFlags_Unauthorized_Reason `protobuf:"varint,1,opt,name=reason,enum=envoy.data.accesslog.v2.ResponseFlags_Unauthorized_Reason" json:"reason,omitempty"`
}
...
func (*ResponseFlags_Unauthorized) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{3, 0} }
...
type TLSProperties struct {
	...
	TlsVersion TLSProperties_TLSVersion `protobuf:"varint,1,opt,name=tls_version,json=tlsVersion,enum=envoy.data.accesslog.v2.TLSProperties_TLSVersion" json:"tls_version,omitempty"`
...
func (*TLSProperties) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{4} }
...
type HTTPRequestProperties struct {
	...
	RequestMethod envoy_api_v2_core.RequestMethod `protobuf:"varint,1,opt,name=request_method,json=requestMethod,enum=envoy.api.v2.core.RequestMethod" json:"request_method,omitempty"`
...
func (*HTTPRequestProperties) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{5} }
...
func (*HTTPResponseProperties) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{6} }
...
func init() { proto.RegisterFile("envoy/data/accesslog/v2/accesslog.proto", fileDescriptor0) }
