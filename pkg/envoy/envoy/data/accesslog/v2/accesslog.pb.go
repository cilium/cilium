...
func (HTTPAccessLogEntry_HTTPVersion) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_accesslog_6ab28ee6592c72ba, []int{1, 0}
}
...
func (ResponseFlags_Unauthorized_Reason) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_accesslog_6ab28ee6592c72ba, []int{3, 0, 0}
}
...
func (TLSProperties_TLSVersion) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_accesslog_6ab28ee6592c72ba, []int{4, 0}
}
...
func (*TCPAccessLogEntry) Descriptor() ([]byte, []int) {
	return fileDescriptor_accesslog_6ab28ee6592c72ba, []int{0}
}
...
func (*HTTPAccessLogEntry) Descriptor() ([]byte, []int) {
	return fileDescriptor_accesslog_6ab28ee6592c72ba, []int{1}
}
...
func (*AccessLogCommon) Descriptor() ([]byte, []int) {
	return fileDescriptor_accesslog_6ab28ee6592c72ba, []int{2}
}
...
func (*ResponseFlags) Descriptor() ([]byte, []int) {
	return fileDescriptor_accesslog_6ab28ee6592c72ba, []int{3}
}
...
func (*ResponseFlags_Unauthorized) Descriptor() ([]byte, []int) {
	return fileDescriptor_accesslog_6ab28ee6592c72ba, []int{3, 0}
}
...
func (*TLSProperties) Descriptor() ([]byte, []int) {
	return fileDescriptor_accesslog_6ab28ee6592c72ba, []int{4}
}
...
func (*HTTPRequestProperties) Descriptor() ([]byte, []int) {
	return fileDescriptor_accesslog_6ab28ee6592c72ba, []int{5}
}
...
func (*HTTPResponseProperties) Descriptor() ([]byte, []int) {
	return fileDescriptor_accesslog_6ab28ee6592c72ba, []int{6}
}
...
func init() {
	proto.RegisterFile("envoy/data/accesslog/v2/accesslog.proto", fileDescriptor_accesslog_6ab28ee6592c72ba)
}

var fileDescriptor_accesslog_6ab28ee6592c72ba = []byte{
