...
func (*NetworkFilter) Descriptor() ([]byte, []int) {
	return fileDescriptor_cilium_network_filter_11ad7912cd203dbf, []int{0}
}
...
func init() {
	proto.RegisterFile("cilium/cilium_network_filter.proto", fileDescriptor_cilium_network_filter_11ad7912cd203dbf)
}

var fileDescriptor_cilium_network_filter_11ad7912cd203dbf = []byte{
