...
func (*NetworkFilter) Descriptor() ([]byte, []int) {
	return fileDescriptor_cilium_network_filter_2b4eb38cdf92ccea, []int{0}
}
...
func init() {
	proto.RegisterFile("cilium/cilium_network_filter.proto", fileDescriptor_cilium_network_filter_2b4eb38cdf92ccea)
}

var fileDescriptor_cilium_network_filter_2b4eb38cdf92ccea = []byte{
