...
type L7Policy struct {
	...
	IsIngress            *wrappers.BoolValue `protobuf:"bytes,4,opt,name=is_ingress,json=isIngress" json:"is_ingress,omitempty"`
...
func (*L7Policy) Descriptor() ([]byte, []int) {
	return fileDescriptor_cilium_l7policy_5f20c6c56e1db6da, []int{0}
}
...
func init() {
	proto.RegisterFile("cilium/cilium_l7policy.proto", fileDescriptor_cilium_l7policy_5f20c6c56e1db6da)
}

var fileDescriptor_cilium_l7policy_5f20c6c56e1db6da = []byte{
