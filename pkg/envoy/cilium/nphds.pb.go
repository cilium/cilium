...
func (*NetworkPolicyHosts) Descriptor() ([]byte, []int) {
	return fileDescriptor_nphds_54f007dcf738ae74, []int{0}
}
...
func init() { proto.RegisterFile("cilium/nphds.proto", fileDescriptor_nphds_54f007dcf738ae74) }

var fileDescriptor_nphds_54f007dcf738ae74 = []byte{
