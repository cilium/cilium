...
func (*BpfMetadata) Descriptor() ([]byte, []int) {
	return fileDescriptor_cilium_bpf_metadata_b9ab2eef2a30baf0, []int{0}
}
...
func init() {
	proto.RegisterFile("cilium/cilium_bpf_metadata.proto", fileDescriptor_cilium_bpf_metadata_b9ab2eef2a30baf0)
}

var fileDescriptor_cilium_bpf_metadata_b9ab2eef2a30baf0 = []byte{
