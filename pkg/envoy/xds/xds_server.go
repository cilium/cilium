...
type XDSServer interface {
	...
	UpdateNetworkPolicy(ctx context.Context, ep endpoint.EndpointUpdater, policy *policy.L4Policy, ingressPolicyEnforced, egressPolicyEnforced bool, wg *completion.WaitGroup) (error, func() error)
