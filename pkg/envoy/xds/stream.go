...
func NewMockStream(ctx context.Context, recvSize, sentSize int, recvTimeout, sentTimeout time.Duration) *MockStream {
	return &MockStream{
		ctx:         ctx,
		recv:        make(chan *envoy_service_discovery_v3.DiscoveryRequest, recvSize),
		sent:        make(chan *envoy_service_discovery_v3.DiscoveryResponse, sentSize),
		recvTimeout: recvTimeout,
		sentTimeout: sentTimeout,
	}
}

func (s *MockStream) Send(resp *envoy_service_discovery_v3.DiscoveryResponse) error {
...
func (s *MockStream) Recv() (*envoy_service_discovery_v3.DiscoveryRequest, error) {
...
func (s *MockStream) SendRequest(req *envoy_service_discovery_v3.DiscoveryRequest) error {
	subCtx, cancel := context.WithTimeout(s.ctx, s.recvTimeout)
...
func (s *MockStream) RecvResponse() (*envoy_service_discovery_v3.DiscoveryResponse, error) {
	subCtx, cancel := context.WithTimeout(s.ctx, s.sentTimeout)
