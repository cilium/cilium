...
// - '/' as a separator between the CEC namespace and the CEC name
// - '-' as a separator between the CEC name and the resource name.
//
// A different separator is used to avoid names clashing in case of two resources
// where one has the name equal to "namespace-name" of the other resource, e.g.:
//
