...
func getAccessLogSocketPath(proxySocketDir string) string {
	return filepath.Join(proxySocketDir, "access_log.sock")
}
...
func StartAccessLogServer(proxySocketDir string, xdsServer *XDSServer) {
