...
func populateStaticENILimits() {
	limits.m = map[string]ipamTypes.Limits{
		...
		"c7g.12xlarge":  {Adapters: 8, IPv4: 30, IPv6: 30},
		"c7g.16xlarge":  {Adapters: 15, IPv4: 50, IPv6: 50},
		"c7g.2xlarge":   {Adapters: 4, IPv4: 15, IPv6: 15},
		"c7g.4xlarge":   {Adapters: 8, IPv4: 30, IPv6: 30},
		"c7g.8xlarge":   {Adapters: 8, IPv4: 30, IPv6: 30},
		"c7g.large":     {Adapters: 3, IPv4: 10, IPv6: 10},
		"c7g.medium":    {Adapters: 2, IPv4: 4, IPv6: 4},
		"c7g.metal":     {Adapters: 15, IPv4: 50, IPv6: 50},
		"c7g.xlarge":    {Adapters: 4, IPv4: 15, IPv6: 15},
