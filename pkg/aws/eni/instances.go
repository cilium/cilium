...
// GetMatchingSubnets returns all subnets in the given VPC and availability zone.
func (m *InstancesManager) GetMatchingSubnets(vpcID, availabilityZone string) []*ipamTypes.Subnet {
	m.mutex.RLock()
	defer m.mutex.RUnlock()
