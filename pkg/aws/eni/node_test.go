...
func TestGetMaximumAllocatableIPv4(t *testing.T) {
	...
	require.Equal(t, n.GetMaximumAllocatableIPv4(), 0)
	...
	require.Equal(t, n.GetMaximumAllocatableIPv4(), 27)
	...
	require.Equal(t, n.GetMaximumAllocatableIPv4(), 18)
...
func TestGetUsedIPWithPrefixes(t *testing.T) {
	...
	require.Equal(t, n.GetUsedIPWithPrefixes(), 32)
}
