...
const (
	...
	// EnableIPEgressGateway enables the IPv4 egress gateway
	EnableIPEgressGateway = "enable-egress-gateway"
...
func (c *DaemonConfig) Populate(logger *slog.Logger, vp *viper.Viper) {
	...
	c.EnableIPEgressGateway = vp.GetBool(EnableIPEgressGateway)
