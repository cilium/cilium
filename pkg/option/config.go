...
const (
	...
	// EnableEndpointPacketPMTUD enables kernel plpmtud discovery on Pod netns.
	EnableEndpointPLPMTUD = "enable-endpoint-packet-layer-pmtud"
)
...
type DaemonConfig struct {
	...
	// EnableEndpointPLPMTUD enables linux plpmtud sysctl configuration on endpoint Pod netns.
	EnableEndpointPLPMTUD bool
}
...
func (c *DaemonConfig) Populate(logger *slog.Logger, vp *viper.Viper) {
	...
	c.EnableEndpointPLPMTUD = vp.GetBool(EnableEndpointPLPMTUD)
