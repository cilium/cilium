...
const (
	...
	// "devices". Devices selected are those first matched by "devices" then those
	// selected by auto-detection. This option does not filter devices matched by "devices", it
	// is only additive.
