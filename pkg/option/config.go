...
const (
	...
	// K8sUseJSONPatch when set, uses JSON Patch to update CNP and CEP
	// status in kube-apiserver.
	K8sUseJSONPatch = "k8s-use-json-patch"
...
func (c *DaemonConfig) Populate() {
	...
	c.K8sUseJSONPatch = viper.GetBool(K8sUseJSONPatch)
