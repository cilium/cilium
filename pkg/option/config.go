...
const (
	...
	// EnableRemoteNodeMasquerade Masquerade packets from endpoints leaving the host destined to a remote node node in BPF masquerading mode. This option requires to set enable-bpf-masquerade to true.
