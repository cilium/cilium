...
const (
	...
	// DirectRoutingDevice is the name of a device used to connect nodes
...
type DaemonConfig struct {
	...
	Devices             []string   // bpf_host devices
	DirectRoutingDevice string     // Device for direct routing (used by NodePort BPF)
