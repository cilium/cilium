...
func (m Metrics) AddClusterMeshConfig(clusterMeshMode string) {
	m.ACLBClusterMeshEnabled.WithLabelValues(clusterMeshMode).Inc()
}

func (m Metrics) DelClusterMeshConfig(clusterMeshMode string) {
	m.ACLBClusterMeshEnabled.WithLabelValues(clusterMeshMode).Dec()
}
