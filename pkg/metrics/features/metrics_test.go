...
func TestUpdateNetworkMode(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			metrics.update(params, config, lbConfig, fakewireguard.Config{}, fakeipsec.Config{})
...
func TestUpdateEncryptionMode(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			metrics.update(params, config, lbConfig, fakewireguard.Config{EnableWireguard: tt.enableWireguard}, fakeipsec.Config{EnableIPsec: tt.enableIPSec})
...
func TestUpdateKubeProxyReplacement(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			lbConfig.LBAlgorithm = defaultNodePortModeAlgorithms[0]
			lbConfig.LBMode = defaultNodePortModes[0]
			lbConfig.KubeProxyReplacement = tt.enableKubeProxyReplacement
