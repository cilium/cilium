...
func TestUpdateNetworkMode(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			metrics.update(params, config, lbConfig, fakeTypes.WireguardConfig{}, fakeTypes.IPsecConfig{})
...
func TestUpdateEncryptionMode(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			metrics.update(params, config, lbConfig, fakeTypes.WireguardConfig{EnableWireguard: tt.enableWireguard}, fakeTypes.IPsecConfig{EnableIPsec: tt.enableIPSec})
...
func TestUpdateKubeProxyReplacement(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			lbCfg.UserConfig.KubeProxyReplacement = tt.enableKubeProxyReplacement

			metrics.update(params, config, lbCfg, fakeTypes.WireguardConfig{}, fakeTypes.IPsecConfig{})
