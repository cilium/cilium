...
func (h *histogram) Describe(descChan chan<- *prometheus.Desc) {
	h.Histogram.Describe(descChan)
}
...
func NewHistogramVec(opts HistogramOpts, labelDescriptions LabelDescriptions) Vec[Observer] {
	return &histogramVec{
		ObserverVec:       prometheus.NewHistogramVec(opts.toPrometheus(), labelDescriptions.labelNames()),
...
func (cv *histogramVec) Labels() LabelDescriptions {
	return append(cv.metric.Labels(), cv.labelDescriptions...)
}
...
func (cv *histogramVec) LabelDescriptions() LabelDescriptions {
	return cv.labelDescriptions
}
...
func (ho HistogramOpts) opts() Opts {
	return Opts{
		...
		EnabledByDefault: ho.EnabledByDefault,
...
func (ho HistogramOpts) toPrometheus() prometheus.HistogramOpts {
	return prometheus.HistogramOpts{
		Namespace:                       ho.Namespace,
		Subsystem:                       ho.Subsystem.Name,
		Name:                            ho.Name,
		Help:                            ho.Help,
		ConstLabels:                     ho.ConstLabels.toPrometheus(),
		Buckets:                         ho.Buckets,
