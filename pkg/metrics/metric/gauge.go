...
func (g *gauge) Describe(descChan chan<- *prometheus.Desc) {
	g.Gauge.Describe(descChan)
}
...
func NewGaugeVec(opts GaugeOpts, labelDescriptions LabelDescriptions) DeletableVec[Gauge] {
	return &gaugeVec{
		GaugeVec:          prometheus.NewGaugeVec(opts.toPrometheus(), labelDescriptions.labelNames()),
...
func (gv *gaugeVec) Labels() LabelDescriptions {
	return append(gv.metric.Labels(), gv.labelDescriptions...)
}
...
func (gv *gaugeVec) LabelDescriptions() LabelDescriptions {
	return gv.labelDescriptions
}
...
func (o GaugeOpts) toPrometheus() prometheus.GaugeOpts {
	return prometheus.GaugeOpts{
		...
		Subsystem:   o.Subsystem.Name,
		Name:        o.Name,
		Help:        o.Help,
		ConstLabels: o.ConstLabels.toPrometheus(),
	}
}
