...
var (
	...
	//LabelPolicySourceis the label used to see the enforcement status
	...
	// policy (and incrementing the policy revision) to seeing it in the
	// datapath. These times should correlate to the delay in marking Enforcing:
	// true on k8s CNPs.
