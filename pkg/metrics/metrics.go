...
var (
	...
	KVStoreOperationsTotal = NoOpCounterVec
...
type Configuration struct {
	...
	KVStoreOperationsTotalEnabled           bool
...
func DefaultMetrics() map[string]struct{} {
	return map[string]struct{}{
		...
		Namespace + "_" + SubsystemKVStore + "_operations_total":                  {},
...
func CreateConfiguration(metricsEnabled []string) (Configuration, []prometheus.Collector) {
	...
	for _, metricName := range metricsEnabled {
		...
		case Namespace + "_" + SubsystemKVStore + "kvstore_operations_total":
			...
			collectors = append(collectors, KVStoreOperationsTotal)
			c.KVStoreOperationsTotalEnabled = true
