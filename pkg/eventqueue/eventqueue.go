...
// UpdateName updates the name of the EventQueue.
func (q *EventQueue) UpdateName(name string) {
	q.getLogger().WithField("newName", name).Debug("updating name of EventQueue")
	q.name = name
}
