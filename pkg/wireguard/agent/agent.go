...
type Agent struct {
	...
	nodeReconciler reconciler.Reconciler[*node.Node]
	stopping       bool
}
...
func (a *Agent) peerGarbageCollector(ctx context.Context, _ cell.Health) error {
	...
	if err := a.waitForNodeReconciliation(ctx, a.nodes.Revision(txn)); err != nil {
		return nil
	}
...
func (a *Agent) waitForNodeReconciliation(
	...
	if _, _, err := a.nodeReconciler.WaitUntilReconciled(ctx, revision); err != nil {
		return err
	}
