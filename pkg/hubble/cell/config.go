...
type config struct {
	...
	// EnableNetworkPolicyEnrichment controls whether to enable network policy enrichment of Hubble flows
	EnableNetworkPolicyEnrichment bool `mapstructure:"hubble-network-policy-enrichment-enabled"`
}
...
func (def config) Flags(flags *pflag.FlagSet) {
	...
	flags.Bool("hubble-network-policy-enrichment-enabled", def.EnableNetworkPolicyEnrichment, "Enable network policy enrichment of Hubble flows")
}
