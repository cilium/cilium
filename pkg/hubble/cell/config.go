...
type config struct {
	...
	EnableL3L4PolicyEnrichment bool `mapstructure:"hubble-enable-l3l4-net-pol-enrichment"`
}
...
func (def config) Flags(flags *pflag.FlagSet) {
	...
	flags.Bool("hubble-enable-l3l4-net-pol-enrichment", def.EnableL3L4PolicyEnrichment, "Enable L3/L4 network policy enrichment of Hubble Flow logs")
}
