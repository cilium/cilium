...
type hubbleExportersOut struct {
	...
	ExporterBuilders []*exporter.FlowLogExporterBuilder `group:"hubble-exporter-builders,flatten"`
}
...
func newHubbleStaticExporter(params hubbleExportersParams) (hubbleExportersOut, error) {
	...
	builder := &exporter.FlowLogExporterBuilder{
	...
	return hubbleExportersOut{ExporterBuilders: []*exporter.FlowLogExporterBuilder{builder}}, nil
}
