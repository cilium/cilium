...
func NewExporterConfigParser(logger logging.FieldLogger) *exporterConfigParser {
...
func NewExporterFactory(logger logging.FieldLogger) *exporterFactory {
...
func (f *exporterFactory) create(config *FlowLogConfig) (*exporter, error) {
	...
	return NewExporter(f.logger.With("flowLogName", config.Name), exporterOpts...)
}
