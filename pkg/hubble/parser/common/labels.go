...
func FilterCIDRLabels(log logging.FieldLogger, labels []string) []string {
...
func SortAndFilterLabels(log logging.FieldLogger, labels []string, securityIdentity identity.NumericIdentity) []string {
