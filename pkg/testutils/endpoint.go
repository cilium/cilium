...
func (e *TestEndpoint) GetSecurityIdentity() (*identity.Identity, error) { return e.Identity, nil }
...
func (e *TestEndpoint) GetOpLabels() []string                            { return []string{"test=foo"} }
func (e *TestEndpoint) GetID16() uint16                                  { return uint16(e.Id) }
func (e *TestEndpoint) GetK8sNamespace() string                          { return e.K8sNamespace }
func (e *TestEndpoint) PolicyRevisionBumpEvent(_ uint64)                 {}
