...
const (
	...
	gieConformanceEnv        = "GIE_CONFORMANCE_TESTS"
...
func GIEConformanceTest(tb testing.TB) {
	tb.Helper()

	if os.Getenv(gieConformanceEnv) == "" {
		tb.Skipf("Set %s to run this test", gieConformanceEnv)
	}
}
