...
func (n *NodeDiscovery) StartDiscovery(kvbackend kvstore.BackendOperations, nodeName string) {
	...
	go func() {
		...
		for {
			if err := n.Registrar.RegisterNode(kvbackend, &n.LocalNode, n.Manager); err != nil {
