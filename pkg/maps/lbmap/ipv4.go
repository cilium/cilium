...
func (s *Service4ValueV2) SetBackendID(id loadbalancer.BackendID) { s.BackendID = id }
func (s *Service4ValueV2) GetBackendID() loadbalancer.BackendID   { return s.BackendID }
