...
func (v EncryptKey) String() string {
...
// EncryptMapCreate will create an encrypt map
func EncryptMapCreate() {
	encryptMap.OpenOrCreate()
}

// EbncryptMapUpdateContext updates the encrypt state with ctxID to use the new keyID
func EncryptMapUpdateContext(ctxID uint32, keyID uint8) error {
