...
// CreateEPPolicyMapWithName creates a new endpoint policy hash of maps for
...
func CreateEPPolicyMapWithName(mapName string) error {
	buildMap.Do(func() {
...
func CreateEPPolicyMap() {
	if err := CreateEPPolicyMapWithName(MapName); err != nil {
