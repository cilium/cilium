...
func TestPolicyMapWildcarding(t *testing.T) {
	...
	for _, tt := range tests {
		...
		case allow:
			...
			require.Equal(t, tt.args.hasExplicitAuthType, entry.Flags&policyFlagHasExplicitAuthType != 0)
		...
		case deny:
			...
			require.Equal(t, policyEntryFlags(0), entry.Flags&policyFlagHasExplicitAuthType)
