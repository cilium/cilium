...
func BenchmarkPrivilegedCtGcTcpDefault(t *testing.B) {
	benchmarkCtGc(t, option.CTMapEntriesGlobalTCPDefault, false)
}
...
func BenchmarkPrivilegedCtGcTcpDefaultExpired(t *testing.B) {
	benchmarkCtGc(t, option.CTMapEntriesGlobalTCPDefault, true)
}
