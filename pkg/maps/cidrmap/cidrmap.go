...
func OpenMapElems(logger logging.FieldLogger, pinPath string, prefixlen int, prefixdyn bool, maxelem uint32) (*CIDRMap, error) {
	...
	m, err := bpf.OpenOrCreateMap(nil, &ebpf.MapSpec{
