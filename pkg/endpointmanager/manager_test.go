...
func (s *EndpointManagerSuite) TestLookup(c *C) {
	...
	ep := endpoint.NewEndpointWithState(s, s, testipcache.NewMockIPCache(), &endpoint.FakeEndpointProxy{}, testidentity.NewMockIdentityAllocator(nil), mpm, 10, endpoint.StateReady)
	mgr := New(&dummyEpSyncher{}, metrics.NewBPFMapMetrics())
	type args struct {
		id string
	}
	type want struct {
...
func (s *EndpointManagerSuite) TestLookupCiliumID(c *C) {
	mgr := New(&dummyEpSyncher{}, metrics.NewBPFMapMetrics())
	mpm := metrics.NewBPFMapMetrics().MapPressure
	ep := endpoint.NewEndpointWithState(s, s, testipcache.NewMockIPCache(), &endpoint.FakeEndpointProxy{}, testidentity.NewMockIdentityAllocator(nil), mpm, 2, endpoint.StateReady)
	type args struct {
		id uint16
	}
	type want struct {
...
func (s *EndpointManagerSuite) TestLookupContainerID(c *C) {
	mgr := New(&dummyEpSyncher{}, metrics.NewBPFMapMetrics())
	mpm := metrics.NewBPFMapMetrics().MapPressure
	ep := endpoint.NewEndpointWithState(s, s, testipcache.NewMockIPCache(), &endpoint.FakeEndpointProxy{}, testidentity.NewMockIdentityAllocator(nil), mpm, 3, endpoint.StateReady)
	type args struct {
		id string
	}
	type want struct {
...
func (s *EndpointManagerSuite) TestLookupIPv4(c *C) {
	mgr := New(&dummyEpSyncher{}, metrics.NewBPFMapMetrics())
	mpm := metrics.NewBPFMapMetrics().MapPressure
	ep := endpoint.NewEndpointWithState(s, s, testipcache.NewMockIPCache(), &endpoint.FakeEndpointProxy{}, testidentity.NewMockIdentityAllocator(nil), mpm, 4, endpoint.StateReady)
	type args struct {
		ip string
	}
	type want struct {
...
func (s *EndpointManagerSuite) TestLookupPodName(c *C) {
	mgr := New(&dummyEpSyncher{}, metrics.NewBPFMapMetrics())
	mpm := metrics.NewBPFMapMetrics().MapPressure
	ep := endpoint.NewEndpointWithState(s, s, testipcache.NewMockIPCache(), &endpoint.FakeEndpointProxy{}, testidentity.NewMockIdentityAllocator(nil), mpm, 5, endpoint.StateReady)
	type args struct {
		podName string
	}
	type want struct {
...
func (s *EndpointManagerSuite) TestUpdateReferences(c *C) {
	mgr := New(&dummyEpSyncher{}, metrics.NewBPFMapMetrics())
	mpm := metrics.NewBPFMapMetrics().MapPressure
	ep := endpoint.NewEndpointWithState(s, s, testipcache.NewMockIPCache(), &endpoint.FakeEndpointProxy{}, testidentity.NewMockIdentityAllocator(nil), mpm, 6, endpoint.StateReady)
	type args struct {
		ep *endpoint.Endpoint
	}
	type want struct {
...
func (s *EndpointManagerSuite) TestRemove(c *C) {
	mgr := New(&dummyEpSyncher{}, metrics.NewBPFMapMetrics())
	mpm := metrics.NewBPFMapMetrics().MapPressure
	ep := endpoint.NewEndpointWithState(s, s, testipcache.NewMockIPCache(), &endpoint.FakeEndpointProxy{}, testidentity.NewMockIdentityAllocator(nil), mpm, 7, endpoint.StateReady)
	type args struct {
	}
	type want struct {
	}
...
func (s *EndpointManagerSuite) TestHasGlobalCT(c *C) {
	mgr := New(&dummyEpSyncher{}, metrics.NewBPFMapMetrics())
	mpm := metrics.NewBPFMapMetrics().MapPressure
	ep := endpoint.NewEndpointWithState(s, s, testipcache.NewMockIPCache(), &endpoint.FakeEndpointProxy{}, testidentity.NewMockIdentityAllocator(nil), mpm, 1, endpoint.StateReady)
	type want struct {
		result bool
	}
	tests := []struct {
