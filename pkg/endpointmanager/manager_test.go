...
func (s *EndpointManagerSuite) TestOnNodeupdate(c *C) {
	...
	// Host endpoint is not available in endpoint manager so the node update
	// is not consumed by enpoint manager.
