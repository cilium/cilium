...
func TestLookup(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if tt.cm != nil {
				ep, err = endpoint.NewEndpointFromChangeModel(context.Background(), nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, s, testipcache.NewMockIPCache(), &endpoint.FakeEndpointProxy{}, testidentity.NewMockIdentityAllocator(nil), ctmap.NewFakeGCRunner(), tt.cm)
...
func TestLookupCiliumID(t *testing.T) {
	...
	mgr := New(&dummyEpSyncher{}, nil, nil)
	ep := endpoint.NewTestEndpointWithState(nil, nil, nil, nil, nil, nil, nil, identitymanager.NewIDManager(), nil, s, testipcache.NewMockIPCache(), &endpoint.FakeEndpointProxy{}, testidentity.NewMockIdentityAllocator(nil), ctmap.NewFakeGCRunner(), 2, endpoint.StateReady)
	type args struct {
		id uint16
	}
	type want struct {
...
func TestLookupCNIAttachmentID(t *testing.T) {
	...
	mgr := New(&dummyEpSyncher{}, nil, nil)
	ep, err := endpoint.NewEndpointFromChangeModel(context.Background(), nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, s, testipcache.NewMockIPCache(), &endpoint.FakeEndpointProxy{}, testidentity.NewMockIdentityAllocator(nil), ctmap.NewFakeGCRunner(), &apiv1.EndpointChangeRequest{
		ContainerID:            "foo",
...
func TestLookupIPv4(t *testing.T) {
	...
	mgr := New(&dummyEpSyncher{}, nil, nil)
	ep := endpoint.NewTestEndpointWithState(nil, nil, nil, nil, nil, nil, nil, identitymanager.NewIDManager(), nil, s, testipcache.NewMockIPCache(), &endpoint.FakeEndpointProxy{}, testidentity.NewMockIdentityAllocator(nil), ctmap.NewFakeGCRunner(), 4, endpoint.StateReady)
	type args struct {
		ip string
	}
	type want struct {
...
func TestRemove(t *testing.T) {
	s := setupEndpointManagerSuite(t)
	mgr := New(&dummyEpSyncher{}, nil, nil)
	ep := endpoint.NewTestEndpointWithState(nil, nil, nil, nil, nil, nil, nil, identitymanager.NewIDManager(), nil, s, testipcache.NewMockIPCache(), &endpoint.FakeEndpointProxy{}, testidentity.NewMockIdentityAllocator(nil), ctmap.NewFakeGCRunner(), 7, endpoint.StateReady)
	type args struct{}
	type want struct{}
	tests := []struct {
		name        string
...
func TestHasGlobalCT(t *testing.T) {
	...
	mgr := New(&dummyEpSyncher{}, nil, nil)
	ep := endpoint.NewTestEndpointWithState(nil, nil, nil, nil, nil, nil, nil, identitymanager.NewIDManager(), nil, s, testipcache.NewMockIPCache(), &endpoint.FakeEndpointProxy{}, testidentity.NewMockIdentityAllocator(nil), ctmap.NewFakeGCRunner(), 1, endpoint.StateReady)
	type want struct {
		result bool
	}
	tests := []struct {
