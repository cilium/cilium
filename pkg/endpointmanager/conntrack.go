...
func ResetProxyPort(ipv4Enabled bool, e *endpoint.Endpoint, isLocal bool, epIPs []net.IP, idsMod policy.SecurityIdentityL4L7Map) {
...
func FlushCTEntriesOf(ipv4Enabled bool, e *endpoint.Endpoint, isLocal bool, epIPs []net.IP, idsToKeep policy.SecurityIdentityL4L7Map) {
