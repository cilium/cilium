...
func (mgr *EndpointManager) OnAddNode(node *slim_corev1.Node) error { return nil }
...
// need for it. This adheres to the subscriber.NodeHandler interface.
func (mgr *EndpointManager) OnUpdateNode(oldNode, newNode *slim_corev1.Node) error {
...
func (mgr *EndpointManager) OnDeleteNode(node *slim_corev1.Node) error { return nil }
