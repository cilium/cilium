...
func NewSockRevNat4StMap(reg *registry.MapRegistry) *bpf.Map {
	m, err := bpf.NewMapFromRegistry(reg, SockRevNat4StMapName, &SockRevNatStKey{}, &SockRevNat4StValue{})
	if err != nil {
...
func NewSockRevNat6StMap(reg *registry.MapRegistry) *bpf.Map {
	m, err := bpf.NewMapFromRegistry(reg, SockRevNat6StMapName, &SockRevNatStKey{}, &SockRevNat6StValue{})
	if err != nil {
