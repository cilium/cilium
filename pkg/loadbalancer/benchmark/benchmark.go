			...
			cell.Provide(
				func() loadbalancer.Config {
					return loadbalancer.Config{
						...
						LBMapEntries:            1000,
						LBServiceMapEntries:     1000,
						LBBackendMapEntries:     1000,
						LBRevNatEntries:         1000,
						LBAffinityMapEntries:    1000,
						LBSourceRangeAllTypes:   false,
						LBSourceRangeMapEntries: 1000,
						LBMaglevMapEntries:      1000,
						LBSockRevNatEntries:     1000,
					}
				},
