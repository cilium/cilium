...
func (m *ManagerTestSuite) newServiceMock(ctx context.Context, lbcfg lb.Config, lbmap datapathTypes.LBMap) {
	m.svc = newService(m.logger, nil, &FakeMonitorAgent{}, lbcfg, lbmap, nil, nil, true, option.Config)
...
func TestRestoreServiceWithStaleBackends(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			svc := newService(logger, nil, &FakeMonitorAgent{}, lb.DefaultConfig, lbmap, nil, nil, true, option.Config)
...
func TestRestoreServicesWithLeakedBackends(t *testing.T) {
	...
	lbmap := m.svc.lbmap.(*mockmaps.LBMockMap)
	logger := hivetest.Logger(t)
	m.svc = newService(logger, nil, &FakeMonitorAgent{}, lb.DefaultConfig, lbmap, nil, nil, true, option.Config)
