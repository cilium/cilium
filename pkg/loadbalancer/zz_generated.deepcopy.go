...
func (in *CtrlFlagParam) DeepCopyInto(out *CtrlFlagParam) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CtrlFlagParam.
func (in *CtrlFlagParam) DeepCopy() *CtrlFlagParam {
	if in == nil {
		return nil
	}
	out := new(CtrlFlagParam)
	in.DeepCopyInto(out)
	return out
}
