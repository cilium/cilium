...
var logAttr = slog.String(logfields.LogSubsys, "ipam-allocator-multi-pool")
...
func (a *Allocator) Init(logger *slog.Logger, ctx context.Context) error {
	a.poolAlloc = NewPoolAllocator(logger)
	a.logger = logger.With(logAttr)
	return nil
}
