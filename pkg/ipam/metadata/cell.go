...
type managerParams struct {
	...
	PoolInformer resource.Resource[*api_v2alpha1.CiliumPodIPPool]
}
...
func newIPAMMetadataManager(params managerParams) Manager {
	...
	manager.logger.Debug("metadata manager: multi-pool IPAM enabled, starting pool watcher")
	params.Jobs.Add(job.Observer("ipam-pool-watcher", manager.handlePoolEvent, params.PoolInformer))
