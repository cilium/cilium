...
func (n *nodeOperationsMock) ResyncInterfacesAndIPs(ctx context.Context, scopedLog *logrus.Entry) (map[string]v2.AllocationIP, error) {
	available := map[string]v2.AllocationIP{}
	for _, ip := range n.allocatedIPs {
		available[ip] = v2.AllocationIP{}
	}
