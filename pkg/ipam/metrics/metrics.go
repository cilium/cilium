...
type prometheusMetrics struct {
	...
	BackgroundSyncDuration prometheus.Histogram
...
func NewPrometheusMetrics(namespace string, registry metrics.RegisterGatherer) *prometheusMetrics {
	...
	m.BackgroundSyncDuration = prometheus.NewHistogram(prometheus.HistogramOpts{
		Namespace: namespace,
		Subsystem: ipamSubsystem,
...
func (p *prometheusMetrics) ObserveBackgroundSync(duration time.Duration) {
	p.BackgroundSyncDuration.Observe(duration.Seconds())
}
...
func (m *NoOpMetrics) ObserveBackgroundSync(duration time.Duration)                              {}
