...
func NewTriggerMetricsIPAM(poolName string, family string, remaining *big.Int) *TriggerMetricsIPAM {
	t := &TriggerMetricsIPAM{
...
func (t *TriggerMetricsIPAM) RegisterMultipool(registry metrics.RegisterGatherer) {
