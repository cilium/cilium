...
func (*mapMock) IterateWithCallback(act.ActiveConnectionTrackingIterateCallback) error {
	return nil
}
...
func TestCallback(t *testing.T) {
	...
	a := newAct(new(mapMock), NewActiveConnectionTrackingMetrics(), opts)
...
func TestCleanup(t *testing.T) {
	...
	m := new(mapMock)
	a := newAct(m, NewActiveConnectionTrackingMetrics(), opts)
