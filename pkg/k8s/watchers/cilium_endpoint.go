		...
		_, ciliumEndpointInformer := informer.NewInformer(
			...
			cache.ResourceEventHandlerFuncs{
				AddFunc: func(obj interface{}) {
					...
					defer k.K8sEventReceived(apiGroup, metricCiliumEndpoint, resources.MetricCreate, valid, equal)
				...
				UpdateFunc: func(oldObj, newObj interface{}) {
					var valid, equal bool
					defer k.K8sEventReceived(apiGroup, metricCiliumEndpoint, resources.MetricUpdate, valid, equal)
				...
				DeleteFunc: func(obj interface{}) {
					var valid, equal bool
					defer k.K8sEventReceived(apiGroup, metricCiliumEndpoint, resources.MetricDelete, valid, equal)
