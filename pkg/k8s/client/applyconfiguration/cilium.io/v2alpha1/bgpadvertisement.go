...
type BGPAdvertisementApplyConfiguration struct {
	AdvertisementType *ciliumiov2alpha1.BGPAdvertisementType `json:"advertisementType,omitempty"`
...
func (b *BGPAdvertisementApplyConfiguration) WithAdvertisementType(value ciliumiov2alpha1.BGPAdvertisementType) *BGPAdvertisementApplyConfiguration {
