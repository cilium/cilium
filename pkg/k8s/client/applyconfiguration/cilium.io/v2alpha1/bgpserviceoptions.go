...
type BGPServiceOptionsApplyConfiguration struct {
	Addresses             []ciliumiov2alpha1.BGPServiceAddressType `json:"addresses,omitempty"`
...
func (b *BGPServiceOptionsApplyConfiguration) WithAddresses(values ...ciliumiov2alpha1.BGPServiceAddressType) *BGPServiceOptionsApplyConfiguration {
	for i := range values {
