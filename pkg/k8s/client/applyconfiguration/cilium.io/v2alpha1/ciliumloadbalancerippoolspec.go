...
type CiliumLoadBalancerIPPoolSpecApplyConfiguration struct {
	...
	AllowFirstLastIPs *ciliumiov2alpha1.AllowFirstLastIPType              `json:"allowFirstLastIPs,omitempty"`
...
func (b *CiliumLoadBalancerIPPoolSpecApplyConfiguration) WithAllowFirstLastIPs(value ciliumiov2alpha1.AllowFirstLastIPType) *CiliumLoadBalancerIPPoolSpecApplyConfiguration {
