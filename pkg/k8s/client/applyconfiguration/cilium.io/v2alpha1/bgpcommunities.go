...
type BGPCommunitiesApplyConfiguration struct {
	Standard  []ciliumiov2alpha1.BGPStandardCommunity  `json:"standard,omitempty"`
	WellKnown []ciliumiov2alpha1.BGPWellKnownCommunity `json:"wellKnown,omitempty"`
	Large     []ciliumiov2alpha1.BGPLargeCommunity     `json:"large,omitempty"`
}
...
func (b *BGPCommunitiesApplyConfiguration) WithStandard(values ...ciliumiov2alpha1.BGPStandardCommunity) *BGPCommunitiesApplyConfiguration {
	for i := range values {
...
func (b *BGPCommunitiesApplyConfiguration) WithWellKnown(values ...ciliumiov2alpha1.BGPWellKnownCommunity) *BGPCommunitiesApplyConfiguration {
	for i := range values {
...
func (b *BGPCommunitiesApplyConfiguration) WithLarge(values ...ciliumiov2alpha1.BGPLargeCommunity) *BGPCommunitiesApplyConfiguration {
	for i := range values {
