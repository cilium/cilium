...
// CiliumIdentityNamespaceListerExpansion allows custom methods to be added to
// CiliumIdentityNamespaceLister.
type CiliumIdentityNamespaceListerExpansion interface{}
