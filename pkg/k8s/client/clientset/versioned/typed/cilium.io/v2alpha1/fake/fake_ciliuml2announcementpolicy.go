...
type fakeCiliumL2AnnouncementPolicies struct {
	*gentype.FakeClientWithListAndApply[*v2alpha1.CiliumL2AnnouncementPolicy, *v2alpha1.CiliumL2AnnouncementPolicyList, *ciliumiov2alpha1.CiliumL2AnnouncementPolicyApplyConfiguration]
	Fake *FakeCiliumV2alpha1
}

func newFakeCiliumL2AnnouncementPolicies(fake *FakeCiliumV2alpha1) typedciliumiov2alpha1.CiliumL2AnnouncementPolicyInterface {
	return &fakeCiliumL2AnnouncementPolicies{
		gentype.NewFakeClientWithListAndApply[*v2alpha1.CiliumL2AnnouncementPolicy, *v2alpha1.CiliumL2AnnouncementPolicyList, *ciliumiov2alpha1.CiliumL2AnnouncementPolicyApplyConfiguration](
			fake.Fake,
			"",
