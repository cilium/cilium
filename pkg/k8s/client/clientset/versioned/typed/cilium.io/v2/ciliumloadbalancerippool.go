...
type CiliumLoadBalancerIPPoolInterface interface {
	...
	Apply(ctx context.Context, ciliumLoadBalancerIPPool *applyconfigurationciliumiov2.CiliumLoadBalancerIPPoolApplyConfiguration, opts v1.ApplyOptions) (result *ciliumiov2.CiliumLoadBalancerIPPool, err error)
	// Add a +genclient:noStatus comment above the type to avoid generating ApplyStatus().
	ApplyStatus(ctx context.Context, ciliumLoadBalancerIPPool *applyconfigurationciliumiov2.CiliumLoadBalancerIPPoolApplyConfiguration, opts v1.ApplyOptions) (result *ciliumiov2.CiliumLoadBalancerIPPool, err error)
...
type ciliumLoadBalancerIPPools struct {
	*gentype.ClientWithListAndApply[*ciliumiov2.CiliumLoadBalancerIPPool, *ciliumiov2.CiliumLoadBalancerIPPoolList, *applyconfigurationciliumiov2.CiliumLoadBalancerIPPoolApplyConfiguration]
}
...
func newCiliumLoadBalancerIPPools(c *CiliumV2Client) *ciliumLoadBalancerIPPools {
	return &ciliumLoadBalancerIPPools{
		gentype.NewClientWithListAndApply[*ciliumiov2.CiliumLoadBalancerIPPool, *ciliumiov2.CiliumLoadBalancerIPPoolList, *applyconfigurationciliumiov2.CiliumLoadBalancerIPPoolApplyConfiguration](
