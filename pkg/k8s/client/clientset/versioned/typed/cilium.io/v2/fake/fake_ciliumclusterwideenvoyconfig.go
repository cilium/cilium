...
type fakeCiliumClusterwideEnvoyConfigs struct {
	*gentype.FakeClientWithListAndApply[*v2.CiliumClusterwideEnvoyConfig, *v2.CiliumClusterwideEnvoyConfigList, *ciliumiov2.CiliumClusterwideEnvoyConfigApplyConfiguration]
	Fake *FakeCiliumV2
}

func newFakeCiliumClusterwideEnvoyConfigs(fake *FakeCiliumV2) typedciliumiov2.CiliumClusterwideEnvoyConfigInterface {
	return &fakeCiliumClusterwideEnvoyConfigs{
		gentype.NewFakeClientWithListAndApply[*v2.CiliumClusterwideEnvoyConfig, *v2.CiliumClusterwideEnvoyConfigList, *ciliumiov2.CiliumClusterwideEnvoyConfigApplyConfiguration](
			fake.Fake,
			"",
