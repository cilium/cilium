...
func (c *FakeCiliumV2) CiliumGlobalNetworkPolicies(namespace string) v2.CiliumGlobalNetworkPolicyInterface {
	return &FakeCiliumGlobalNetworkPolicies{c, namespace}
}
