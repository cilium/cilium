...
type CiliumNodeConfigInterface interface {
	...
	Apply(ctx context.Context, ciliumNodeConfig *applyconfigurationciliumiov2.CiliumNodeConfigApplyConfiguration, opts v1.ApplyOptions) (result *ciliumiov2.CiliumNodeConfig, err error)
	CiliumNodeConfigExpansion
}

// ciliumNodeConfigs implements CiliumNodeConfigInterface
type ciliumNodeConfigs struct {
	*gentype.ClientWithListAndApply[*ciliumiov2.CiliumNodeConfig, *ciliumiov2.CiliumNodeConfigList, *applyconfigurationciliumiov2.CiliumNodeConfigApplyConfiguration]
}
...
func newCiliumNodeConfigs(c *CiliumV2Client, namespace string) *ciliumNodeConfigs {
	return &ciliumNodeConfigs{
		gentype.NewClientWithListAndApply[*ciliumiov2.CiliumNodeConfig, *ciliumiov2.CiliumNodeConfigList, *applyconfigurationciliumiov2.CiliumNodeConfigApplyConfiguration](
			"ciliumnodeconfigs",
			c.RESTClient(),
