...
type CiliumNetworkPolicyInterface interface {
	...
	List(opts meta_v1.ListOptions) (*v1.CiliumNetworkPolicyList, error)
	Watch(opts meta_v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1.CiliumNetworkPolicy, err error)
...
func newCiliumNetworkPolicies(c *CiliumV1Client, namespace string) *ciliumNetworkPolicies {
...
func (c *ciliumNetworkPolicies) Get(name string, options meta_v1.GetOptions) (result *v1.CiliumNetworkPolicy, err error) {
...
func (c *ciliumNetworkPolicies) List(opts meta_v1.ListOptions) (result *v1.CiliumNetworkPolicyList, err error) {
	result = &v1.CiliumNetworkPolicyList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("ciliumnetworkpolicies").
...
func (c *ciliumNetworkPolicies) Watch(opts meta_v1.ListOptions) (watch.Interface, error) {
	opts.Watch = true
	return c.client.Get().
		Namespace(c.ns).
		Resource("ciliumnetworkpolicies").
...
func (c *ciliumNetworkPolicies) Create(ciliumNetworkPolicy *v1.CiliumNetworkPolicy) (result *v1.CiliumNetworkPolicy, err error) {
	result = &v1.CiliumNetworkPolicy{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("ciliumnetworkpolicies").
...
func (c *ciliumNetworkPolicies) Update(ciliumNetworkPolicy *v1.CiliumNetworkPolicy) (result *v1.CiliumNetworkPolicy, err error) {
	result = &v1.CiliumNetworkPolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("ciliumnetworkpolicies").
...
func (c *ciliumNetworkPolicies) Delete(name string, options *meta_v1.DeleteOptions) error {
...
func (c *ciliumNetworkPolicies) DeleteCollection(options *meta_v1.DeleteOptions, listOptions meta_v1.ListOptions) error {
	return c.client.Delete().
		Namespace(c.ns).
		Resource("ciliumnetworkpolicies").
...
func (c *ciliumNetworkPolicies) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1.CiliumNetworkPolicy, err error) {
	result = &v1.CiliumNetworkPolicy{}
