...
import (
	...
	v2 "github.com/cilium/cilium/pkg/k8s/client/listers/cilium/v2"
...
func defaultCiliumNetworkPolicyInformer(client versioned.Interface, resyncPeriod time.Duration) cache.SharedIndexInformer {
	return NewCiliumNetworkPolicyInformer(client, v1.NamespaceAll, resyncPeriod, cache.Indexers{cache.NamespaceIndex: cache.MetaNamespaceIndexFunc})
}

func (f *ciliumNetworkPolicyInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&cilium_io_v2.CiliumNetworkPolicy{}, defaultCiliumNetworkPolicyInformer)
}
