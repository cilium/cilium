...
import (
	v1 "github.com/cilium/cilium/pkg/k8s/client/informers/externalversions/cilium/v1"
	v2 "github.com/cilium/cilium/pkg/k8s/client/informers/externalversions/cilium/v2"
