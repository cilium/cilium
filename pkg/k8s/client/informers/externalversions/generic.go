...
func (f *sharedInformerFactory) ForResource(resource schema.GroupVersionResource) (GenericInformer, error) {
	...
	case v2alpha1.SchemeGroupVersion.WithResource("ciliumqosclasses"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Cilium().V2alpha1().CiliumQoSClasses().Informer()}, nil
	case v2alpha1.SchemeGroupVersion.WithResource("ciliumqosmechanisms"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Cilium().V2alpha1().CiliumQoSMechanisms().Informer()}, nil
	case v2alpha1.SchemeGroupVersion.WithResource("ciliumqospolicies"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Cilium().V2alpha1().CiliumQoSPolicies().Informer()}, nil
