...
type CiliumClusterwideEnvoyConfigInformer interface {
	...
	Lister() v2alpha1.CiliumClusterwideEnvoyConfigLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.CiliumV2alpha1().CiliumClusterwideEnvoyConfigs().List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CiliumV2alpha1().CiliumClusterwideEnvoyConfigs().Watch(context.TODO(), options)
			},
		},
		&ciliumiov2alpha1.CiliumClusterwideEnvoyConfig{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *ciliumClusterwideEnvoyConfigInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&ciliumiov2alpha1.CiliumClusterwideEnvoyConfig{}, f.defaultInformer)
}

func (f *ciliumClusterwideEnvoyConfigInformer) Lister() v2alpha1.CiliumClusterwideEnvoyConfigLister {
	return v2alpha1.NewCiliumClusterwideEnvoyConfigLister(f.Informer().GetIndexer())
}
