...
type CiliumBGPNodeConfigOverrideIndexInformer cache.TypedSharedIndexInformer[*apisciliumiov2alpha1.CiliumBGPNodeConfigOverride]
...
type CiliumBGPNodeConfigOverrideHandlerFuncs = cache.TypedResourceEventHandlerFuncs[*apisciliumiov2alpha1.CiliumBGPNodeConfigOverride]
...
type CiliumBGPNodeConfigOverrideDetailedHandlerFuncs = cache.TypedResourceEventHandlerDetailedFuncs[*apisciliumiov2alpha1.CiliumBGPNodeConfigOverride]
...
type CiliumBGPNodeConfigOverrideFilteringHandler = cache.TypedFilteringResourceEventHandler[*apisciliumiov2alpha1.CiliumBGPNodeConfigOverride]

// CiliumBGPNodeConfigOverrideIndexers is a specialization of [cache.TypedIndexers] for CiliumBGPNodeConfigOverride.
type CiliumBGPNodeConfigOverrideIndexers = cache.TypedIndexers[*apisciliumiov2alpha1.CiliumBGPNodeConfigOverride]

// DeletedCiliumBGPNodeConfigOverride is a specialization of [cache.DeletedObject] for CiliumBGPNodeConfigOverride.
type DeletedCiliumBGPNodeConfigOverride = cache.DeletedObject[*apisciliumiov2alpha1.CiliumBGPNodeConfigOverride]
...
func NewTypedCiliumBGPNodeConfigOverrideInformerWithOptions(client versioned.Interface, options internalinterfaces.InformerOptions) CiliumBGPNodeConfigOverrideIndexInformer {
	...
	return cache.NewTypedSharedIndexInformer[*apisciliumiov2alpha1.CiliumBGPNodeConfigOverride](cache.NewSharedIndexInformerWithOptions(
...
func (f *ciliumBGPNodeConfigOverrideInformer) TypedInformer() CiliumBGPNodeConfigOverrideIndexInformer {
	return cache.NewTypedSharedIndexInformer[*apisciliumiov2alpha1.CiliumBGPNodeConfigOverride](f.factory.InformerFor(&apisciliumiov2alpha1.CiliumBGPNodeConfigOverride{}, f.defaultInformer))
}
...
func (a *ciliumBGPNodeConfigOverrideTypedInformerAdapter) TypedInformer() CiliumBGPNodeConfigOverrideIndexInformer {
	return cache.NewTypedSharedIndexInformer[*apisciliumiov2alpha1.CiliumBGPNodeConfigOverride](a.Informer())
}
...
func ToCiliumBGPNodeConfigOverrideIndexInformer(informer cache.SharedIndexInformer) CiliumBGPNodeConfigOverrideIndexInformer {
	...
	return cache.NewTypedSharedIndexInformer[*apisciliumiov2alpha1.CiliumBGPNodeConfigOverride](informer)
}
