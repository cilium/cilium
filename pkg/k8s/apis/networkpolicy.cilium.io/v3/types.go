...
type CiliumNetworkPolicy struct {
	...
	Spec *v3.Rule `json:"spec,omitempty"`

	// Specs is a list of desired Cilium specific rule specification.
	Specs v3.Rules `json:"specs,omitempty"`
...
// rules.
func (r *CiliumNetworkPolicy) Parse() (v3.Rules, error) {
...
func (r *CiliumNetworkPolicy) GetControllerName() string {
	...
	return fmt.Sprintf("%s (v3 %s)", k8sConst.CtrlPrefixPolicyStatus, name)
}
