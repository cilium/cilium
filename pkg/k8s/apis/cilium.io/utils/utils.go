...
const (
	...
	// ResourceTypeCiliumGlobalNetworkPolicy is the resource type used for the
	// PolicyLabelDerivedFrom label
	ResourceTypeCiliumGlobalNetworkPolicy = "CiliumGlobalNetworkPolicy"
)
...
// this is when translating selectors for CiliumGlobalNetworkPolicy.
...
// might happen in case of CiliumGlobalNetworkPolicy which enforces a policy on the cluster
