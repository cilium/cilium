...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PoolCIDR) DeepCopyInto(out *PoolCIDR) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PoolCIDR.
func (in *PoolCIDR) DeepCopy() *PoolCIDR {
	if in == nil {
		return nil
	}
	out := new(PoolCIDR)
