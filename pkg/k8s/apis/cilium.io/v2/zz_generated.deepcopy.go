...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CiliumBGPBMPServer) DeepCopyInto(out *CiliumBGPBMPServer) {
	*out = *in
	if in.PeerPort != nil {
	...
	if in.MonitoringPolicy != nil {
		in, out := &in.MonitoringPolicy, &out.MonitoringPolicy
		*out = new(string)
		**out = **in
	}
	if in.StatisticsTimeout != nil {
		in, out := &in.StatisticsTimeout, &out.StatisticsTimeout
		*out = new(int32)
		**out = **in
	}
	return
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CiliumBGPBMPServer.
func (in *CiliumBGPBMPServer) DeepCopy() *CiliumBGPBMPServer {
	if in == nil {
		return nil
	}
	out := new(CiliumBGPBMPServer)
	in.DeepCopyInto(out)
	return out
}
...
func (in *CiliumBGPInstance) DeepCopyInto(out *CiliumBGPInstance) {
	*out = *in
	...
	if in.BMPServers != nil {
		in, out := &in.BMPServers, &out.BMPServers
		*out = make([]CiliumBGPBMPServer, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
