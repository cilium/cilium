...
func (in *CiliumDerivativePolicyStatus) DeepCopyInto(out *CiliumDerivativePolicyStatus) {
	*out = *in
	in.LastUpdated.DeepCopyInto(&out.LastUpdated)
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CiliumDerivativePolicyStatus.
func (in *CiliumDerivativePolicyStatus) DeepCopy() *CiliumDerivativePolicyStatus {
	if in == nil {
		return nil
	}
	out := new(CiliumDerivativePolicyStatus)
	in.DeepCopyInto(out)
	return out
}
...
func (in *CiliumNetworkPolicyStatus) DeepCopyInto(out *CiliumNetworkPolicyStatus) {
	*out = *in
	...
	if in.DerivativesPolicies != nil {
		in, out := &in.DerivativesPolicies, &out.DerivativesPolicies
		*out = make(map[string]CiliumDerivativePolicyStatus, len(*in))
		for key, val := range *in {
			(*out)[key] = *val.DeepCopy()
		}
	}
