...
type CiliumIdentity struct {
	...
	// SecurityLabels is the source-of-truth set of labels for this identity. The
	// labels placed in metav1.ObjectMeta are there for convenience when
	// searching and manipulating the CRD.
	SecurityLabels map[string]string `json:"securityLabels"`
