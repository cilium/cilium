...
// DeepEqual is an autogenerated deepequal function, deeply comparing the
// receiver with other. in must be non-nil.
func (in *ClusterwideLocalRedirectPolicy) DeepEqual(other *ClusterwideLocalRedirectPolicy) bool {
	if other == nil {
		return false
	}

	if !in.LocalRedirectPolicy.DeepEqual(&other.LocalRedirectPolicy) {
		return false
	}
...
// DeepEqual is an autogenerated deepequal function, deeply comparing the
// receiver with other. in must be non-nil.
func (in *L3L4Info) DeepEqual(other *L3L4Info) bool {
	if other == nil {
		return false
	}
	...
	if in.ToPort != other.ToPort {
		return false
	}
	if in.L4Proto != other.L4Proto {
		return false
	}
...
// DeepEqual is an autogenerated deepequal function, deeply comparing the
// receiver with other. in must be non-nil.
func (in *LocalRedirectPolicy) DeepEqual(other *LocalRedirectPolicy) bool {
	if other == nil {
		return false
	}
...
// DeepEqual is an autogenerated deepequal function, deeply comparing the
// receiver with other. in must be non-nil.
func (in *LocalRedirectPolicySpec) DeepEqual(other *LocalRedirectPolicySpec) bool {
	if other == nil {
		return false
	}

	if !in.RedirectFrom.DeepEqual(&other.RedirectFrom) {
		return false
	}

	if !in.RedirectTo.DeepEqual(&other.RedirectTo) {
		return false
	}
...
// DeepEqual is an autogenerated deepequal function, deeply comparing the
// receiver with other. in must be non-nil.
func (in *LocalRedirectPolicyStatus) DeepEqual(other *LocalRedirectPolicyStatus) bool {
	if other == nil {
		return false
	}
...
// DeepEqual is an autogenerated deepequal function, deeply comparing the
// receiver with other. in must be non-nil.
func (in *RedirectFrom) DeepEqual(other *RedirectFrom) bool {
	if other == nil {
		return false
	}

	if in.ToL3L4 != other.ToL3L4 {
		return false
	}

	if !in.ToService.DeepEqual(&other.ToService) {
		return false
	}
...
// DeepEqual is an autogenerated deepequal function, deeply comparing the
// receiver with other. in must be non-nil.
func (in *RedirectTo) DeepEqual(other *RedirectTo) bool {
	if other == nil {
		return false
	}
