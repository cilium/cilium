...
// DeepEqual is an autogenerated deepequal function, deeply comparing the
// receiver with other. in must be non-nil.
func (in *CiliumBGPBMPServer) DeepEqual(other *CiliumBGPBMPServer) bool {
	if other == nil {
		return false
	}
	...
	if (in.MonitoringPolicy == nil) != (other.MonitoringPolicy == nil) {
		return false
	} else if in.MonitoringPolicy != nil {
		if *in.MonitoringPolicy != *other.MonitoringPolicy {
			return false
		}
	}

	if (in.StatisticsTimeout == nil) != (other.StatisticsTimeout == nil) {
		return false
	} else if in.StatisticsTimeout != nil {
		if *in.StatisticsTimeout != *other.StatisticsTimeout {
			return false
		}
	}
...
func (in *CiliumBGPInstance) DeepEqual(other *CiliumBGPInstance) bool {
	...
	if ((in.BMPServers != nil) && (other.BMPServers != nil)) || ((in.BMPServers == nil) != (other.BMPServers == nil)) {
		in, other := &in.BMPServers, &other.BMPServers
		if other == nil {
			return false
		}
