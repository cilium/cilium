...
// DeepEqual is an autogenerated deepequal function, deeply comparing the
// receiver with other. in must be non-nil.
func (in *VTEPConnection) DeepEqual(other *VTEPConnection) bool {
	if other == nil {
		return false
	}
...
func (in *VTEPEndpoint) DeepEqual(other *VTEPEndpoint) bool {
	...
	if (in.Standby == nil) != (other.Standby == nil) {
		return false
	} else if in.Standby != nil {
		if !in.Standby.DeepEqual(other.Standby) {
			return false
		}
	}
