...
func (in *CiliumNetworkDriverDeviceManagerConfig) DeepEqual(other *CiliumNetworkDriverDeviceManagerConfig) bool {
	...
	if (in.EswitchSRIOV == nil) != (other.EswitchSRIOV == nil) {
		return false
	} else if in.EswitchSRIOV != nil {
		if !in.EswitchSRIOV.DeepEqual(other.EswitchSRIOV) {
			return false
		}
	}
...
// DeepEqual is an autogenerated deepequal function, deeply comparing the
// receiver with other. in must be non-nil.
func (in *EswitchBridgeConfig) DeepEqual(other *EswitchBridgeConfig) bool {
	if other == nil {
		return false
	}
	...
	if ((in.Params != nil) && (other.Params != nil)) || ((in.Params == nil) != (other.Params == nil)) {
		in, other := &in.Params, &other.Params
		if other == nil {
			return false
		}
...
// DeepEqual is an autogenerated deepequal function, deeply comparing the
// receiver with other. in must be non-nil.
func (in *EswitchSRIOVDeviceConfig) DeepEqual(other *EswitchSRIOVDeviceConfig) bool {
	if other == nil {
		return false
	}
	...
	if in.BridgeName != other.BridgeName {
		return false
	}
...
// DeepEqual is an autogenerated deepequal function, deeply comparing the
// receiver with other. in must be non-nil.
func (in *EswitchSRIOVDeviceManagerConfig) DeepEqual(other *EswitchSRIOVDeviceManagerConfig) bool {
	if other == nil {
		return false
	}
	...
	if ((in.Bridges != nil) && (other.Bridges != nil)) || ((in.Bridges == nil) != (other.Bridges == nil)) {
		in, other := &in.Bridges, &other.Bridges
		if other == nil {
			return false
		}
