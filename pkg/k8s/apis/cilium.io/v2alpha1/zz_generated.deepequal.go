...
func (in *BGPCommunities) DeepEqual(other *BGPCommunities) bool {
	...
	if ((in.Extended != nil) && (other.Extended != nil)) || ((in.Extended == nil) != (other.Extended == nil)) {
		in, other := &in.Extended, &other.Extended
		if other == nil {
			return false
		}
...
// DeepEqual is an autogenerated deepequal function, deeply comparing the
// receiver with other. in must be non-nil.
func (in *BGPExtendedCommunity) DeepEqual(other *BGPExtendedCommunity) bool {
	if other == nil {
		return false
	}

	if in.SubType != other.SubType {
		return false
	}
