...
// DeepEqual is an autogenerated deepequal function, deeply comparing the
// receiver with other. in must be non-nil.
func (in *CiliumResourceNetworkConfig) DeepEqual(other *CiliumResourceNetworkConfig) bool {
	if other == nil {
		return false
	}

	if ((in.Spec != nil) && (other.Spec != nil)) || ((in.Spec == nil) != (other.Spec == nil)) {
		in, other := &in.Spec, &other.Spec
		if other == nil {
			return false
		}
...
// DeepEqual is an autogenerated deepequal function, deeply comparing the
// receiver with other. in must be non-nil.
func (in *CiliumResourceNetworkConfigSpec) DeepEqual(other *CiliumResourceNetworkConfigSpec) bool {
	if other == nil {
		return false
	}
	...
	if ((in.Sysctl != nil) && (other.Sysctl != nil)) || ((in.Sysctl == nil) != (other.Sysctl == nil)) {
		in, other := &in.Sysctl, &other.Sysctl
		if other == nil {
			return false
		}
	...
	if (in.InterfaceSysctl == nil) != (other.InterfaceSysctl == nil) {
		return false
	} else if in.InterfaceSysctl != nil {
		if !in.InterfaceSysctl.DeepEqual(other.InterfaceSysctl) {
			return false
		}
	}
...
// DeepEqual is an autogenerated deepequal function, deeply comparing the
// receiver with other. in must be non-nil.
func (in *IPv4NetworkConfigSpec) DeepEqual(other *IPv4NetworkConfigSpec) bool {
	if other == nil {
		return false
	}

	if in.NetMask != other.NetMask {
		return false
	}
	if ((in.StaticRoutes != nil) && (other.StaticRoutes != nil)) || ((in.StaticRoutes == nil) != (other.StaticRoutes == nil)) {
		in, other := &in.StaticRoutes, &other.StaticRoutes
		if other == nil {
			return false
		}
...
// DeepEqual is an autogenerated deepequal function, deeply comparing the
// receiver with other. in must be non-nil.
func (in *IPv6NetworkConfigSpec) DeepEqual(other *IPv6NetworkConfigSpec) bool {
	if other == nil {
		return false
	}
...
// DeepEqual is an autogenerated deepequal function, deeply comparing the
// receiver with other. in must be non-nil.
func (in *IPv6StaticRouteSpec) DeepEqual(other *IPv6StaticRouteSpec) bool {
	if other == nil {
		return false
	}
...
// DeepEqual is an autogenerated deepequal function, deeply comparing the
// receiver with other. in must be non-nil.
func (in *InterfaceSysctl) DeepEqual(other *InterfaceSysctl) bool {
	if other == nil {
		return false
	}

	if ((in.IPv4 != nil) && (other.IPv4 != nil)) || ((in.IPv4 == nil) != (other.IPv4 == nil)) {
		in, other := &in.IPv4, &other.IPv4
		if other == nil {
			return false
		}
	...
	if ((in.IPv6 != nil) && (other.IPv6 != nil)) || ((in.IPv6 == nil) != (other.IPv6 == nil)) {
		in, other := &in.IPv6, &other.IPv6
		if other == nil {
			return false
		}
