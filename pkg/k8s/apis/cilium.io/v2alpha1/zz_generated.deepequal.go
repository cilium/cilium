...
// DeepEqual is an autogenerated deepequal function, deeply comparing the
// receiver with other. in must be non-nil.
func (in *CiliumLoadBalancerIPCounts) DeepEqual(other *CiliumLoadBalancerIPCounts) bool {
	if other == nil {
		return false
	}

	if in.Total != other.Total {
		return false
	}
	if in.Available != other.Available {
		return false
	}
	if in.Used != other.Used {
		return false
	}
