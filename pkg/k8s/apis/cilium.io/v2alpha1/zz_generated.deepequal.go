...
// DeepEqual is an autogenerated deepequal function, deeply comparing the
// receiver with other. in must be non-nil.
func (in *CiliumEgressSRv6Policy) DeepEqual(other *CiliumEgressSRv6Policy) bool {
	if other == nil {
		return false
	}
...
// DeepEqual is an autogenerated deepequal function, deeply comparing the
// receiver with other. in must be non-nil.
func (in *CiliumEgressSRv6PolicySpec) DeepEqual(other *CiliumEgressSRv6PolicySpec) bool {
	if other == nil {
		return false
	}
