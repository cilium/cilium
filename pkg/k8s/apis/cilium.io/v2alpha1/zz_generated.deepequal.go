...
func (in *CiliumWorldCIDRSetSpec) DeepEqual(other *CiliumWorldCIDRSetSpec) bool {
	...
	if (in.Encapsulate == nil) != (other.Encapsulate == nil) {
		return false
	} else if in.Encapsulate != nil {
		if *in.Encapsulate != *other.Encapsulate {
			return false
		}
	}

	if ((in.CIDRGroupRefs != nil) && (other.CIDRGroupRefs != nil)) || ((in.CIDRGroupRefs == nil) != (other.CIDRGroupRefs == nil)) {
		in, other := &in.CIDRGroupRefs, &other.CIDRGroupRefs
		if other == nil {
			return false
		}
