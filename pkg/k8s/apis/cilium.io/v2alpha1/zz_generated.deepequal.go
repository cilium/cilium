...
// DeepEqual is an autogenerated deepequal function, deeply comparing the
// receiver with other. in must be non-nil.
func (in *CiliumVtepPolicy) DeepEqual(other *CiliumVtepPolicy) bool {
	if other == nil {
		return false
	}
...
// DeepEqual is an autogenerated deepequal function, deeply comparing the
// receiver with other. in must be non-nil.
func (in *CiliumVtepPolicyRules) DeepEqual(other *CiliumVtepPolicyRules) bool {
	if other == nil {
		return false
	}
...
// DeepEqual is an autogenerated deepequal function, deeply comparing the
// receiver with other. in must be non-nil.
func (in *CiliumVtepPolicySpec) DeepEqual(other *CiliumVtepPolicySpec) bool {
	if other == nil {
		return false
	}
	...
	if (in.ExternalVTEP == nil) != (other.ExternalVTEP == nil) {
		return false
	} else if in.ExternalVTEP != nil {
		if !in.ExternalVTEP.DeepEqual(other.ExternalVTEP) {
			return false
		}
	}
...
// DeepEqual is an autogenerated deepequal function, deeply comparing the
// receiver with other. in must be non-nil.
func (in *ExternalVTEP) DeepEqual(other *ExternalVTEP) bool {
	if other == nil {
		return false
	}
