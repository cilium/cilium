...
// DeepEqual is an autogenerated deepequal function, deeply comparing the
// receiver with other. in must be non-nil.
func (in *CiliumEnvoyExtProcFilter) DeepEqual(other *CiliumEnvoyExtProcFilter) bool {
	if other == nil {
		return false
	}
...
// DeepEqual is an autogenerated deepequal function, deeply comparing the
// receiver with other. in must be non-nil.
func (in *CiliumEnvoyExtProcFilterSpec) DeepEqual(other *CiliumEnvoyExtProcFilterSpec) bool {
	if other == nil {
		return false
	}

	if !in.BackendRef.DeepEqual(&other.BackendRef) {
		return false
	}

	if (in.ProcessingMode == nil) != (other.ProcessingMode == nil) {
		return false
	} else if in.ProcessingMode != nil {
		if !in.ProcessingMode.DeepEqual(other.ProcessingMode) {
			return false
		}
	}

	if in.FailureModeAllow != other.FailureModeAllow {
		return false
	}
	if (in.MessageTimeout == nil) != (other.MessageTimeout == nil) {
		return false
	} else if in.MessageTimeout != nil {
		if !in.MessageTimeout.DeepEqual(other.MessageTimeout) {
			return false
		}
	}
...
// DeepEqual is an autogenerated deepequal function, deeply comparing the
// receiver with other. in must be non-nil.
func (in *ExtProcBackendRef) DeepEqual(other *ExtProcBackendRef) bool {
	if other == nil {
		return false
	}
...
// DeepEqual is an autogenerated deepequal function, deeply comparing the
// receiver with other. in must be non-nil.
func (in *ExtProcProcessingMode) DeepEqual(other *ExtProcProcessingMode) bool {
	if other == nil {
		return false
	}

	if (in.RequestHeaderMode == nil) != (other.RequestHeaderMode == nil) {
		return false
	} else if in.RequestHeaderMode != nil {
		if *in.RequestHeaderMode != *other.RequestHeaderMode {
			return false
		}
	}

	if (in.ResponseHeaderMode == nil) != (other.ResponseHeaderMode == nil) {
		return false
	} else if in.ResponseHeaderMode != nil {
		if *in.ResponseHeaderMode != *other.ResponseHeaderMode {
			return false
		}
	}

	if (in.RequestBodyMode == nil) != (other.RequestBodyMode == nil) {
		return false
	} else if in.RequestBodyMode != nil {
		if *in.RequestBodyMode != *other.RequestBodyMode {
			return false
		}
	}

	if (in.ResponseBodyMode == nil) != (other.ResponseBodyMode == nil) {
		return false
	} else if in.ResponseBodyMode != nil {
		if *in.ResponseBodyMode != *other.ResponseBodyMode {
			return false
		}
	}

	if (in.RequestTrailerMode == nil) != (other.RequestTrailerMode == nil) {
		return false
	} else if in.RequestTrailerMode != nil {
		if *in.RequestTrailerMode != *other.RequestTrailerMode {
			return false
		}
	}

	if (in.ResponseTrailerMode == nil) != (other.ResponseTrailerMode == nil) {
		return false
	} else if in.ResponseTrailerMode != nil {
		if *in.ResponseTrailerMode != *other.ResponseTrailerMode {
			return false
		}
	}
