...
func (in *BGPCommunities) DeepCopyInto(out *BGPCommunities) {
	*out = *in
	...
	if in.Extended != nil {
		...
		*out = make([]BGPExtendedCommunity, len(*in))
		copy(*out, *in)
	}
	return
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *BGPExtendedCommunity) DeepCopyInto(out *BGPExtendedCommunity) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new BGPExtendedCommunity.
func (in *BGPExtendedCommunity) DeepCopy() *BGPExtendedCommunity {
	if in == nil {
		return nil
	}
	out := new(BGPExtendedCommunity)
	in.DeepCopyInto(out)
	return out
}
