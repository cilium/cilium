...
func (in *CiliumWorldCIDRSetSpec) DeepCopyInto(out *CiliumWorldCIDRSetSpec) {
	*out = *in
	if in.Encapsulate != nil {
		in, out := &in.Encapsulate, &out.Encapsulate
		*out = new(bool)
		**out = **in
	}
	if in.CIDRGroupRefs != nil {
		in, out := &in.CIDRGroupRefs, &out.CIDRGroupRefs
		*out = make([]api.CIDRGroupRef, len(*in))
		copy(*out, *in)
	}
	return
}
