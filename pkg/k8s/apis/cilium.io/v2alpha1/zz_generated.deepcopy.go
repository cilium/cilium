...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CiliumLoadBalancerIPCounts) DeepCopyInto(out *CiliumLoadBalancerIPCounts) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CiliumLoadBalancerIPCounts.
func (in *CiliumLoadBalancerIPCounts) DeepCopy() *CiliumLoadBalancerIPCounts {
	if in == nil {
		return nil
	}
	out := new(CiliumLoadBalancerIPCounts)
	in.DeepCopyInto(out)
	return out
}
...
func (in *CiliumLoadBalancerIPPoolStatus) DeepCopyInto(out *CiliumLoadBalancerIPPoolStatus) {
	*out = *in
	...
	if in.CIDRCounts != nil {
		in, out := &in.CIDRCounts, &out.CIDRCounts
		*out = make(map[string]CiliumLoadBalancerIPCounts, len(*in))
