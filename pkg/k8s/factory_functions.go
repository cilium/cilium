...
func listV1NetworkPolicies(client interface{}) func() (*versioned.ComparableMap, error) {
	...
	return func() (*versioned.ComparableMap, error) {
		vm := &versioned.ComparableMap{}
		...
		for {
			...
			for i := range list.Items {
				vm.Add(getVerStructFrom(&list.Items[i]))
			}
			if lo.Continue == "" {
				break
			}
...
func listV1Services(client interface{}) func() (*versioned.ComparableMap, error) {
	k8sClient, ok := client.(kubernetes.Interface)
	if !ok {
		log.Panicf("Invalid resource type %s: expecting 'kubernetes.Interface'", reflect.TypeOf(client))
	}
...
func listV1Endpoints(client interface{}) func() (*versioned.ComparableMap, error) {
	k8sClient, ok := client.(kubernetes.Interface)
	if !ok {
		log.Panicf("Invalid resource type %s: expecting 'kubernetes.Interface'", reflect.TypeOf(client))
	}
...
func listV1beta1Ingress(client interface{}) func() (*versioned.ComparableMap, error) {
	k8sClient, ok := client.(kubernetes.Interface)
	if !ok {
		log.Panicf("Invalid resource type %s: expecting 'kubernetes.Interface'", reflect.TypeOf(client))
	}
...
func listV2CNP(client interface{}) func() (*versioned.ComparableMap, error) {
...
func listV1Pod(client interface{}) func() (*versioned.ComparableMap, error) {
	k8sClient, ok := client.(kubernetes.Interface)
	if !ok {
		log.Panicf("Invalid resource type %s: expecting 'kubernetes.Interface'", reflect.TypeOf(client))
	}
...
func listV1Node(client interface{}) func() (*versioned.ComparableMap, error) {
	k8sClient, ok := client.(kubernetes.Interface)
	if !ok {
		log.Panicf("Invalid resource type %s: expecting 'kubernetes.Interface'", reflect.TypeOf(client))
	}
...
func listV1Namespace(client interface{}) func() (*versioned.ComparableMap, error) {
	k8sClient, ok := client.(kubernetes.Interface)
	if !ok {
		log.Panicf("Invalid resource type %s: expecting 'kubernetes.Interface'", reflect.TypeOf(client))
	}
