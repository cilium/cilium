...
// headless Services when enableHeadlessServiceWatch is true.
...
// Unlike kube-proxy Cilium also watches headless services and their endpoint slices when enableHeadlessServiceWatch is true.
