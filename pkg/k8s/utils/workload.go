...
// GetWorkloadFromPod heuristically derives workload metadata from the pod spec.
func GetWorkloadFromPod(pod *slim_corev1.Pod) (*models.Workload, bool) {
	if pod == nil {
		return nil, false
	}
	...
	// if the pod name was generated (or is scheduled for generation), we can begin an
	// investigation into the controlling reference for the pod.
	...
	return &models.Workload{
		...
		Name:      workloadObjectMeta.Name,
		Namespace: workloadObjectMeta.Namespace,
	}, true
}
