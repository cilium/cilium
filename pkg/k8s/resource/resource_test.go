...
func TestResource_Releasable(t *testing.T) {
	...
	// the store will be updated because the underlying informer is still alive thanks to the Events subscriber
	node = &corev1.Node{
		ObjectMeta: metav1.ObjectMeta{
	...
	// the underlying informer is now stopped and the store won't be updated anymore
