...
var endpointslicesResource = schema.GroupVersionResource{Group: "discovery", Version: "v1", Resource: "endpointslices"}

var endpointslicesKind = schema.GroupVersionKind{Group: "discovery", Version: "v1", Kind: "EndpointSlice"}
