...
func (in *ContainerStatus) DeepEqual(other *ContainerStatus) bool {
	...
	if !in.LastTerminationState.DeepEqual(&other.LastTerminationState) {
		return false
	}
	...
	if in.RestartCount != other.RestartCount {
		return false
	}
	if in.Image != other.Image {
		return false
	...
	if (in.Started == nil) != (other.Started == nil) {
		return false
	} else if in.Started != nil {
		if *in.Started != *other.Started {
			return false
		}
	}
