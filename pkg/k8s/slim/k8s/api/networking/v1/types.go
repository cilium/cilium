...
type IngressStatus struct {
	...
	// +optional
	LoadBalancer slim_corev1.LoadBalancerStatus `json:"loadBalancer,omitempty" protobuf:"bytes,1,opt,name=loadBalancer"`
}
...
type IngressBackend struct {
	...
	// +optional
	Resource *slim_corev1.TypedLocalObjectReference `json:"resource,omitempty" protobuf:"bytes,3,opt,name=resource"`
}
