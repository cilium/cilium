...
// DummyAnnotator is a placeholder annotator which does nothing.
type DummyAnnotator struct {
}

// AnnotatePod makes DummyAnnotator fulfill the Annotator interface. It does
// nothing.
func (d DummyAnnotator) AnnotatePod(k8sNamespace, k8sPodName, annotationKey, annotationValue string) error {
	return nil
}

// AnnotateNode makes DummyAnnotator fulfill the Annotator interface. It does
// nothing.
