...
const (
	...
	// BackendConditionServing is identical to ready except that it is set regardless of the
...
func ParseEndpointConditionsV1(conditions slim_discovery_v1.EndpointConditions) (bc BackendCondition) {
	...
	if (conditions.Serving == nil && bc.IsReady()) || (conditions.Serving != nil && *conditions.Serving) {
