...
func newFixture(t testing.TB) *fixture {
	...
	hive.New(
		...
		cell.Invoke(func(d *statedb.DB, t statedb.RWTable[*tables.L2AnnounceEntry], svcs_ statedb.RWTable[*loadbalancer.Service], fes_ statedb.RWTable[*loadbalancer.Frontend], h_ cell.Health, j job.Registry, jg_ job.Group) {
			db = d
			tbl = t
			jr = j
			jg = jg_
