...
func newTestData(t testing.TB) *testData {
	td := &testData{
		...
		repo:              NewPolicyRepository(nil, &fakeCertificateManager{}, envoypolicy.NewEnvoyL7RulesTranslator(hivetest.Logger(t), certificatemanager.NewMockSecretManagerInline()), nil, api.NewPolicyMetricsNoop()),
		testPolicyContext: &testPolicyContextType{},
	}
