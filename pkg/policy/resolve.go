...
// NewIdentityPolicy returns an empty IdentityPolicy stub.
func NewIdentityPolicy() *IdentityPolicy {
	return &IdentityPolicy{}
}

// DistillPolicy filters down the specified IdentityPolicy (which acts upon
...
func (p *IdentityPolicy) DistillPolicy(policyOwner PolicyOwner, identityCache cache.IdentityCache) *EndpointPolicy {
...
func NewEndpointPolicy() *EndpointPolicy {
	return &EndpointPolicy{
		IdentityPolicy: NewIdentityPolicy(),
	}
}
...
func (p *IdentityPolicy) Realizes(desired *IdentityPolicy) {
	if p == nil {
		p = &IdentityPolicy{}
	}
...
func (p *EndpointPolicy) Realizes(desired *EndpointPolicy) {
	...
	p.IdentityPolicy.Realizes(desired.IdentityPolicy)
