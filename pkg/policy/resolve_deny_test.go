...
func (ds *PolicyTestSuite) TestMapStateWithIngressDenyWildcard(c *C) {
	...
	rule1MapStateEntry := NewMapStateEntry(wildcardCachedSelector, labels.LabelArrayList{ruleLabel}, 0, "", true, DefaultAuthType, AuthTypeDisabled)
...
func (ds *PolicyTestSuite) TestMapStateWithIngressDeny(c *C) {
	...
	rule1MapStateEntry := NewMapStateEntry(cachedSelectorTest, labels.LabelArrayList{ruleLabel}, 0, "", true, DefaultAuthType, AuthTypeDisabled)
	allowEgressMapStateEntry := NewMapStateEntry(nil, labels.LabelArrayList{ruleLabelAllowAnyEgress}, 0, "", false, ExplicitAuthType, AuthTypeDisabled)
