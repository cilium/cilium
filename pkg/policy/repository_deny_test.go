...
func TestWildcardL4RulesIngressDeny(t *testing.T) {
	...
	expectedDenyPolicy := NewL4PolicyMapWithValues(map[string]*L4Filter{
		"80/TCP": {
			...
			RuleOrigin: map[CachedSelector]labels.LabelArrayList{td.cachedSelectorB: {labelsL4HTTP}},
		},
		"9092/TCP": {
			Port:     9092,
			Protocol: api.ProtoTCP,
			...
			RuleOrigin: map[CachedSelector]labels.LabelArrayList{td.cachedSelectorB: {labelsL4Kafka}},
		},
	})
...
func TestWildcardL3RulesEgressDeny(t *testing.T) {
	...
	expectedDenyPolicy := NewL4PolicyMapWithValues(map[string]*L4Filter{
		"0/ANY": {
			...
			Ingress:    false,
			RuleOrigin: map[CachedSelector]labels.LabelArrayList{td.cachedSelectorB: {labelsL4}},
		},
		"8/ICMP": {
			Port:     8,
			...
			Ingress:    false,
			RuleOrigin: map[CachedSelector]labels.LabelArrayList{td.cachedSelectorB: {labelsICMP}},
		},
		"128/ICMPV6": {
			Port:     128,
			...
			Ingress:    false,
			RuleOrigin: map[CachedSelector]labels.LabelArrayList{td.cachedSelectorB: {labelsICMPv6}},
		},
	})
...
func TestWildcardL4RulesEgressDeny(t *testing.T) {
	...
	expectedDenyPolicy := NewL4PolicyMapWithValues(map[string]*L4Filter{
		"80/TCP": {
			...
			RuleOrigin: map[CachedSelector]labels.LabelArrayList{td.cachedSelectorB: {labelsL3HTTP}},
		},
		"53/UDP": {
			Port:     53,
			...
			RuleOrigin: map[CachedSelector]labels.LabelArrayList{td.cachedSelectorB: {labelsL3DNS}},
		},
	})
