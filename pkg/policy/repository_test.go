...
func (ds *PolicyTestSuite) TestComputePolicyEnforcementAndRules(c *C) {
	...
	_, numDeleted := repo.DeleteByLabelsLocked(labels.LabelArray{fooIngressRule1Label}, map[uint16]*identity.Identity{}, NewIdSet(), &sync.WaitGroup{})
	...
	_, numDeleted = repo.DeleteByLabelsLocked(labels.LabelArray{fooIngressRule2Label}, map[uint16]*identity.Identity{}, NewIdSet(), &sync.WaitGroup{})
	c.Assert(numDeleted, Equals, 1)
	...
	_, numDeleted = repo.DeleteByLabelsLocked(labels.LabelArray{fooEgressRule1Label}, map[uint16]*identity.Identity{}, NewIdSet(), &sync.WaitGroup{})
	c.Assert(numDeleted, Equals, 1)
	...
	_, numDeleted = repo.DeleteByLabelsLocked(labels.LabelArray{fooEgressRule2Label}, map[uint16]*identity.Identity{}, NewIdSet(), &sync.WaitGroup{})
	c.Assert(numDeleted, Equals, 1)
	...
	_, numDeleted = repo.DeleteByLabelsLocked(labels.LabelArray{combinedLabel}, map[uint16]*identity.Identity{}, NewIdSet(), &sync.WaitGroup{})
	c.Assert(numDeleted, Equals, 1)
