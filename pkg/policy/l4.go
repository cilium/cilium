...
type L4Filter struct {
	...
	// Concurrent access is governed by the mutex in the L4Policy containing this.
	policy *L4Policy
}
...
// AccumulateMapChanges distriburtes the given changes to the registered users.
func (l4 *L4Policy) AccumulateMapChanges(adds, deletes []identity.NumericIdentity,
	...
	if l4 == nil {
		log.Warning("L4Filter: Skipping incremental updates due to nil policy pointer")
		return
	}
