...
func (l4 *L4Filter) ToKeys(filter *L4Filter, direction trafficdirection.TrafficDirection, identityCache cache.IdentityCache, deniedIdentities cache.IdentityCache) []Key {
	keysToAdd := []Key{}
