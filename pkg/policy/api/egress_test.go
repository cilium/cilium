...
func (s *PolicyAPITestSuite) TestHasChildRuleWithoutToGroups(c *C) {
	eg := EgressRule{}
	c.Assert(eg.RequiresDerivative(), Equals, false)
}

func (s *PolicyAPITestSuite) TestHasChildRuleWitToGroups(c *C) {
	eg := EgressRule{}
	c.Assert(eg.RequiresDerivative(), Equals, false)
}

func (s *PolicyAPITestSuite) TestCreateChildRuleWithoutToGroups(c *C) {
	eg := &EgressRule{
...
func (s *PolicyAPITestSuite) TestCreateChildRuleWithToGroupsWitInvalidRegisterCallback(c *C) {
...
func (s *PolicyAPITestSuite) TestCreateChildRuleWithToGroupsAndToPorts(c *C) {
	...
	// Checking that the child is working correctly
