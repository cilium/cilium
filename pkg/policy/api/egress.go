...
func (in *EgressCommonRule) DeepEqual(other *EgressCommonRule) bool {
	if in.ToEndpoints == nil && other.ToEndpoints != nil ||
		in.ToEndpoints != nil && other.ToEndpoints == nil {
		return false
	}
	if in.ToCIDR == nil && other.ToCIDR != nil ||
		in.ToCIDR != nil && other.ToCIDR == nil {
		return false
	}
	if in.ToCIDRSet == nil && other.ToCIDRSet != nil ||
		in.ToCIDRSet != nil && other.ToCIDRSet == nil {
		return false
	}
	if in.ToEntities == nil && other.ToEntities != nil ||
		in.ToEntities != nil && other.ToEntities == nil {
		return false
	}
