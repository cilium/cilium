...
func (s *PolicyAPITestSuite) TestK8sServiceNamespaceMatches(c *C) {
	...
	tests := []testDef{
		{
			id:           K8sServiceIdentifier{K8sServiceNamespace{"svc1", "default"}, map[string]string{"foo": "bar"}},
			sel:          K8sServiceNamespace{ServiceName: "svc1", Namespace: "default"},
			expectResult: true,
		},
		{
			id:           K8sServiceIdentifier{K8sServiceNamespace{"svc2", "default"}, map[string]string{"foo": "bar"}},
			sel:          K8sServiceNamespace{ServiceName: "svc1", Namespace: "default"},
			expectResult: false,
		},
		{
			id:           K8sServiceIdentifier{K8sServiceNamespace{"svc1", "other"}, map[string]string{"foo": "bar"}},
			sel:          K8sServiceNamespace{ServiceName: "svc1", Namespace: "default"},
			expectResult: false,
		},
		{
...
func (s *PolicyAPITestSuite) TestK8sServiceSelectorNamespaceMatches(c *C) {
	...
	tests := []testDef{
		...
		{
			id:           K8sServiceIdentifier{K8sServiceNamespace{"svc1", "default"}, map[string]string{"foo": "bar", "foo2": "bar"}},
			sel:          K8sServiceSelectorNamespace{Namespace: "default", Selector: newServiceSelectorFromMatchLabels(map[string]string{"foo": "bar"})},
			expectResult: true,
		},
		{
		...
		{
			id:           K8sServiceIdentifier{K8sServiceNamespace{"svc1", "default2"}, map[string]string{"foo": "bar"}},
			sel:          K8sServiceSelectorNamespace{Namespace: "default", Selector: newServiceSelectorFromMatchLabels(map[string]string{"foo": "bar"})},
			expectResult: false,
		},
		{
