...
func TestEndpointSelectorMarshalling(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			sanitizedExepected: EndpointSelector{
				LabelSelector:     &slim_metav1.LabelSelector{},
				cachedSelectorKey: "&LabelSelector{MatchLabels:map[string]string{},MatchExpressions:[]LabelSelectorRequirement{},}",
				Generated:         false,
			},
			sanitizedOutputJSON: `{}`,
			expectedErr:         false,
		},
		{
			...
			sanitizedExepected: EndpointSelector{
				...
				cachedSelectorKey: "&LabelSelector{MatchLabels:map[string]string{any:app: frontend,},MatchExpressions:[]LabelSelectorRequirement{},}",
				Generated:         false,
			},
		...
		},
		{
			...
			sanitizedExepected: EndpointSelector{
				...
				cachedSelectorKey: "&LabelSelector{MatchLabels:map[string]string{k8s:app: frontend,},MatchExpressions:[]LabelSelectorRequirement{},}",
				Generated:         false,
			},
		...
		},
		{
			...
			sanitizedExepected: EndpointSelector{
				...
				cachedSelectorKey: "&LabelSelector{MatchLabels:map[string]string{},MatchExpressions:[]LabelSelectorRequirement{LabelSelectorRequirement{Key:any:role,Operator:In,Values:[database],},},}",
				Generated:         false,
			},
		...
		},
		{
			...
			sanitizedExepected: EndpointSelector{
				...
				cachedSelectorKey: "&LabelSelector{MatchLabels:map[string]string{},MatchExpressions:[]LabelSelectorRequirement{LabelSelectorRequirement{Key:k8s:role,Operator:In,Values:[database],},},}",
				Generated:         false,
			},
		...
		},
		{
			...
			sanitizedExepected: EndpointSelector{
				...
				cachedSelectorKey: "&LabelSelector{MatchLabels:map[string]string{any:app: frontend,},MatchExpressions:[]LabelSelectorRequirement{LabelSelectorRequirement{Key:any:role,Operator:In,Values:[database],},},}",
				Generated:         false,
			},
		...
		},
		{
			...
			sanitizedExepected: EndpointSelector{
				...
				cachedSelectorKey: "&LabelSelector{MatchLabels:map[string]string{k8s:app: frontend,},MatchExpressions:[]LabelSelectorRequirement{LabelSelectorRequirement{Key:k8s:role,Operator:In,Values:[database],},},}",
				Generated:         false,
			},
		...
		},
		{
			...
			sanitizedExepected: EndpointSelector{
				...
				cachedSelectorKey: "&LabelSelector{MatchLabels:map[string]string{k8s:app: frontend,},MatchExpressions:[]LabelSelectorRequirement{LabelSelectorRequirement{Key:any:role,Operator:In,Values:[database],},},}",
				Generated:         false,
			},
