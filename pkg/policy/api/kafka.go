...
// RoleToAPIKeys returns the KafkaRole corresponding to the role specified within
// the provided PortRuleKafka, or an error if the role within the PortRuleKafka
// is invalid.
