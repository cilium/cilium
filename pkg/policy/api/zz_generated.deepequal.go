...
func (in *AWSGroup) DeepEqual(other *AWSGroup) bool {
	...
	if (in.ManagedPrefixList == nil) != (other.ManagedPrefixList == nil) {
		return false
	} else if in.ManagedPrefixList != nil {
		if !in.ManagedPrefixList.DeepEqual(other.ManagedPrefixList) {
			return false
		}
	}
...
// DeepEqual is an autogenerated deepequal function, deeply comparing the
// receiver with other. in must be non-nil.
func (in *AWSManagedPrefixList) DeepEqual(other *AWSManagedPrefixList) bool {
	if other == nil {
		return false
	}

	if ((in.IDs != nil) && (other.IDs != nil)) || ((in.IDs == nil) != (other.IDs == nil)) {
		in, other := &in.IDs, &other.IDs
		if other == nil {
			return false
		}
	...
	if ((in.Names != nil) && (other.Names != nil)) || ((in.Names == nil) != (other.Names == nil)) {
		in, other := &in.Names, &other.Names
		if other == nil {
			return false
		}
	...
	if ((in.OwnerIDs != nil) && (other.OwnerIDs != nil)) || ((in.OwnerIDs == nil) != (other.OwnerIDs == nil)) {
		in, other := &in.OwnerIDs, &other.OwnerIDs
		if other == nil {
			return false
		}
