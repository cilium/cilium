...
func (in *EgressCommonRule) deepEqual(other *EgressCommonRule) bool {
	...
	if ((in.IPProtocols != nil) && (other.IPProtocols != nil)) || ((in.IPProtocols == nil) != (other.IPProtocols == nil)) {
		in, other := &in.IPProtocols, &other.IPProtocols
		if other == nil || !in.DeepEqual(other) {
			return false
		}
	}
...
// DeepEqual is an autogenerated deepequal function, deeply comparing the
// receiver with other. in must be non-nil.
func (in *IPProtocol) DeepEqual(other *IPProtocol) bool {
	if other == nil {
		return false
	}
...
// DeepEqual is an autogenerated deepequal function, deeply comparing the
// receiver with other. in must be non-nil.
func (in *IPProtocols) DeepEqual(other *IPProtocols) bool {
	if other == nil {
		return false
	}
