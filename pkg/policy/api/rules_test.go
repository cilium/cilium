	...
	tests := []struct {
	...
	}{
		{
			...
			rs: Rules{
				...
				{
					Labels: labels.ParseLabelArrayFromArray([]string{"foo=bar", "foo=baz"}),
				},
				{
					Labels: labels.ParseLabelArrayFromArray([]string{"foo=baz", "foo=bar"}),
				},
				{
					Labels: labels.ParseLabelArrayFromArray([]string{"foo=baz"}),
				},
			...
			want: []labels.LabelArray{
				...
				labels.ParseLabelArrayFromArray([]string{"foo=bar", "foo=baz"}),
				labels.ParseLabelArrayFromArray([]string{"foo=baz", "foo=bar"}),
			},
		},
	}
