...
func (in *IngressCommonRule) DeepEqual(other *IngressCommonRule) bool {
	if in.FromEndpoints == nil && other.FromEndpoints != nil ||
		in.FromEndpoints != nil && other.FromEndpoints == nil {
		return false
	}
	if in.FromCIDR == nil && other.FromCIDR != nil ||
		in.FromCIDR != nil && other.FromCIDR == nil {
		return false
	}
	if in.FromCIDRSet == nil && other.FromCIDRSet != nil ||
		in.FromCIDRSet != nil && other.FromCIDRSet == nil {
		return false
	}
	if in.FromEntities == nil && other.FromEntities != nil ||
		in.FromEntities != nil && other.FromEntities == nil {
		return false
	}
