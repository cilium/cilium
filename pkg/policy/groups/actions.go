...
// any rule that need to create a new derivative policy(eg: ToGroups). In case
// that the newCNP will not have any derivative policy and the old one had one,
// it'll delete the old policy.
