...
// UpdateDerivativerenCNPIfNeeded will update or create a  CNP if the given CNP has
...
// old policy.
func UpdateDerivativerenCNPIfNeeded(newCNP *cilium_v2.CiliumNetworkPolicy, oldCNP *cilium_v2.CiliumNetworkPolicy) bool {
