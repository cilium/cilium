...
// PolicyLocalClusterName returns what should be considered the local cluster
// name in network policies
func (p PolicyConfig) PolicyLocalClusterName(localClusterName string) string {
	if p.PolicyDefaultLocalCluster {
