...
func (rc *remoteCluster) restartRemoteConnection(allocator RemoteIdentityWatcher, ipc *ipcache.IPCache) {
...
func (rc *remoteCluster) onInsert(allocator RemoteIdentityWatcher, ipc *ipcache.IPCache) {
