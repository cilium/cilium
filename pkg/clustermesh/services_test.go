...
func (s *ClusterMeshServicesTestSuite) TestClusterMeshServicesGlobal(c *C) {
	...
	s.expectEvent(c, k8s.UpdateService, svcID, func(event k8s.ServiceEvent) bool {
		return event.Endpoints.Backends[cmtypes.NewIPCluster("10.0.185.196", 0)] != nil &&
			event.Endpoints.Backends[cmtypes.NewIPCluster("20.0.185.196", 0)] != nil
	})
	...
	s.expectEvent(c, k8s.UpdateService, svcID, func(event k8s.ServiceEvent) bool {
		return event.Endpoints.Backends[cmtypes.NewIPCluster("30.0.185.196", 0)] != nil
	})
...
func (s *ClusterMeshServicesTestSuite) TestClusterMeshServicesUpdate(c *C) {
	...
	s.expectEvent(c, k8s.UpdateService, svcID, func(event k8s.ServiceEvent) bool {
		return event.Endpoints.Backends[cmtypes.NewIPCluster("10.0.185.196", 0)] != nil &&
			event.Endpoints.Backends[cmtypes.NewIPCluster("10.0.185.196", 0)].Ports["http"].DeepEqual(
				loadbalancer.NewL4Addr(loadbalancer.TCP, 80)) &&
			event.Endpoints.Backends[cmtypes.NewIPCluster("20.0.185.196", 0)] != nil &&
			event.Endpoints.Backends[cmtypes.NewIPCluster("20.0.185.196", 0)].Ports["http2"].DeepEqual(
	...
	kvstore.Client().Set(context.TODO(), k, []byte(v))
	s.expectEvent(c, k8s.UpdateService, svcID, func(event k8s.ServiceEvent) bool {
		return event.Endpoints.Backends[cmtypes.NewIPCluster("80.0.185.196", 0)] != nil &&
			event.Endpoints.Backends[cmtypes.NewIPCluster("20.0.185.196", 0)] != nil
	})
	...
	s.expectEvent(c, k8s.UpdateService, svcID, func(event k8s.ServiceEvent) bool {
		return event.Endpoints.Backends[cmtypes.NewIPCluster("80.0.185.196", 0)] != nil &&
			event.Endpoints.Backends[cmtypes.NewIPCluster("90.0.185.196", 0)] != nil
	})
