...
func (p *Proxy) UpdateNetworkPolicy(ipv6 addressing.CiliumIPv6, ipv4 addressing.CiliumIPv4, id identityPkg.NumericIdentity, policy *policy.L4Policy,
	...
	return envoy.UpdateNetworkPolicy(ipv6, ipv4, id, policy, labelsMap, deniedIngressIdentities, deniedEgressIdentities)
}

// RemoveNetworkPolicy removes a network policy from the set published to
// L7 proxies.
func (p *Proxy) RemoveNetworkPolicy(ipv6 addressing.CiliumIPv6, ipv4 addressing.CiliumIPv4) {
	envoy.RemoveNetworkPolicy(ipv6, ipv4)
}
