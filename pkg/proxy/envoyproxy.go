...
func (p *envoyProxyIntegration) createRedirect(r *Redirect, wg *completion.WaitGroup, cb func(err error)) RedirectImplementation {
	...
	p.xdsServer.AddListener(redirect.listenerName, policy.L7ParserType(l.ProxyType), l.ProxyPort, l.Ingress, mayUseOriginalSourceAddr, wg, cb)
