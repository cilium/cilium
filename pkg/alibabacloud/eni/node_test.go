...
func TestCandidateAndEmtpyInterfaces(t *testing.T) {
	setup(t)
...
func TestPrepareIPAllocation(t *testing.T) {
	...
	require.NoError(t, err)
	require.Equal(t, 0, a.IPv4.InterfaceCandidates, fmt.Sprintf("empty: %v, candidates: %v", a.EmptyInterfaceSlots, a.IPv4.InterfaceCandidates))
