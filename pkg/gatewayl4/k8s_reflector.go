...
type gatewayL4FeatureConfig struct {
	cell.In

	Config envoyconfig.SecretSyncConfig
}

func gatewayL4ListerWatchers(cs client.Clientset, featureCfg gatewayL4FeatureConfig) (out struct {
	cell.Out
	LW listerWatchers
},
) {
	if cs.IsEnabled() && featureCfg.Config.EnableGatewayAPI {
...
func registerGatewayL4K8sReflector(
	featureCfg gatewayL4FeatureConfig,
	...
	if !featureCfg.Config.EnableGatewayAPI || lws.gatewayL4 == nil {
		return nil
	}
