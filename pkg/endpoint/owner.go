...
type Owner interface {
	...
	// The redirect port is returned via the 'acked' callback if the update succeeds.
	UpdateProxyRedirect(e *Endpoint, l4 *policy.L4Filter, proxyWaitGroup *completion.WaitGroup, acked func(redirectPort uint16), nacked func(error)) error
