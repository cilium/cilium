...
func TestReadEPsFromDirNames(t *testing.T) {
	...
	eps := ReadEPsFromDirNames(context.TODO(), s, nil, nil, s.orchestrator, nil, nil, nil, nil, nil, s, s, tmpDir, epsNames)
...
func TestReadEPsFromDirNamesWithRestoreFailure(t *testing.T) {
	...
	epResult := ReadEPsFromDirNames(context.TODO(), s, nil, nil, s.orchestrator, nil, nil, nil, nil, nil, s, s, tmpDir, epNames)
