...
func (e *Endpoint) GetPolicyModel() *models.EndpointPolicyStatus {
	...
	policyEnabled := e.GetPolicyStatus()
...
// GetPolicyStatus returns the endpoint's policy status
//
// Must be called with e.Mutex locked.
func (e *Endpoint) GetPolicyStatus() models.EndpointPolicyEnabled {
...
func (e *Endpoint) LeaveLocked(owner Owner, proxyWaitGroup *completion.WaitGroup) []error {
	...
	epdpointPolicyStatus.DeleteEndpoint(e.ID)
