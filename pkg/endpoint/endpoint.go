...
// RunLabelsResolver starts a controller associated with the received endpoint
// which will periodically attempt to resolve the metadata for the endpoint and
// update the endpoint with the related. It stops resolving after either the
// first successful metadata resolution or when the endpoint is removed.
//
