...
type Endpoint struct {
	...
	// buildStatus contains the building information and current status
...
func (e *Endpoint) updateState() {
	...
	case !e.buildStatus.initialSuccessful && e.restoredFromState:
	...
	case !e.buildStatus.initialSuccessful:
	...
	case e.buildStatus.numWaiting > 0:
...
//
// Required to implement the buildqueue.Buildable interface
