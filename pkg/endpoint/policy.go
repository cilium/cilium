...
// RegenerateSync regenerates the endpoint and returns a channel that is closed
// when the regeneration of the endpoint is complete. The channel returns:
...
func (e *Endpoint) RegenerateSync(owner regeneration.Owner, regenMetadata *regeneration.ExternalRegenerationMetadata) <-chan bool {
	if err := e.LockAlive(); err != nil {
