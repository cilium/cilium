...
func (e *Endpoint) regeneratePolicy(owner Owner, opts models.ConfigurationMap) (bool, error) {
	...
	optsChanged := e.updateEndpointOptions(owner, opts)
...
// updateEndpointOptions updates the boolean configuration options for the endpoint
...
// Must be called with endpoint mutex held.
func (e *Endpoint) updateEndpointOptions(owner Owner, opts models.ConfigurationMap) (optsChanged bool) {
	if opts == nil {
