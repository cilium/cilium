...
func (e *Endpoint) realizeBPFState(regenContext *regenerationContext) (compilationExecuted bool, err error) {
	...
	if datapathRegenCtxt.regenerationLevel > regeneration.RegenerateWithoutDatapath {
		...
		if datapathRegenCtxt.regenerationLevel == regeneration.RegenerateWithDatapathRebuild {
			err = e.Loader.CompileAndLoad(datapathRegenCtxt.completionCtx, datapathRegenCtxt.epInfoCache, &stats.datapathRealization)
			...
			err = e.Loader.CompileOrLoad(datapathRegenCtxt.completionCtx, datapathRegenCtxt.epInfoCache, &stats.datapathRealization)
			if err == nil {
			...
			err = e.Loader.ReloadDatapath(datapathRegenCtxt.completionCtx, datapathRegenCtxt.epInfoCache, &stats.datapathRealization)
			if err == nil {
...
func (e *Endpoint) runPreCompilationSteps(regenContext *regenerationContext) (preCompilationError error) {
	...
	var changed bool
	datapathRegenCtxt.bpfHeaderfilesHash, err = e.Loader.EndpointHash(e)
	if err != nil {
...
func (e *Endpoint) DeleteBPFProgramLocked() error {
	...
	return e.Loader.DeleteDatapath(context.TODO(), e.IfName, "ingress")
}
