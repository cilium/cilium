...
// is cleaner.
type EndpointSynchronzier struct{}
...
var (
	...
	log = logging.DefaultLogger.WithField(logfields.LogSubsys, "endpoint-kubernetes-interaction")
)
...
// CiliumEndpoint objects have the same name as the pod they represent
func (epSync *EndpointSynchronzier) RunK8sCiliumEndpointSync(e *endpoint.Endpoint) {
	var (
		endpointID     = e.ID
