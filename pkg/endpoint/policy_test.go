...
func TestIncrementalUpdatesDuringPolicyGeneration(t *testing.T) {
	...
	repo := policy.NewPolicyRepository(logger, cmtypes.DefaultClusterInfo.ID, fakeAllocator.GetIdentityCache().ToOld(), nil, nil, idManager, testpolicy.NewPolicyMetricsNoop())
