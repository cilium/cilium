...
func InstallRules(ifName string) error {
	...
	matchFromIPSecEncrypt := fmt.Sprintf("%#08x/%#08x", linux.RouteMarkDecrypt, linux.RouteMarkMask)
	matchFromIPSecDecrypt := fmt.Sprintf("%#08x/%#08x", linux.RouteMarkEncrypt, linux.RouteMarkMask)
