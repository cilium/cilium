...
// TestPrivilegedReloadSourceExclusionMaps verifies that reloadSourceExclusionMaps initializes,
// reconciles deletions, and inserts CIDRs into NAT exclusion maps according to LocalNodeConfiguration.
func TestPrivilegedReloadSourceExclusionMaps(t *testing.T) {
	initBpffs(t)
	...
	require.NoError(t, reloadSourceExclusionMaps(logger, &lnc))
