...
// TestPrivilegedReloadNatExclusionMaps verifies that reloadNatExclusionMaps initializes,
// reconciles deletions, and inserts CIDRs into NAT exclusion maps according to LocalNodeConfiguration.
func TestPrivilegedReloadNatExclusionMaps(t *testing.T) {
	initBpffs(t)
	...
	require.NoError(t, reloadNatExclusionMaps(logger, &lnc))
	...
	require.NotNil(t, nat.NatExclusionMapIPv4)
	require.NotNil(t, nat.NatExclusionMapIPv6)
	require.True(t, nat.NatExclusionMapIPv4.CIDRExists(*v4a))
	require.True(t, nat.NatExclusionMapIPv6.CIDRExists(*v6a))
	...
	require.False(t, nat.NatExclusionMapIPv4.CIDRExists(*v4a))
	require.True(t, nat.NatExclusionMapIPv4.CIDRExists(*v4b))
	require.True(t, nat.NatExclusionMapIPv6.CIDRExists(*v6a))
}
