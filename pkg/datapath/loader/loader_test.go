...
func TestReload(t *testing.T) {
	...
	for range 2 {
		...
		require.NoError(t, attachSKBProgram(logger, l, coll.Programs[symbolFromEndpoint], symbolFromEndpoint, tmp, netlink.HANDLE_MIN_INGRESS, true))
		require.NoError(t, attachSKBProgram(logger, l, coll.Programs[symbolToEndpoint], symbolToEndpoint, tmp, netlink.HANDLE_MIN_EGRESS, true))
