...
// an endpoint.
var epConfigs funcRegistry[epConfigFunc]

// epConfigFunc is a function type that generates BPF configuration data for an
// endpoint. It should return a structure generated by dpgen.
type epConfigFunc func(datapath.EndpointConfiguration, *datapath.LocalNodeConfiguration) any

// endpointConfiguration returns a slice of endpoint configuration objects
// yielded by all registered config providers.
func endpointConfiguration(ep datapath.EndpointConfiguration, lnc *datapath.LocalNodeConfiguration) []any {
	var configs []any
