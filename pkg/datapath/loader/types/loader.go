...
type Loader interface {
	...
	Reinitialize(ctx context.Context, previousCfg, cfg *config.Config, tunnelConfig tunnel.Config, iptMgr iptables.Manager, p proxy.Proxy, bigtcp bigtcp.Config) error
