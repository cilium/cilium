...
// GetHardwareName returns hardware name on this host as 'uname -m'.
...
func progCFlags(prog *progInfo, dir *directoryInfo) []string {
	...
	if err == nil && strings.Contains(hardwarename, "aarch64") {
		testIncludes = append(testIncludes, "-I/usr/include/aarch64-linux-gnu/")
	}
