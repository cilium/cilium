...
func (l *Loader) CompileBasePrograms(o datapath.BaseProgramOwner, deviceMTU int, iptMgr datapath.RulesManager, p datapath.Proxy, r datapath.RouteReserver) error {
	var args []string
	var mode string
	var ret error
