...
// LoadSockTerm configures and loads the cil_sock_udp_destroy program.
// mapPinPath specifies the pin path for the cilium_lb4_reverse_sk and
// cilium_lb4_reverse_sk maps. If mapPinPath is empty, it uses the default pin
// path.
func LoadSockTerm(mapPinPath string) (*ebpf.Program, error) {
