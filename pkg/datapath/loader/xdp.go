...
func xdpConfigModeToFlag(xdpMode xdp.TCMode) link.XDPAttachFlags {
	switch xdpMode {
	case xdp.TCModeLinkDriver:
		return link.XDPDriverMode
	case xdp.TCModeLinkGeneric:
...
// during tests.
func (l *loader) maybeUnloadObsoleteXDPPrograms(xdpDevs []string, xdpMode xdp.TCMode, bpffsBase string) {
...
func compileAndLoadXDPProg(ctx context.Context, xdpDev string, xdpMode xdp.TCMode, extraCArgs []string) error {
