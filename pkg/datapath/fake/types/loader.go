...
func (f *FakeLoader) EndpointHash(cfg endpoint.Config, _ *datapath.LocalNodeConfiguration) (string, error) {
	panic("implement me")
}
...
func (f *FakeLoader) Reinitialize(ctx context.Context, lnc *datapath.LocalNodeConfiguration, tunnelConfig tunnel.Config, iptMgr datapath.IptablesManager, p datapath.Proxy, bigtcp bigtcp.Configuration) error {
	return nil
}
...
func (f *FakeLoader) WriteEndpointConfig(w io.Writer, e endpoint.Config, lnc *datapath.LocalNodeConfiguration) error {
	return nil
}
