...
// them.
func NewMapSweeper(defaultLogger *slog.Logger, g endpointManager, bwm dptypes.BandwidthManager, lbConfig loadbalancer.Config, kprOpts kpr.KPROpts) *MapSweeper {
	return &MapSweeper{
