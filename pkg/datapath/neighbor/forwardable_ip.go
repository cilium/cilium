...
func newForwardableIPTable(db *statedb.DB) (*ForwardableIPManager, statedb.Table[*ForwardableIP], error) {
	...
	return &ForwardableIPManager{db: db, table: tbl}, tbl, db.RegisterTable(tbl)
}
