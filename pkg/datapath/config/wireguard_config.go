...
type BPFWireguard struct {
	...
	// First 32 bytes of the MAC address of the interface the bpf program is
	// attached to.
	InterfaceMAC1 uint32 `config:"interface_mac_1"`
	// Second 16 bytes of the MAC address of the interface the bpf program is
	// attached to.
...
func NewBPFWireguard() *BPFWireguard {
	return &BPFWireguard{0x5dc,0x0,0x0,0x0,0x0,0x0,0x0}
}
