...
type BPFWireguard struct {
	...
	// Pass traffic with unknown protocols.
	EnableUnknownProtocols bool `config:"enable_unknown_protocols"`
...
func NewBPFWireguard(node Node) *BPFWireguard {
	return &BPFWireguard{0x5dc, false, 0x0, [8]byte{0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0},
