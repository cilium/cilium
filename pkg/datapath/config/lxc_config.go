...
type BPFLXC struct {
	...
	EnableFullSocketLb bool `config:"enable_full_socket_lb"`
	...
	EnablePerPacketLb bool `config:"enable_per_packet_lb"`
...
func NewBPFLXC(node Node) *BPFLXC {
	return &BPFLXC{0x5dc, false, false, false, false, false, 0x0, [4]byte{0x0, 0x0, 0x0, 0x0},
