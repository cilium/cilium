...
func (in *Config) deepEqual(other *Config) bool {
	...
	if !in.VLANFilter.DeepEqual(&other.VLANFilter) {
		return false
	}
...
// DeepEqual is an autogenerated deepequal function, deeply comparing the
// receiver with other. in must be non-nil.
func (in *VLANFilter) DeepEqual(other *VLANFilter) bool {
	if other == nil {
		return false
	}

	if ((in.Entries != nil) && (other.Entries != nil)) || ((in.Entries == nil) != (other.Entries == nil)) {
		in, other := &in.Entries, &other.Entries
		if other == nil {
			return false
		}
...
// DeepEqual is an autogenerated deepequal function, deeply comparing the
// receiver with other. in must be non-nil.
func (in *VLANFilterEntry) DeepEqual(other *VLANFilterEntry) bool {
	if other == nil {
		return false
	}
