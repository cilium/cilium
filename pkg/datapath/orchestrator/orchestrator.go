...
func newOrchestrator(params orchestratorParams) *orchestrator {
	...
	group := params.JobRegistry.NewGroup(params.Scope)
...
func (o *orchestrator) reconciler(ctx context.Context, health cell.HealthReporter) error {
...
func (o *orchestrator) CompileAndLoad(ctx context.Context, ep datapath.Endpoint, stats *metrics.SpanStat) error {
	<-o.dbInitialized
	return o.params.Loader.CompileAndLoad(ctx, ep, o.devices, stats)
}

func (o *orchestrator) CompileOrLoad(ctx context.Context, ep datapath.Endpoint, stats *metrics.SpanStat) error {
	<-o.dbInitialized
	return o.params.Loader.CompileOrLoad(ctx, ep, o.devices, stats)
}
