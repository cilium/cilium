...
func TestConfig(t *testing.T) {
	...
	var (
		dcIPv46 = &option.DaemonConfig{EnableIPv4: true, EnableIPv6: true}
		dcIPv4  = &option.DaemonConfig{EnableIPv4: true, EnableIPv6: false}
	)
	...
	tests := []struct {
		...
		{
			name:           "tunnel enabled, vxlan, alt underlay",
