...
type LocalNodeConfiguration struct {
	...
	// DisableLocalNodeRoute disables installation of the route which
	// points the allocation prefix of the local node. Use of this option
	// is useful when another component is responsible for the routing of
	// the allocation CIDR IPs into Cilium endpoints.
	DisableLocalNodeRoute bool
}
