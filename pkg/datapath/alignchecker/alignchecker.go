...
func CheckStructAlignments(path string) error {
	...
	toCheck := map[string][]reflect.Type{
		...
		"lb4_key_v2":           {reflect.TypeOf(lbmap.Service4Key{})},
		"lb4_service_v2":       {reflect.TypeOf(lbmap.Service4Value{})},
		"lb4_backend":          {reflect.TypeOf(lbmap.Backend4Value{})},
		"lb6_key_v2":           {reflect.TypeOf(lbmap.Service6Key{})},
		"lb6_service_v2":       {reflect.TypeOf(lbmap.Service6Value{})},
