...
// NewNodeHandler constructs the Linux node datapath, registers its node table
// reconciler, and provides node ID lookups.
func NewNodeHandler(
	...
	lifecycle.Append(cell.Hook{
		OnStart: func(_ cell.HookContext) error {
			...
			nodeWriter.RegisterReconciler(node.LinuxNodeReconciler)
			...
			if err != nil {
				nodeWriter.UnregisterReconciler(node.LinuxNodeReconciler)
