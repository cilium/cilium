...
func (n *linuxNodeHandler) updateDirectRoutes(oldCIDRs, newCIDRs []*cidr.CIDR, oldIP, newIP net.IP, firstAddition, directRouteEnabled bool) error {
	...
	// TODO: Is this safe in the presence of the agent missing updates??
...
func (n *linuxNodeHandler) nodeUpdate(oldNode, newNode *nodeTypes.Node, firstAddition bool) error {
	var (
		...
		newAllIP4AllocCidrs                      = append([]*cidr.CIDR{newNode.IPv4AllocCIDR}, newNode.IPv4SecondaryAllocCIDRs...)
		newAllIP6AllocCidrs                      = append([]*cidr.CIDR{newNode.IPv6AllocCIDR}, newNode.IPv6SecondaryAllocCIDRs...)
	...
	if oldNode != nil {
		...
		oldAllIP4AllocCidrs = append([]*cidr.CIDR{oldNode.IPv4AllocCIDR}, oldNode.IPv4SecondaryAllocCIDRs...)
		oldAllIP6AllocCidrs = append([]*cidr.CIDR{oldNode.IPv6AllocCIDR}, oldNode.IPv6SecondaryAllocCIDRs...)
