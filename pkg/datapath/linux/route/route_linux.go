...
// Lookups attempts to find the linux route based on the route specification.
...
// Replace adds or updates a Linux kernel route. The route described can be in
...
func Replace(route Route, mtuConfig mtu.Configuration) (bool, error) {
