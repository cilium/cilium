...
// TODO: Add BPF unit tests for the VLAN allowlist config variables
// (vlan_filter_id_0..5) once the BPF C changes are compiled. The old
// preprocessor macro tests (TestPrivilegedVLANBypassConfig) have been removed
// along with vlanFilterMacros.
