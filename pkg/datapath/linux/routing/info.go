...
func NewRoutingInfo(logger logging.FieldLogger, gateway string, cidrs []string, mac, ifaceNum, ipamMode string, masquerade bool) (*RoutingInfo, error) {
	return parse(logger, gateway, cidrs, mac, ifaceNum, ipamMode, masquerade)
}

func parse(logger logging.FieldLogger, gateway string, cidrs []string, macAddr, ifaceNum, ipamMode string, masquerade bool) (*RoutingInfo, error) {
