...
const (
	...
	L2PodAnnouncementsInterfaces = "l2-pod-announcements-interfaces"
...
type Config struct {
	...
	L2PodAnnouncementsInterfaces string
...
func (def Config) Flags(flags *pflag.FlagSet) {
	...
	flags.MarkDeprecated(L2PodAnnouncementsInterface, "use --"+L2PodAnnouncementsInterfaces+" instead")
	flags.String(L2PodAnnouncementsInterfaces, def.L2PodAnnouncementsInterfaces, "Regex matching interfaces used for sending gratuitous arp messages")
