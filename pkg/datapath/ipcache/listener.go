...
// IPCacheListenerBPF implements the ipcache.IPIdentityMappingListener
...
// handleMapShuffleFailure attempts to move the 'oldPath' back to
// 'standardPath', and logs a warning message if this can't be achieved.
