...
func NewInsertOrderedMap[K comparable, V any](initialCapacity int) *InsertOrderedMap[K, V] {
	return &InsertOrderedMap[K, V]{
		indexes: make(map[K]int, initialCapacity),
		kvs:     make([]keyValuePair[K, V], 0, initialCapacity),
	}
}
