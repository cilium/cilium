...
func (c *Client) GetServiceID(id int64) (*models.Service, error) {
	params := service.NewGetServiceIDParams().WithID(id).WithTimeout(defaults.ClientTimeout)
...
func (c *Client) PutServiceID(id int64, svc *models.ServiceSpec) (bool, error) {
	svc.ID = id
	params := service.NewPutServiceIDParams().WithID(id).WithConfig(svc).WithTimeout(defaults.ClientTimeout)
...
func (c *Client) DeleteServiceID(id int64) error {
	params := service.NewDeleteServiceIDParams().WithID(id).WithTimeout(defaults.ClientTimeout)
