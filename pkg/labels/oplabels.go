...
func (o *OpLabels) ReplaceInformationLabels(l Labels, logger *logrus.Entry) bool {
	...
	o.orchestrationInfo.deleteMarked()
...
func (o *OpLabels) ReplaceIdentityLabels(l Labels, logger *logrus.Entry) bool {
	...
	for k, v := range l {
		...
		if o.disabled.labels[k] != nil {
			o.disabled.clearDeletionMark(k)
	...
	if o.orchestrationIdentity.deleteMarked() || o.disabled.deleteMarked() {
		changed = true
	}
...
// clearDeletionMark marks the label with 'key' to not be deleted.
func (l markedLabels) clearDeletionMark(key string) {
	if l.keepers == nil {
...
func (l markedLabels) deleteMarked() bool {
	deleted := false
