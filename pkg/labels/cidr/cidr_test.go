...
func TestGetCIDRLabels(t *testing.T) {
	...
	for _, tc := range []struct {
		...
		},
		{
			...
			enableIPv4: false,
			enableIPv6: true,
			prefix:     mustCIDR("2001:db8:cafe::cab:4:b0b:0/112"),
			expected: labels.ParseLabelArray(
		...
		},
		{
			...
			enableIPv4: false,
			enableIPv6: true,
			prefix:     mustCIDR("2001:DB8::1/128"),
			expected: labels.ParseLabelArray(
				"cidr:0--0/0",
				"cidr:0--0/1", "cidr:0--0/2", "cidr:2000--0/3", "cidr:2000--0/4",
				"cidr:2000--0/5", "cidr:2000--0/6", "cidr:2000--0/7", "cidr:2000--0/8",
...
func TestCIDRLabelsCache(t *testing.T) {
	...
	prefixes := []*net.IPNet{
		mustCIDR("87.151.93.239/32"), mustCIDR("87.151.93.238/31"),
		mustCIDR("87.151.93.236/30"), mustCIDR("87.151.93.232/29"),
		mustCIDR("87.151.93.224/28"), mustCIDR("87.151.93.224/27"),
		mustCIDR("87.151.93.192/26"), mustCIDR("87.151.93.128/25"),
		mustCIDR("87.151.93.0/24"), mustCIDR("87.151.92.0/23"),
		mustCIDR("87.151.92.0/22"), mustCIDR("87.151.88.0/21"),
		mustCIDR("87.151.80.0/20"), mustCIDR("87.151.64.0/19"),
		mustCIDR("87.151.64.0/18"), mustCIDR("87.151.0.0/17"),
		mustCIDR("87.151.0.0/16"), mustCIDR("87.150.0.0/15"),
		mustCIDR("87.148.0.0/14"), mustCIDR("87.144.0.0/13"),
		mustCIDR("87.144.0.0/12"), mustCIDR("87.128.0.0/11"),
		mustCIDR("87.128.0.0/10"), mustCIDR("87.128.0.0/9"),
		mustCIDR("87.0.0.0/8"), mustCIDR("86.0.0.0/7"),
		mustCIDR("84.0.0.0/6"), mustCIDR("80.0.0.0/5"),
		mustCIDR("80.0.0.0/4"), mustCIDR("64.0.0.0/3"),
		mustCIDR("64.0.0.0/2"), mustCIDR("0.0.0.0/1"),
		mustCIDR("0.0.0.0/0"),
	}
	cidrLabels := []string{
		"cidr:0.0.0.0/0",
