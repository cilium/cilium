...
func (c *Client) ListAllNetworkInterfaces(ctx context.Context) ([]*armnetwork.Interface, error) {
	return c.listAllNetworkInterfaces(ctx)
}
...
func (c *Client) ParseInterfacesIntoInstanceMap(networkInterfaces []*armnetwork.Interface, subnets ipamTypes.SubnetMap) *ipamTypes.InstanceMap {
	return c.parseInterfacesIntoInstanceMap(networkInterfaces, subnets)
}

// parseInterfacesIntoInstanceMap is the internal implementation of ParseInterfacesIntoInstanceMap
func (c *Client) parseInterfacesIntoInstanceMap(networkInterfaces []*armnetwork.Interface, subnets ipamTypes.SubnetMap) *ipamTypes.InstanceMap {
...
func (c *Client) ParseInterfacesIntoInstance(networkInterfaces []*armnetwork.Interface, subnets ipamTypes.SubnetMap) *ipamTypes.Instance {
	return c.parseInterfacesIntoInstance(networkInterfaces, subnets)
}

// parseInterfacesIntoInstance is the internal implementation of ParseInterfacesIntoInstance
func (c *Client) parseInterfacesIntoInstance(networkInterfaces []*armnetwork.Interface, subnets ipamTypes.SubnetMap) *ipamTypes.Instance {
...
func (c *Client) GetSubnetsByIDs(ctx context.Context, subnetIDs []string) (ipamTypes.SubnetMap, error) {
	...
	for _, subnetID := range subnetIDs {
		...
		if err != nil {
			slog.Warn("Failed to parse subnet ID, skipping", "error", err, "subnetID", subnetID)
			continue
		}
		...
		if err != nil {
			slog.Warn("Failed to get subnet details, skipping", "error", err)
			continue
		}
