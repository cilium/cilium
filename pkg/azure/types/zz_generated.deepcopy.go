...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in InstanceMap) DeepCopyInto(out *InstanceMap) {
	{
		in := &in
		*out = make(InstanceMap, len(*in))
		for key, val := range *in {
			var outVal *Instance
			if val == nil {
				(*out)[key] = nil
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new InstanceMap.
func (in InstanceMap) DeepCopy() InstanceMap {
	if in == nil {
		return nil
	}
	out := new(InstanceMap)
