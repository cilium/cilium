...
// HealthStatusProvider is an interface for checking the health status
...
type StandaloneDNSProxy struct {
	...
	// healthStatus tracks the health status of this standalone DNS proxy instance
	healthStatus atomic.Bool
}

// IsHealthy returns the current health status of the standalone DNS proxy
func (sdp *StandaloneDNSProxy) IsHealthy() bool {
	return sdp.healthStatus.Load()
}

// setHealthy sets the health status of the standalone DNS proxy
func (sdp *StandaloneDNSProxy) setHealthy(healthy bool) {
	sdp.healthStatus.Store(healthy)
}
...
// NewHealthStatusProvider creates a HealthStatusProvider from the StandaloneDNSProxy
func NewHealthStatusProvider(sdp *StandaloneDNSProxy) HealthStatusProvider {
	return sdp
}
...
func (sdp *StandaloneDNSProxy) StartStandaloneDNSProxy() error {
	...
	// Mark the proxy as healthy since it has started successfully
	sdp.setHealthy(true)
