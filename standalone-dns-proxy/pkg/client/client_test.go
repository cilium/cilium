...
func (b *mockDefaultDialer) DialContext(ctx context.Context, target string, opts ...grpc.DialOption) (*grpc.ClientConn, error) {
...
func TestPolicyStream(t *testing.T) {
	...
	require.Positive(t, server.success.Load(), "Should have received some policy state messages")
