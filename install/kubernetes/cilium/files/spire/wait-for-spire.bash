...
{{- if .Values.encryption.ztunnel.spire.serverAddress }}
ADDR="{{ .Values.encryption.ztunnel.spire.serverAddress }}"
{{- else }}
ADDR="spire-server.{{ .Values.encryption.ztunnel.spire.install.namespace}}.svc:8081"
{{- end }}
CONN_TIMEOUT="3"
TIMEOUT="60"
