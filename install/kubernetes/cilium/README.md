...
| ciliumEndpointSlice.sliceMode | string | `"cesSliceModeIdentity"` | The slicing mode to use for CiliumEndpointSlices. cesSliceModeIdentity groups together CiliumEndpoints that share the same identity. cesSliceModeFCFS groups together CiliumEndpoints in a first-come-first-serve basis, filling in the largest non-full slice first. |
