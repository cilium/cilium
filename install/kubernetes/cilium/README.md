...
| ipTracingOptionType | int | `0` | Configure the IP tracing option type. This option is used to specify the IP option type to use for tracing. The value must be an integer between 1 and 255. |
