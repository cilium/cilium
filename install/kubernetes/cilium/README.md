...
| qos | object | `{"enabled":false}` | Configure the QoS API |
| qos.enabled | bool | `false` | Enable the QoS API, which installs and watches the CiliumQoSMechanism, CiliumQoSClass and CiliumQoSPolicy CRDs. |
