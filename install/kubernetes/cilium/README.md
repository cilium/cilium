...
| hubble.hostUsers | bool | `true` | Enable hostUsers for Hubble. This will allow use of user-namespaces for hubble components. Not all clusters support user-namespaces. The default for kubernetes (checked 1.35) is hostUsers: true . See: https://kubernetes.io/docs/concepts/workloads/pods/user-namespaces/ |
