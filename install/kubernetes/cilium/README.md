...
| bpf.ctAnyMax | int | `262144` |  |
| bpf.ctTcpMax | int | `524288` |  |
...
| cnpStatusUpdates.enabled | bool | `false` |  |
| conntrackGCInterval | string | `"0s"` |  |
...
| disableEnvoyVersionCheck | bool | `false` |  |
...
| etcd.extraEnv | object | `{}` |  |
| etcd.extraHostPathMounts | list | `[]` |  |
| etcd.extraInitContainers | list | `[]` |  |
| etcd.image.pullPolicy | string | `"Always"` |  |
| etcd.image.repository | string | `"cilium-etcd-operator"` |  |
| etcd.image.tag | string | `"latest"` |  |
...
| fragmentTracking | bool | `true` |  |
| gke.enabled | bool | `false` |  |
| global.hubble | string | `nil` |  |
...
| hubble.eventQueueSize | string | `""` |  |
| hubble.flowBufferSize | string | `""` |  |
| hubble.listenAddress | string | `""` |  |
| hubble.metrics.enabled | string | `""` |  |
| hubble.metrics.port | int | `9091` |  |
| hubble.metrics.serviceMonitor.enabled | bool | `false` |  |
| hubble.metricsServer | string | `""` |  |
| hubble.relay.debug | bool | `false` |  |
| hubble.relay.dialTimeout | string | `nil` |  |
| hubble.relay.enabled | bool | `false` |  |
| hubble.relay.image.pullPolicy | string | `"Always"` |  |
| hubble.relay.image.repository | string | `"cilium/hubble-relay"` |  |
| hubble.relay.image.tag | string | `"latest"` |  |
| hubble.relay.imagePullSecrets | string | `nil` |  |
| hubble.relay.listenHost | string | `""` |  |
| hubble.relay.listenPort | string | `"4245"` |  |
| hubble.relay.nodeSelector | object | `{}` |  |
| hubble.relay.numReplicas | int | `1` |  |
| hubble.relay.retryTimeout | string | `nil` |  |
| hubble.relay.serviceAccount.annotations | object | `{}` |  |
| hubble.relay.serviceAccount.create | bool | `true` |  |
| hubble.relay.servicePort | int | `80` |  |
...
| hubble.relay.tls.enabled | bool | `true` |  |
...
| hubble.ui.imagePullSecrets | object | `{}` |  |
...
| hubble.ui.ingress.path | string | `"/"` |  |
| hubble.ui.ingress.tls | list | `[]` |  |
| hubble.ui.nodeSelector | object | `{}` |  |
| hubble.ui.proxy.image.pullPolicy | string | `"Always"` |  |
| hubble.ui.proxy.image.repository | string | `"envoyproxy/envoy"` |  |
| hubble.ui.proxy.image.tag | string | `"v1.14.1"` |  |
| hubble.ui.proxy.resources | object | `{}` |  |
| hubble.ui.replicas | int | `1` |  |
| hubble.ui.securityContext.enabled | bool | `true` |  |
| hubble.ui.serviceAccount.annotations | object | `{}` |  |
| hubble.ui.serviceAccount.create | bool | `true` |  |
| hubble.ui.tolerations | list | `[]` |  |
| identityAllocationMode | string | `"crd"` |  |
| identityChangeGracePeriod | string | `"5s"` |  |
| identityGCInterval | string | `nil` |  |
| identityHeartbeatTimeout | string | `""` |  |
| image.pullPolicy | string | `"Always"` |  |
| image.repository | string | `"cilium/cilium"` |  |
...
| iptablesLockTimeout | string | `"5s"` |  |
| ipv4.enabled | bool | `true` |  |
| ipv6.enabled | bool | `false` |  |
| ipvlan.enabled | bool | `false` |  |
| ipvlan.masterDevice | string | `"eth0"` |  |
| k8s.requireIPv4PodCIDR | bool | `false` |  |
...
| maglev.tableSize | string | `"251"` |  |
| masquerade | bool | `true` |  |
| monitor.enabled | bool | `false` |  |
| name | string | `"cilium"` |  |
| nodePort.acceleration | string | `"disabled"` |  |
...
| nodePort.mode | string | `"snat"` |  |
| nodePort.range | string | `"30000,32767"` |  |
| nodeSelector | object | `{}` |  |
...
| nodeinit.image.repository | string | `"cilium/startup-script"` |  |
...
| operator.image.repository | string | `"cilium/operator"` |  |
...
| preflight.image.repository | string | `"cilium/cilium"` |  |
