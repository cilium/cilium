...
| standaloneDnsProxy.proxyPort | int | `10094` | Standalone DNS proxy port # -- Port on which the DNS proxy listens for DNS requests. It should match the port configured in cilium-agent's dnsProxy.proxyPort. |
