...
| clustermesh.config | object | `{"clusters":[],"domain":"mesh.cilium.io","enabled":false,"maxConnectedClusters":255}` | Clustermesh explicit configuration. |
...
| clustermesh.config.maxConnectedClusters | int | `255` | The maximum number of clusters to support in a clustermesh. Values > 255 will decrease maximum allocatable identities per cluster. |
