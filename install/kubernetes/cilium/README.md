...
| k8sServiceHostRef | object | `{"key":null,"name":null}` | k8sServiceHostRef is used to configure the Kubernetes service endpoint dynamically using a ConfigMap. Mutually exclusive with `k8sServiceHost`. |
