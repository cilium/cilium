...
| daemon.enableConntrackLocal | bool | `true` | enableConntrackLocal is a boolean flag to enable or disable local conntrack  By default, this functionality is enabled |
...
| envoy.prometheus.serviceMonitor.relabelings | list | `[{"replacement":null,"sourceLabels":["__meta_kubernetes_pod_node_name"],"targetLabel":"node"}]` | Relabeling configs for the ServiceMonitor cilium-envoy or for cilium-agent with Envoy configured. |
...
| hubble.metrics.serviceMonitor.relabelings | list | `[{"replacement":null,"sourceLabels":["__meta_kubernetes_pod_node_name"],"targetLabel":"node"}]` | Relabeling configs for the ServiceMonitor hubble |
...
| prometheus.serviceMonitor.relabelings | list | `[{"replacement":null,"sourceLabels":["__meta_kubernetes_pod_node_name"],"targetLabel":"node"}]` | Relabeling configs for the ServiceMonitor cilium-agent |
