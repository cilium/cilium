...
| enableDeviceReconfiguration | bool | `false` | Enables runtime device reconfiguration when new devices are added or removed. This feature is currently experimental. |
