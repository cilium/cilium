...
| authentication.mutual.spire.install.server.spireConfig.image | string | `"docker.io/library/busybox:1.35.0@sha256:223ae047b1065bd069aac01ae3ac8088b3ca4a527827e283b85112f29385fb1b"` | Image for running the configuration script towards the SPIRE server |
...
| clustermesh.apiserver.image | object | `{"digest":"sha256:2eb0f9ddd91682e1a591b23fcbd29563e6f9b2e1555903a2f417791516ffdf38","override":null,"pullPolicy":"IfNotPresent","repository":"quay.io/cilium/clustermesh-apiserver","tag":"v1.14.0","useDigest":true}` | Clustermesh API server image. |
...
| clustermesh.apiserver.kvstoremesh.image | object | `{"digest":"sha256:efa5d069ec6227b14928da65c5df646d4013737fd5973b17c74d0ede654e47bb","override":null,"pullPolicy":"IfNotPresent","repository":"quay.io/cilium/kvstoremesh","tag":"v1.14.0","useDigest":true}` | KVStoreMesh image. |
...
| hubble.relay.image | object | `{"digest":"sha256:bfe6ef86a1c0f1c3e8b105735aa31db64bcea97dd4732db6d0448c55a3c8e70c","override":null,"pullPolicy":"IfNotPresent","repository":"quay.io/cilium/hubble-relay","tag":"v1.14.0","useDigest":true}` | Hubble-relay container image. |
...
| image | object | `{"digest":"sha256:5a94b561f4651fcfd85970a50bc78b201cfbd6e2ab1a03848eab25a82832653a","override":null,"pullPolicy":"IfNotPresent","repository":"quay.io/cilium/cilium","tag":"v1.14.0","useDigest":true}` | Agent container image. |
...
| preflight.image | object | `{"digest":"sha256:5a94b561f4651fcfd85970a50bc78b201cfbd6e2ab1a03848eab25a82832653a","override":null,"pullPolicy":"IfNotPresent","repository":"quay.io/cilium/cilium","tag":"v1.14.0","useDigest":true}` | Cilium pre-flight image. |
