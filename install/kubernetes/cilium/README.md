...
| ingressController.hostNetwork.sharedPort | int | `0` | Configure a specific port on the host network that gets used for the shared listener. This is used for HTTP and HTTPS. |
