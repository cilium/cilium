...
| hubble.tls | object | `{"auto":{"certManagerIssuerRef":{},"certValidityDuration":1095,"enabled":true,"issuerCertValidityDuration":26280,"method":"helm","schedule":"0 0 1 */4 *"},"ca":{"cert":"","key":""},"enabled":true,"server":{"cert":"","extraDnsNames":[],"extraIpAddresses":[],"key":""}}` | TLS configuration for Hubble |
| hubble.tls.auto | object | `{"certManagerIssuerRef":{},"certValidityDuration":1095,"enabled":true,"issuerCertValidityDuration":26280,"method":"helm","schedule":"0 0 1 */4 *"}` | Configure automatic TLS certificates generation. |
...
| hubble.tls.auto.issuerCertValidityDuration | int | `26280` | Generated CA certificate validity duration in days for the Issuer. Only used if certManagerIssuerRef is not specified. |
