...
| clustermesh | object | `{"apiserver":{"etcd":{"image":{"pullPolicy":"IfNotPresent","repository":"quay.io/coreos/etcd","tag":"v3.4.13"}},"image":{"pullPolicy":"IfNotPresent","repository":"quay.io/cilium/clustermesh-apiserver","tag":"v1.9.0"},"nodeSelector":{},"podAnnotations":{},"replicas":1,"resources":{},"service":{"annotations":{},"nodePort":32379,"type":"NodePort"},"tls":{"admin":{"cert":"","key":""},"auto":{"certValidityDuration":1095,"enabled":true,"method":"helm"},"ca":{"cert":"","key":""},"client":{"cert":"","key":""},"remote":{"cert":"","key":""},"server":{"cert":"","key":""}},"tolerations":[],"updateStrategy":{"rollingUpdate":{"maxUnavailable":1},"type":"RollingUpdate"}},"useAPIServer":false}` | disableEnvoyVersionCheck removes the check for Envoy, which can be useful on AArch64 as the images do not currently ship a version of Envoy. |
