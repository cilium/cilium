...
| prometheus.metrics | string | `nil` | Array of metrics that should be enabled or disabled from the default metric list.  metrics:   - +metric_foo   - -metric_bar  This enables `metric_foo` and disables `metric_bar`. ref: https://docs.cilium.io/en/stable/observability/metrics/ |
