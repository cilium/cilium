...
| envoy.accessLog.format | string | `"text"` | Access log format Applicable values: text, json |
| envoy.accessLog.path | string | `nil` | Path to a separate Envoy log file, if any. Defaults to /dev/stdout. |
| envoy.accessLog.pattern | string | `nil` | Format string pattern for Envoy access logs. ref: https://www.envoyproxy.io/docs/envoy/latest/configuration/observability/access_log/usage |
