...
| auth.mTLS.spire.enabled | bool | `true` | Enable SPIRE integration |
...
| auth.mTLS.spire.install.enabled | bool | `true` | Enable SPIRE installation. This will only take effect only if auth.mTLS.spire.enabled is true |
