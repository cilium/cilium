...
| hostServices | object | `{"enabled":false}` | Configure socket-lb (deprecated in favor of socketLB). |
| hostServices.enabled | bool | `false` | Enable host reachable services (deprecated in favor of socketLB). |
