...
| hubble.networkPolicyEnrichment | object | `{"enabled":true}` | Enable network policy enrichment of Hubble flows, i.e. populating `egress_allowed_by`, `ingress_denied_by` fields with policy information. |
