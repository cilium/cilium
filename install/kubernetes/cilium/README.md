...
| encryption.strictMode.ingress.enabled | bool | `false` | Enable strict ingress encryption. When enabled, all unencrypted Pod2Pod ingress traffic will be dropped. This option is only applicable when WireGuard and tunneling is enabled. |
