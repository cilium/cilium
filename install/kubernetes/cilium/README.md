...
| enableTunedBufferMargins | bool | `false` | Enable tuning of buffer margins on pod network devices (this is experimental and requires bpf.datapathMode=netkit or bpf.datapathMode=netkit-l2) |
