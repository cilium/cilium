...
| dnsProxy.ttlBoundZones | list | `[]` | DNS zones whose names expire on their TTL instead of being deferred as zombies. An entry covers the zone and every name under it. Connections outliving the DNS TTL may be dropped. |
