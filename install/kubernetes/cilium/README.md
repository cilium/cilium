...
| certgen.image.tag | string | `"v0.1.2@sha256:c56e1cd89e6f49a9fa442ad129974e2addfc687ef6ac524ee26849162425c489"` |  |
...
| hubble.ui.backend.image.tag | string | `"v0.7.2"` |  |
...
| hubble.ui.frontend.image.tag | string | `"v0.7.2"` |  |
