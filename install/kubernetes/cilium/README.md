...
| hubble.metrics.tls.server.commonName | string | `""` | DNS name to build the certificate for |
...
| hubble.relay.tls | object | `{"client":{"cert":"","commonName":"","existingSecret":"","extraDnsNames":[],"extraIpAddresses":[],"key":""},"server":{"cert":"","commonName":"","enabled":false,"existingSecret":"","extraDnsNames":[],"extraIpAddresses":[],"key":"","mtls":false,"relayName":"ui.hubble-relay.cilium.io"}}` | TLS configuration for Hubble Relay |
| hubble.relay.tls.client | object | `{"cert":"","commonName":"","existingSecret":"","extraDnsNames":[],"extraIpAddresses":[],"key":""}` | The hubble-relay client certificate and private key. This keypair is presented to Hubble server instances for mTLS authentication and is required when hubble.tls.enabled is true. These values need to be set manually if hubble.tls.auto.enabled is false. |
...
| hubble.relay.tls.client.commonName | string | `""` | DNS name to build the certificate for |
...
| hubble.relay.tls.client.extraDnsNames | list | `[]` | extra DNS names added to certificate when its auto gen |
| hubble.relay.tls.client.extraIpAddresses | list | `[]` | extra IP addresses added to certificate when its auto gen |
...
| hubble.relay.tls.server | object | `{"cert":"","commonName":"","enabled":false,"existingSecret":"","extraDnsNames":[],"extraIpAddresses":[],"key":"","mtls":false,"relayName":"ui.hubble-relay.cilium.io"}` | The hubble-relay server certificate and private key |
...
| hubble.relay.tls.server.commonName | string | `""` | DNS name to build the certificate for |
...
| hubble.tls | object | `{"auto":{"certManagerIssuerRef":{},"certValidityDuration":365,"enabled":true,"method":"helm","schedule":"0 0 1 */4 *"},"enabled":true,"server":{"cert":"","commonName":"","existingSecret":"","extraDnsNames":[],"extraIpAddresses":[],"key":""}}` | TLS configuration for Hubble |
...
| hubble.tls.server | object | `{"cert":"","commonName":"","existingSecret":"","extraDnsNames":[],"extraIpAddresses":[],"key":""}` | The Hubble server certificate and private key |
...
| hubble.tls.server.commonName | string | `""` | DNS name to build the certificate for |
...
| hubble.ui.tls.client.commonName | string | `""` | DNS name to build the certificate for |
...
| hubble.ui.tls.client.extraDnsNames | list | `[]` | extra DNS names added to certificate when its auto gen |
| hubble.ui.tls.client.extraIpAddresses | list | `[]` | extra IP addresses added to certificate when its auto gen |
