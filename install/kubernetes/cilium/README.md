...
| encryption.ztunnel.spire.adminSocketPath | string | `"/run/spire/sockets/admin.sock"` | SPIRE socket path where the SPIRE delegated api agent is listening |
| encryption.ztunnel.spire.agentSocketPath | string | `"/run/spire/sockets/agent/agent.sock"` | SPIRE socket path where the SPIRE workload agent is listening. Applies to both the Cilium Agent and Operator |
| encryption.ztunnel.spire.annotations | object | `{}` | Annotations to be added to all top-level spire objects (resources under templates/spire) |
| encryption.ztunnel.spire.connectionTimeout | string | `"30s"` | SPIRE connection timeout |
| encryption.ztunnel.spire.install.agent.affinity | object | `{}` | SPIRE agent affinity configuration |
| encryption.ztunnel.spire.install.agent.annotations | object | `{}` | SPIRE agent annotations |
| encryption.ztunnel.spire.install.agent.image | object | `{"digest":"sha256:41b0dcd8b258a69db9e2768292a060766fb76fd866e4bc925849981ea1b825ff","override":null,"pullPolicy":"Always","repository":"ghcr.io/spiffe/spire-agent","tag":"1.15.3","useDigest":true}` | SPIRE agent image |
| encryption.ztunnel.spire.install.agent.labels | object | `{}` | SPIRE agent labels |
| encryption.ztunnel.spire.install.agent.nodeSelector | object | `{}` | SPIRE agent nodeSelector configuration ref: ref: https://kubernetes.io/docs/concepts/scheduling-eviction/assign-pod-node/#nodeselector |
| encryption.ztunnel.spire.install.agent.podSecurityContext | object | `{}` | Security context to be added to spire agent pods. SecurityContext holds pod-level security attributes and common container settings. ref: https://kubernetes.io/docs/tasks/configure-pod-container/security-context/#set-the-security-context-for-a-pod |
| encryption.ztunnel.spire.install.agent.priorityClassName | string | `""` | The priority class to use for the spire agent |
| encryption.ztunnel.spire.install.agent.resources | object | `{}` | container resource limits & requests |
| encryption.ztunnel.spire.install.agent.securityContext | object | `{}` | Security context to be added to spire agent containers. SecurityContext holds pod-level security attributes and common container settings. ref: https://kubernetes.io/docs/tasks/configure-pod-container/security-context/#set-the-security-context-for-a-container |
| encryption.ztunnel.spire.install.agent.serviceAccount | object | `{"create":true,"name":"spire-agent"}` | SPIRE agent service account |
| encryption.ztunnel.spire.install.agent.skipKubeletVerification | bool | `true` | SPIRE Workload Attestor kubelet verification. |
| encryption.ztunnel.spire.install.agent.tolerations | list | `[{"effect":"NoSchedule","key":"node.kubernetes.io/not-ready"},{"effect":"NoSchedule","key":"node-role.kubernetes.io/master"},{"effect":"NoSchedule","key":"node-role.kubernetes.io/control-plane"},{"effect":"NoSchedule","key":"node.cloudprovider.kubernetes.io/uninitialized","value":"true"},{"key":"CriticalAddonsOnly","operator":"Exists"}]` | SPIRE agent tolerations configuration By default it follows the same tolerations as the agent itself to allow the Cilium agent on this node to connect to SPIRE. ref: https://kubernetes.io/docs/concepts/scheduling-eviction/taint-and-toleration/ |
| encryption.ztunnel.spire.install.enabled | bool | `true` | Enable SPIRE installation. This only takes effect when encryption.enabled=true, encryption.type=ztunnel, and encryption.ztunnel.ca.type=spire. |
| encryption.ztunnel.spire.install.existingNamespace | bool | `false` | SPIRE namespace already exists. Set to true if Helm should not create, manage, and import the SPIRE namespace. |
| encryption.ztunnel.spire.install.initImage | object | `{"digest":"sha256:dc2d74b28e4cf8984fa52af1f39bc7c3d9c73760b41a74d629f5d11b1ab28616","override":null,"pullPolicy":"Always","repository":"docker.io/library/busybox","tag":"1.38.0","useDigest":true}` | init container image of SPIRE agent and server |
| encryption.ztunnel.spire.install.namespace | string | `"cilium-spire"` | SPIRE namespace to install into |
| encryption.ztunnel.spire.install.server.affinity | object | `{}` | SPIRE server affinity configuration |
| encryption.ztunnel.spire.install.server.annotations | object | `{}` | SPIRE server annotations |
| encryption.ztunnel.spire.install.server.ca.keyType | string | `"rsa-4096"` | SPIRE CA key type AWS requires the use of RSA. EC cryptography is not supported |
| encryption.ztunnel.spire.install.server.ca.subject | object | `{"commonName":"Cilium SPIRE CA","country":"US","organization":"SPIRE"}` | SPIRE CA Subject |
| encryption.ztunnel.spire.install.server.dataStorage.accessMode | string | `"ReadWriteOnce"` | Access mode of the SPIRE server data storage |
| encryption.ztunnel.spire.install.server.dataStorage.enabled | bool | `true` | Enable SPIRE server data storage |
| encryption.ztunnel.spire.install.server.dataStorage.size | string | `"1Gi"` | Size of the SPIRE server data storage |
| encryption.ztunnel.spire.install.server.dataStorage.storageClass | string | `nil` | StorageClass of the SPIRE server data storage |
| encryption.ztunnel.spire.install.server.image | object | `{"digest":"sha256:4082f30d3e0ddc4000a171392c4ea174345ee44d161ee917c70b97b2ecfba141","override":null,"pullPolicy":"Always","repository":"ghcr.io/spiffe/spire-server","tag":"1.15.3","useDigest":true}` | SPIRE server image |
| encryption.ztunnel.spire.install.server.initContainers | list | `[]` | SPIRE server init containers |
| encryption.ztunnel.spire.install.server.labels | object | `{}` | SPIRE server labels |
| encryption.ztunnel.spire.install.server.nodeSelector | object | `{}` | SPIRE server nodeSelector configuration ref: ref: https://kubernetes.io/docs/concepts/scheduling-eviction/assign-pod-node/#nodeselector |
| encryption.ztunnel.spire.install.server.podSecurityContext | object | `{}` | Security context to be added to spire server pods. SecurityContext holds pod-level security attributes and common container settings. ref: https://kubernetes.io/docs/tasks/configure-pod-container/security-context/#set-the-security-context-for-a-pod |
| encryption.ztunnel.spire.install.server.priorityClassName | string | `""` | The priority class to use for the spire server |
| encryption.ztunnel.spire.install.server.resources | object | `{}` | container resource limits & requests |
| encryption.ztunnel.spire.install.server.securityContext | object | `{}` | Security context to be added to spire server containers. SecurityContext holds pod-level security attributes and common container settings. ref: https://kubernetes.io/docs/tasks/configure-pod-container/security-context/#set-the-security-context-for-a-container |
| encryption.ztunnel.spire.install.server.service.annotations | object | `{}` | Annotations to be added to the SPIRE server service |
| encryption.ztunnel.spire.install.server.service.labels | object | `{}` | Labels to be added to the SPIRE server service |
| encryption.ztunnel.spire.install.server.service.type | string | `"ClusterIP"` | Service type for the SPIRE server service |
| encryption.ztunnel.spire.install.server.serviceAccount | object | `{"create":true,"name":"spire-server"}` | SPIRE server service account |
| encryption.ztunnel.spire.install.server.tolerations | list | `[]` | SPIRE server tolerations configuration ref: https://kubernetes.io/docs/concepts/scheduling-eviction/taint-and-toleration/ |
| encryption.ztunnel.spire.serverAddress | string | `nil` | SPIRE server address used by Cilium Operator  If k8s Service DNS along with port number is used (e.g. <service-name>.<namespace>.svc(.*):<port-number> format), Cilium Operator will resolve its address by looking up the clusterIP from Service resource.  Example values: 10.0.0.1:8081, spire-server.cilium-spire.svc:8081 |
| encryption.ztunnel.spire.trustDomain | string | `"spiffe.cilium"` | SPIFFE trust domain to use for fetching certificates |
