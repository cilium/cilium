...
| envoy.log.accessLogWorkers | int | `4` | Number of worker goroutines processing Envoy access log messages per connection. Increase this value on nodes with high L7 traffic to reduce per-connection processing latency. |
