            ...
            steps {
                script {
                    parallel(
                        ...
                        "K8s-1.8":{
                            sh 'cd ${TESTDIR}; K8S_VERSION=1.8 ginkgo --focus=" K8s*" -v --failFast=${FAILFAST} --seed=1537401655'
                        },
                        "K8s-1.11":{
                            sh 'cd ${TESTDIR}; K8S_VERSION=1.11 ginkgo --focus=" K8s*" -v --failFast=${FAILFAST} --seed=1537401655'
                        },
