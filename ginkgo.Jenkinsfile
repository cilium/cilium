                ...
                script {
                    parallel(
                        "Runtime":{
                            ...
                            sh 'cd ${TESTDIR}; ginkgo --focus="XFoo*" -v --failFast=${FAILFAST} -- -cilium.provision=false'
                        },
                        "K8s-1.8":{
                        ...
                        "K8s-1.12":{
                            ...
                            sh 'cd ${TESTDIR}; K8S_VERSION=1.12 ginkgo --focus=" K8sFoo*" -v --failFast=${FAILFAST} -- -cilium.provision=false'
                        },
