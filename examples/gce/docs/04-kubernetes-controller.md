...
```
wget https://raw.githubusercontent.com/cilium/cilium/master/examples/gce/deployments/token.csv
```
...
```
wget https://raw.githubusercontent.com/cilium/cilium/master/examples/gce/deployments/authorization-policy.jsonl
```
...
You probably have noticed, the IP `10.32.0.1` was previously used when we were creating the
