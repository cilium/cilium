...
desc_rate "Luke Skywalker has vanished. In his absence, the"
desc_rate "empire has risen from the ashes and adopted microservices"
desc_rate "and continuous delivery."
desc_rate ""
...
desc_rate "which is aware of its weaknessses."
...
run ""
desc_rate "In the meantime, IT operations of the empire have detected"
...
run ""
desc_rate "Despite the obvious good move of the empire IT department to"
desc_rate "adopt cilium and HTTP security policies, we can't let the"
desc_rate "empire win so here is what really happened..."

desc_rate "The Jedi have forseen this situation and manipulated the"
