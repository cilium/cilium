...
INGRESS_ENABLED_CMD="cilium endpoint list | grep -v reserved | awk '{print $2}' | grep 'Enabled' -c"
INGRESS_DISABLED_CMD="cilium endpoint list | grep -v reserved | awk '{print $2}' | grep 'Disabled' -c"

EGRESS_ENABLED_CMD="cilium endpoint list | grep -v reserved | awk '{print $3}' | grep 'Enabled' -c"
EGRESS_DISABLED_CMD="cilium endpoint list | grep -v reserved | awk '{print $3}' | grep 'Disabled' -c"
