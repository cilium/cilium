...
function init {
	...
	node_run cilium-master 'docker network create --ipv6 --driver cilium --ipam-driver cilium cilium 2> /dev/null' || true
	node_run cilium-node-2 'docker network create --ipv6 --driver cilium --ipam-driver cilium cilium 2> /dev/null' || true
}
