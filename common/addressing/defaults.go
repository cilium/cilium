...
var (
	...
	// state:                   beef:beef:beef:beef:<state>::/80
	// node:		    beef:beef:beef:beef:<state>:<node>:<node>:/112
	// lxc:			    beef:beef:beef:beef:<state>:<node>:<node>:<lxc>/128

	// ClusterIPv6Mask represents the CIDR Mask for an entire cluster
	ClusterIPv6Mask = net.CIDRMask(64, 128)
	// StateIPv6Mask represents the CIDR Mask for the state porition
	StateIPv6Mask = net.CIDRMask(80, 128)
