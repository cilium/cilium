...
gcloud container clusters create "${owner_pipeline_name}" \
  --project "${project}" \
	...
	--preemptible
# --enable-service-externalips is required for our tests, and is now enabled
# by default on GKE version 1.21 and above, cf. https://cloud.google.com/kubernetes-engine/docs/release-notes#December_20_2021
