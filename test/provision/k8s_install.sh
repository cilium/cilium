...
docker run --net outside --ip 192.168.9.10 -d docker.io/cilium/demo-httpd:latest
docker run --net outside --ip 192.168.9.11 -d docker.io/cilium/demo-httpd:latest
