...
var ciliumBasePath = flag.String("cilium-base-path", filepath.Join("..", ".."), "Cilium checkout base path")
...
func TestVerifier(t *testing.T) {
	...
	ciKernelVersion := getCIKernelVersion(t)
	t.Logf("CI kernel version: %s", ciKernelVersion)
