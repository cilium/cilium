...
var _ = Describe("K8sFQDNTest", func() {
	...
	BeforeAll(func() {
		...
		ExpectDeployReady(kubectl, helpers.DefaultNamespace, "app1", helpers.HelperTimeout)
		ExpectDeployReady(kubectl, helpers.DefaultNamespace, "app2", helpers.HelperTimeout)
		ExpectDeployReady(kubectl, helpers.DefaultNamespace, "app3", helpers.HelperTimeout)
	})
