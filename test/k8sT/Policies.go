...
var _ = Describe("K8sPolicyTest", func() {
	...
	Context("Basic Test", func() {
		...
		validateConnectivity := func(expectWorldSuccess, expectClusterSuccess bool) {
			...
			// getMatcher return a helper.CMDSucess() matcher for sucess or fail situations.
		...
		Context("Validate to-entities policies", func() {
			const (
				WorldConnetivityDeny  = false
				WorldConnetivityAllow = true

				ClusterConnetivityDeny  = false
				ClusterConnetivityAllow = true
			)
			...
			It("Validate toEntities All", func() {
				...
				validateConnectivity(WorldConnetivityAllow, ClusterConnetivityAllow)
			})
			...
			It("Validate toEntities World", func() {
				...
				By("Verifying policy correctness")
				validateConnectivity(WorldConnetivityAllow, ClusterConnetivityDeny)
			...
			It("Validate toEntities Cluster", func() {
				...
				By("Verifying policy correctness")
				validateConnectivity(WorldConnetivityDeny, ClusterConnetivityAllow)
			})
			...
			It("Validate toEntities Host", func() {
				...
				By("Verifying policy correctness")
				validateConnectivity(WorldConnetivityDeny, ClusterConnetivityDeny)
			})
		})
	})
