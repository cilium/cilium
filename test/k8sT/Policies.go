...
EOF`, k, v)
	...
	Context("Namespaces policies", func() {
		...
		BeforeAll(func() {
			...
			ExpectDeployReady(kubectl, secondNS, "app1", helpers.HelperTimeout)
			ExpectDeployReady(kubectl, secondNS, "app2", helpers.HelperTimeout)
			ExpectDeployReady(kubectl, secondNS, "app3", helpers.HelperTimeout)
			ExpectDeployReady(kubectl, helpers.DefaultNamespace, "app1", helpers.HelperTimeout)
			ExpectDeployReady(kubectl, helpers.DefaultNamespace, "app2", helpers.HelperTimeout)
			ExpectDeployReady(kubectl, helpers.DefaultNamespace, "app3", helpers.HelperTimeout)
