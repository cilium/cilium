...
var (
	...
	// CheckLogs new buffer where all the warnings and checks that happens
	// during the test are saved. This buffer will be printed in the test
	// output inside <checks> labels.
