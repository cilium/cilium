...
var (
	...
	defaultHelmOptions = map[string]string{
		...
		"operator.generic.image.repository":      "k8s1:5000/cilium/operator",
		"operator.generic.image.tag":             "latest",
		"operator.generic.image.suffix":          "",
		"operator.generic.image.useDigest":       "false",
		"operator.azure.image.repository":        "k8s1:5000/cilium/operator",
		"operator.azure.image.tag":               "latest",
		"operator.azure.image.suffix":            "",
		"operator.azure.image.useDigest":         "false",
		"operator.aws.image.repository":          "k8s1:5000/cilium/operator",
		"operator.aws.image.tag":                 "latest",
		"operator.aws.image.suffix":              "",
		"operator.aws.image.useDigest":           "false",
		"operator.alibabacloud.image.repository": "k8s1:5000/cilium/operator",
		"operator.alibabacloud.image.tag":        "latest",
		"operator.alibabacloud.image.suffix":     "",
		"operator.alibabacloud.image.useDigest":  "false",
