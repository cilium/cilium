...
// EnsureLabels labels nodes in vagrant env. If you are running tests on different cluster you need to label your nodes by yourself
func (kub *Kubectl) EnsureLabels() {
