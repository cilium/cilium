...
type CmdRes struct {
	...
	wg       *sync.WaitGroup // Is used to wait until done when used context execution
}
...
// WaitUntilFinish is a command that wait until the command context completes correctly
