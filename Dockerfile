...
#
FROM quay.io/cilium/cilium-envoy:c6d564bb08632a09947bfe224096379df4775ccd as cilium-envoy
...
#
FROM quay.io/cilium/cilium-builder:2019-10-18-v1.6 as builder
...
#
FROM quay.io/cilium/cilium-runtime:2019-10-18-v1.6
LABEL maintainer="maintainer@cilium.io"
