...
pipeline {
    ...
    environment {
        ...
        BASE_IMAGE="""${sh(
                returnStdout: true,
                script: 'if [ "${run_with_race_detection}" = "" ]; then echo -n "scratch"; else echo -n "quay.io/cilium/cilium-runtime:93bafe487a63c476b35b6cbc3c50095898ededf2@sha256:5b644376821ebea594a84bf7334b0b8bdd5b32801eacf08063f9bb858215cd85"; fi'
            )}"""
    }
