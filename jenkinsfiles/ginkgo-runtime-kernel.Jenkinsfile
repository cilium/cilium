...
pipeline {
    ...
    environment {
        ...
        BASE_IMAGE="""${sh(
                returnStdout: true,
                script: 'if [ "${run_with_race_detection}" = "" ]; then echo -n "scratch"; else echo -n "quay.io/cilium/cilium-runtime:0bb6c0fdbc65de84ac82dd78432e4fe6cc99bb86@sha256:b272cadc529b4f95159e8b92e216de51e7969ce83b3a25c94991b0afd0247c64"; fi'
            )}"""
    }
