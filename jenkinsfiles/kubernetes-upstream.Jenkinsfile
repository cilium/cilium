            ...
            steps {
                script {
                    ...
                    if (env.run_with_race_detection?.trim()) {
                        ...
                        env.RACE = 1
                        env.LOCKDEBUG = 1
                        env.BASE_IMAGE = "quay.io/cilium/cilium-runtime:b54bb52bdfeb8e00b513ff4e1735209b18513ce7@sha256:1051e062a17cee337b526de7648527ae5d5f77a8fa647177ab1ddf7db057b105"
                    }
                }
            }
        }
