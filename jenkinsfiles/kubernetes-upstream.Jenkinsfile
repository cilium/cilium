            ...
            steps {
                script {
                    ...
                    if (env.run_with_race_detection?.trim()) {
                        ...
                        env.RACE = 1
                        env.LOCKDEBUG = 1
                        env.BASE_IMAGE = "quay.io/cilium/cilium-runtime:f696a73dbf58e54b52b4069d45d3d97bcde18022@sha256:8a15cb2fb30a05365377dba3d8ca4dca6355e7fd485cae31f9f5db51ac4cacb8"
                    }
                }
            }
        }
