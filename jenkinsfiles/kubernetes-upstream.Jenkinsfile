            ...
            steps {
                script {
                    ...
                    if (env.run_with_race_detection?.trim()) {
                        ...
                        env.RACE = 1
                        env.LOCKDEBUG = 1
                        env.BASE_IMAGE = "quay.io/cilium/cilium-runtime:e5434bff811d871a8f476f191386a7516ba6cf35@sha256:0f817cf60deaa841f072d8cd4f22a306bc6223341c33decc954d49ebcef720b7"
                    }
                }
            }
        }
