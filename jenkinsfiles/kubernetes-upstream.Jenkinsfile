            ...
            steps {
                script {
                    ...
                    if (env.run_with_race_detection?.trim()) {
                        ...
                        env.RACE = 1
                        env.LOCKDEBUG = 1
                        env.BASE_IMAGE = "quay.io/cilium/cilium-runtime:1418356835c7319a909358670e435ff07a15e092@sha256:a310874630996fc5f0df3e2573eb3ed2b2a6ded8a60c80c5ed84eb4fd0c72d4d"
                    }
                }
            }
        }
