            ...
            steps {
                script {
                    ...
                    if (env.run_with_race_detection?.trim()) {
                        ...
                        env.RACE = 1
                        env.LOCKDEBUG = 1
                        env.BASE_IMAGE = "quay.io/cilium/cilium-runtime:c1a6b950cfa040d2ba63baa638cf92d516968918@sha256:e430519f31fe9c4244eba4f3d00bb2ec480e97874b28e7293a744862f3469d5b"
                    }
                }
            }
        }
