            ...
            steps {
                script {
                    ...
                    if (env.run_with_race_detection?.trim()) {
                        ...
                        env.RACE = 1
                        env.LOCKDEBUG = 1
                        env.BASE_IMAGE = "quay.io/cilium/cilium-runtime:e34d9f3420e3a4d8d725ab5d027335ebf593d4a0@sha256:622d2c2584315dab365eb5d35034e631805752a36f3e32a2ea2e2a08d0ea0f20"
                    }
                }
            }
        }
