            ...
            steps {
                script {
                    ...
                    if (env.run_with_race_detection?.trim()) {
                        ...
                        env.RACE = 1
                        env.LOCKDEBUG = 1
                        env.BASE_IMAGE = "quay.io/cilium/cilium-runtime:13e2cc459b67bfa087c7c697629fd7d27a07fc8f@sha256:181e628161c77b794a524fd3d33e0567443a676335ba078fc218c9b5299eb627"
                    }
                }
            }
        }
