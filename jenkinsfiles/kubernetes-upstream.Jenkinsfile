            ...
            steps {
                script {
                    ...
                    if (env.run_with_race_detection?.trim()) {
                        ...
                        env.RACE = 1
                        env.LOCKDEBUG = 1
                        env.BASE_IMAGE = "quay.io/cilium/cilium-runtime:d3c4c5fe8f4e1e98be66bc1bb97eadc802041032@sha256:b81663e08bf5c7af2de3e62f93702d43d8077319b4e6f9d00e20d050da2d0c36"
                    }
                }
            }
        }
