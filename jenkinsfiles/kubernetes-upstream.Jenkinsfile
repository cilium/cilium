            ...
            steps {
                script {
                    ...
                    if (env.run_with_race_detection?.trim()) {
                        ...
                        env.RACE = 1
                        env.LOCKDEBUG = 1
                        env.BASE_IMAGE = "quay.io/cilium/cilium-runtime:b542f3d6757db6a12e3d1907af2223d3a881a908@sha256:5d59d17abfc3760204a9d282bf38f4619fb0a49867446407c3bccb237ac3efc9"
                    }
                }
            }
        }
