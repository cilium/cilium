            ...
            steps {
                script {
                    ...
                    if (env.run_with_race_detection?.trim()) {
                        ...
                        env.RACE = 1
                        env.LOCKDEBUG = 1
                        env.BASE_IMAGE = "quay.io/cilium/cilium-runtime:087009ba056ac83fa07e3c5a5debe555bd8b4ac6@sha256:f945cd8551c26e69ba2da1a2f376ce1e422e027405e2c8ae261fdfbee07f081b"
                    }
                }
            }
        }
