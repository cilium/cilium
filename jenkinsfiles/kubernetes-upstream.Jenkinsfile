            ...
            steps {
                script {
                    ...
                    if (env.run_with_race_detection?.trim()) {
                        ...
                        env.RACE = 1
                        env.LOCKDEBUG = 1
                        env.BASE_IMAGE = "quay.io/cilium/cilium-runtime:7dcfcedb696d3830e3177892a47988fbf9da17dd@sha256:617ff8b919259b2130f354aa9eb81f8087b353eb6de5ec690ea6ac003da04967"
                    }
                }
            }
        }
