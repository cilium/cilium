            ...
            steps {
                script {
                    ...
                    if (env.run_with_race_detection?.trim()) {
                        ...
                        env.RACE = 1
                        env.LOCKDEBUG = 1
                        env.BASE_IMAGE = "quay.io/cilium/cilium-runtime:7e9835586a87a0ff16edbed42e9b435a6ec3081b@sha256:cce56cb32523dad4eb3c379187f2ac204d0d80e01cfe15f81dc841b796070a52"
                    }
                }
            }
        }
