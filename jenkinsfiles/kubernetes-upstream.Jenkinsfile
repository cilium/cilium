            ...
            steps {
                script {
                    ...
                    if (env.run_with_race_detection?.trim()) {
                        ...
                        env.RACE = 1
                        env.LOCKDEBUG = 1
                        env.BASE_IMAGE = "quay.io/cilium/cilium-runtime:dfc656c8318e2b31657c648a1e71021f312a8910@sha256:2d3bc82b983cc6f3f22de6b59f870266ca28a6eeb72e42c8de3557bb887daf9c"
                    }
                }
            }
        }
