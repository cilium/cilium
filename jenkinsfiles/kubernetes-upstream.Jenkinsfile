            ...
            steps {
                script {
                    ...
                    if (env.run_with_race_detection?.trim()) {
                        ...
                        env.RACE = 1
                        env.LOCKDEBUG = 1
                        env.BASE_IMAGE = "quay.io/cilium/cilium-runtime:5a1b50a816e4595aa4bd4a30436c3c2de244997f@sha256:775fe8dec80480952781f6c2dd02853122032e06c8d8db8abc58d35f3a33f403"
                    }
                }
            }
        }
