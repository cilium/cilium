            ...
            steps {
                script {
                    ...
                    if (env.run_with_race_detection?.trim()) {
                        ...
                        env.RACE = 1
                        env.LOCKDEBUG = 1
                        env.BASE_IMAGE = "quay.io/cilium/cilium-runtime:d7ca49933cc6e1fce46044918444303d50a83acd@sha256:c3e2e1b1d87df30c8940c7ce4828460524b09e327abceda5ceeed97bb01e521a"
                    }
                }
            }
        }
