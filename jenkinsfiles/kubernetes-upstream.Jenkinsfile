            ...
            steps {
                script {
                    ...
                    if (env.run_with_race_detection?.trim()) {
                        ...
                        env.RACE = 1
                        env.LOCKDEBUG = 1
                        env.BASE_IMAGE = "quay.io/cilium/cilium-runtime:1e8c2f35d58671e80cb5621a3f418abc27c62674@sha256:c00ca0daf08ad50df3650e6953b2d517cd9d9aa5f48e8c1e0c32162634959c18"
                    }
                }
            }
        }
