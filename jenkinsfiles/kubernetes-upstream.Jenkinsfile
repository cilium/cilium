            ...
            steps {
                script {
                    ...
                    if (env.run_with_race_detection?.trim()) {
                        ...
                        env.RACE = 1
                        env.LOCKDEBUG = 1
                        env.BASE_IMAGE = "quay.io/cilium/cilium-runtime:df9cd83d149e39a1e9a7e5f7732f3c9a00138088@sha256:6e6f14b271f521956b56549b23fc6917267560c790fd51d8f365473d2257efc8"
                    }
                }
            }
        }
