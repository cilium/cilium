            ...
            steps {
                script {
                    ...
                    if (env.run_with_race_detection?.trim()) {
                        ...
                        env.RACE = 1
                        env.LOCKDEBUG = 1
                        env.BASE_IMAGE = "quay.io/cilium/cilium-runtime:5ad7a4c7b6d9f92d4dc1445f05ff7da61c215bb5@sha256:aa3c6b0ae8ffa6be38de05ae81bf84ab51dc7a3755ae53c82831831164ef0055"
                    }
                }
            }
        }
