            ...
            steps {
                script {
                    ...
                    if (env.run_with_race_detection?.trim()) {
                        ...
                        env.RACE = 1
                        env.LOCKDEBUG = 1
                        env.BASE_IMAGE = "quay.io/cilium/cilium-runtime:06490dbd15ea4fce4a8b779710f1b731e1d14bf7@sha256:5a6a20ab2631b57c0ee1bb2a4c1ab9b5d1e735ae51e282e062bc70cb0848e5c2"
                    }
                }
            }
        }
