            ...
            steps {
                script {
                    ...
                    if (env.run_with_race_detection?.trim()) {
                        ...
                        env.RACE = 1
                        env.LOCKDEBUG = 1
                        env.BASE_IMAGE = "quay.io/cilium/cilium-runtime:a3abb740921325627e4fe925c374d2b32d72d7cc@sha256:cb67095a0ce8177c9e6f72ebe810da2dbaefedd59bb572a8b7ba1b601b805c58"
                    }
                }
            }
        }
