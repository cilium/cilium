            ...
            steps {
                script {
                    ...
                    if (env.run_with_race_detection?.trim()) {
                        ...
                        env.RACE = 1
                        env.LOCKDEBUG = 1
                        env.BASE_IMAGE = "quay.io/cilium/cilium-runtime:973fb63293c54ed64677bafd9da5c33211c7d81a@sha256:d2ca2b4f015a827f59f4aa1b35e767e9abd4afb28c2e1c3f4b50cf5a1368e3be"
                    }
                }
            }
        }
