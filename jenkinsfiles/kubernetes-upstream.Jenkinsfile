            ...
            steps {
                script {
                    ...
                    if (env.run_with_race_detection?.trim()) {
                        ...
                        env.RACE = 1
                        env.LOCKDEBUG = 1
                        env.BASE_IMAGE = "quay.io/cilium/cilium-runtime:563224e0b1b24a4296c632c38f60d1181d1a7f2c@sha256:3686e654f313817ce8a55709b1a52f420bbb56e39bf74659a7e7a01bf4bde666"
                    }
                }
            }
        }
