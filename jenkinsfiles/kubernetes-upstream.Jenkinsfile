            ...
            steps {
                script {
                    ...
                    if (env.run_with_race_detection?.trim()) {
                        ...
                        env.RACE = 1
                        env.LOCKDEBUG = 1
                        env.BASE_IMAGE = "quay.io/cilium/cilium-runtime:1e1499d13a7c1c9a61bfd25e93ba7939e329c875@sha256:e64960224a7985da95be77ed4707ac556f30a011e2a79ef37f87fb0c2c1ff30f"
                    }
                }
            }
        }
