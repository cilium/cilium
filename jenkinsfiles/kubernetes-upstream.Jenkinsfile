            ...
            steps {
                script {
                    ...
                    if (env.run_with_race_detection?.trim()) {
                        ...
                        env.RACE = 1
                        env.LOCKDEBUG = 1
                        env.BASE_IMAGE = "quay.io/cilium/cilium-runtime:2cd6c6c20cb4bf488313731ef5fd0964b8ba1264@sha256:9ac803ffef0cf354f02b6a86599a63ec5c7463b300cba7461f3840e3b5f4cb22"
                    }
                }
            }
        }
