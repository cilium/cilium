            ...
            steps {
                script {
                    ...
                    if (env.run_with_race_detection?.trim()) {
                        ...
                        env.RACE = 1
                        env.LOCKDEBUG = 1
                        env.BASE_IMAGE = "quay.io/cilium/cilium-runtime:1945586a473b4e4791035cd23d9582f85ba0d586@sha256:dc4867c9c89b5e6a914437bb0915b556084df950e55976bd3db31b1feccb5b28"
                    }
                }
            }
        }
