            ...
            steps {
                script {
                    ...
                    if (env.run_with_race_detection?.trim()) {
                        ...
                        env.RACE = 1
                        env.LOCKDEBUG = 1
                        env.BASE_IMAGE = "quay.io/cilium/cilium-runtime:cacb29de750ec721ba316707b4fba662cfa2d4f3@sha256:51a284290545c9d89fc5d5ad6e07c380adc9ba4b20d4e1c57afcb5bc934cdd0e"
                    }
                }
            }
        }
