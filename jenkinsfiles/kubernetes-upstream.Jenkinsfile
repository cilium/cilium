            ...
            steps {
                script {
                    ...
                    if (env.run_with_race_detection?.trim()) {
                        ...
                        env.RACE = 1
                        env.LOCKDEBUG = 1
                        env.BASE_IMAGE = "quay.io/cilium/cilium-runtime:0ce09dc60d09d4c39b47c37e727a5411eada4964@sha256:08afe5e9a228b18ecbd8cee238f6feaa5f6f73a9c554651a45e67acb906a19b3"
                    }
                }
            }
        }
