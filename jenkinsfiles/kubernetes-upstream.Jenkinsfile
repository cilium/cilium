            ...
            steps {
                script {
                    ...
                    if (env.run_with_race_detection?.trim()) {
                        ...
                        env.RACE = 1
                        env.LOCKDEBUG = 1
                        env.BASE_IMAGE = "quay.io/cilium/cilium-runtime:9f01ce8b48a55632cda7bef914313ccfa6f3d922@sha256:26cf394bdcc184b4d1255bea3d6a2728f6228a7418fb0fe9b43c5b5ac5d3b73e"
                    }
                }
            }
        }
