            ...
            steps {
                script {
                    ...
                    if (env.run_with_race_detection?.trim()) {
                        ...
                        env.RACE = 1
                        env.LOCKDEBUG = 1
                        env.BASE_IMAGE = "quay.io/cilium/cilium-runtime:c043ab7fd14a8f9e651a203958f8846ba516183b@sha256:5f9e0be1db11d3e877d0d8b0b9ae3f69a2d28177c72ca015ce5400db001189d6"
                    }
                }
            }
        }
