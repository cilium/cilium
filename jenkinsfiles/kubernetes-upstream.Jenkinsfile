            ...
            steps {
                script {
                    ...
                    if (env.run_with_race_detection?.trim()) {
                        ...
                        env.RACE = 1
                        env.LOCKDEBUG = 1
                        env.BASE_IMAGE = "quay.io/cilium/cilium-runtime:3e2e833be819bf5180a66c1fb4f5b6e06190ff08@sha256:aea4e311470eb79c15b081d0fed55b666ac23d334e9813093eef097e037c003e"
                    }
                }
            }
        }
