            ...
            steps {
                script {
                    ...
                    if (env.run_with_race_detection?.trim()) {
                        ...
                        env.RACE = 1
                        env.LOCKDEBUG = 1
                        env.BASE_IMAGE = "quay.io/cilium/cilium-runtime:5e172c29a08dcd3c3b35d38a3a877871f8d85fff@sha256:884dd20a1bab972b37302987e9fa5327aec7a9bcd61f4b0071d530ce0135b7f8"
                    }
                }
            }
        }
