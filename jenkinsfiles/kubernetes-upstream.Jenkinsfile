            ...
            steps {
                script {
                    ...
                    if (env.run_with_race_detection?.trim()) {
                        ...
                        env.RACE = 1
                        env.LOCKDEBUG = 1
                        env.BASE_IMAGE = "quay.io/cilium/cilium-runtime:ff34620c7ff4836f82b45ea220a6f24b35ea1eb4@sha256:adfdb186f0c3e353d9c4093f513c4c4d0b925bf1d916a342585f9da1ffb6ba74"
                    }
                }
            }
        }
