            ...
            steps {
                script {
                    ...
                    if (env.run_with_race_detection?.trim()) {
                        ...
                        env.RACE = 1
                        env.LOCKDEBUG = 1
                        env.BASE_IMAGE = "quay.io/cilium/cilium-runtime:158ad1e5449a508836b28940eedeaa346e1ff8af@sha256:762c4c5c2aedad216fa745d4dab34ca64adff10a7931ce501ad1486e9f05305d"
                    }
                }
            }
        }
