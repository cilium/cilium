            ...
            steps {
                script {
                    ...
                    if (env.run_with_race_detection?.trim()) {
                        ...
                        env.RACE = 1
                        env.LOCKDEBUG = 1
                        env.BASE_IMAGE = "quay.io/cilium/cilium-runtime:abe2b193a769bd4c9a96bc46e5ea6549e43295d0@sha256:8d434551494c25674ded177509a4d7d70ef918b3ac3443b76a50619217579a56"
                    }
                }
            }
        }
