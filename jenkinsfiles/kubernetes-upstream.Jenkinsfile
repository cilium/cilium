            ...
            steps {
                script {
                    ...
                    if (env.run_with_race_detection?.trim()) {
                        ...
                        env.RACE = 1
                        env.LOCKDEBUG = 1
                        env.BASE_IMAGE = "quay.io/cilium/cilium-runtime:9024fd147a121081bc419b567e3d76226e3ad38c@sha256:6ee3135edf5b71628334315dee67f0f870721a89f414134f6be71952059e4915"
                    }
                }
            }
        }
