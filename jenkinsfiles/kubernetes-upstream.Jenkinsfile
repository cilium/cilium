            ...
            steps {
                script {
                    ...
                    if (env.run_with_race_detection?.trim()) {
                        ...
                        env.RACE = 1
                        env.LOCKDEBUG = 1
                        env.BASE_IMAGE = "quay.io/cilium/cilium-runtime:b0782dc8e9c0985ff9d7853352e428f5307115b0@sha256:10d6eba1fc668c6f87065f562ddb437e7ce906c22a42af076bff5c1bded07cb2"
                    }
                }
            }
        }
