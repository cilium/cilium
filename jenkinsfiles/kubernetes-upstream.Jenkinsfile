            ...
            steps {
                script {
                    ...
                    if (env.run_with_race_detection?.trim()) {
                        ...
                        env.RACE = 1
                        env.LOCKDEBUG = 1
                        env.BASE_IMAGE = "quay.io/cilium/cilium-runtime:336f18ffc68df54905a20b49e7a1c5fb1023aff4@sha256:dcfcdb78de1d8b429aa292e4b17d8c98b268828de7f043977abf8c21ab2197ed"
                    }
                }
            }
        }
