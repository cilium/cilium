            ...
            steps {
                script {
                    ...
                    if (env.run_with_race_detection?.trim()) {
                        ...
                        env.RACE = 1
                        env.LOCKDEBUG = 1
                        env.BASE_IMAGE = "quay.io/cilium/cilium-runtime:2690979bf14e08e479b6740fa8cfd0189ac89d4d@sha256:5d4df8b0c8fde2d4c9c6a57ed489067e492bedd9e107f635a896dcadfa9a8e68"
                    }
                }
            }
        }
