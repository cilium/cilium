            ...
            steps {
                script {
                    ...
                    if (env.run_with_race_detection?.trim()) {
                        ...
                        env.RACE = 1
                        env.LOCKDEBUG = 1
                        env.BASE_IMAGE = "quay.io/cilium/cilium-runtime:0122ba734281d24da7e779c0c210ad9b089e46e1@sha256:dc41f50265b138e4820845b7a08aeba16480fdbae2f35b3de2fe075d018fc6f5"
                    }
                }
            }
        }
