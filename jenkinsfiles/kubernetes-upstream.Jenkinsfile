            ...
            steps {
                script {
                    ...
                    if (env.run_with_race_detection?.trim()) {
                        ...
                        env.RACE = 1
                        env.LOCKDEBUG = 1
                        env.BASE_IMAGE = "quay.io/cilium/cilium-runtime:f23db556d94ddfbdff8fe6873c40087670e7cd4d@sha256:e807b7a372f385838bcd654dd500954572d3b6184cb40860a4225f4c8a8770d4"
                    }
                }
            }
        }
