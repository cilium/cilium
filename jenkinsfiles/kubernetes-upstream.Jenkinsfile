            ...
            steps {
                script {
                    ...
                    if (env.run_with_race_detection?.trim()) {
                        ...
                        env.RACE = 1
                        env.LOCKDEBUG = 1
                        env.BASE_IMAGE = "quay.io/cilium/cilium-runtime:820cc3316b8849eac05fa331588cc89f10aad233@sha256:af86e527203d2fee89f6ae05cea94497a15c6e5a1d3764fdddf059375fc32dfa"
                    }
                }
            }
        }
