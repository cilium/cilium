            ...
            steps {
                script {
                    ...
                    if (env.run_with_race_detection?.trim()) {
                        ...
                        env.RACE = 1
                        env.LOCKDEBUG = 1
                        env.BASE_IMAGE = "quay.io/cilium/cilium-runtime:a3d756ad4c3057f59ea05874d1521a0cc8e8ac5b@sha256:c528c27dc01bfbd633de32420b6fb75d0a5c51df1115e0b9b18f6c4e004fb8e4"
                    }
                }
            }
        }
