            ...
            steps {
                script {
                    ...
                    if (env.run_with_race_detection?.trim()) {
                        ...
                        env.RACE = 1
                        env.LOCKDEBUG = 1
                        env.BASE_IMAGE = "quay.io/cilium/cilium-runtime:98f4eeadcb7114ea005651db9ac5ec151df8f2ca@sha256:3f6e9c96193e21695856923647c01da37305597c2404a257acbe73d8045366cf"
                    }
                }
            }
        }
