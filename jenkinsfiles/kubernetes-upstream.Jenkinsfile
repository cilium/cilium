            ...
            steps {
                script {
                    ...
                    if (env.run_with_race_detection?.trim()) {
                        ...
                        env.RACE = 1
                        env.LOCKDEBUG = 1
                        env.BASE_IMAGE = "quay.io/cilium/cilium-runtime:edd960caf1637ddfaa6aa408a97e964aa092d27a@sha256:8582fa189b4de69af1b0243dd0429b99b31b0838d2cdb1e95a2825677e951fab"
                    }
                }
            }
        }
