            ...
            steps {
                script {
                    ...
                    if (env.run_with_race_detection?.trim()) {
                        ...
                        env.RACE = 1
                        env.LOCKDEBUG = 1
                        env.BASE_IMAGE = "quay.io/cilium/cilium-runtime:96fc240933c32e0cbb19aba93619c509ca2d5130@sha256:9ab9e8c02fb2f733dde730d1a81d6cfe11006f652842bae4bee46a0a98a24b3e"
                    }
                }
            }
        }
