            ...
            steps {
                script {
                    ...
                    if (env.run_with_race_detection?.trim()) {
                        ...
                        env.RACE = 1
                        env.LOCKDEBUG = 1
                        env.BASE_IMAGE = "quay.io/cilium/cilium-runtime:5de601a26afe3cd7c8ca65d27047d5b995081fca@sha256:a0077ba7cec656527a3d7a8fbd6692e54074f45e0f9794ff71c6c5fc4b2a9c87"
                    }
                }
            }
        }
