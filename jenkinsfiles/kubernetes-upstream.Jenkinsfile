            ...
            steps {
                script {
                    ...
                    if (env.run_with_race_detection?.trim()) {
                        ...
                        env.RACE = 1
                        env.LOCKDEBUG = 1
                        env.BASE_IMAGE = "quay.io/cilium/cilium-runtime:4c67907d7e9d8f2cd1e94ef17fb97ca7f8c8f4bb@sha256:db061a88e80e5d2e067f1a796913a748062eaf342c02d962d137f3fb4e6853e7"
                    }
                }
            }
        }
