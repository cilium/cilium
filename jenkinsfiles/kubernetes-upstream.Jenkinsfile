            ...
            steps {
                script {
                    ...
                    if (env.run_with_race_detection?.trim()) {
                        ...
                        env.RACE = 1
                        env.LOCKDEBUG = 1
                        env.BASE_IMAGE = "quay.io/cilium/cilium-runtime:1f2066df2ebcaece98f24d0127c1dc648e4b11cb@sha256:0cd9485b6d6730e2d0b7e21c090cc821592de7ffacebc9450c3a4dde614abc6c"
                    }
                }
            }
        }
