            ...
            steps {
                script {
                    ...
                    if (env.run_with_race_detection?.trim()) {
                        ...
                        env.RACE = 1
                        env.LOCKDEBUG = 1
                        env.BASE_IMAGE = "quay.io/cilium/cilium-runtime:faaf5082a5d34178eefb90804af3f6097416c677@sha256:35e1cb549eaa84a74f1797c9cb86232ac601d22eb9bdf401f4f5960fa550d8cd"
                    }
                }
            }
        }
