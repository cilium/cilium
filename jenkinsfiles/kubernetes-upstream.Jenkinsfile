            ...
            steps {
                script {
                    ...
                    if (env.run_with_race_detection?.trim()) {
                        ...
                        env.RACE = 1
                        env.LOCKDEBUG = 1
                        env.BASE_IMAGE = "quay.io/cilium/cilium-runtime:d030b0055f0b3dec06fbfa5e9dfd26ebd64ebb20@sha256:2f5ed3f0f52434895458a039ca3caf46c4c95ad0da14d15079114c4ecd0a6c79"
                    }
                }
            }
        }
