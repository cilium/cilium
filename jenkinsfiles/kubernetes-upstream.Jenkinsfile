            ...
            steps {
                script {
                    ...
                    if (env.run_with_race_detection?.trim()) {
                        ...
                        env.RACE = 1
                        env.LOCKDEBUG = 1
                        env.BASE_IMAGE = "quay.io/cilium/cilium-runtime:022976689e1cd5aa3b181f4dbb1fa66bf29e71b4@sha256:93634dbdf6b1987376d2f7802019a88406055de026a5a7df22fd1853f0a719f1"
                    }
                }
            }
        }
