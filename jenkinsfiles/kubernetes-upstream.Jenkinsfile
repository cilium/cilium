            ...
            steps {
                script {
                    ...
                    if (env.run_with_race_detection?.trim()) {
                        ...
                        env.RACE = 1
                        env.LOCKDEBUG = 1
                        env.BASE_IMAGE = "quay.io/cilium/cilium-runtime:ebc687308f54d8b99a33b06e4f4487586fd3dccf@sha256:f5ff7e9e3ae78eccbe113daba7c897cd7a0576f070c18221970d0bc64a0cdc05"
                    }
                }
            }
        }
