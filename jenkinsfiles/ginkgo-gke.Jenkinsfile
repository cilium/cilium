            ...
            steps {
                script {
                    ...
                    if (env.run_with_race_detection?.trim()) {
                        ...
                        env.RACE = 1
                        env.LOCKDEBUG = 1
                        env.BASE_IMAGE = "quay.io/cilium/cilium-runtime:b0885b399fc9d0ebe6055e8228746e804a1db08f@sha256:70ddac8b12af3a4e35b41525327483ee726bfdd34e5bae44048f85f59a084634"
                    }
                }
            }
        }
