            ...
            steps {
                script {
                    ...
                    if (env.run_with_race_detection?.trim()) {
                        ...
                        env.RACE = 1
                        env.LOCKDEBUG = 1
                        env.BASE_IMAGE = "quay.io/cilium/cilium-runtime:b58cfddf7d5d23aaaf67aec03625829cb981a650@sha256:2a15e9d38854df887f40a570c377e2cf8544efffe0e26a8d1a81d653ebd98a4c"
                    }
                }
            }
        }
