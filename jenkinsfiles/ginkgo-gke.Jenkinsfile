            ...
            steps {
                script {
                    ...
                    if (env.run_with_race_detection?.trim()) {
                        ...
                        env.RACE = 1
                        env.LOCKDEBUG = 1
                        env.BASE_IMAGE = "quay.io/cilium/cilium-runtime:cde28051dc1a0ca962e46b429629fef2e0a8ad76@sha256:34a92610499232ec47541dfc65fd96c65a6ebd8f14be490487af61cb67b85d17"
                    }
                }
            }
        }
