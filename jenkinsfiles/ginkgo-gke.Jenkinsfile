            ...
            steps {
                script {
                    ...
                    if (env.run_with_race_detection?.trim()) {
                        ...
                        env.RACE = 1
                        env.LOCKDEBUG = 1
                        env.BASE_IMAGE = "quay.io/cilium/cilium-runtime:21c06d053d35fa5d381e55aaddc30ae1413628da@sha256:4a0b58bccab3a9da8de65f9acb82833bc4960be9c666986e16fe13f8bdebc65d"
                    }
                }
            }
        }
