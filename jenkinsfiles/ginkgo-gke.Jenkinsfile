            ...
            steps {
                script {
                    ...
                    if (env.run_with_race_detection?.trim()) {
                        ...
                        env.RACE = 1
                        env.LOCKDEBUG = 1
                        env.BASE_IMAGE = "quay.io/cilium/cilium-runtime:b697d634b751d24a764839b5ba518609940138c4@sha256:87bb40673a1a1087301686bf34e47b04ca229c6f2b3c00c7b702365a72015a89"
                    }
                }
            }
        }
