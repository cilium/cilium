            ...
            steps {
                script {
                    ...
                    if (env.run_with_race_detection?.trim()) {
                        ...
                        env.RACE = 1
                        env.LOCKDEBUG = 1
                        env.BASE_IMAGE = "quay.io/cilium/cilium-runtime:55b5da3af70057b755a1add87bd4584b24421ecb@sha256:c8c164ad5ec76679e44295a1ba63abe4df84255df188e2f4cba0b912e3becd01"
                    }
                }
            }
        }
