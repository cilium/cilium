            ...
            steps {
                script {
                    ...
                    if (env.run_with_race_detection?.trim()) {
                        ...
                        env.RACE = 1
                        env.LOCKDEBUG = 1
                        env.BASE_IMAGE = "quay.io/cilium/cilium-runtime:dbcf3530a541e87ffd39d4092c5075dc1e67bc06@sha256:7c52235b92b523da2724ac173e4f2ed75731c387897ede971831efdb2f1e7e44"
                    }
                }
            }
        }
