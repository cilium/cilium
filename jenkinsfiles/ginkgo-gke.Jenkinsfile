            ...
            steps {
                script {
                    ...
                    if (env.run_with_race_detection?.trim()) {
                        ...
                        env.RACE = 1
                        env.LOCKDEBUG = 1
                        env.BASE_IMAGE = "quay.io/cilium/cilium-runtime:ce0d703d6dec4e04d3240cf0324fbbee700f572b@sha256:a186ef2569b2403c2f132765d4b3e7c97c2ea82280a103c6fe3c2b019ff86c3e"
                    }
                }
            }
        }
