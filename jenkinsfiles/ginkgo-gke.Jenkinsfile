            ...
            steps {
                script {
                    ...
                    if (env.run_with_race_detection?.trim()) {
                        ...
                        env.RACE = 1
                        env.LOCKDEBUG = 1
                        env.BASE_IMAGE = "quay.io/cilium/cilium-runtime:8264606c7467015d6dd940840b0b60adce197d4d@sha256:7bb1f6dd0bad7816b080d4a4dc52bd8959b107cc2a6c05910d36795ede359711"
                    }
                }
            }
        }
