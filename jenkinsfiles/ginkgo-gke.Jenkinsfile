            ...
            steps {
                script {
                    ...
                    if (env.run_with_race_detection?.trim()) {
                        ...
                        env.RACE = 1
                        env.LOCKDEBUG = 1
                        env.BASE_IMAGE = "quay.io/cilium/cilium-runtime:5f983a94517575472ca8ff5fe840c300df2c2974@sha256:df682dfaf542ee20ec1295931d6796ff88e91ab6fa46200eed78ab55e949c435"
                    }
                }
            }
        }
