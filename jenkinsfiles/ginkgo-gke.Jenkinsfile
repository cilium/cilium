            ...
            steps {
                script {
                    ...
                    if (env.run_with_race_detection?.trim()) {
                        ...
                        env.RACE = 1
                        env.LOCKDEBUG = 1
                        env.BASE_IMAGE = "quay.io/cilium/cilium-runtime:2f1679a5fb3fb615cf3b94f77836a10e070a42ee@sha256:eb310ad6f7c1757dd8d023b875eae64f64d531bf965f848cadf88925b3ddf9c1"
                    }
                }
            }
        }
