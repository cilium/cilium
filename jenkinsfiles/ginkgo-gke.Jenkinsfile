            ...
            steps {
                script {
                    ...
                    if (env.run_with_race_detection?.trim()) {
                        ...
                        env.RACE = 1
                        env.LOCKDEBUG = 1
                        env.BASE_IMAGE = "quay.io/cilium/cilium-runtime:f759a5cb8871eae9b2d04257901e3f4cc8a39ec3@sha256:10399d6fc307cf959ea2cff3cd00d400986214509f456bf9eab56f186265ecbf"
                    }
                }
            }
        }
