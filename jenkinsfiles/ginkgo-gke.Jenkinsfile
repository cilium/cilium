            ...
            steps {
                script {
                    ...
                    if (env.run_with_race_detection?.trim()) {
                        ...
                        env.RACE = 1
                        env.LOCKDEBUG = 1
                        env.BASE_IMAGE = "quay.io/cilium/cilium-runtime:6e58bd1d77ca7a8fa8bd9bafdc6fbd10b3b0c061@sha256:65779b9eda33d264fe2c2618454059f7e99c52a206824677bb92916c11de9ae0"
                    }
                }
            }
        }
