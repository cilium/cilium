            ...
            steps {
                script {
                    ...
                    if (env.run_with_race_detection?.trim()) {
                        ...
                        env.RACE = 1
                        env.LOCKDEBUG = 1
                        env.BASE_IMAGE = "quay.io/cilium/cilium-runtime:6e2e3f2606e478b1c9a404070e3b21f2f5496445@sha256:964737fd10e65bcdac6497b67c657760bc0304aee52a897c64cab03de6576015"
                    }
                }
            }
        }
