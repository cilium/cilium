...
func findMaster(mac string) (index int, err error) {
...
func eniAdd(ipConfig *current.IPConfig, ipam *models.IPAMAddressResponse) error {
	...
	ifindex, err := findMaster(ipam.MasterMac)
	if err != nil {
		return err
	}
