...
func (driver *driver) getDefaultAddressSpaces(w http.ResponseWriter, r *http.Request) {
	...
	log.WithField("resp", logfields.Repr(resp)).Debug("Get Default Address Spaces response")
...
func (driver *driver) requestPool(w http.ResponseWriter, r *http.Request) {
	...
	log.WithField("req", logfields.Repr(&req)).Debug("Request Pool request")
	resp := driver.getPoolResponse(&req)
	log.WithField("resp", logfields.Repr(resp)).Debug("Request Pool response")
	objectResponse(w, resp)
}
...
func (driver *driver) releasePool(w http.ResponseWriter, r *http.Request) {
	...
	log.WithField("req", logfields.Repr(&release)).Debug("Release Pool request")
...
func (driver *driver) requestAddress(w http.ResponseWriter, r *http.Request) {
	...
	log.WithField("req", logfields.Repr(&request)).Debug("Request Address request")
	...
	log.WithField("resp", logfields.Repr(resp)).Debug("Request Address response")
	objectResponse(w, resp)
}
...
func (driver *driver) releaseAddress(w http.ResponseWriter, r *http.Request) {
	...
	log.WithField("req", logfields.Repr(&release)).Debug("Release Address request")
