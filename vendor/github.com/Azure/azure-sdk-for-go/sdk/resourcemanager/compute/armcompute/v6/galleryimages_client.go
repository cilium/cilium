...
func (client *GalleryImagesClient) listByGalleryCreateRequest(ctx context.Context, resourceGroupName string, galleryName string, _ *GalleryImagesClientListByGalleryOptions) (*policy.Request, error) {
