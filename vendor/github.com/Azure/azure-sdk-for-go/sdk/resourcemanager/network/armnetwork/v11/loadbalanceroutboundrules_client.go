...
func (client *LoadBalancerOutboundRulesClient) getCreateRequest(ctx context.Context, resourceGroupName string, loadBalancerName string, outboundRuleName string, _ *LoadBalancerOutboundRulesClientGetOptions) (*policy.Request, error) {
...
func (client *LoadBalancerOutboundRulesClient) getHandleResponse(resp *http.Response, successCodes ...int) (LoadBalancerOutboundRulesClientGetResponse, error) {
...
func (client *LoadBalancerOutboundRulesClient) listCreateRequest(ctx context.Context, resourceGroupName string, loadBalancerName string, nextLink string, _ *LoadBalancerOutboundRulesClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *LoadBalancerOutboundRulesClient) listHandleResponse(resp *http.Response, successCodes ...int) (LoadBalancerOutboundRulesClientListResponse, error) {
