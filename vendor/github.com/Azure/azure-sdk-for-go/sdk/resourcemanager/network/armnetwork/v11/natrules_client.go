...
func (client *NatRulesClient) getHandleResponse(resp *http.Response, successCodes ...int) (NatRulesClientGetResponse, error) {
...
func (client *NatRulesClient) listByVPNGatewayCreateRequest(ctx context.Context, resourceGroupName string, gatewayName string, nextLink string, _ *NatRulesClientListByVPNGatewayOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *NatRulesClient) listByVPNGatewayHandleResponse(resp *http.Response, successCodes ...int) (NatRulesClientListByVPNGatewayResponse, error) {
