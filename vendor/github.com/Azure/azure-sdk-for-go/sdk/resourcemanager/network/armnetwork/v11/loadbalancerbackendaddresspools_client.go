...
func (client *LoadBalancerBackendAddressPoolsClient) getHandleResponse(resp *http.Response, successCodes ...int) (LoadBalancerBackendAddressPoolsClientGetResponse, error) {
...
func (client *LoadBalancerBackendAddressPoolsClient) listCreateRequest(ctx context.Context, resourceGroupName string, loadBalancerName string, nextLink string, _ *LoadBalancerBackendAddressPoolsClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *LoadBalancerBackendAddressPoolsClient) listHandleResponse(resp *http.Response, successCodes ...int) (LoadBalancerBackendAddressPoolsClientListResponse, error) {
