...
//   - vpnSiteLinkName - The name of the resource that is unique within a resource group. This name can be used to access the
//     resource.
...
func (client *VPNSiteLinksClient) getCreateRequest(ctx context.Context, resourceGroupName string, vpnSiteName string, vpnSiteLinkName string, _ *VPNSiteLinksClientGetOptions) (*policy.Request, error) {
...
func (client *VPNSiteLinksClient) getHandleResponse(resp *http.Response, successCodes ...int) (VPNSiteLinksClientGetResponse, error) {
...
func (client *VPNSiteLinksClient) NewListByVPNSitePager(resourceGroupName string, vpnSiteName string, options *VPNSiteLinksClientListByVPNSiteOptions) *runtime.Pager[VPNSiteLinksClientListByVPNSiteResponse] {
	return runtime.NewPager(runtime.PagingHandler[VPNSiteLinksClientListByVPNSiteResponse]{
		...
		Fetcher: func(ctx context.Context, page *VPNSiteLinksClientListByVPNSiteResponse) (VPNSiteLinksClientListByVPNSiteResponse, error) {
			...
			req, err := client.listByVPNSiteCreateRequest(ctx, resourceGroupName, vpnSiteName, nextLink, options)
			if err != nil {
			...
			return client.listByVPNSiteHandleResponse(resp, http.StatusOK)
		},
...
func (client *VPNSiteLinksClient) listByVPNSiteCreateRequest(ctx context.Context, resourceGroupName string, vpnSiteName string, nextLink string, _ *VPNSiteLinksClientListByVPNSiteOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *VPNSiteLinksClient) listByVPNSiteHandleResponse(resp *http.Response, successCodes ...int) (VPNSiteLinksClientListByVPNSiteResponse, error) {
