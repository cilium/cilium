...
func (client *AvailableEndpointServicesClient) listCreateRequest(ctx context.Context, location string, nextLink string, _ *AvailableEndpointServicesClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *AvailableEndpointServicesClient) listHandleResponse(resp *http.Response, successCodes ...int) (AvailableEndpointServicesClientListResponse, error) {
