...
// AddressPrefixSet - Address prefix set child resource of an application security group.
...
// AddressPrefixSetListResult - The response of a AddressPrefixSet list operation.
type AddressPrefixSetListResult struct {
	// REQUIRED; The AddressPrefixSet items on this page
...
// AddressPrefixSetPropertiesFormat - Properties of address prefix set.
type AddressPrefixSetPropertiesFormat struct {
	// REQUIRED; The list of address prefixes in CIDR notation. Supports both IPv4 and IPv6 CIDR notation (e.g. '10.0.0.0/16',
	// '2001:db8::/32').
	AddressPrefixes []*string

	// READ-ONLY; The provisioning state of the address prefix set resource.
...
type AdminRule struct {
	// CONSTANT; Whether the rule is custom or default.
	// Field has constant value AdminRuleKindCustom, any specified value is ignored.
	Kind *AdminRuleKind
...
// AdminRuleCollectionListResult - The response of a AdminRuleCollection list operation.
type AdminRuleCollectionListResult struct {
	// REQUIRED; The AdminRuleCollection items on this page
...
// AdminRuleListResult - Paged collection of BaseAdminRule items
type AdminRuleListResult struct {
	// REQUIRED; The BaseAdminRule items on this page
...
// AdvertisedPublicPrefixProperties - Prefix properties required to perform validation using openssl signature.
type AdvertisedPublicPrefixProperties struct {
	...
	// READ-ONLY; Advertised Public Prefix State that denotes if the prefix is validated or not.
	ValidationState *AdvertisedPublicPrefixPropertiesValidationState
}

// AfcConfiguration - AFC configuration for the Azure Firewall.
type AfcConfiguration struct {
	// READ-ONLY; The endpoint URL of the AFC control plane associated with this Azure Firewall.
...
type ApplicationGatewayAvailableSSLPredefinedPolicies struct {
	// REQUIRED; The ApplicationGatewaySslPredefinedPolicy items on this page
...
type ApplicationGatewayBackendHTTPSettingsPropertiesFormat struct {
	...
	// Specify an SNI value to match the common name of the certificate on the backend. By default, the application gateway uses
	// the incoming request’s host header as the SNI. Default value is null.
	SniName *string
	...
	// When enabled, verifies if the Common Name of the certificate provided by the backend server matches the Server Name Indication
	// (SNI) value. Default value is true.
	ValidateSNI *bool
...
type ApplicationGatewayHeaderConfiguration struct {
	...
	// headers with the same name exist. Currently supported for Set-Cookie Response header only. For more details, visit https://aka.ms/appgwheadercrud
...
// ApplicationGatewayListResult - The response of a ApplicationGateway list operation.
type ApplicationGatewayListResult struct {
	// REQUIRED; The ApplicationGateway items on this page
...
// ApplicationGatewayManagedHsm - Managed HSM properties of an application gateway.
...
// ApplicationGatewayPrivateEndpointConnectionListResult - The response of a ApplicationGatewayPrivateEndpointConnection list
// operation.
type ApplicationGatewayPrivateEndpointConnectionListResult struct {
	// REQUIRED; The ApplicationGatewayPrivateEndpointConnection items on this page
...
// ApplicationGatewayPrivateLinkResourceListResult - The response of a ApplicationGatewayPrivateLinkResource list operation.
type ApplicationGatewayPrivateLinkResourceListResult struct {
	// REQUIRED; The ApplicationGatewayPrivateLinkResource items on this page
...
type ApplicationGatewayProbePropertiesFormat struct {
	...
	// port from http settings will be used. This property is valid for Basic, Standard_v2 and WAF_v2 only.
	Port *int32
...
type ApplicationGatewayPropertiesFormat struct {
	...
	// Entra JWT validation configurations for the application gateway resource. For default limits, see [Application Gateway
...
type ApplicationGatewayWafDynamicManifestResultList struct {
	// REQUIRED; The ApplicationGatewayWafDynamicManifestResult items on this page
...
type ApplicationRule struct {
	// CONSTANT; Rule Type.
	// Field has constant value FirewallPolicyRuleTypeApplicationRule, any specified value is ignored.
...
// ApplicationSecurityGroupListResult - The response of a ApplicationSecurityGroup list operation.
type ApplicationSecurityGroupListResult struct {
	// REQUIRED; The ApplicationSecurityGroup items on this page
...
type AutoApprovedPrivateLinkServicesResult struct {
	// REQUIRED; The AutoApprovedPrivateLinkService items on this page
...
type AvailableDelegationsResult struct {
	// REQUIRED; The AvailableDelegation items on this page
...
type AvailablePrivateEndpointTypesResult struct {
	// REQUIRED; The AvailablePrivateEndpointType items on this page
...
type AvailableServiceAliasesResult struct {
	// REQUIRED; The AvailableServiceAlias items on this page
...
// AzureFirewallFqdnTagListResult - The response of a AzureFirewallFqdnTag list operation.
type AzureFirewallFqdnTagListResult struct {
	// REQUIRED; The AzureFirewallFqdnTag items on this page
...
// AzureFirewallListResult - The response of a AzureFirewall list operation.
type AzureFirewallListResult struct {
	// REQUIRED; The AzureFirewall items on this page
	Value []*AzureFirewall
...
// AzureFirewallPacketCaptureResponse - Response of an Azure Firewall Packet Capture Operation.
type AzureFirewallPacketCaptureResponse struct {
...
type AzureFirewallPropertiesFormat struct {
	...
	// READ-ONLY; AFC configuration for the Azure Firewall.
...
// AzureWebCategoryListResult - List of Azure Web Categories for a given Subscription.
type AzureWebCategoryListResult struct {
	// REQUIRED; The AzureWebCategory items on this page
...
type BastionActiveSessionListResult struct {
	// REQUIRED; The BastionActiveSession items on this page
...
// BastionHostListResult - The response of a BastionHost list operation.
type BastionHostListResult struct {
	// REQUIRED; The BastionHost items on this page
	Value []*BastionHost
...
type BastionShareableLinkListResult struct {
	// REQUIRED; The BastionShareableLink items on this page
...
// BgpServiceCommunityListResult - The response of a BgpServiceCommunity list operation.
type BgpServiceCommunityListResult struct {
	// REQUIRED; The BgpServiceCommunity items on this page
...
// CommitListResult - The response of a Commit list operation.
type CommitListResult struct {
	// REQUIRED; The Commit items on this page
	Value []*Commit
...
// CommitProperties - Properties of commit
...
// ConnectionAnalyzer - Defines a connection analyzer resource.
type ConnectionAnalyzer struct {
	// REQUIRED; Resource location.
	Location *string

	// REQUIRED; Properties of the connection analyzer.
	...
	// READ-ONLY; Resource ID of the connection analyzer.
	ID *string

	// READ-ONLY; Name of the connection analyzer.
	Name *string
...
// ConnectionAnalyzerEndpoint - Describes a source or destination endpoint of a connection analyzer.
...
type ConnectionAnalyzerEndpoint struct {
	// REQUIRED; The type of the endpoint. Determines which of `resourceId` and `address`
...
// ConnectionAnalyzerListResult - List of connection analyzers.
type ConnectionAnalyzerListResult struct {
...
// ConnectionAnalyzerProperties - Properties of a connection analyzer.
type ConnectionAnalyzerProperties struct {
	// REQUIRED; Destination endpoint of the connection analyzer.
	Destination *ConnectionAnalyzerEndpoint

	// REQUIRED; List of diagnostic operations to run.
	DiagnosticOperations []*DiagnosticOperation

	// REQUIRED; Source endpoint of the connection analyzer.
	...
	// READ-ONLY; The provisioning state of the connection analyzer resource.
	ProvisioningState *ProvisioningState

	// READ-ONLY; UTC time when the connection analyzer request was received.
	RequestTime *time.Time

	// READ-ONLY; Current execution status of the connection analyzer.
	Status *ConnectionAnalyzerStatus
}

// ConnectionAnalyzerQueryStatusResult - Status result returned when querying a connection analyzer for its diagnostic results.
type ConnectionAnalyzerQueryStatusResult struct {
...
// ConnectionPolicyProperties - Properties of the ConnectionPolicy resource.
type ConnectionPolicyProperties struct {
	...
	// READ-ONLY; List of connection names (e.g. VpnConnection, HubVirtualNetworkConnection) associated with this ConnectionPolicy.
	// These are resource names, not Azure resource IDs, consistent with the established VirtualWAN pattern used by HubRouteTable.associatedConnections.
	AssociatedConnections []*string

	// READ-ONLY; The provisioning state of the ConnectionPolicy resource.
	ProvisioningState *ProvisioningState
}
...
type ConnectionSharedKeyResultList struct {
	// REQUIRED; The ConnectionSharedKeyResult items on this page
...
// ConnectivityCheckSettings - Settings that control how connectivity checks are performed by the connection analyzer.
type ConnectivityCheckSettings struct {
...
// ConnectivityConfigurationListResult - The response of a ConnectivityConfiguration list operation.
type ConnectivityConfigurationListResult struct {
	// REQUIRED; The ConnectivityConfiguration items on this page
...
// ConnectivityConfigurationPropertiesConnectivityCapabilities - Collection of additional settings to enhance specific topology
...
type ConnectivityConfigurationPropertiesConnectivityCapabilities struct {
	// REQUIRED; Behavior to handle overlapped IP address space among members of the connected group of the connectivity configuration.
	ConnectedGroupAddressOverlap *ConnectedGroupAddressOverlap

	// REQUIRED; Option indicating the scale of private endpoints allowed in the connected group of the connectivity configuration.
	ConnectedGroupPrivateEndpointsScale *ConnectedGroupPrivateEndpointsScale

	// REQUIRED; Option indicating enforcement of peerings created by the connectivity configuration.
...
// CustomIPPrefixListResult - The response of a CustomIpPrefix list operation.
type CustomIPPrefixListResult struct {
	// REQUIRED; The CustomIpPrefix items on this page
...
// DdosCustomPolicyListResult - The response of a DdosCustomPolicy list operation.
type DdosCustomPolicyListResult struct {
	// REQUIRED; The DdosCustomPolicy items on this page
	Value []*DdosCustomPolicy
...
type DdosCustomPolicyPropertiesFormat struct {
	...
	// READ-ONLY; The list of public IP addresses associated with the custom policy. This list is read-only.
...
type DdosDetectionRule struct {
	...
	// READ-ONLY; The resource ID of the DDoS detection rule.
	ID *string
...
// DdosFrontendIPConfigurationSettings - DDoS protection settings for a frontend IP configuration.
...
// DdosProtectionPlanListResult - The response of a DdosProtectionPlan list operation.
type DdosProtectionPlanListResult struct {
	// REQUIRED; The DdosProtectionPlan items on this page
...
type DefaultAdminRule struct {
	// CONSTANT; Whether the rule is custom or default.
	// Field has constant value AdminRuleKindDefault, any specified value is ignored.
	Kind *AdminRuleKind
...
// DiagnosticOperationResult - Result of an individual diagnostic operation run by a connection analyzer.
type DiagnosticOperationResult struct {
	// REQUIRED; The diagnostic operation that was run.
...
// DiagnosticOperationsSettings - Diagnostic settings to provide for the ConnectionAnalyzer operation.
type DiagnosticOperationsSettings struct {
...
// DscpConfigurationListResult - The response of a DscpConfiguration list operation.
type DscpConfigurationListResult struct {
	// REQUIRED; The DscpConfiguration items on this page
...
type EffectiveNetworkSecurityGroupListResult struct {
	// REQUIRED; The EffectiveNetworkSecurityGroup items on this page
...
type EffectiveRouteListResult struct {
	// REQUIRED; The EffectiveRoute items on this page
...
// EndpointServicesListResult - Paged collection of EndpointServiceResult items
type EndpointServicesListResult struct {
	// REQUIRED; The EndpointServiceResult items on this page
...
// ExpressRouteCircuitConnectionListResult - The response of a ExpressRouteCircuitConnection list operation.
type ExpressRouteCircuitConnectionListResult struct {
	// REQUIRED; The ExpressRouteCircuitConnection items on this page
...
// ExpressRouteCircuitListResult - The response of a ExpressRouteCircuit list operation.
type ExpressRouteCircuitListResult struct {
	// REQUIRED; The ExpressRouteCircuit items on this page
...
// ExpressRouteCircuitPeeringListResult - The response of a ExpressRouteCircuitPeering list operation.
type ExpressRouteCircuitPeeringListResult struct {
	// REQUIRED; The ExpressRouteCircuitPeering items on this page
...
type ExpressRouteCircuitPropertiesFormat struct {
	...
	// READ-ONLY; The resiliency level of the ExpressRoute circuit.
...
type ExpressRouteCircuitsArpTableListResult struct {
	// REQUIRED; The ExpressRouteCircuitArpTable items on this page
...
type ExpressRouteCircuitsRoutesTableListResult struct {
	// REQUIRED; The ExpressRouteCircuitRoutesTable items on this page
...
type ExpressRouteCircuitsRoutesTableSummaryListResult struct {
	// REQUIRED; The ExpressRouteCircuitRoutesTableSummary items on this page
...
// ExpressRouteCrossConnectionListResult - The response of a ExpressRouteCrossConnection list operation.
type ExpressRouteCrossConnectionListResult struct {
	// REQUIRED; The ExpressRouteCrossConnection items on this page
...
type ExpressRouteCrossConnectionPeeringList struct {
	// REQUIRED; The ExpressRouteCrossConnectionPeering items on this page
...
type ExpressRouteCrossConnectionsRoutesTableSummaryListResult struct {
	// REQUIRED; The ExpressRouteCrossConnectionRoutesTableSummary items on this page
...
// ExpressRouteDiagnosticsSettings - Settings that control how Express Route diagnostics are performed by the connection analyzer.
type ExpressRouteDiagnosticsSettings struct {
...
// ExpressRouteLag - ExpressRoute LAG
//
// ExpressRouteLag resource definition.
type ExpressRouteLag struct {
	...
	// READ-ONLY; The unique identifier of the resource.
	ID *string
...
type ExpressRouteLagLink struct {
	...
	// READ-ONLY; Name of child link resource that is unique among child link resources of the parent.
	Name *string
...
// ExpressRouteLagLinkListResult - ExpressRoute LAG Link List Result
//
// Paged collection of ExpressRouteLagLink items
type ExpressRouteLagLinkListResult struct {
	// REQUIRED; The ExpressRouteLagLink items on this page
...
// ExpressRouteLagLinkPropertiesFormat - ExpressRouteLagLink Resource Properties
//
// Properties specific to ExpressRouteLagLink resources.
type ExpressRouteLagLinkPropertiesFormat struct {
	...
	// READ-ONLY; The provisioning state of the express route LAG link resource.
	ProvisioningState *ProvisioningState

	// READ-ONLY; Name of Azure router associated with link.
	RouterName *string
}

// ExpressRouteLagListResult - ExpressRoute LAG List Result
//
// Paged collection of ExpressRouteLag items
type ExpressRouteLagListResult struct {
	// REQUIRED; The ExpressRouteLag items on this page
...
type ExpressRouteLagMember struct {
	...
	// READ-ONLY; Name of child member resource that is unique among child member resources of the parent.
	Name *string
...
// ExpressRouteLagMemberListResult - ExpressRoute LAG Member List Result
//
// Paged collection of ExpressRouteLagMember items
type ExpressRouteLagMemberListResult struct {
	// REQUIRED; The ExpressRouteLagMember items on this page
...
// ExpressRouteLagMemberPropertiesFormat - ExpressRouteLagMember Resource Properties
//
// Properties specific to ExpressRouteLagMember resources.
type ExpressRouteLagMemberPropertiesFormat struct {
	// Administrative state of the member port.
	AdminState *ExpressRouteLinkAdminState

	// READ-ONLY; Cololocation for ExpressRoute member.
	ColoLocation *string
	...
	// READ-ONLY; The provisioning state of the express route LAG member resource.
	ProvisioningState *ProvisioningState
...
// ExpressRouteLagPropertiesFormat - ExpressRouteLag Resource Properties
//
...
type ExpressRouteLagPropertiesFormat struct {
	...
	MinimumActivePortsRequired *int32
	...
	// READ-ONLY; Maximum transmission unit of the LAG.
	Mtu *string

	// READ-ONLY; Aggregate Gbps of associated circuit bandwidths.
	ProvisionedBandwidthInGbps *float64

	// READ-ONLY; The provisioning state of the express route LAG resource.
	ProvisioningState *ProvisioningState

	// READ-ONLY; The resource GUID property of the express route LAG resource.
	ResourceGUID *string
}

// ExpressRouteLagUpdateTagsOrIdentityRequest - ExpressRouteLag Update Tags or Identity Request
//
// Parameters for updating ExpressRouteLag tags or identity.
type ExpressRouteLagUpdateTagsOrIdentityRequest struct {
	// The identity of ExpressRouteLag, if configured.
	Identity *ManagedServiceIdentity
...
// ExpressRouteLinkFailoverAllTestsDetails - ExpressRoute circuit link failover test details for all tests.
type ExpressRouteLinkFailoverAllTestsDetails struct {
	...
	CircuitTestCategory *MaintenanceTestCategory
	...
	// The link type.
	LinkType *ExpressRouteFailoverLinkType
...
// ExpressRouteLinkFailoverRoute - Represents a failover route for an ExpressRoute link.
...
// ExpressRouteLinkFailoverRouteList - Represents a list of failover routes for an ExpressRoute link.
...
// ExpressRouteLinkFailoverSingleTestDetails - ExpressRoute circuit link failover single test details.
...
// ExpressRouteLinkFailoverStopAPIParameters - Parameters for stopping an ExpressRoute circuit link failover test.
...
// ExpressRouteLinkFailoverTestBgpStatus - Represents the BGP status of an ExpressRoute link failover test.
type ExpressRouteLinkFailoverTestBgpStatus struct {
	// The check time in UTC.
	CheckTimeUTC *string

	// The link type.
	Link *ExpressRouteFailoverLinkType

	// The BGP status.
	Status *ExpressRouteLinkFailoverBgpStatus

	// The address family type.
	Type *ExpressRouteFailoverBgpStatusAddressFamily
}

// ExpressRouteLinkListResult - ExpressRouteLink List Result
//
// Response for ListExpressRouteLinks API service call.
type ExpressRouteLinkListResult struct {
	// REQUIRED; The ExpressRouteLink items on this page
...
// ExpressRoutePort - ExpressRoute Port
//
...
// ExpressRoutePortAuthorization - ExpressRoute Port Authorization
//
...
// ExpressRoutePortAuthorizationListResult - ExpressRoute Port Authorization List Result
//
// Paged collection of ExpressRoutePortAuthorization items
type ExpressRoutePortAuthorizationListResult struct {
	// REQUIRED; The ExpressRoutePortAuthorization items on this page
...
// ExpressRoutePortAuthorizationPropertiesFormat - ExpressRoute Port Authorization Properties
//
...
// ExpressRoutePortListResult - ExpressRoute Port List Result
//
// Paged collection of ExpressRoutePort items
type ExpressRoutePortListResult struct {
	// REQUIRED; The ExpressRoutePort items on this page
...
// ExpressRoutePortsLocationBandwidths - ExpressRoutePorts Location Bandwidths
//
...
// ExpressRoutePortsLocationListResult - ExpressRoutePorts Location List Result
//
// Paged collection of ExpressRoutePortsLocation items
type ExpressRoutePortsLocationListResult struct {
	// REQUIRED; The ExpressRoutePortsLocation items on this page
...
// ExpressRoutePortsLocationPropertiesFormat - ExpressRoutePorts Location Properties
//
...
type ExpressRouteProviderPortListResult struct {
	// REQUIRED; The ExpressRouteProviderPort items on this page
...
// ExpressRouteServiceProviderListResult - The response of a ExpressRouteServiceProvider list operation.
type ExpressRouteServiceProviderListResult struct {
	// REQUIRED; The ExpressRouteServiceProvider items on this page
...
type FirewallPacketCaptureParameters struct {
	...
	// The packet capture operation to perform. If the Start operation is selected, please provide all the fields in the firewallPacketCaptureParameters
	// to successfully initiate the packet capture. If the Status or Stop operation is selected, only the operation field is required;
	// all other fields in the firewallPacketCaptureParameters can be omitted to successfully retrieve the capture status or stop
	// the capture.
...
type FirewallPolicyFilterRuleCollection struct {
	// CONSTANT; The type of the rule collection.
	// Field has constant value FirewallPolicyRuleCollectionTypeFirewallPolicyFilterRuleCollection, any specified value is ignored.
...
type FirewallPolicyIntrusionDetectionConfiguration struct {
	...
	// ranges defined by IANA RFC 1918 are considered private IP addresses. To modify default ranges, specify your Private IP
...
// FirewallPolicyKubeSelectorGroup - Firewall Policy Kubernetes Selector Group resource.
type FirewallPolicyKubeSelectorGroup struct {
	// Resource ID.
	ID *string
...
// FirewallPolicyKubeSelectorGroupListResult - The response of a FirewallPolicyKubeSelectorGroup list operation.
type FirewallPolicyKubeSelectorGroupListResult struct {
	// REQUIRED; The FirewallPolicyKubeSelectorGroup items on this page
...
// FirewallPolicyKubeSelectorGroupProperties - Properties of the Kubernetes Selector Group.
type FirewallPolicyKubeSelectorGroupProperties struct {
	...
	// READ-ONLY; The provisioning state of the firewall policy Kubernetes selector group resource.
	ProvisioningState *ProvisioningState
}

// FirewallPolicyListResult - The response of a FirewallPolicy list operation.
type FirewallPolicyListResult struct {
	// REQUIRED; The FirewallPolicy items on this page
...
type FirewallPolicyNatRuleCollection struct {
	// CONSTANT; The type of the rule collection.
	// Field has constant value FirewallPolicyRuleCollectionTypeFirewallPolicyNatRuleCollection, any specified value is ignored.
	RuleCollectionType *FirewallPolicyRuleCollectionType
...
type FirewallPolicyPropertiesFormat struct {
	...
	// READ-ONLY; Indicates that the Firewall Policy is managed by AFC (Azure Firewall for Containers). When set, the policy is
	...
	// READ-ONLY; List of references to FirewallPolicyKubeSelectorGroups.
...
// FirewallPolicyRuleCollectionGroupListResult - The response of a FirewallPolicyRuleCollectionGroup list operation.
type FirewallPolicyRuleCollectionGroupListResult struct {
	// REQUIRED; The FirewallPolicyRuleCollectionGroup items on this page
...
// FirstPartyServiceTag - First party service tag resource.
type FirstPartyServiceTag struct {
	// Resource location.
	Location *string
...
// FirstPartyServiceTagListResult - The response of a FirstPartyServiceTag list operation.
type FirstPartyServiceTagListResult struct {
	// REQUIRED; The FirstPartyServiceTag items on this page
...
// FirstPartyServiceTagPropertiesFormat - Properties of the first party service tag.
type FirstPartyServiceTagPropertiesFormat struct {
	// REQUIRED; The value of the first party service tag.
	Value *string

	// READ-ONLY; The reason for failure, if any.
	FailedReason *string

	// READ-ONLY; The provisioning state of the first party service tag resource.
	ProvisioningState *ProvisioningState

	// READ-ONLY; The resource GUID property of the first party service tag resource.
	ResourceGUID *string
}
...
// FlowLogListResult - The response of a FlowLog list operation.
type FlowLogListResult struct {
	// REQUIRED; The FlowLog items on this page
	Value []*FlowLog
...
type FlowLogProperties struct {
	...
	// at every five-minute interval. E represents End, when a flow is terminated. D represents Deny, when a flow is denied. If
	// not specified, all network traffic will be logged.
	RecordTypes *string
...
type FrontendIPConfigurationPropertiesFormat struct {
	...
	// Enables UDP flow tracking for traffic associated with the frontend IP configuration. When enabled, packets belonging to
	// the same UDP flow are consistently directed to the same backend instance. This setting applies to all associated load balancing
	// rules and takes precedence over rule-level enableConnectionTracking settings.
...
// GatewayEffectiveRoute - Gateway effective routing details.
type GatewayEffectiveRoute struct {
	// READ-ONLY; The list of address prefixes for the effective route.
	AddressPrefixes []*string

	// READ-ONLY; The gateway's local address.
	LocalAddress *string

	// READ-ONLY; The IP address of the next hop for the effective route.
	NextHopIPAddress *string

	// READ-ONLY; The next hop type of the effective route.
	NextHopType *GatewayEffectiveRouteNextHopType
}

// GatewayEffectiveRouteListResult - List of virtual network gateway effective routes.
type GatewayEffectiveRouteListResult struct {
...
// GatewayResiliencyInformation - Gateway Resiliency Information
type GatewayResiliencyInformation struct {
	...
	NextEligibleComputeTime *time.Time
...
// GatewayResiliencyRecommendation - Resiliency Recommendation details
...
type GatewayRouteSet struct {
	...
	Details map[string][]*RouteSourceDetails
...
// GatewayRouteSetsInformation - Gateway Route Sets Information
type GatewayRouteSetsInformation struct {
	// Dictionary containing map of the circuit id and circuit details
	CircuitsMetadataMap map[string]*CircuitMetadataMap
...
// GenerateExpressRouteLagsLOARequest - The customer name to be printed on a letter of authorization for ExpressRouteLag.
type GenerateExpressRouteLagsLOARequest struct {
...
// GenerateExpressRouteLagsLOAResult - Response for GenerateExpressRouteLagsLOA API service call.
type GenerateExpressRouteLagsLOAResult struct {
...
type GetServiceGatewayAddressLocationsResult struct {
	// REQUIRED; The ServiceGatewayAddressLocationResponse items on this page
...
type GetServiceGatewayServicesResult struct {
	// REQUIRED; The ServiceGatewayService items on this page
...
// GroupListResult - The response of a NetworkGroup list operation.
type GroupListResult struct {
	// REQUIRED; The NetworkGroup items on this page
	Value []*Group
...
// header when multiple headers with the same name exist. Currently supported for Set-Cookie Response header only. For more
...
// IPAllocationListResult - The response of a IpAllocation list operation.
type IPAllocationListResult struct {
	// REQUIRED; The IpAllocation items on this page
	Value []*IPAllocation
...
// IPGroupListResult - The response of a IpGroup list operation.
type IPGroupListResult struct {
	// REQUIRED; The IpGroup items on this page
	Value []*IPGroup
...
// InboundNatRuleListResult - The response of a InboundNatRule list operation.
type InboundNatRuleListResult struct {
	// REQUIRED; The InboundNatRule items on this page
...
// InterconnectGroup - An interconnect group resource.
...
// InterconnectGroupListResult - The response of a InterconnectGroup list operation.
type InterconnectGroupListResult struct {
	// REQUIRED; The InterconnectGroup items on this page
...
// InterconnectGroupNodeAvailability - Represents node availability information for subgroups within an interconnect group.
...
// InterconnectGroupPropertiesFormat - Interconnect group properties.
type InterconnectGroupPropertiesFormat struct {
	// REQUIRED; The subgroup profile of the interconnect group resource.
	SubgroupProfile *SubgroupProfile

	// Scope of interconnect group resource.
	Scope *InterconnectGroupScope

	// READ-ONLY; The provisioning state of the interconnect group resource.
	ProvisioningState *ProvisioningState

	// READ-ONLY; The resource GUID property of the interconnect group resource.
	ResourceGUID *string

	// READ-ONLY; A list of subgroups of the interconnect group.
	Subgroups []*Subgroup
}
...
// InterfaceIPConfigurationListResult - The response of a NetworkInterfaceIPConfiguration list operation.
type InterfaceIPConfigurationListResult struct {
	// REQUIRED; The NetworkInterfaceIPConfiguration items on this page
...
// InterfaceListResult - The response of a NetworkInterface list operation.
...
// InterfaceLoadBalancerListResult - Paged collection of LoadBalancer items
...
// InterfaceTapConfigurationListResult - The response of a NetworkInterfaceTapConfiguration list operation.
type InterfaceTapConfigurationListResult struct {
	// REQUIRED; The NetworkInterfaceTapConfiguration items on this page
...
// InternetIngressPublicIPsProperties - Internet Ingress Public Ip Properties
//
...
type IpamPoolList struct {
	// REQUIRED; The IpamPool items on this page
	Value []*IpamPool
...
// LabelSelectorExpression - A label selector requirement is a selector that contains values, a key, and an operator that
...
// ListConnectionPoliciesResult - List of ConnectionPolicies and a URL nextLink to get the next set of results.
type ListConnectionPoliciesResult struct {
	// REQUIRED; The ConnectionPolicy items on this page
...
type ListHubRouteTablesResult struct {
	// REQUIRED; The HubRouteTable items on this page
	Value []*HubRouteTable
...
type ListHubVirtualNetworkConnectionsResult struct {
	// REQUIRED; The HubVirtualNetworkConnection items on this page
...
type ListP2SVPNGatewaysResult struct {
	// REQUIRED; The P2SVpnGateway items on this page
	Value []*P2SVPNGateway
...
type ListRouteMapsResult struct {
	// REQUIRED; The RouteMap items on this page
	Value []*RouteMap
...
type ListRoutingIntentResult struct {
	// REQUIRED; The RoutingIntent items on this page
	Value []*RoutingIntent
...
type ListVPNConnectionsResult struct {
	// REQUIRED; The VpnConnection items on this page
	Value []*VPNConnection
...
type ListVPNGatewayNatRulesResult struct {
	// REQUIRED; The VpnGatewayNatRule items on this page
...
type ListVPNGatewaysResult struct {
	// REQUIRED; The VpnGateway items on this page
	Value []*VPNGateway
...
type ListVPNServerConfigurationPolicyGroupsResult struct {
	// REQUIRED; The VpnServerConfigurationPolicyGroup items on this page
...
type ListVPNServerConfigurationsResult struct {
	// REQUIRED; The VpnServerConfiguration items on this page
...
type ListVPNSiteLinkConnectionsResult struct {
	// REQUIRED; The VpnSiteLinkConnection items on this page
...
type ListVPNSiteLinksResult struct {
	// REQUIRED; The VpnSiteLink items on this page
	Value []*VPNSiteLink
...
type ListVPNSitesResult struct {
	// REQUIRED; The VpnSite items on this page
	Value []*VPNSite
...
type ListVirtualHubBgpConnectionResults struct {
	// REQUIRED; The BgpConnection items on this page
	Value []*BgpConnection
...
type ListVirtualHubIPConfigurationResults struct {
	// REQUIRED; The HubIpConfiguration items on this page
...
type ListVirtualHubRouteTableV2SResult struct {
	// REQUIRED; The VirtualHubRouteTableV2 items on this page
...
type ListVirtualHubsResult struct {
	// REQUIRED; The VirtualHub items on this page
	Value []*VirtualHub
...
type ListVirtualNetworkGatewayNatRulesResult struct {
	// REQUIRED; The VirtualNetworkGatewayNatRule items on this page
...
type ListVirtualWANsResult struct {
	// REQUIRED; The VirtualWAN items on this page
	Value []*VirtualWAN
...
// LoadBalancerBackendAddressPoolListResult - Paged collection of BackendAddressPool items
type LoadBalancerBackendAddressPoolListResult struct {
	// REQUIRED; The BackendAddressPool items on this page
...
// LoadBalancerFrontendIPConfigurationListResult - Paged collection of FrontendIPConfiguration items
type LoadBalancerFrontendIPConfigurationListResult struct {
	// REQUIRED; The FrontendIPConfiguration items on this page
...
// LoadBalancerLoadBalancingRuleListResult - Paged collection of LoadBalancingRule items
type LoadBalancerLoadBalancingRuleListResult struct {
	// REQUIRED; The LoadBalancingRule items on this page
...
// LoadBalancerOutboundRuleListResult - Paged collection of OutboundRule items
type LoadBalancerOutboundRuleListResult struct {
	// REQUIRED; The OutboundRule items on this page
	Value []*OutboundRule
...
// LoadBalancerProbeListResult - Paged collection of Probe items
type LoadBalancerProbeListResult struct {
	// REQUIRED; The Probe items on this page
	Value []*Probe
...
type LoadBalancerPropertiesFormat struct {
	...
	// The load balancer mode. Set to `Advanced` to enable additional capabilities on a Standard SKU load balancer. Advanced mode
	// must be specified at creation and cannot be changed afterward.
...
type LoadBalancingRulePropertiesFormat struct {
	...
	// Enables UDP flow tracking for the load balancing rule. This property is retained for rule-level configuration compatibility.
	// When enableConnectionTracking is specified on the associated frontend IP configuration, the frontend setting takes precedence.
	EnableConnectionTracking *bool
...
// LocalNetworkGatewayListResult - The response of a LocalNetworkGateway list operation.
type LocalNetworkGatewayListResult struct {
	// REQUIRED; The LocalNetworkGateway items on this page
...
type ManagedServiceIdentity struct {
	...
	UserAssignedIdentities map[string]*ManagedServiceIdentityUserAssignedIdentities
...
type ManagedServiceIdentityUserAssignedIdentities struct {
...
// ManagerConnectionListResult - The response of a NetworkManagerConnection list operation.
type ManagerConnectionListResult struct {
	// REQUIRED; The NetworkManagerConnection items on this page
...
// ManagerListResult - The response of a NetworkManager list operation.
type ManagerListResult struct {
	// REQUIRED; The NetworkManager items on this page
	Value []*Manager
...
// ManagerRoutingConfigurationListResult - The response of a NetworkManagerRoutingConfiguration list operation.
type ManagerRoutingConfigurationListResult struct {
	// REQUIRED; The NetworkManagerRoutingConfiguration items on this page
...
// MoveIPConfigurationItem - An item representing a source and target IP configuration for a move operation.
type MoveIPConfigurationItem struct {
	// REQUIRED; The source IP configuration to move from.
	SourceIPConfiguration *MoveIPConfigurationResourceReference

	// REQUIRED; The target IP configuration to move to.
	TargetIPConfiguration *MoveIPConfigurationResourceReference
}

// MoveIPConfigurationResourceReference - Reference to an IP configuration resource by ARM resource ID.
type MoveIPConfigurationResourceReference struct {
	// REQUIRED; The ARM resource ID of the IP configuration.
	ID *string
}

// MoveIPConfigurationsRequest - Request body for the MoveIpConfigurations operation.
type MoveIPConfigurationsRequest struct {
	// REQUIRED; A list of IP configuration move items.
...
type NatRule struct {
	// CONSTANT; Rule Type.
	// Field has constant value FirewallPolicyRuleTypeNatRule, any specified value is ignored.
	RuleType *FirewallPolicyRuleType
...
// NspAccessRuleListResult - The response of a NspAccessRule list operation.
type NspAccessRuleListResult struct {
	// REQUIRED; The NspAccessRule items on this page
	Value []*NspAccessRule
...
// NspAssociationsListResult - Paged collection of NspAssociation items
type NspAssociationsListResult struct {
	// REQUIRED; The NspAssociation items on this page
...
// NspLinkListResult - The response of a NspLink list operation.
type NspLinkListResult struct {
	// REQUIRED; The NspLink items on this page
	Value []*NspLink
...
// NspLinkReferenceListResult - The response of a NspLinkReference list operation.
type NspLinkReferenceListResult struct {
	// REQUIRED; The NspLinkReference items on this page
...
type NspLinkReferenceProperties struct {
	...
	// profiles at remote perimeter. This property can only be updated from corresponding link resource present in remote perimeter.
	RemoteOutboundProfiles []*string
...
// NspLoggingConfigurationListResult - The response of a NspLoggingConfiguration list operation.
type NspLoggingConfigurationListResult struct {
	// REQUIRED; The NspLoggingConfiguration items on this page
...
// NspProfileListResult - The response of a NspProfile list operation.
type NspProfileListResult struct {
	// REQUIRED; The NspProfile items on this page
	Value []*NspProfile
...
// NspServiceTagsListResult - Result of the request to list NSP service tags.
type NspServiceTagsListResult struct {
	// REQUIRED; The NspServiceTagsResource items on this page
	Value []*NspServiceTagsResource

	// The link to the next page of items
	NextLink *string
}

// NspServiceTagsResource - Resource containing list of NSP service tags.
type NspServiceTagsResource struct {
	// NSP service tags.
	ServiceTags []*string
}

// NvaInVnetSubnetReferenceProperties - Subnet references where the NVA NICS will be deployed
//
...
// NvaInterfaceConfigurationsProperties - Specifies input parameters required NVA in VNet interface configuration.
type NvaInterfaceConfigurationsProperties struct {
	...
	// Specifies the NIC types for the NVA interface configuration. Allowed values: PrivateNic, PublicNic, AdditionalPrivateNic,
	// AdditionalPublicNic. Only the combination of PrivateNic and PublicNic is currently supported.
	Type []*NvaNicType
}
...
// OutputSettings - Settings that control where the connection analyzer writes its results.
...
// PartnerManagedResourceProperties - Properties of the partner managed resource. Only appliable for SaaS NVA.
...
// PeerExpressRouteCircuitConnectionListResult - The response of a PeerExpressRouteCircuitConnection list operation.
type PeerExpressRouteCircuitConnectionListResult struct {
	// REQUIRED; The PeerExpressRouteCircuitConnection items on this page
...
type PerimeterAssociableResource struct {
	...
	// READ-ONLY; Identifier of the perimeter associable resource.
	ID *string
...
type PerimeterAssociableResourceProperties struct {
	// READ-ONLY; Description of the PaaS resource type.
	Description *string

	// READ-ONLY; A friendly name for the properties of perimeter associable resources.
	DisplayName *string

	// READ-ONLY; Indicates whether the resource type supports outbound scenario.
	OutboundSupported *bool

	// READ-ONLY; Public DNS zone names of the resources.
	PublicDNSZones []*string

	// READ-ONLY; The readiness state of the resource type for NSP support.
	ReadinessState *NspReadinessState

	// READ-ONLY; Resource type/provider name.
	ResourceType *string

	// READ-ONLY; Service tags associated with the resource provider.
	ServiceTags []*string
}

// PerimeterAssociableResourcesListResult - Paged collection of PerimeterAssociableResource items
type PerimeterAssociableResourcesListResult struct {
	// REQUIRED; The PerimeterAssociableResource items on this page
...
type PoolAssociationList struct {
	// REQUIRED; The PoolAssociation items on this page
...
type PrivateDNSZoneGroupListResult struct {
	// REQUIRED; The PrivateDnsZoneGroup items on this page
...
// PrivateEndpointListResult - The response of a PrivateEndpoint list operation.
type PrivateEndpointListResult struct {
	// REQUIRED; The PrivateEndpoint items on this page
...
// PrivateLinkServiceListResult - The response of a PrivateLinkService list operation.
type PrivateLinkServiceListResult struct {
	// REQUIRED; The PrivateLinkService items on this page
...
type ProbePropertiesFormat struct {
	...
	// After failing the number of consecutive probes equal to this value, the endpoint will be taken out of rotation and require
...
// ProfileListResult - The response of a NetworkProfile list operation.
type ProfileListResult struct {
	// REQUIRED; The NetworkProfile items on this page
	Value []*Profile
...
// ProtocolSettings - Protocol-level settings for the connection analyzer.
...
type PublicIPAddressDNSSettings struct {
	...
	// for the public IP in the Microsoft Azure DNS system with a hashed value includes in FQDN.
...
type PublicIPAddressPropertiesFormat struct {
	...
	// READ-ONLY; Whether the public IP address SKU has been upgraded from Standard to StandardV2.
	UpgradedToV2 *bool
}
...
// PublicIPPrefixListResult - The response of a PublicIPPrefix list operation.
type PublicIPPrefixListResult struct {
	// REQUIRED; The PublicIPPrefix items on this page
...
type PublicIPPrefixPropertiesFormat struct {
	...
	// READ-ONLY; Whether the public IP prefix SKU has been upgraded from Standard to StandardV2.
	UpgradedToV2 *bool
}
...
// RadiusAuthServer - Gateway or VpnServerConfiguration Radius server with radius secret details
...
// RadiusAuthServerListResult - List of Radius servers with respective radius secrets.
type RadiusAuthServerListResult struct {
	// REQUIRED; The RadiusAuthServer items on this page
...
type RadiusServer struct {
	...
	// The secret used for this radius server. We will no longer return radiusServerSecret in VirtualNetworkGateway Create/Update/Get/List/UpdateTags
...
// ReachabilityAnalysisIntentListResult - The response of a ReachabilityAnalysisIntent list operation.
type ReachabilityAnalysisIntentListResult struct {
	// REQUIRED; The ReachabilityAnalysisIntent items on this page
...
// ReachabilityAnalysisRunListResult - The response of a ReachabilityAnalysisRun list operation.
type ReachabilityAnalysisRunListResult struct {
	// REQUIRED; The ReachabilityAnalysisRun items on this page
...
type ResourceNavigationLink struct {
	...
	// READ-ONLY; Resource navigation link identifier.
	ID *string
...
// ResourceNavigationLinksListResult - Paged collection of ResourceNavigationLink items
type ResourceNavigationLinksListResult struct {
	// REQUIRED; The ResourceNavigationLink items on this page
...
// RouteFilterListResult - The response of a RouteFilter list operation.
type RouteFilterListResult struct {
	// REQUIRED; The RouteFilter items on this page
	Value []*RouteFilter
...
type RouteFilterRuleListResult struct {
	// REQUIRED; The RouteFilterRule items on this page
...
// RouteNextHopEcmp - The next hop definition for ECMP routes containing multiple next hop IP addresses.
type RouteNextHopEcmp struct {
	// REQUIRED; List of next hop IP addresses for ECMP routing. Must contain between 2 and 64 IP addresses.
...
// RouteTableListResult - The response of a RouteTable list operation.
type RouteTableListResult struct {
	// REQUIRED; The RouteTable items on this page
	Value []*RouteTable
...
type RouteTablePropertiesFormat struct {
	...
	// Whether to disable the routes learned by peering on the route table. 'None' means peering routes are enabled, 'All' means
...
// RoutingRuleCollectionListResult - The response of a RoutingRuleCollection list operation.
type RoutingRuleCollectionListResult struct {
	// REQUIRED; The RoutingRuleCollection items on this page
...
// RoutingRuleListResult - The response of a RoutingRule list operation.
type RoutingRuleListResult struct {
	// REQUIRED; The RoutingRule items on this page
	Value []*RoutingRule
...
type Rule struct {
	// CONSTANT; Rule Type.
	// Field has constant value FirewallPolicyRuleTypeNetworkRule, any specified value is ignored.
	RuleType *FirewallPolicyRuleType
...
// ScopeConnectionListResult - The response of a ScopeConnection list operation.
type ScopeConnectionListResult struct {
	// REQUIRED; The ScopeConnection items on this page
...
// SecurityAdminConfigurationListResult - The response of a SecurityAdminConfiguration list operation.
type SecurityAdminConfigurationListResult struct {
	// REQUIRED; The SecurityAdminConfiguration items on this page
...
// SecurityGroupListResult - The response of a NetworkSecurityGroup list operation.
...
// SecurityPartnerProviderListResult - The response of a SecurityPartnerProvider list operation.
type SecurityPartnerProviderListResult struct {
	// REQUIRED; The SecurityPartnerProvider items on this page
...
// SecurityPerimeterListResult - The response of a NetworkSecurityPerimeter list operation.
type SecurityPerimeterListResult struct {
	// REQUIRED; The NetworkSecurityPerimeter items on this page
...
// SecurityUserConfigurationListResult - The response of a SecurityUserConfiguration list operation.
type SecurityUserConfigurationListResult struct {
	// REQUIRED; The SecurityUserConfiguration items on this page
...
// SecurityUserRuleCollectionListResult - The response of a SecurityUserRuleCollection list operation.
type SecurityUserRuleCollectionListResult struct {
	// REQUIRED; The SecurityUserRuleCollection items on this page
...
// SecurityUserRuleListResult - The response of a SecurityUserRule list operation.
type SecurityUserRuleListResult struct {
	// REQUIRED; The SecurityUserRule items on this page
...
// ServiceAssociationLinksListResult - Paged collection of ServiceAssociationLink items
type ServiceAssociationLinksListResult struct {
	// REQUIRED; The ServiceAssociationLink items on this page
...
// ServiceEndpointPolicyDefinitionListResult - The response of a ServiceEndpointPolicyDefinition list operation.
type ServiceEndpointPolicyDefinitionListResult struct {
	// REQUIRED; The ServiceEndpointPolicyDefinition items on this page
...
// ServiceEndpointPolicyListResult - The response of a ServiceEndpointPolicy list operation.
type ServiceEndpointPolicyListResult struct {
	// REQUIRED; The ServiceEndpointPolicy items on this page
...
// ServiceGatewayActionOkResponseBody - Empty success response.
type ServiceGatewayActionOkResponseBody struct {
	// READ-ONLY; The status of the operation.
	Status *string
}
...
// ServiceGatewayListResult - The response of a ServiceGateway list operation.
type ServiceGatewayListResult struct {
	// REQUIRED; The ServiceGateway items on this page
...
type ServiceTagInformationListResult struct {
	// REQUIRED; The ServiceTagInformation items on this page
...
type StaticCidrList struct {
	// REQUIRED; The StaticCidr items on this page
	Value []*StaticCidr
...
// StaticMemberListResult - The response of a StaticMember list operation.
type StaticMemberListResult struct {
	// REQUIRED; The StaticMember items on this page
	Value []*StaticMember
...
type StaticRoutesConfig struct {
	// Boolean indicating whether static routes on this connection are automatically propagate to route tables which this connection
	// propagates to.
...
type StopCircuitLinkFailoverTestParameterBody struct {
	// REQUIRED; Parameters supplied to stop the link failover simulation on the express route circuit.
	StopParameters *ExpressRouteLinkFailoverStopAPIParameters
}

type StopSiteFailoverTestParameterBody struct {
	// REQUIRED; Parameters supplied to stop the failover simulation on the express route gateway.
	StopParameters *ExpressRouteFailoverStopAPIParameters
}

// StorageAccountSettings - Storage account where the connection analyzer writes its output.
type StorageAccountSettings struct {
	// REQUIRED; Resource ID of the storage account.
...
// Subgroup - A subgroup in an interconnect group.
...
// SubgroupListResult - The response of a Subgroup list operation.
type SubgroupListResult struct {
	// REQUIRED; The Subgroup items on this page
	Value []*Subgroup
...
// SubgroupNodeAvailabilityEntry - Represents the node availability information for a single subgroup.
...
// SubgroupProfile - Subgroup profile of the interconnect group resource.
type SubgroupProfile struct {
	// REQUIRED; VM size of the subgroup profile.
	VMSize *string
...
// SubgroupProperties - Properties of subgroup.
type SubgroupProperties struct {
	// READ-ONLY; The reference to an interconnect block resource.
	InterconnectBlock *SubResource

	// READ-ONLY; The unique identifier of the subgroup.
	InternalSubgroupID *string

	// READ-ONLY; The provisioning state of the subgroup.
	ProvisioningState *ProvisioningState

	// READ-ONLY; A list of virtual machine references.
...
// SubnetListResult - The response of a Subnet list operation.
type SubnetListResult struct {
	// REQUIRED; The Subnet items on this page
	Value []*Subnet
...
type SubnetPropertiesFormat struct {
	...
	// be set if defaultOutboundAccess is set to false, both properties can only be set if subnet is empty.
...
type VPNClientConfiguration struct {
	...
	// The radius secret property of the VirtualNetworkGateway resource for vpn client connection. We will no longer return radiusServerSecret
	// in VirtualNetworkGateway Create/Update/Get/List/UpdateTags APIs response. Please use VirtualNetworkGateway ListRadiusSecrets
	// API to fetch radius server secrets.
	RadiusServerSecret *string
...
type VPNServerConfigurationProperties struct {
	...
	// The radius secret property of the VpnServerConfiguration resource for point to site client connection. We will no longer
	// return radiusServerSecret in VpnServerConfiguration Create/Update/Get/List/UpdateTags APIs response. Please use VpnServerConfiguration
...
type VPNSiteLinkConnectionProperties struct {
	...
	// SharedKey for the vpn link connection. We will no longer return sharedKey in any Create/Update/Get/List/UpdateTags VpnGateway/VpnConnection/VpnLinkConnection
	// APIs response. Please use 'Vpn Link Connections - List Default Shared Key' API to fetch Vpn link connection sharedKey.
	SharedKey *string
...
type VerifierWorkspace struct {
	...
	// READ-ONLY; String representing unique etag for the resource document.
	Etag *string
...
// VerifierWorkspaceListResult - The response of a VerifierWorkspace list operation.
type VerifierWorkspaceListResult struct {
	// REQUIRED; The VerifierWorkspace items on this page
...
// VirtualApplianceCommitMigrationProperties - Properties supplied to commit the migration of a Network Virtual Appliance.
type VirtualApplianceCommitMigrationProperties struct {
	// REQUIRED; The type of migration workflow to commit.
	MigrationType *MigrationType
}

// VirtualApplianceCommitMigrationRequest - Parameters supplied to commit the migration of a Network Virtual Appliance.
type VirtualApplianceCommitMigrationRequest struct {
	// Properties of the commit migration request.
	Properties *VirtualApplianceCommitMigrationProperties
}
...
type VirtualApplianceConnectionList struct {
	// REQUIRED; The NetworkVirtualApplianceConnection items on this page
...
// VirtualApplianceExecuteMigrationProperties - Properties supplied to execute the migration of a Network Virtual Appliance.
type VirtualApplianceExecuteMigrationProperties struct {
	// REQUIRED; The type of migration workflow to execute.
	MigrationType *MigrationType
}

// VirtualApplianceExecuteMigrationRequest - Parameters supplied to execute the migration of a Network Virtual Appliance.
type VirtualApplianceExecuteMigrationRequest struct {
	// Properties of the execute migration request.
	Properties *VirtualApplianceExecuteMigrationProperties
}

// VirtualApplianceIPConfiguration - Represents a single IP configuration.
type VirtualApplianceIPConfiguration struct {
	// For hub NVAs, primary IP configs must be named 'privatenicipconfig' and 'publicnicipconfig', with non-primary configs using
	// these prefixes; no naming restrictions apply for NVAs in VNets. Maximum 80 character are allowed.
	Name *string
...
type VirtualApplianceInstanceIDs struct {
	...
	// being performed on all virtual machines belonging to the network virtual appliance.
	InstanceIDs []*string
}

// VirtualApplianceListResult - The response of a NetworkVirtualAppliance list operation.
type VirtualApplianceListResult struct {
	// REQUIRED; The NetworkVirtualAppliance items on this page
...
// VirtualApplianceMigrationStatus - The migration status of a Network Virtual Appliance.
type VirtualApplianceMigrationStatus struct {
...
type VirtualApplianceNicProperties struct {
	...
	// READ-ONLY; NIC type - PublicNic, PrivateNic, or AdditionalNic; AdditionalPrivateNic and AdditionalPublicNic are only supported
	...
	// READ-ONLY; Private IPv6 address. Populated for dual-stack NVAs, including on additional-NIC configurations when the NVA
	// is dual-stack.
	...
	// READ-ONLY; Public IPv6 address. Populated for dual-stack NVAs, including on additional-NIC configurations when the NVA
	// is dual-stack.
	PublicIPAddressV6 *string
}

// VirtualAppliancePrepareMigrationProperties - Properties supplied to prepare the migration of a Network Virtual Appliance.
type VirtualAppliancePrepareMigrationProperties struct {
	// REQUIRED; The type of migration workflow to prepare.
	MigrationType *MigrationType
...
// VirtualAppliancePrepareMigrationRequest - Parameters supplied to prepare the migration of a Network Virtual Appliance.
type VirtualAppliancePrepareMigrationRequest struct {
	// Properties of the prepare migration request.
	Properties *VirtualAppliancePrepareMigrationProperties
}
...
type VirtualAppliancePropertiesFormat struct {
	...
	// The address families to deploy the NVA in. ["IPv4", "IPv6"] deploys a dual-stack NVA (the vHub/VNet must also be dual-stack).
	// ["IPv4"], an empty array, or omitting the field deploys an IPv4-only NVA. The value "IPv6" may only appear in combination
	...
	// READ-ONLY; Address Prefix for Dual-Stack NVAs.
	...
	// READ-ONLY; The migration status of the Network Virtual Appliance.
	MigrationStatus *VirtualApplianceMigrationStatus

	// READ-ONLY; A Internal Load Balancer's HA port frontend IP address. Can be used to set routes & UDR to load balance traffic
	// between NVA instances
	PrivateIPAddress *string

	// READ-ONLY; An Internal Load Balancer's HA port frontend IPv6 address. Can be used to set routes & UDR to load balance traffic
	// between NVA instances. This field appears in dual-stack NVAs.
	PrivateIPAddressV6 *string
...
// VirtualApplianceSKUListResult - The response of a NetworkVirtualApplianceSku list operation.
type VirtualApplianceSKUListResult struct {
	// REQUIRED; The NetworkVirtualApplianceSku items on this page
...
// VirtualApplianceSiteListResult - Paged collection of VirtualApplianceSite items
type VirtualApplianceSiteListResult struct {
	// REQUIRED; The VirtualApplianceSite items on this page
...
// VirtualNetworkApplianceListResult - The response of a VirtualNetworkAppliance list operation.
type VirtualNetworkApplianceListResult struct {
	// REQUIRED; The VirtualNetworkAppliance items on this page
...
type VirtualNetworkDdosProtectionStatusResult struct {
	// REQUIRED; The PublicIpDdosProtectionStatusResult items on this page
...
type VirtualNetworkGatewayConnectionListEntityPropertiesFormat struct {
	...
	// The IPSec shared key. We will no longer return sharedKey in VirtualNetworkGatewayConnection Create/Update/Get/List/UpdateTags
	// APIs response. Please use VirtualNetworkGatewayConnection GetSharedKey API to fetch connection sharedKey.
	SharedKey *string
...
// VirtualNetworkGatewayConnectionListResult - The response of a VirtualNetworkGatewayConnection list operation.
type VirtualNetworkGatewayConnectionListResult struct {
	// REQUIRED; The VirtualNetworkGatewayConnection items on this page
...
type VirtualNetworkGatewayListConnectionsResult struct {
	// REQUIRED; The VirtualNetworkGatewayConnectionListEntity items on this page
...
// VirtualNetworkGatewayListResult - The response of a VirtualNetworkGateway list operation.
type VirtualNetworkGatewayListResult struct {
	// REQUIRED; The VirtualNetworkGateway items on this page
...
// VirtualNetworkGatewayMigrationParameters - Virtual network gateway migration parameters.
type VirtualNetworkGatewayMigrationParameters struct {
	// REQUIRED; MigrationType for the virtual network gateway.
...
type VirtualNetworkListUsageResult struct {
	// READ-ONLY; The VirtualNetworkUsage items on this page
...
// VirtualNetworkPeeringListResult - The response of a VirtualNetworkPeering list operation.
...
type VirtualNetworkPropertiesFormat struct {
	...
	// READ-ONLY; A reference to the default public nat gateway being used by this virtual network resource.
...
// VirtualNetworkTapListResult - The response of a VirtualNetworkTap list operation.
type VirtualNetworkTapListResult struct {
	// REQUIRED; The VirtualNetworkTap items on this page
...
// VirtualRouterListResult - The response of a VirtualRouter list operation.
type VirtualRouterListResult struct {
	// REQUIRED; The VirtualRouter items on this page
	Value []*VirtualRouter
...
// VirtualRouterPeeringListResult - The response of a VirtualRouterPeering list operation.
type VirtualRouterPeeringListResult struct {
	// REQUIRED; The VirtualRouterPeering items on this page
...
// WebApplicationFirewallPolicyListResult - Paged collection of WebApplicationFirewallPolicy items
