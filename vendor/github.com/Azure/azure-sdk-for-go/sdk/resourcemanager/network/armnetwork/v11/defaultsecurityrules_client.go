...
func (client *DefaultSecurityRulesClient) getCreateRequest(ctx context.Context, resourceGroupName string, networkSecurityGroupName string, defaultSecurityRuleName string, _ *DefaultSecurityRulesClientGetOptions) (*policy.Request, error) {
...
func (client *DefaultSecurityRulesClient) getHandleResponse(resp *http.Response, successCodes ...int) (DefaultSecurityRulesClientGetResponse, error) {
...
func (client *DefaultSecurityRulesClient) listCreateRequest(ctx context.Context, resourceGroupName string, networkSecurityGroupName string, nextLink string, _ *DefaultSecurityRulesClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *DefaultSecurityRulesClient) listHandleResponse(resp *http.Response, successCodes ...int) (DefaultSecurityRulesClientListResponse, error) {
