...
func (client *ApplicationGatewayPrivateEndpointConnectionsClient) getHandleResponse(resp *http.Response, successCodes ...int) (ApplicationGatewayPrivateEndpointConnectionsClientGetResponse, error) {
...
func (client *ApplicationGatewayPrivateEndpointConnectionsClient) NewListPager(resourceGroupName string, applicationGatewayName string, options *ApplicationGatewayPrivateEndpointConnectionsClientListOptions) *runtime.Pager[ApplicationGatewayPrivateEndpointConnectionsClientListResponse] {
	return runtime.NewPager(runtime.PagingHandler[ApplicationGatewayPrivateEndpointConnectionsClientListResponse]{
		...
		Fetcher: func(ctx context.Context, page *ApplicationGatewayPrivateEndpointConnectionsClientListResponse) (ApplicationGatewayPrivateEndpointConnectionsClientListResponse, error) {
			...
			req, err := client.listCreateRequest(ctx, resourceGroupName, applicationGatewayName, nextLink, options)
			if err != nil {
...
func (client *ApplicationGatewayPrivateEndpointConnectionsClient) listCreateRequest(ctx context.Context, resourceGroupName string, applicationGatewayName string, nextLink string, _ *ApplicationGatewayPrivateEndpointConnectionsClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *ApplicationGatewayPrivateEndpointConnectionsClient) listHandleResponse(resp *http.Response, successCodes ...int) (ApplicationGatewayPrivateEndpointConnectionsClientListResponse, error) {
