...
//   - routeMapName - The name of the resource that is unique within a resource group. This name can be used to access the resource.
...
func (client *RouteMapsClient) getHandleResponse(resp *http.Response, successCodes ...int) (RouteMapsClientGetResponse, error) {
...
func (client *RouteMapsClient) listCreateRequest(ctx context.Context, resourceGroupName string, virtualHubName string, nextLink string, _ *RouteMapsClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *RouteMapsClient) listHandleResponse(resp *http.Response, successCodes ...int) (RouteMapsClientListResponse, error) {
