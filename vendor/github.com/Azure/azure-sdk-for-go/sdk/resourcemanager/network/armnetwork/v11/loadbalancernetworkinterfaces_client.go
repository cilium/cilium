...
func (client *LoadBalancerNetworkInterfacesClient) listCreateRequest(ctx context.Context, resourceGroupName string, loadBalancerName string, nextLink string, _ *LoadBalancerNetworkInterfacesClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *LoadBalancerNetworkInterfacesClient) listHandleResponse(resp *http.Response, successCodes ...int) (LoadBalancerNetworkInterfacesClientListResponse, error) {
