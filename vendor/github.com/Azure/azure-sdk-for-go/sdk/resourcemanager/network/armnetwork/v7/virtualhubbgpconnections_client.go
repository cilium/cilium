...
func (client *VirtualHubBgpConnectionsClient) listCreateRequest(ctx context.Context, resourceGroupName string, virtualHubName string, _ *VirtualHubBgpConnectionsClientListOptions) (*policy.Request, error) {
