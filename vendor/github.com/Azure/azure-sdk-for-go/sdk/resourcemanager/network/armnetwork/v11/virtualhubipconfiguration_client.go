...
func (client *VirtualHubIPConfigurationClient) getHandleResponse(resp *http.Response, successCodes ...int) (VirtualHubIPConfigurationClientGetResponse, error) {
...
func (client *VirtualHubIPConfigurationClient) listCreateRequest(ctx context.Context, resourceGroupName string, virtualHubName string, nextLink string, _ *VirtualHubIPConfigurationClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *VirtualHubIPConfigurationClient) listHandleResponse(resp *http.Response, successCodes ...int) (VirtualHubIPConfigurationClientListResponse, error) {
