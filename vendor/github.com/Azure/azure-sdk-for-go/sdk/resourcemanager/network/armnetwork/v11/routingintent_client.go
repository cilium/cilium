...
//   - routingIntentName - The name of the resource that is unique within a resource group. This name can be used to access the
//     resource.
...
func (client *RoutingIntentClient) getHandleResponse(resp *http.Response, successCodes ...int) (RoutingIntentClientGetResponse, error) {
...
func (client *RoutingIntentClient) listCreateRequest(ctx context.Context, resourceGroupName string, virtualHubName string, nextLink string, _ *RoutingIntentClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *RoutingIntentClient) listHandleResponse(resp *http.Response, successCodes ...int) (RoutingIntentClientListResponse, error) {
