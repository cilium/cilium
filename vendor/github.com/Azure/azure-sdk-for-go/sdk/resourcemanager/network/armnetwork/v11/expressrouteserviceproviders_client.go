...
func (client *ExpressRouteServiceProvidersClient) listCreateRequest(ctx context.Context, nextLink string, _ *ExpressRouteServiceProvidersClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *ExpressRouteServiceProvidersClient) listHandleResponse(resp *http.Response, successCodes ...int) (ExpressRouteServiceProvidersClientListResponse, error) {
