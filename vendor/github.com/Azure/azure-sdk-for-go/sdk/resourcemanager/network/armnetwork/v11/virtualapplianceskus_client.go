...
func (client *VirtualApplianceSKUsClient) getHandleResponse(resp *http.Response, successCodes ...int) (VirtualApplianceSKUsClientGetResponse, error) {
...
func (client *VirtualApplianceSKUsClient) listCreateRequest(ctx context.Context, nextLink string, _ *VirtualApplianceSKUsClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *VirtualApplianceSKUsClient) listHandleResponse(resp *http.Response, successCodes ...int) (VirtualApplianceSKUsClientListResponse, error) {
