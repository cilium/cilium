...
func (client *AzureFirewallsClient) getHandleResponse(resp *http.Response, successCodes ...int) (AzureFirewallsClientGetResponse, error) {
...
func (client *AzureFirewallsClient) listCreateRequest(ctx context.Context, resourceGroupName string, nextLink string, _ *AzureFirewallsClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *AzureFirewallsClient) listHandleResponse(resp *http.Response, successCodes ...int) (AzureFirewallsClientListResponse, error) {
