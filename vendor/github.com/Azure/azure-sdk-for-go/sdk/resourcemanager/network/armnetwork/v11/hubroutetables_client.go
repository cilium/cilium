...
//   - routeTableName - The name of the resource that is unique within a resource group. This name can be used to access the resource.
...
func (client *HubRouteTablesClient) getHandleResponse(resp *http.Response, successCodes ...int) (HubRouteTablesClientGetResponse, error) {
...
func (client *HubRouteTablesClient) listCreateRequest(ctx context.Context, resourceGroupName string, virtualHubName string, nextLink string, _ *HubRouteTablesClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *HubRouteTablesClient) listHandleResponse(resp *http.Response, successCodes ...int) (HubRouteTablesClientListResponse, error) {
