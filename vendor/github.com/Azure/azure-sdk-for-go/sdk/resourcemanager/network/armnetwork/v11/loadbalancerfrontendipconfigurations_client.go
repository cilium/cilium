...
func (client *LoadBalancerFrontendIPConfigurationsClient) getHandleResponse(resp *http.Response, successCodes ...int) (LoadBalancerFrontendIPConfigurationsClientGetResponse, error) {
...
func (client *LoadBalancerFrontendIPConfigurationsClient) listCreateRequest(ctx context.Context, resourceGroupName string, loadBalancerName string, nextLink string, _ *LoadBalancerFrontendIPConfigurationsClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *LoadBalancerFrontendIPConfigurationsClient) listHandleResponse(resp *http.Response, successCodes ...int) (LoadBalancerFrontendIPConfigurationsClientListResponse, error) {
