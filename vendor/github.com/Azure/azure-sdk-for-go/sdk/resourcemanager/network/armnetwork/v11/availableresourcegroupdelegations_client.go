...
func (client *AvailableResourceGroupDelegationsClient) NewListPager(location string, resourceGroupName string, options *AvailableResourceGroupDelegationsClientListOptions) *runtime.Pager[AvailableResourceGroupDelegationsClientListResponse] {
	return runtime.NewPager(runtime.PagingHandler[AvailableResourceGroupDelegationsClientListResponse]{
		...
		Fetcher: func(ctx context.Context, page *AvailableResourceGroupDelegationsClientListResponse) (AvailableResourceGroupDelegationsClientListResponse, error) {
			...
			req, err := client.listCreateRequest(ctx, location, resourceGroupName, nextLink, options)
			if err != nil {
...
func (client *AvailableResourceGroupDelegationsClient) listCreateRequest(ctx context.Context, location string, resourceGroupName string, nextLink string, _ *AvailableResourceGroupDelegationsClientListOptions) (*policy.Request, error) {
	firstPage := nextLink == ""
...
func (client *AvailableResourceGroupDelegationsClient) listHandleResponse(resp *http.Response, successCodes ...int) (AvailableResourceGroupDelegationsClientListResponse, error) {
