...
func (c *Client) addOperationGetSnapshotBlockPublicAccessStateMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err = addGetSnapshotBlockPublicAccessStateResolveEndpointMiddleware(stack, options); err != nil {
		return err
	}
...
type opGetSnapshotBlockPublicAccessStateResolveEndpointMiddleware struct {
	EndpointResolver EndpointResolverV2
	BuiltInResolver  builtInParameterResolver
}

func (*opGetSnapshotBlockPublicAccessStateResolveEndpointMiddleware) ID() string {
	return "ResolveEndpointV2"
}

func (m *opGetSnapshotBlockPublicAccessStateResolveEndpointMiddleware) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
...
func addGetSnapshotBlockPublicAccessStateResolveEndpointMiddleware(stack *middleware.Stack, options Options) error {
	return stack.Serialize.Insert(&opGetSnapshotBlockPublicAccessStateResolveEndpointMiddleware{
