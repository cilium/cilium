...
var file_cilium_api_nphds_proto_depIdxs = []int32{
	...
	2, // 2: cilium.NetworkPolicyHostsDiscoveryService.DeltaNetworkPolicyHosts:input_type -> envoy.service.discovery.v3.DeltaDiscoveryRequest
	3, // 3: cilium.NetworkPolicyHostsDiscoveryService.StreamNetworkPolicyHosts:output_type -> envoy.service.discovery.v3.DiscoveryResponse
	3, // 4: cilium.NetworkPolicyHostsDiscoveryService.FetchNetworkPolicyHosts:output_type -> envoy.service.discovery.v3.DiscoveryResponse
	4, // 5: cilium.NetworkPolicyHostsDiscoveryService.DeltaNetworkPolicyHosts:output_type -> envoy.service.discovery.v3.DeltaDiscoveryResponse
