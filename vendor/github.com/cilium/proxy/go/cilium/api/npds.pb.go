...
type HttpNetworkPolicyRule struct {
	...
	// impose_headers is a map of HTTP header name and value pairs that
	// will be placed into request headers, if all the match requirements
	// are met, and if not already present with the given value.  A missing
	// or incorrect value will not cause the request to be dropped, but
	// this will be noted in the generated access log message.
	//
	// Optional.
	ImposeHeaders        map[string]string `protobuf:"bytes,2,rep,name=impose_headers,json=imposeHeaders,proto3" json:"impose_headers,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	XXX_NoUnkeyedLiteral struct{}          `json:"-"`
	XXX_unrecognized     []byte            `json:"-"`
	XXX_sizecache        int32             `json:"-"`
}
...
func (m *HttpNetworkPolicyRule) GetImposeHeaders() map[string]string {
	if m != nil {
		return m.ImposeHeaders
	}
	return nil
}
...
func init() {
	...
	proto.RegisterMapType((map[string]string)(nil), "cilium.HttpNetworkPolicyRule.ImposeHeadersEntry")
...
var fileDescriptor_c04d25916f7381d1 = []byte{
	...
	,
}
