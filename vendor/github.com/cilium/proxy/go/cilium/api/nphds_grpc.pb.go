...
const (
	...
	NetworkPolicyHostsDiscoveryService_DeltaNetworkPolicyHosts_FullMethodName  = "/cilium.NetworkPolicyHostsDiscoveryService/DeltaNetworkPolicyHosts"
)
...
type NetworkPolicyHostsDiscoveryServiceClient interface {
	...
	DeltaNetworkPolicyHosts(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[v3.DeltaDiscoveryRequest, v3.DeltaDiscoveryResponse], error)
}
...
func (c *networkPolicyHostsDiscoveryServiceClient) DeltaNetworkPolicyHosts(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[v3.DeltaDiscoveryRequest, v3.DeltaDiscoveryResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &NetworkPolicyHostsDiscoveryService_ServiceDesc.Streams[1], NetworkPolicyHostsDiscoveryService_DeltaNetworkPolicyHosts_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type NetworkPolicyHostsDiscoveryService_DeltaNetworkPolicyHostsClient = grpc.BidiStreamingClient[v3.DeltaDiscoveryRequest, v3.DeltaDiscoveryResponse]
...
type NetworkPolicyHostsDiscoveryServiceServer interface {
	...
	DeltaNetworkPolicyHosts(grpc.BidiStreamingServer[v3.DeltaDiscoveryRequest, v3.DeltaDiscoveryResponse]) error
...
func (UnimplementedNetworkPolicyHostsDiscoveryServiceServer) DeltaNetworkPolicyHosts(grpc.BidiStreamingServer[v3.DeltaDiscoveryRequest, v3.DeltaDiscoveryResponse]) error {
	return status.Error(codes.Unimplemented, "method DeltaNetworkPolicyHosts not implemented")
}
...
func _NetworkPolicyHostsDiscoveryService_DeltaNetworkPolicyHosts_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(NetworkPolicyHostsDiscoveryServiceServer).DeltaNetworkPolicyHosts(&grpc.GenericServerStream[v3.DeltaDiscoveryRequest, v3.DeltaDiscoveryResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type NetworkPolicyHostsDiscoveryService_DeltaNetworkPolicyHostsServer = grpc.BidiStreamingServer[v3.DeltaDiscoveryRequest, v3.DeltaDiscoveryResponse]
