...
type BpfMetadata struct {
	...
	// l7_lb_identity is the identity of the ingress listener. Optional.
	L7LbIdentity uint32 `protobuf:"varint,10,opt,name=l7_lb_identity,json=l7LbIdentity,proto3" json:"l7_lb_identity,omitempty"`
	// l7_policy_identity is the endpoint id. Optional.
	L7LbPolicyIdentity uint32 `protobuf:"varint,11,opt,name=l7_lb_policy_identity,json=l7LbPolicyIdentity,proto3" json:"l7_lb_policy_identity,omitempty"`
}
...
func (x *BpfMetadata) GetL7LbIdentity() uint32 {
	if x != nil {
		return x.L7LbIdentity
	}
	return 0
}

func (x *BpfMetadata) GetL7LbPolicyIdentity() uint32 {
	if x != nil {
		return x.L7LbPolicyIdentity
	}
	return 0
}
...
var file_cilium_api_bpf_metadata_proto_rawDesc = []byte{
	...
	0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x82, 0x04, 0x0a, 0x0b, 0x42, 0x70, 0x66, 0x4d,
	...
	0x6d, 0x69, 0x74, 0x12, 0x24, 0x0a, 0x0e, 0x6c, 0x37, 0x5f, 0x6c, 0x62, 0x5f, 0x69, 0x64, 0x65,
	0x6e, 0x74, 0x69, 0x74, 0x79, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0c, 0x6c, 0x37, 0x4c,
	0x62, 0x49, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x12, 0x31, 0x0a, 0x15, 0x6c, 0x37, 0x5f,
	0x6c, 0x62, 0x5f, 0x70, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x5f, 0x69, 0x64, 0x65, 0x6e, 0x74, 0x69,
	0x74, 0x79, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x12, 0x6c, 0x37, 0x4c, 0x62, 0x50, 0x6f,
	0x6c, 0x69, 0x63, 0x79, 0x49, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x42, 0x2e, 0x5a, 0x2c,
