...
// ValidateAll checks the field values on StreamTracesResponse with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// StreamTracesResponseMultiError, or nil if none found.
func (m *StreamTracesResponse) ValidateAll() error {
	return m.validate(true)
}

func (m *StreamTracesResponse) validate(all bool) error {
	if m == nil {
		return nil
	}
...
// StreamTracesResponseMultiError is an error wrapping multiple validation
// errors returned by StreamTracesResponse.ValidateAll() if the designated
...
func (m StreamTracesResponseMultiError) AllErrors() []error { return m }
...
// ValidateAll checks the field values on StreamTracesMessage with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// StreamTracesMessageMultiError, or nil if none found.
func (m *StreamTracesMessage) ValidateAll() error {
	return m.validate(true)
}

func (m *StreamTracesMessage) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if all {
		...
		case interface{ ValidateAll() error }:
			if err := v.ValidateAll(); err != nil {
				errors = append(errors, StreamTracesMessageValidationError{
					field:  "Identifier",
...
// StreamTracesMessageMultiError is an error wrapping multiple validation
// errors returned by StreamTracesMessage.ValidateAll() if the designated
// constraints aren't met.
...
// AllErrors returns a list of validation violation errors.
func (m StreamTracesMessageMultiError) AllErrors() []error { return m }
...
// ValidateAll checks the field values on StreamTracesMessage_Identifier with
// the rules defined in the proto definition for this message. If any rules
// are violated, the result is a list of violation errors wrapped in
// StreamTracesMessage_IdentifierMultiError, or nil if none found.
func (m *StreamTracesMessage_Identifier) ValidateAll() error {
	return m.validate(true)
}

func (m *StreamTracesMessage_Identifier) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if m.GetNode() == nil {
		err := StreamTracesMessage_IdentifierValidationError{
			field:  "Node",
	...
	if all {
		...
		case interface{ ValidateAll() error }:
			if err := v.ValidateAll(); err != nil {
				errors = append(errors, StreamTracesMessage_IdentifierValidationError{
					field:  "Node",
					reason: "embedded message failed validation",
					cause:  err,
				})
...
// StreamTracesMessage_IdentifierMultiError is an error wrapping multiple
// validation errors returned by StreamTracesMessage_Identifier.ValidateAll()
...
// AllErrors returns a list of validation violation errors.
func (m StreamTracesMessage_IdentifierMultiError) AllErrors() []error { return m }
