...
// ValidateAll checks the field values on ReloadConfig with the rules defined
// in the proto definition for this message. If any rules are violated, the
// result is a list of violation errors wrapped in ReloadConfigMultiError, or
// nil if none found.
func (m *ReloadConfig) ValidateAll() error {
	return m.validate(true)
}

func (m *ReloadConfig) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if all {
		...
		case interface{ ValidateAll() error }:
			if err := v.ValidateAll(); err != nil {
				errors = append(errors, ReloadConfigValidationError{
					field:  "Backoff",
		...
		if err := v.Validate(); err != nil {
			return ReloadConfigValidationError{
				field:  "Backoff",
				reason: "embedded message failed validation",
				cause:  err,
			}
	...
	if len(errors) > 0 {
		return ReloadConfigMultiError(errors)
	}

	return nil
}

// ReloadConfigMultiError is an error wrapping multiple validation errors
// returned by ReloadConfig.ValidateAll() if the designated constraints aren't met.
...
func (m ReloadConfigMultiError) AllErrors() []error { return m }
...
func (m *PluginConfig) validate(all bool) error {
	...
	// no validation rules for FailurePolicy

	if all {
		switch v := interface{}(m.GetReloadConfig()).(type) {
		case interface{ ValidateAll() error }:
			if err := v.ValidateAll(); err != nil {
				errors = append(errors, PluginConfigValidationError{
					field:  "ReloadConfig",
	...
	} else if v, ok := interface{}(m.GetReloadConfig()).(interface{ Validate() error }); ok {
		if err := v.Validate(); err != nil {
			return PluginConfigValidationError{
				field:  "ReloadConfig",
				reason: "embedded message failed validation",
