...
type FileSystemHttpCacheConfig struct {
	...
	//
	// [#not-implemented-hide:]
	MaxCacheEntrySizeBytes *wrapperspb.UInt64Value `protobuf:"bytes,4,opt,name=max_cache_entry_size_bytes,json=maxCacheEntrySizeBytes,proto3" json:"max_cache_entry_size_bytes,omitempty"`
