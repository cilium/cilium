...
// SubPrice is a nested struct in ecs response
type SubPrice struct {
	...
	RuleIdSet             RuleIdSetInDescribeRenewalPrice  `json:"RuleIdSet" xml:"RuleIdSet"`
	DepreciateInfo        DepreciateInfo                   `json:"DepreciateInfo" xml:"DepreciateInfo"`
	Promotions            PromotionsInDescribeRenewalPrice `json:"Promotions" xml:"Promotions"`
}
