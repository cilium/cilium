...
const file_envoy_extensions_access_loggers_wasm_v3_wasm_proto_rawDesc = "" +
	"\n" +
	"2envoy/extensions/access_loggers/wasm/v3/wasm.proto\x12'envoy.extensions.access_loggers.wasm.v3\x1a#envoy/extensions/wasm/v3/wasm.proto\x1a\x1dudpa/annotations/status.proto\"O\n" +
	"\rWasmAccessLog\x12>\n" +
	"\x06config\x18\x01 \x01(\v2&.envoy.extensions.wasm.v3.PluginConfigR\x06configB\xa3\x01\xba\x80\xc8\xd1\x06\x02\x10\x02\n" +
	"5io.envoyproxy.envoy.extensions.access_loggers.wasm.v3B\tWasmProtoP\x01ZUgithub.com/envoyproxy/go-control-plane/envoy/extensions/access_loggers/wasm/v3;wasmv3b\x06proto3"

var (
	file_envoy_extensions_access_loggers_wasm_v3_wasm_proto_rawDescOnce sync.Once
	file_envoy_extensions_access_loggers_wasm_v3_wasm_proto_rawDescData []byte
)
...
func file_envoy_extensions_access_loggers_wasm_v3_wasm_proto_rawDescGZIP() []byte {
	file_envoy_extensions_access_loggers_wasm_v3_wasm_proto_rawDescOnce.Do(func() {
		file_envoy_extensions_access_loggers_wasm_v3_wasm_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_envoy_extensions_access_loggers_wasm_v3_wasm_proto_rawDesc), len(file_envoy_extensions_access_loggers_wasm_v3_wasm_proto_rawDesc)))
	})
...
func file_envoy_extensions_access_loggers_wasm_v3_wasm_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_envoy_extensions_access_loggers_wasm_v3_wasm_proto_rawDesc), len(file_envoy_extensions_access_loggers_wasm_v3_wasm_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
