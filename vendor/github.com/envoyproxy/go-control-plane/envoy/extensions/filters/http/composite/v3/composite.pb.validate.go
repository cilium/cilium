...
// Validate checks the field values on CompositePerRoute with the rules defined
// in the proto definition for this message. If any rules are violated, the
// first error encountered is returned, or nil if there are no violations.
func (m *CompositePerRoute) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on CompositePerRoute with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// CompositePerRouteMultiError, or nil if none found.
func (m *CompositePerRoute) ValidateAll() error {
	return m.validate(true)
}

func (m *CompositePerRoute) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if m.GetMatcher() == nil {
		err := CompositePerRouteValidationError{
			field:  "Matcher",
	...
	if all {
		...
		case interface{ ValidateAll() error }:
			if err := v.ValidateAll(); err != nil {
				errors = append(errors, CompositePerRouteValidationError{
					field:  "Matcher",
					reason: "embedded message failed validation",
					cause:  err,
				})
		...
		if err := v.Validate(); err != nil {
			return CompositePerRouteValidationError{
				field:  "Matcher",
				reason: "embedded message failed validation",
				cause:  err,
			}
	...
	if len(errors) > 0 {
		return CompositePerRouteMultiError(errors)
	}

	return nil
}

// CompositePerRouteMultiError is an error wrapping multiple validation errors
// returned by CompositePerRoute.ValidateAll() if the designated constraints
// aren't met.
type CompositePerRouteMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m CompositePerRouteMultiError) Error() string {
	msgs := make([]string, 0, len(m))
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m CompositePerRouteMultiError) AllErrors() []error { return m }

// CompositePerRouteValidationError is the validation error returned by
// CompositePerRoute.Validate if the designated constraints aren't met.
type CompositePerRouteValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e CompositePerRouteValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e CompositePerRouteValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e CompositePerRouteValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e CompositePerRouteValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e CompositePerRouteValidationError) ErrorName() string {
	return "CompositePerRouteValidationError"
}

// Error satisfies the builtin error interface
func (e CompositePerRouteValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sCompositePerRoute.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = CompositePerRouteValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = CompositePerRouteValidationError{}
