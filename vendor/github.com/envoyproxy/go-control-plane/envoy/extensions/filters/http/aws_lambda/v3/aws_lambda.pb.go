...
type Config struct {
	...
	MatchExcludedHeaders []*v3.StringMatcher `protobuf:"bytes,7,rep,name=match_excluded_headers,json=matchExcludedHeaders,proto3" json:"match_excluded_headers,omitempty"`
	...
	MatchIncludedHeaders []*v3.StringMatcher `protobuf:"bytes,8,rep,name=match_included_headers,json=matchIncludedHeaders,proto3" json:"match_included_headers,omitempty"`
...
func (x *Config) GetMatchExcludedHeaders() []*v3.StringMatcher {
	if x != nil {
...
func (x *Config) GetMatchIncludedHeaders() []*v3.StringMatcher {
	if x != nil {
...
const file_envoy_extensions_filters_http_aws_lambda_v3_aws_lambda_proto_rawDesc = "" +
	"\n" +
	"<envoy/extensions/filters/http/aws_lambda/v3/aws_lambda.proto\x12+envoy.extensions.filters.http.aws_lambda.v3\x1a\"envoy/type/matcher/v3/string.proto\x1a\x1dudpa/annotations/status.proto\x1a!udpa/annotations/versioning.proto\x1a\x17validate/validate.proto\"\xa3\x05\n" +
	"\x06Config\x12\x19\n" +
	...
	"\vcredentials\x18\x06 \x01(\v28.envoy.extensions.filters.http.aws_lambda.v3.CredentialsR\vcredentials\x12Z\n" +
	"\x16match_excluded_headers\x18\a \x03(\v2$.envoy.type.matcher.v3.StringMatcherR\x14matchExcludedHeaders\x12Z\n" +
	"\x16match_included_headers\x18\b \x03(\v2$.envoy.type.matcher.v3.StringMatcherR\x14matchIncludedHeaders\"3\n" +
...
var file_envoy_extensions_filters_http_aws_lambda_v3_aws_lambda_proto_depIdxs = []int32{
	...
	4, // 2: envoy.extensions.filters.http.aws_lambda.v3.Config.match_excluded_headers:type_name -> envoy.type.matcher.v3.StringMatcher
	4, // 3: envoy.extensions.filters.http.aws_lambda.v3.Config.match_included_headers:type_name -> envoy.type.matcher.v3.StringMatcher
	1, // 4: envoy.extensions.filters.http.aws_lambda.v3.PerRouteConfig.invoke_config:type_name -> envoy.extensions.filters.http.aws_lambda.v3.Config
