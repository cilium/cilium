...
func (m *CommonGeoipProviderConfig_GeolocationHeadersToAdd) MarshalToSizedBufferVTStrict(dAtA []byte) (int, error) {
	...
	if len(m.Anon) > 0 {
		i -= len(m.Anon)
		copy(dAtA[i:], m.Anon)
		i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.Anon)))
		i--
		dAtA[i] = 0x62
	}
	if len(m.ApplePrivateRelay) > 0 {
		i -= len(m.ApplePrivateRelay)
		copy(dAtA[i:], m.ApplePrivateRelay)
		i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.ApplePrivateRelay)))
		i--
		dAtA[i] = 0x5a
	}
	if len(m.Isp) > 0 {
		i -= len(m.Isp)
		copy(dAtA[i:], m.Isp)
		i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.Isp)))
		i--
		dAtA[i] = 0x52
	}
...
func (m *CommonGeoipProviderConfig_GeolocationFieldKeys) MarshalVTStrict() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *CommonGeoipProviderConfig_GeolocationFieldKeys) MarshalToVTStrict(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVTStrict(dAtA[:size])
}

func (m *CommonGeoipProviderConfig_GeolocationFieldKeys) MarshalToSizedBufferVTStrict(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
...
func (m *CommonGeoipProviderConfig) MarshalToSizedBufferVTStrict(dAtA []byte) (int, error) {
	...
	if m.GeoFieldKeys != nil {
		size, err := m.GeoFieldKeys.MarshalToSizedBufferVTStrict(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *CommonGeoipProviderConfig_GeolocationFieldKeys) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
