...
const file_envoy_type_range_proto_rawDesc = "" +
	"\n" +
	"\x16envoy/type/range.proto\x12\n" +
	"envoy.type\x1a\x1dudpa/annotations/status.proto\"4\n" +
	"\n" +
	"Int64Range\x12\x14\n" +
	...
	"\x03end\x18\x02 \x01(\x01R\x03endBc\xba\x80\xc8\xd1\x06\x02\x10\x01\n" +
	"\x18io.envoyproxy.envoy.typeB\n" +
	"RangeProtoP\x01Z1github.com/envoyproxy/go-control-plane/envoy/typeb\x06proto3"

var (
	file_envoy_type_range_proto_rawDescOnce sync.Once
	file_envoy_type_range_proto_rawDescData []byte
)

func file_envoy_type_range_proto_rawDescGZIP() []byte {
	file_envoy_type_range_proto_rawDescOnce.Do(func() {
		file_envoy_type_range_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_envoy_type_range_proto_rawDesc), len(file_envoy_type_range_proto_rawDesc)))
	})
	return file_envoy_type_range_proto_rawDescData
}

var file_envoy_type_range_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_envoy_type_range_proto_goTypes = []any{
...
func file_envoy_type_range_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_envoy_type_range_proto_rawDesc), len(file_envoy_type_range_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
