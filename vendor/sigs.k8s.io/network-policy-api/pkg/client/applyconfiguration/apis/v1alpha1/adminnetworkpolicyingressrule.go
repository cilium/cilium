...
func (b *AdminNetworkPolicyIngressRuleApplyConfiguration) WithAction(value apisv1alpha1.AdminNetworkPolicyRuleAction) *AdminNetworkPolicyIngressRuleApplyConfiguration {
	b.Action = &value
	return b
}
