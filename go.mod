...
replace (
	...
	github.com/aws/aws-sdk-go-v2 => github.com/aws/aws-sdk-go-v2 v0.14.0
	...
	github.com/go-openapi/loads => github.com/go-openapi/loads v0.19.3
	github.com/go-openapi/runtime => github.com/go-openapi/runtime v0.19.6
	...
	github.com/go-openapi/validate => github.com/go-openapi/validate v0.19.3
	...
	github.com/google/go-querystring => github.com/google/go-querystring v0.0.0-20170111101155-53e6ce116135
	...
	github.com/mattn/go-isatty => github.com/mattn/go-isatty v0.0.10
	github.com/mattn/go-runewidth => github.com/mattn/go-runewidth v0.0.2
	github.com/mattn/go-shellwords => github.com/mattn/go-shellwords v1.0.6
	...
	github.com/onsi/ginkgo => github.com/onsi/ginkgo v1.10.2
	...
	github.com/pelletier/go-toml => github.com/pelletier/go-toml v1.5.0
	...
	github.com/shirou/gopsutil => github.com/shirou/gopsutil v2.19.9+incompatible
	...
	go.uber.org/multierr => go.uber.org/multierr v1.2.0
	go.uber.org/zap => go.uber.org/zap v1.10.0
	golang.org/x/crypto => golang.org/x/crypto v0.0.0-20190820162420-60c769a6c586
	golang.org/x/exp => golang.org/x/exp v0.0.0-20191014171548-69215a2ee97e
	golang.org/x/image => golang.org/x/image v0.0.0-20191009234506-e7c1f5e7dbb8
	golang.org/x/lint => golang.org/x/lint v0.0.0-20190930215403-16217165b5de
	golang.org/x/mobile => golang.org/x/mobile v0.0.0-20191002175909-6d0d39b2ca82
	golang.org/x/mod => golang.org/x/mod v0.1.1-0.20190911151517-c5eba5822913
	...
	golang.org/x/time => golang.org/x/time v0.0.0-20190921001708-c4c64cad1fd0
	...
	google.golang.org/genproto => google.golang.org/genproto v0.0.0-20191009194640-548a555dbc03
	...
	// b3cbbae08ec52a7fc73d334838e18d17e8512749 -> k8s v1.16.2
	k8s.io/api => k8s.io/kubernetes/staging/src/k8s.io/api v0.0.0-20191110224336-b3cbbae08ec5
	k8s.io/apiextensions-apiserver => k8s.io/kubernetes/staging/src/k8s.io/apiextensions-apiserver v0.0.0-20191110224336-b3cbbae08ec5
	k8s.io/apimachinery => k8s.io/kubernetes/staging/src/k8s.io/apimachinery v0.0.0-20191110224336-b3cbbae08ec5
	k8s.io/apiserver => k8s.io/kubernetes/staging/src/k8s.io/apiserver v0.0.0-20191110224336-b3cbbae08ec5
	k8s.io/cli-runtime => k8s.io/kubernetes/staging/src/k8s.io/cli-runtime v0.0.0-20191110224336-b3cbbae08ec5
	k8s.io/client-go => github.com/cilium/client-go v0.0.0-20191114212527-f525a083bcf5
	k8s.io/cloud-provider => k8s.io/kubernetes/staging/src/k8s.io/cloud-provider v0.0.0-20191110224336-b3cbbae08ec5
	k8s.io/cluster-bootstrap => k8s.io/kubernetes/staging/src/k8s.io/cluster-bootstrap v0.0.0-20191110224336-b3cbbae08ec5
	k8s.io/code-generator => k8s.io/kubernetes/staging/src/k8s.io/code-generator v0.0.0-20191110224336-b3cbbae08ec5
	k8s.io/component-base => k8s.io/kubernetes/staging/src/k8s.io/component-base v0.0.0-20191110224336-b3cbbae08ec5
	k8s.io/cri-api => k8s.io/kubernetes/staging/src/k8s.io/cri-api v0.0.0-20191110224336-b3cbbae08ec5
	k8s.io/csi-translation-lib => k8s.io/kubernetes/staging/src/k8s.io/csi-translation-lib v0.0.0-20191110224336-b3cbbae08ec5
	k8s.io/gengo => k8s.io/gengo v0.0.0-20190822140433-26a664648505
	k8s.io/heapster => k8s.io/heapster v1.2.0-beta.1
	k8s.io/klog => k8s.io/klog v0.4.0
	k8s.io/kube-aggregator => k8s.io/kubernetes/staging/src/k8s.io/kube-aggregator v0.0.0-20191110224336-b3cbbae08ec5
	k8s.io/kube-controller-manager => k8s.io/kubernetes/staging/src/k8s.io/kube-controller-manager v0.0.0-20191110224336-b3cbbae08ec5
	k8s.io/kube-openapi => k8s.io/kube-openapi v0.0.0-20190816220812-743ec37842bf
	k8s.io/kube-proxy => k8s.io/kubernetes/staging/src/k8s.io/kube-proxy v0.0.0-20191110224336-b3cbbae08ec5
	k8s.io/kube-scheduler => k8s.io/kubernetes/staging/src/k8s.io/kube-scheduler v0.0.0-20191110224336-b3cbbae08ec5
	k8s.io/kubectl => k8s.io/kubernetes/staging/src/k8s.io/kubectl v0.0.0-20191110224336-b3cbbae08ec5
	k8s.io/kubelet => k8s.io/kubernetes/staging/src/k8s.io/kubelet v0.0.0-20191110224336-b3cbbae08ec5
	k8s.io/kubernetes => k8s.io/kubernetes v1.16.3
	k8s.io/legacy-cloud-providers => k8s.io/kubernetes/staging/src/k8s.io/legacy-cloud-providers v0.0.0-20191110224336-b3cbbae08ec5
	k8s.io/metrics => k8s.io/kubernetes/staging/src/k8s.io/metrics v0.0.0-20191110224336-b3cbbae08ec5
	k8s.io/repo-infra => k8s.io/repo-infra v0.0.0-20181204233714-00fe14e3d1a3
	k8s.io/sample-apiserver => k8s.io/kubernetes/staging/src/k8s.io/sample-apiserver v0.0.0-20191110224336-b3cbbae08ec5
