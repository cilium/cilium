...
replace github.com/cilium/cilium/pkg/k8s/apis/cilium.io/v2 => ./pkg/k8s/apis/cilium.io/v2
...
require (
	...
	github.com/cilium/cilium/pkg/k8s/apis/cilium.io/v2 v2.0.0-00010101000000-000000000000
