...
func ciliumDbgCommands(cmdDir string) []string {
	ciliumDbgCommands := []string{
		...
		"cilium-dbg policy selectors --top-identities --show-direction --limit 0 -o json",
		"cilium-dbg policy selectors --top-endpoints --limit 0 -o json",
		"cilium-dbg policy selectors --top-endpoints --show-direction --limit 0 -o json",
