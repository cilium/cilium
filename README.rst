...
|cii| |go-report| |clomonitor| |artifacthub| |slack| |go-doc| |rtd| |apache| |bsd| |gpl| |fossa| |gateway-api| |codespaces| |openssf scorecard|
...
+---------------------------------------------------------+------------+------------------------------------+----------------------------------------------------------------------------+
| `v1.15 <https://github.com/cilium/cilium/tree/v1.15>`__ | 2024-05-10 | ``quay.io/cilium/cilium:v1.15.5``  | `Release Notes <https://github.com/cilium/cilium/releases/tag/v1.15.5>`__  |
+---------------------------------------------------------+------------+------------------------------------+----------------------------------------------------------------------------+
| `v1.14 <https://github.com/cilium/cilium/tree/v1.14>`__ | 2024-05-10 | ``quay.io/cilium/cilium:v1.14.11`` | `Release Notes <https://github.com/cilium/cilium/releases/tag/v1.14.11>`__ |
+---------------------------------------------------------+------------+------------------------------------+----------------------------------------------------------------------------+
| `v1.13 <https://github.com/cilium/cilium/tree/v1.13>`__ | 2024-05-10 | ``quay.io/cilium/cilium:v1.13.16`` | `Release Notes <https://github.com/cilium/cilium/releases/tag/v1.13.16>`__ |
+---------------------------------------------------------+------------+------------------------------------+----------------------------------------------------------------------------+
...
+--------------------------------------------------------------------------------------+------------+----------------------------------------------+-------------------------------------------------------------------------------------------+
| `v1.16.0-pre.3 <https://github.com/cilium/cilium/commits/v1.16.0-pre.3>`__           | 2024-06-03 | ``quay.io/cilium/cilium:v1.16.0-pre.3``      | `Release Candidate Notes <https://github.com/cilium/cilium/releases/tag/v1.16.0-pre.3>`__ |
+--------------------------------------------------------------------------------------+------------+----------------------------------------------+-------------------------------------------------------------------------------------------+
...
.. |openssf scorecard| image:: https://api.securityscorecards.dev/projects/github.com/cilium/cilium/badge
    ...
    :target: https://api.securityscorecards.dev/projects/github.com/cilium/cilium
