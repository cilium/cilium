...
+----------------------------------------------------------------------------+------------+-----------------------------------------+---------------------------------------------------------------------------------+
| `v1.20.0-rc.0 <https://github.com/cilium/cilium/commits/v1.20.0-rc.0>`__   | 2026-07-14 | ``quay.io/cilium/cilium:v1.20.0-rc.0``  | `Release Notes <https://github.com/cilium/cilium/releases/tag/v1.20.0-rc.0>`__  |
+----------------------------------------------------------------------------+------------+-----------------------------------------+---------------------------------------------------------------------------------+
